...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-thanh-toan/thanh-toan-qua-mb-bank/
---
...
Nhằm hỗ trợ các gian hàng thúc đẩy việc thanh toán phi tiền mặt, KiotViet kết hợp cùng ngân hàng MB Bank đã ra mắt tính năng thanh toán chuyển khoản bằng phương pháp quét mã VietQR và nhận thông báo kết quả ngay trên phần mềm.

**Đối tượng áp dụng:** Tất cả gian hàng trên KiotViet (bao gồm cả gian hàng dùng thử và gian hàng chính thức) có tài khoản tại ngân hàng MB Bank.

**Lợi ích nổi bật của tính năng**:

* **Giúp chủ cửa hàng và quản lý:** Dễ dàng đăng ký và quản lý nhiều tài khoản MB Bank trên cùng một gian hàng, giúp việc đối soát và theo dõi dòng tiền trở nên đơn giản và tập trung.
...
**Tóm tắt luồng hoạt động**: Về cơ bản, luồng hoạt động của tính năng bao gồm 2 bước chính: 1. Đăng ký dịch vụ nhận thông báo thanh toán của MB Bank -> 2. Nhận thông báo kết quả giao dịch trên màn hình **Bán hàng**.
...
* **Lưu ý về nguyên tắc liên kết tài khoản MB Bank:**
  + Một gian hàng KiotViet có thể liên kết với **nhiều tài khoản MB Bank**.
  + Một tài khoản MB Bank tại một thời điểm **chỉ có thể liên kết với một gian hàng KiotViet duy nhất**. Nếu muốn sử dụng tài khoản cho gian hàng khác, bạn cần hủy liên kết ở gian hàng cũ trước.
  + Quá trình này được thực hiện như sau:

#### **1.1. Đăng ký dịch vụ trên KiotViet**

– Tài khoản admin của chủ gian hàng đăng nhập vào màn hình **Quản lý**, chọn mục **Thanh toán** và nhấn ***Đăng ký*** tại thẻ **MB Bank**.

* Hoặc trên màn hình **Bán hàng**,
* Ngay sau khi ***Lưu*** thông tin thêm tài khoản ngân hàng MB -> hệ thống hiển thị popup **Bật thông báo thanh toán QR**, bạn chọn ***Bật ngay***
* Hay khi tạo đơn hàng, bạn chọn phương thức thanh toán ***Chuyển khoản*** -> chọn tài khoản **MB** -> nhấn ***Nhận thông báo tiền về***

* Tiếp theo, bạn chọn loại tài khoản là **Cá nhân** (tương ứng tài khoản cá nhân/hộ kinh doanh tại ngân hàng) hoặc **Doanh nghiệp** và điền đầy đủ thông tin được yêu cầu:
  + **Với tài khoản cá nhân/hộ kinh doanh**: Bạn điền các thông tin Số tài khoản, Chủ tài khoản, CCCD/CMT/Hộ chiếu, Số điện thoại.

* **Với tài khoản doanh nghiệp**: Bạn điền các thông tin Số tài khoản, Tên tài khoản doanh nghiệp, Mã số thuế, Số điện thoại, Giấy phép đăng ký kinh doanh.

* Tích vào ô đồng ý với điều khoản và chọn ***Đăng ký***.

#### **1.2. Xác thực bằng mã OTP với tài khoản cá nhân/hộ kinh doanh**

– Sau khi nhấn ***Đăng ký***, với tài khoản cá nhân/hộ kinh doanh, hệ thống sẽ gửi một mã OTP đến số điện thoại bạn đã đăng ký với ngân hàng MB Bank.
...
#### **1.3. Tiếp nhận và xử lý yêu cầu với tài khoản doanh nghiệp**

- Với tài khoản doanh nghiệp, sau khi bạn gửi thông tin đăng ký thành công → KiotViet sẽ tiếp nhận và xử lý yêu cầu trong vòng 3 ngày làm việc.

- Nếu thông tin đăng ký chính xác, chuyên viên KiotViet sẽ liên hệ để xác nhận yêu cầu và kích hoạt tính năng trên gian hàng.

- Nếu thông tin đăng ký chưa chính xác, hệ thống sẽ hủy yêu cầu, bạn vui lòng điền lại thông tin đăng ký chính xác để sử dụng tính năng.

### **2. Nhận thông báo kết quả giao dịch**

* **Tình huống**: Khi khách hàng thực hiện thanh toán, hệ thống sẽ tự động hiển thị kết quả ngay trên màn hình **Bán hàng** để bạn xác nhận.
* Thao tác trên màn hình **Bán hàng**:
  + Khi tạo hóa đơn, bạn chọn phương thức thanh toán Chuyển khoản để hiển thị mã QR của tài khoản MB Bank đã liên kết.
...
### **1. Xem danh sách tài khoản MB Bank đã đăng ký dịch vụ**

* **Tình huống**: Khi bạn cần kiểm tra lại thông tin các tài khoản MB Bank nào đang được kết nối để nhận thông báo tự động trên KiotViet.
* **Thao tác thực hiện như sau**:

1. Tại màn hình **Quản lý**, vào menu **Thanh toán**.
2. Chọn thẻ **MB Bank** và nhấn **Xem chi tiết** để xem danh sách các tài khoản đã liên kết.

### **2. Hủy dịch vụ nhận thông báo thanh toán MB Bank**

* **Tình huống:** Khi bạn không còn nhu cầu sử dụng dịch vụ nhận thông báo tự động cho một tài khoản MB Bank cụ thể.
* **Thao tác thực hiện như sau**:
...
– Chọn thẻ **MB Bank**, điền các thông tin cần thiết và nhấn ***Tiếp tục***.
...
– Truy cập mục **Thanh toán** và chọn thẻ **MB Bank**.
