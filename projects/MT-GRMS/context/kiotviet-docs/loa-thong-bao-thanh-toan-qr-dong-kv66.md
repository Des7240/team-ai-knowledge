...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-thiet-bi-phan-cung/loa-thong-bao-thanh-toan-qr-dong-kv66/
---
...
Tài liệu này cung cấp hướng dẫn chi tiết để cài đặt và sử dụng thiết bị Loa thông báo thanh toán QR động KV66 của KiotViet. Đây là thiết bị thông minh tích hợp màn hình hiển thị mã QR động cùng loa phát âm thanh thông báo ngay khi giao dịch chuyển khoản thành công, giúp chủ cửa hàng và thu ngân xử lý thanh toán chính xác, nhanh chóng ngay tại quầy.

**Thông số kỹ thuật và Cấu hình phần cứng:**

* **Nguồn điện & Pin:**
  + Thiết bị sử dụng pin sạc qua cổng Type-C.
  + Thời gian sạc đầy là 6 tiếng với củ sạc (adapter) 5V 1A (khi sạc đầy có thể rút dây ra để sử dụng linh hoạt).

* **Chi tiết hệ thống nút bấm (Mặt sau):**
  + **Nút 1 (Volume+):** Nhấn để tăng âm lượng loa.
  + **Nút 2 (Volume-):** Nhấn để giảm âm lượng loa.
  + **Nút 3 (Repeat - Biểu tượng mũi tên quay tròn):** Nhấn để nghe lại thông báo số tiền giao dịch gần nhất; Nhấn và giữ để kích hoạt chế độ cấu hình Wi-Fi ("Chế độ chia sẻ mạng lân cận").
  + **Nút 4 (Power - Nút nguồn):** Nhấn và giữ để bật/tắt thiết bị; Nhấn 1 lần khi máy đang bật để nghe thông báo trạng thái hoạt động hiện tại.

* **Chi tiết đèn báo tín hiệu (Indicator):**
  + **Đèn màu trắng:** Thiết bị đã bật nguồn.
  + **Đèn xanh lá nhấp nháy:** Thiết bị đang trong quá trình tìm kiếm mạng.
  + **Đèn màu xanh dương:** Kết nối mạng Wi-Fi thành công.
  + **Đèn đỏ nhấp nháy:** Cảnh báo pin yếu, cần cắm sạc.
  + **Đèn màu xanh lá (sáng cố định):** Thiết bị đang phát thông báo âm thanh.

**Lợi ích nổi bật của tính năng:**

* **Thanh toán chính xác tuyệt đối:** Tự động tạo mã QR động chứa thông tin tài khoản và chính xác số tiền của hóa đơn, loại bỏ hoàn toàn rủi ro khách hàng nhập sai số tiền hoặc số tài khoản.
* **Thông báo âm thanh tức thì:** Loa trên thiết bị KV66 phát âm thanh xác nhận ngay khi tiền về tài khoản, thu ngân không cần chờ đợi hay chụp lại màn hình điện thoại của khách hàng.
* **Tăng tốc độ giao dịch:** Giúp nhân viên xử lý thanh toán chỉ trong khoảng 5 giây, giảm thiểu ùn tắc tại quầy thu ngân trong giờ cao điểm.
* **Cấu hình gọn nhẹ, chuyên nghiệp:** Kết nối mạng Wi-Fi linh hoạt, không cần cắm dây phức tạp, mang lại hình ảnh hiện đại cho cửa hàng.

​

## **II. Các thao tác cơ bản**

### **1. Cấu hình Wi-Fi cho thiết bị KV66**

**Tình huống:** Khi mới mua thiết bị hoặc khi cửa hàng thay đổi mạng Wi-Fi, bạn cần thực hiện cài đặt Wi-Fi cho Payment Soundbox KV66 để thiết bị kết nối vào mạng nội bộ của cửa hàng.

**Thao tác thực hiện như sau:**

* **Bước 1:** Quay mặt lưng máy, bạn nhấn và giữ nút mũi tên quay tròn (Nút số 3 - Repeat) cho đến khi thiết bị phát ra âm thanh thông báo "Chế độ chia sẻ mạng lân cận".

* **Bước 2:** Trên máy tính hoặc điện thoại, bạn truy cập phần cài đặt Wi-Fi và kết nối với mạng Wi-Fi phát ra từ thiết bị có tên dạng **QR payment device...**

* **Bước 3:** Sau khi kết nối thành công, màn hình sẽ tự động bật cửa sổ/trình duyệt cấu hình. Nếu cửa sổ không tự động bật, bạn mở trình duyệt web và nhập địa chỉ 192.168.1.1 rồi nhấn Enter.

* **Bước 4:** Tại giao diện cấu hình, bạn chọn đúng tên Wi-Fi của cửa hàng, nhập mật khẩu Wi-Fi và nhấn kết nối. Thiết bị KV66 sẽ phát âm thanh thông báo khi kết nối Wi-Fi thành công.

* **Bước 5:** Kết nối lại máy tính hoặc điện thoại của bạn về mạng Wi-Fi chính của cửa hàng như bình thường.

### **2. Khai báo tài khoản ngân hàng**

**Tình huống:** Để thiết bị KV66 có thể tạo mã QR với đúng thông tin nhận tiền của cửa hàng, bạn cần thiết lập tài khoản ngân hàng trên phần mềm KiotViet.

**Thao tác thực hiện như sau:**

* **Bước 1:** Trên màn hình quản lý KiotViet, bạn truy cập vào menu **Sổ quỹ**.

* **Bước 2:** Bạn chuyển qua tab **Ngân hàng**.
* **Bước 3:** Bạn nhấn vào nút Thêm ở góc trên để thêm mới.

* **Bước 4:** Bạn điền đầy đủ các thông tin yêu cầu bao gồm: Tên ngân hàng, chủ tài khoản, số tài khoản và nhấn lưu lại.

### **3. Đăng ký thông báo thanh toán thành công**

**Tình huống:** Để thiết bị KV66 phát âm thanh thông báo ngay khi giao dịch chuyển khoản thành công, bạn cần đăng ký kích hoạt dịch vụ thông báo thanh toán cho tài khoản ngân hàng hoặc ví điện tử của cửa hàng.

**Các kênh thanh toán hỗ trợ:**

* Các ngân hàng có liên kết với KiotViet (Vietcombank, Vietinbank, BIDV, MB Bank, VIB Bank, VP Bank, Techcombank,...).

* Các ví điện tử doanh nghiệp: MoMo doanh nghiệp, ZaloPay Merchant.

* Mã thanh toán VietQR Global của Napas.

**Thao tác thực hiện như sau:**

* **Bước 1:** Bạn truy cập vào Màn hình quản lý của Phần mềm KiotViet.
* **Bước 2:** Bạn tìm đến mục **Thanh toán** và thực hiện đăng ký tính năng thông báo thanh toán tự động.

### **4. Kết nối và hiển thị mã QR khi thanh toán**

**Tình huống:** Khi khách hàng tại quầy muốn thanh toán hóa đơn bằng hình thức chuyển khoản qua mã QR, bạn thực hiện kết nối thiết bị KV66 trên màn hình bán hàng (trên máy tính) để tạo mã QR và phát thông báo âm thanh.

**Thao tác thực hiện như sau:**

* **Bước 1:** Bạn ưu tiên sử dụng trình duyệt Google Chrome để truy cập vào Màn hình Bán hàng nhằm hạn chế lỗi kết nối chập chờn.
* **Bước 2:** Sau khi đã chọn đủ sản phẩm cho hóa đơn, bạn nhấn **Thanh toán**.

* **Bước 3:** Bạn chọn hình thức thanh toán là **Chuyển khoản** và nhấn nút **Hiện mã QR**.

* **Bước 4:** Bạn chọn **Kết nối thiết bị qua Wifi** và nhập số Seri (Serial) ghi ở mặt dưới đáy máy KV66.

* **Bước 5:** Khi trình duyệt hiển thị thông báo yêu cầu cho phép truy cập mạng nội bộ ("Access other devices on your local network"), bạn nhấn **Allow** (Cho phép).

* **Bước 6:** Sau khi kết nối thành công (thiết bị sẽ tự động ghi nhớ và nhận kết nối cho các lần bán hàng tiếp theo), bạn bật loa nghe thử và tạo mã QR bán hàng bình thường để khách hàng quét mã thanh toán.

**Lưu ý:**

* Thiết bị KV66 hiện hỗ trợ hiển thị mã QR khi thao tác trên Màn hình Bán hàng bằng máy tính. Thiết bị chưa hỗ trợ kết nối trực tiếp trên ứng dụng điện thoại và máy POS Android.

### **5. Tự động thông báo thanh toán thành công và nghe lại thông báo**

**Tình huống:** Bạn muốn nhận xác nhận tức thì bằng âm thanh ngay khi khách hàng thực hiện chuyển khoản thành công tại quầy, hoặc nghe lại thông báo số tiền của giao dịch gần nhất khi quầy bán hàng ồn ào.

**Thao tác thực hiện như sau:**

* **Tự động thông báo thanh toán thành công:** Ngay khi khách hàng quét mã QR và chuyển khoản thành công, thiết bị KV66 sẽ tự động phát loa thông báo rõ ràng số tiền đã nhận được.

* **Nghe lại thông báo giao dịch gần nhất:** Nhấn nút mũi tên quay tròn (Nút số 3 - Repeat) ở mặt sau thiết bị KV66. Thiết bị sẽ ngay lập tức đọc lại thông báo số tiền của giao dịch thành công gần nhất.
