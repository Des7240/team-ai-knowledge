...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-chuyen-nganh/nganh-me-va-be/
---
...
Để đáp ứng những yêu cầu đặc thù của ngành Mẹ và Bé, KiotViet đã phát triển một bộ tính năng chuyên ngành, được thiết kế riêng để giúp các cửa hàng vận hành hiệu quả, chuyên nghiệp và tối ưu hóa việc quản lý sản phẩm. Bộ tính năng này không chỉ là một công cụ quản lý bán hàng thông thường mà còn là một giải pháp toàn diện, tập trung vào việc quản lý các mặt hàng đa dạng (sữa, bỉm, quần áo, đồ chơi) theo **thuộc tính (size, màu)**, kiểm soát chặt chẽ sản phẩm có giá trị cao theo **Lô – Hạn sử dụng**, tạo các **gói hàng (combo)** hấp dẫn và quản lý **chương trình khách hàng thân thiết (tích điểm)**. Tất cả đều nhằm mục đích giúp chủ cửa hàng kiểm soát chặt chẽ hàng tồn kho, giảm thiểu rủi ro, tăng cường sự gắn kết của khách hàng và nâng cao chất lượng phục vụ.
...
* **Kiểm soát tồn kho chính xác, minh bạch:** Dễ dàng theo dõi số lượng tồn kho của từng loại hàng hóa theo size, màu sắc và của từng lô hàng riêng biệt. Mọi giao dịch đều được ghi nhận chi tiết, giúp bạn truy xuất lịch sử và quản lý hàng hóa một cách minh bạch, tránh thất thoát.
* **Tối ưu hóa bán hàng và chăm sóc khách hàng:** Nhanh chóng tạo các gói combo hấp dẫn, xác định sản phẩm sắp hết hạn để lên chương trình khuyến mại, kết hợp với các chính sách giá và chương trình tích điểm linh hoạt để giữ chân khách hàng và gia tăng doanh thu.

*Tài liệu này hướng dẫn anh chị các tính năng phổ biến liên quan tới ngành hàng Mẹ và Bé mà KiotViet gợi ý cửa hàng tham khảo và lựa chọn các giải pháp phù hợp.*
...
Để dễ hình dung, các ví dụ dưới đây sẽ minh họa những tình huống thực tế tại cửa hàng Mẹ và Bé.
...
#### **2.1. Thêm mới hàng hóa theo Lô - Hạn sử dụng**

* **Tình huống:** Bạn cần tạo một sản phẩm mới như "Kem dưỡng ẩm" với nhiều phiên bản thể tích khác nhau và muốn quản lý sản phẩm này theo từng lô nhập hàng để kiểm soát chính xác.
* **Thao tác thực hiện như sau:**

(1) Tại màn hình **Hàng hóa** → **Danh sách hàng hóa**, bạn nhấn **Tạo mới** → **Hàng hóa**.

(2) Điền các thông tin cơ bản về sản phẩm (tên, nhóm hàng, giá vốn, giá bán,...). Chọn **Có** vào ô **Quản lý theo lô, hạn sử dụng** để kích hoạt tính năng quản lý theo lô.

(3) **Thêm thuộc tính:** Tại mục ***Quản lý theo thuộc tính, đơn vị tính***, nhấn ***Thiết lập***.

* Tại khu vực **Thuộc tính**: Tạo thuộc tính mới tên "Thể tích" và nhập các giá trị như "30ml", "50ml", "100ml".

(4) Nhấn ***Xong*** *→* hệ thống quay lại màn hình **Tạo hàng hóa**, bạn nhấn ***Lưu*** ở cuối trang

#### **2.2. Tạo Gói hàng (Combo)**

* **Tình huống:** Bạn muốn tạo một gói sản phẩm hấp dẫn như "Combo khăn + gối" với giá ưu đãi để thu hút khách hàng.
* **Thao tác thực hiện như sau:**

(1) Tại màn hình **Hàng hóa** → **Danh sách hàng hóa**, bạn nhấn ***Tạo mới*** → ***Combo - đóng gói***.

(2) Đặt tên cho combo, ví dụ: "Combo Tiện Lợi Cho Bé".

(3) Tại mục ***Hàng hóa thành phần***, tìm và thêm các sản phẩm bạn muốn đưa vào combo (ví dụ: 10 khăn xô, 1 gối ôm, 1 gối đầu).

(4) Nhập ***Giá bán*** cho cả combo. Hệ thống sẽ tự động trừ tồn kho của từng sản phẩm thành phần khi bạn bán combo này.
...
Nhấn ***Hoàn thành*** phiếu nhập để tăng tồn kho cho lô hàng vừa nhập.
