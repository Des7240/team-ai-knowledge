...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-thiet-lap/xoa-du-lieu-gian-hang/
---
...
Tính năng **Xóa dữ liệu gian hàng** giúp chủ cửa hàng tối ưu hóa việc lưu trữ và quản lý hệ thống một cách chủ động. Thay vì phải liên hệ tổng đài, bạn có thể tự thiết lập quy trình xóa dữ liệu thừa hoặc làm mới lại hoàn toàn dữ liệu gian hàng ngay trên phần mềm.

**Lợi ích nổi bật của tính năng:**

* **Chủ động và Linh hoạt:** Tự do đặt lịch xóa giao dịch, thu chi theo thời điểm hoặc chu kỳ (định kỳ) mong muốn hoặc xóa toàn bộ dữ liệu để bắt đầu lại.
* **An toàn dữ liệu:** Hệ thống hỗ trợ lưu trữ dữ liệu cũ dưới dạng file nén (ZIP) và gửi qua email, giúp bạn dễ dàng truy xuất và so sánh khi cần thiết.
* **Phạm vi áp dụng rộng:** Xử lý được nhiều loại dữ liệu bao gồm giao dịch với khách hàng, nhà cung cấp, giao dịch nội bộ và các phiếu thu chi.

**Lưu ý:** Tính năng chỉ áp dụng cho gian hàng đã ký hợp đồng chính thức, không áp dụng cho gian dùng thử.

## **II. Các thao tác cơ bản**

Để dễ hình dung, các ví dụ dưới đây sẽ minh họa những tình huống thực tế trong ngành Bán buôn, Bán lẻ.

### **1. Đặt lịch xóa giao dịch và thu chi**

* **Tình huống:** Sau một thời gian dài kinh doanh, dữ liệu của cửa hàng trở nên quá lớn, bao gồm nhiều giao dịch cũ từ các năm trước không còn nhu cầu quản lý thường xuyên. Bạn muốn xóa bớt các giao dịch và phiếu thu chi cũ để hệ thống vận hành nhẹ nhàng hơn, nhưng vẫn muốn lưu lại file sao lưu.
* **Thao tác thực hiện như sau:**

(1) Trên màn hình **Quản lý**, bạn chọn biểu tượng **Thiết lập** → chọn **Dữ liệu và Lịch sử thao tác**.

(2) Tại menu bên trái, chọn **Xóa dữ liệu gian hàng** → nhấn ***Xem chi tiết*** → chọn ***Thêm lịch***.

(3) Chọn tùy chọn ***Xóa giao dịch và thu chi*** sau đó nhấn ***Tiếp tục***.

(4) Hệ thống hiển thị các lưu ý quan trọng. Bạn cần đọc kỹ, tích chọn ***Tôi đã đọc kỹ và hiểu rõ các tác động của việc xóa dữ liệu***, sau đó nhấn ***Tiếp tục***.

(5) Nhập ***Mật khẩu*** gian hàng và ***Điện thoại*** chính chủ trên hợp đồng để xác thực.

(6) ***Nhập mã xác thực*** (OTP) được gửi về điện thoại và nhấn ***Tiếp tục***.

(7) Thiết lập cấu hình xóa:

* Nếu chọn ***Xóa một lần***: Chọn ngày giới hạn tại ô ***Phạm vi dữ liệu*** (xóa từ quá khứ đến hết ngày này), chọn ***Ngày xóa*** (thời điểm hệ thống bắt đầu xóa) và nhập ***Email*** nhận file tổng hợp dữ liệu khi hoàn tất xóa.

* Nếu chọn ***Xóa định kỳ***: Chọn ***Ngày xóa*** bắt đầu. Thiết lập chu kỳ ***Lặp lại*** (3 tháng, 6 tháng hoặc 12 tháng/lần) và thời điểm ***Kết thúc lặp lại*** (Không bao giờ hoặc Vào ngày cụ thể). Nhập ***Email*** nhận file tổng hợp dữ liệu khi hoàn tất xóa.

(8) Nhấn ***Xong*** để hoàn tất việc đặt lịch → hệ thống hiển thị thông báo như sau:

Vào 00:00 của ngày xóa, hệ thống tự động thực hiện:

* Tạo các phiếu kiểm kho và các phiếu cân bằng để tính toán lại số lượng tồn kho, giá vốn hàng hóa, điểm khách hàng và công nợ đối tác (khách hàng, nhà cung cấp, đối tác giao hàng).
* Xóa dữ liệu giao dịch và thu chi, cụ thể:
  + Giao dịch với khách hàng: Hóa đơn, Đặt hàng, Trả hàng, Vận đơn, Bảo hành bảo trì, Yêu cầu sửa chữa.
  + Giao dịch với nhà cung cấp: Nhập hàng, Đặt hàng nhập, Trả hàng nhập.
  + Giao dịch nội bộ: Kiểm kho, Xuất hủy, Chuyển hàng, Sản xuất.
  + Phiếu thu, Phiếu chi.
* Sau khi việc xóa hoàn tất, bạn sẽ nhận được thông báo và file tổng hợp dữ liệu kèm mật khẩu mở file qua email. **Lưu ý**: File dữ liệu đã xóa được lưu trữ trên hệ thống trong **7 ngày**, bạn vui lòng tải xuống nếu cần lưu trữ trên thiết bị cá nhân.

Ngoài ra, trên ứng dụng KiotViet, hệ thống cũng sẽ gửi thông báo:

* Nhắc lịch xóa dữ liệu trước 3 ngày và 1 ngày tính từ ngày xóa.

* Đã xóa dữ liệu kèm mật khẩu mở file.

### **2. Xóa toàn bộ dữ liệu (Làm mới gian hàng)**

* **Tình huống:** Bạn muốn tái cấu trúc lại toàn bộ quy trình vận hành hoặc chuyển đổi mô hình kinh doanh. Bạn cần xóa sạch toàn bộ dữ liệu cũ (hàng hóa, giao dịch, đối tác...) để nhập liệu lại từ đầu, nhưng vẫn giữ lại tài khoản người dùng và chi nhánh.
* **Thao tác thực hiện như sau:**
...
(3) Chọn tùy chọn ***Xóa toàn bộ dữ liệu*** sau đó nhấn ***Tiếp tục***.

(4) Đọc kỹ cảnh báo, tích xác nhận và kích **Tiếp tục**.

(5) Nhập ***Mật khẩu*** gian hàng và ***Điện thoại*** chính chủ trên hợp đồng để xác thực.

(6) ***Nhập mã xác thực*** (OTP) được gửi về điện thoại và nhấn ***Tiếp tục***.

(7) Chọn ***Có*** hoặc ***Không*** tại mục nhận file tổng hợp dữ liệu.

(8) Nhập email nhận thông báo (nếu cần).

(9) Nhấn ***Xong*** và xác nhận ***Đồng ý***. Hệ thống sẽ tiến hành xóa toàn bộ dữ liệu (ngoại trừ Người dùng và Chi nhánh).

(10) Việc xóa có thể mất thời gian tùy vào lượng dữ liệu. KiotViet khuyến nghị bạn nên đợi quá trình xóa hoàn tất trước khi thêm dữ liệu mới và hiển thị thông báo. Bạn có thể liên hệ KiotViet để khôi phục dữ liệu trong vòng 24 giờ sau khi xóa.

Nếu bạn điền email nhận thông báo và chọn ***Có*** nhận file tổng hợp dữ liệu khi hoàn tất xóa, bạn sẽ nhận được thông báo và file tổng hợp dữ liệu kèm mật khẩu mở file qua email. **Lưu ý**: File dữ liệu đã xóa được lưu trữ trên hệ thống trong **7 ngày**, bạn vui lòng tải xuống nếu cần lưu trữ trên thiết bị cá nhân.

Ngoài ra, trên ứng dụng KiotViet, hệ thống cũng sẽ gửi thông báo: Đã xóa toàn bộ dữ liệu kèm mật khẩu mở file (nếu bạn chọn ***Có*** nhận file tổng hợp dữ liệu)

## **III. Tính năng nâng cao**

* **Tình huống:** Bạn đã đặt lịch xóa giao dịch và thu chi nhưng muốn thay đổi lại ngày thực hiện, hoặc quá trình xóa đã hoàn tất và bạn muốn tải về file dữ liệu cũ để lưu trữ trên máy tính cá nhân.
* **Thao tác thực hiện như sau:**

(1) Truy cập vào menu **Xóa dữ liệu gian hàng**.

(2) **Theo dõi trạng thái:**

* **Còn x ngày:** Chưa đến ngày thực hiện xóa.
* **Đang tiến hành xóa:** Hệ thống đang xử lý.
* **Đã hoàn tất:** Đã xóa xong.

(3) **Sửa hoặc Hủy lịch:** Khi trạng thái là "Còn x ngày", bạn có thể kích vào lịch để chọn ***Sửa lịch*** hoặc ***Hủy lịch***.

(4) **Tải dữ liệu:** Khi trạng thái là "Đã hoàn tất", bạn kích nút **Tải xuống** để nhận file dữ liệu đã xóa (File ZIP).

**Lưu ý***:* File này chỉ được lưu trữ trên hệ thống trong vòng **7 ngày** kể từ khi xóa xong. Sau khi tải về, bạn sử dụng mật khẩu (được gửi qua email hoặc thông báo trên ứng dụng) để mở file.

(5) **Xem lịch sử:** Kích **Xem chi tiết** để xem lại lịch sử thao tác của từng lệnh xóa.
