...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-hang-hoa/xuat-huy/
---
...
Việc sử dụng tính năng Xuất hủy trên KiotViet giúp bạn giải quyết triệt để các vấn đề liên quan đến hàng hóa không còn khả năng kinh doanh, mang lại 3 lợi ích chính:

**Lợi ích nổi bật của tính năng Xuất hủy trên KiotViet:**

* **Hạch toán lãi lỗ chính xác:** Cho phép bạn loại bỏ giá trị của các sản phẩm hỏng, lỗi, hoặc hết hạn sử dụng ra khỏi giá trị tồn kho, giúp việc hạch toán lãi lỗ của cửa hàng trở nên chính xác hơn.
* **Kiểm soát tồn kho chặt chẽ, giảm thiểu thất thoát:** Thao tác xuất hủy sẽ trừ tồn kho thực tế của hàng hóa, giúp số liệu trên phần mềm luôn khớp với thực tế, hỗ trợ bạn quản lý kho hiệu quả.
* **Quản lý minh bạch, dễ dàng truy vết:** Mỗi lần xuất hủy đều được ghi nhận thành một phiếu riêng biệt, có thể tìm kiếm và tra cứu dễ dàng, giúp bạn kiểm soát chặt chẽ các hoạt động trong kho.

## **II. Các thao tác cơ bản**

Để dễ hình dung, các ví dụ dưới đây sẽ minh họa những tình huống thực tế trên máy tính (Website).

**Tạo phiếu xuất hủy hàng hóa**

* **Tình huống:** Bạn cần ghi nhận việc loại bỏ một số hàng hóa bị hư hỏng hoặc hết hạn sử dụng ra khỏi kho.
* **Thao tác thực hiện như sau:**

1. Tại màn hình **Quản lý**, vào menu **Hàng hóa**, chọn **Xuất hủy**.

2. Nhấn vào nút **+ Xuất hủy**.

3. Sử dụng thanh tìm kiếm để thêm sản phẩm cần hủy vào phiếu. Bạn có thể dùng phím **F6** để chuyển đổi giữa chế độ nhập thường và nhập nhanh (tối ưu cho máy quét mã vạch).

4. Nhập số lượng cần hủy cho từng sản phẩm.
5. Nhấn **Hoàn thành** để kết thúc. Hệ thống sẽ trừ tồn kho của các hàng hóa trong phiếu.

## **III. Các tính năng nâng cao**

### **1. Quản lý thông tin phiếu xuất hủy**

* **Tình huống:** Bạn cần chỉnh sửa ghi chú, tạo nhanh một phiếu hủy mới dựa trên phiếu cũ, hoặc hoàn lại tồn kho cho một phiếu đã hủy nhầm.
* **Thao tác thực hiện như sau:** 
  + **Cập nhật:** Mở phiếu đã hoàn thành để cập nhật các thông tin như: ***Người xuất hủy***, ***Ngày xuất hủy***, ***Ghi chú*** → nhấn ***Lưu*** để ghi nhận thông tin.

* **Sao chép:** Mở phiếu cần sao chép và nhấn **Sao chép** để tạo một phiếu mới với thông tin tương tự.

* **Hủy:** Mở phiếu → nhấn ***Hủy*** **→** chọn ***Đồng ý*** để xác nhận thông tin. Hệ thống sẽ cộng lại tồn kho các mặt hàng trong phiếu đó.

### **2. Tìm kiếm, sắp xếp và xuất file**

* **Tình huống:** Bạn cần tìm lại một phiếu xuất hủy cũ hoặc xuất dữ liệu ra file Excel để lưu trữ, báo cáo.
* **Thao tác thực hiện như sau:** 
  + **Tìm kiếm:** Tại danh sách phiếu xuất hủy, sử dụng bộ lọc đa dạng để tìm phiếu theo mã phiếu, mã/tên hàng, Serial/IMEI, Lô - Hạn sử dụng, thời gian, trạng thái...

* **Sắp xếp:** Nhấn vào tiêu đề của các cột để sắp xếp danh sách tăng dần hoặc giảm dần.

* **Xuất file:** Hệ thống cho phép xuất chi tiết phiếu và danh sách các phiếu xuất hủy ra file Excel.

## **IV. Thao tác trên Điện thoại**

Tính năng Xuất hủy trên ứng dụng KiotViet hỗ trợ cửa hàng thực hiện các thao tác: Tạo, Xem, Cập nhật, Hủy và Tìm kiếm phiếu xuất hủy.

### **1. Tạo phiếu xuất hủy**

* **Tình huống:** Bạn đang ở kho và cần ghi nhận nhanh việc hủy hàng hóa ngay trên điện thoại.
* **Thao tác thực hiện như sau:**

1. Mở ứng dụng KiotViet, vào menu **Nhiều hơn** → chạm **Xuất hủy**.
2. Chạm vào biểu tượng dấu **+**.
3. Thêm hàng hóa vào phiếu bằng cách tìm kiếm hoặc quét mã vạch.
4. Nhập số lượng cần hủy cho từng sản phẩm và chạm **Xong**.

5. Chạm ***Tiếp tục*** → **Hoàn thành** để kết thúc hoặc ***Lưu tạm*** nếu muốn chỉnh sửa sau.

### **2. Quản lý phiếu xuất hủy**

* **Tình huống:** Bạn cần xem lại chi tiết, cập nhật hoặc hủy một phiếu xuất hủy đã tạo trên ứng dụng.
* **Thao tác thực hiện như sau:** 
  + **Xem và cập nhật:** Chạm vào một phiếu bất kỳ trong danh sách để xem chi tiết. Nếu phiếu ở trạng thái ***Phiếu tạm***, bạn có thể ***Tiếp tục xử lý***.

* **Hủy:** Tại danh sách, vuốt phiếu cần hủy sang trái và chọn ***Hủy***, hoặc mở chi tiết phiếu và chọn 3 chấm → ***Hủy phiếu*** → chọn ***Đồng ý*** để xác nhận hủy.
