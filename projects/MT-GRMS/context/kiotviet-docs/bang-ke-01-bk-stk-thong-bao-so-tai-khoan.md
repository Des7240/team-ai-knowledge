...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-to-khai-thue-hkd/bang-ke-01-bk-stk-thong-bao-so-tai-khoan/
---
...
Hỗ trợ
Tờ khai Thuế HKDBảng kê 01/BK-STK - Thông báo Số Tài Khoản
...
Bảng kê 01/BK-STK là phụ lục bắt buộc theo quy định của Thông tư 18/2026/TT-BTC, được sử dụng để thông báo danh sách số tài khoản ngân hàng và ví điện tử liên quan đến hoạt động kinh doanh của cửa hàng lên cơ quan thuế.

Tính năng này giúp bạn tạo bảng kê trực tiếp ngay trong phần mềm KiotViet. Dữ liệu tài khoản sẽ được hệ thống tự động tổng hợp từ hồ sơ thiết lập ban đầu và sổ quỹ ngân hàng, thay thế hoàn toàn việc phải khai báo thủ công trên trang web của cơ quan thuế.

**Lợi ích nổi bật của tính năng:**

* **Tiết kiệm thời gian nhập liệu:** Dữ liệu số tài khoản, tên chủ tài khoản và tên ngân hàng được hệ thống tự động điền đầy đủ, giúp bạn không cần phải nhập lại từ đầu.
* **Giảm thiểu sai sót:** Hệ thống thông minh tự động gợi ý trạng thái của từng tài khoản (Khai lần đầu, Thay đổi thông tin, hoặc Đóng) dựa trên lịch sử kê khai trước đó.
* **Khai và nộp liền mạch:** Bảng kê được hiển thị trực quan trên màn hình tổng quan hoặc đính kèm trực tiếp vào tờ khai thuế tương ứng, giúp bạn dễ dàng quản lý và nộp hồ sơ mà không cần tạo tệp dữ liệu rời.

## **II. Các thao tác cơ bản**

Để dễ hình dung, các ví dụ dưới đây sẽ minh họa những tình huống thực tế trong ngành Bán buôn, Bán lẻ.

### **1. Thêm số tài khoản hoặc ví điện tử mới trên Sổ quỹ**

**Tình huống:** Bạn vừa mở thêm một tài khoản ngân hàng hoặc ví điện tử mới cho cửa hàng. Bạn cần khai báo thông tin này vào hệ thống để dữ liệu sẵn sàng được tự động tổng hợp đầy đủ khi lập bảng kê.

**Thao tác thực hiện như sau:**

* **Bước 1:** Trên màn hình **Quản lý** → truy cập vào **Sổ quỹ**.
* **Bước 2:** Chọn ***Ngân hàng*** hoặc ***Ví điện tử***.
* **Bước 3:** Trên dòng ***Tài khoản***, nhấn ***Thêm*** để tạo tài khoản mới.

**Lưu ý**: Để thông tin tài khoản xuất hiện trên Bảng kê sau này, bạn BẮT BUỘC phải thêm mới/cập nhật từ **Sổ quỹ**. Hệ thống KHÔNG cho phép thêm mới/ thay đổi thông tin số tài khoản trực tiếp trong màn hình lập bảng kê.

* **Bước 4:** Hoàn tất việc thêm tài khoản. Hệ thống sẽ lưu trữ và tự động đồng bộ tài khoản này vào danh sách khi bạn tiến hành tạo bảng kê ở các bước tiếp theo.

### **2. Tạo bảng kê cho Hộ kinh doanh khai thuế theo Năm (Doanh thu ≤ 1 tỷ)**

**Tình huống:** Cửa hàng của bạn thuộc nhóm doanh thu từ 1 tỷ trở xuống và khai thuế theo năm. Bạn cần tạo và lưu bảng kê 01/BK-STK để nộp kèm theo tờ khai năm.

**Thao tác thực hiện như sau:**

* **Bước 1:** Truy cập vào menu **Thuế & Kế toán** → **Thuế & Kế toán**.

* **Bước 2:** Chọn **Tờ khai thuế**. Tại đây, ***Bảng kê số tài khoản ngân hàng (01/BK-STK)*** hiển thị rõ các thông tin về Kỳ kê khai, Hạn nộp và Trạng thái tờ khai (Chưa nộp/Đã nộp).

* **Bước 3:** Nhấn ***Xem chi tiết***.
* **Bước 4:** Kiểm tra dữ liệu trên màn hình.
  + ***Thông tin người nộp thuế***: Đồng bộ thông tin từ ***Tờ khai thuế***.
  + ***Bảng kê số tài khoản/ số hiệu điện tử***: Tự động tổng hợp toàn bộ danh sách tài khoản từ **Sổ quỹ** ngân hàng/ ví điện tử của cửa hàng.

### **3. Tạo bảng kê cho Hộ kinh doanh khai thuế theo Quý hoặc Tháng (Doanh thu > 1 tỷ)**

**Tình huống:** Cửa hàng của bạn thuộc nhóm doanh thu trên 1 tỷ và phải khai thuế định kỳ theo quý hoặc tháng. Bạn cần tạo bảng kê 01/BK-STK để đính kèm vào tờ khai 01/CNKD của kỳ hiện tại.

**Thao tác thực hiện như sau:**

* **Bước 1:** Truy cập vào menu **Thuế & Kế toán** → **Thuế & Kế toán** → chọn **Tờ khai thuế** → nhấn ***Xem chi tiết*** trên kỳ kê khai.

* **Bước 2:** Trong màn hình chi tiết của tờ khai, chọn tab **Bảng kê Số tài khoản**.

## **III. Các tính năng nâng cao**

### **1. Điều chỉnh trạng thái và hiển thị tài khoản**

**Tình huống:** Bạn có một số tài khoản không còn dùng để kinh doanh nữa và muốn ẩn đi, hoặc bạn cần cập nhật lại trạng thái khai báo của tài khoản cho cơ quan thuế.

**Thao tác thực hiện như sau:**

* **Bước 1:** Tại màn hình Bảng kê số tài khoản, bạn nhấn ***Chỉnh sửa***.

* Tại mỗi dòng tài khoản → bật xanh nếu muốn hiển thị số tài khoản này trên mã địa điểm kinh doanh.
* Tắt xám nếu muốn ẩn đi khi tài khoản tạm thời không sử dụng nhưng vẫn muốn giữ lại dữ liệu.

* **Bước 2:** Lựa chọn trạng thái phù hợp cho tài khoản từ danh sách. Bao gồm:
  + **Khai lần đầu:** Dành cho tài khoản chưa từng được thông báo với cơ quan thuế.
  + **Thay đổi thông tin:** Dành cho tài khoản đã khai báo trước đây nhưng hiện tại có cập nhật thông tin (như đổi số tài khoản, đổi tên chủ tài khoản).
  + **Đóng:** Dành cho tài khoản không còn sử dụng cho mục đích kinh doanh.

* **Bước 3:** Nhấn ***Lưu*** để hệ thống ghi nhận.

**Lưu ý**: Hệ thống sẽ tự động lưu lại theo thao tác thay đổi trạng thái cuối cùng trên tất cả các mã địa điểm kinh doanh.

### **2. Xử lý dữ liệu cho cửa hàng có nhiều địa điểm kinh doanh**

**Tình huống:** Cửa hàng của bạn có từ 2 địa điểm kinh doanh trở lên và bạn cần phân bổ số tài khoản thu tiền tương ứng cho từng chi nhánh.

**Thao tác thực hiện như sau:**

* **Bước 1:** Mở Bảng kê số tài khoản.
* **Bước 2:** Hệ thống tự động chia dữ liệu số tài khoản thành các nhóm riêng biệt, mỗi nhóm tương ứng với một địa điểm kinh doanh để bạn dễ dàng quản lý.

### **3. Xử lý các tình huống thường gặp**

**Tình huống:** Trong quá trình lập bảng kê, hệ thống cảnh báo lỗi hoặc bạn không thể thao tác được một số chức năng.

**Thao tác thực hiện như sau:**

* **Trường hợp không có dòng tài khoản nào:**
  + Hệ thống báo: ***Không có dữ liệu bảng kê số tài khoản***.
  + Cách xử lý: Bạn cần quay lại **Sổ quỹ** để khai báo thêm tài khoản ngân hàng/ ví điện tử trước.

* **Trường hợp nút "Xem chi tiết" bị mờ (vô hiệu hóa):** Tính năng chỉ áp dụng đối với các kỳ kê khai từ năm 2026 trở đi. Với các kỳ trước năm 2026, tính năng này không khả dụng.

## **IV. Thao tác trên Điện thoại**

Tính năng Bảng kê 01/BK-STK trên ứng dụng KiotViet hỗ trợ cửa hàng thực hiện thao tác: xem và quản lý thông tin.

**Tình huống:** Bạn không có mặt tại cửa hàng nhưng cần kiểm tra nhanh danh sách các tài khoản ngân hàng đã được tổng hợp để gửi cơ quan thuế.
...
* **Bước 3:** Bấm xem chi tiết tờ khai hoặc dòng Bảng kê số tài khoản ngân hàng tương ứng để kiểm tra danh sách tài khoản đã được hệ thống đồng bộ.

* **Bước 4**: Chỉnh sửa tài khoản.
  + Bạn chạm vào dòng tài khoản cần chỉnh sửa.
  + Bật xanh nếu muốn hiển thị số tài khoản này trên mã địa điểm kinh doanh
  + Tắt xám nếu muốn ẩn đi khi tài khoản tạm thời không sử dụng nhưng vẫn muốn giữ lại dữ liệu.
  + Chọn 1 trong 3 trạng thái: ***Khai lần đầu***/ ***Thay đổi thông tin***/ ***Đóng***.
  + Chạm ***Xong*** để ghi nhận thông tin.
  + Hệ thống sẽ tự động lưu lại theo thao tác thay đổi trạng thái cuối cùng trên tất cả các mã địa điểm kinh doanh.
