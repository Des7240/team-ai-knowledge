...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-lam-quen-voi-kiotviet/buoc-5-quan-ly-cong-no/
---
...
Sau khi thực hiện các giao dịch mua và bán, việc phát sinh công nợ là điều thường thấy. Tính năng **Quản lý công nợ** giúp bạn theo dõi, thanh toán và đối soát tất cả các khoản nợ một cách tập trung, khoa học và chính xác, đảm bảo dòng tiền của cửa hàng luôn minh bạch và được kiểm soát chặt chẽ.

**Lợi ích nổi bật của tính năng**:

* **Quản lý tập trung**: Giúp chủ cửa hàng và kế toán theo dõi toàn bộ công nợ phải thu của khách hàng và phải trả cho nhà cung cấp tại một nơi duy nhất.
* **Minh bạch và chính xác**: Hỗ trợ chủ cửa hàng đối soát dễ dàng nhờ mọi giao dịch tạo ra hoặc thanh toán công nợ đều được ghi nhận chi tiết, tránh sai sót.
* **Cập nhật tự động**: Giúp nhân viên yên tâm khi công nợ được tự động tạo ra từ các phiếu chưa thanh toán đủ và được cập nhật ngay khi có phiếu thu/chi.​

## **II. Các thao tác cơ bản**

Để dễ hình dung, các ví dụ dưới đây sẽ minh họa những tình huống kinh doanh thực tế.

### **1. Thanh toán công nợ nhà cung cấp đã phát sinh**

**Tình huống:** Khi bạn cần thanh toán một khoản công nợ đã phát sinh từ phiếu nhập hàng trước đó, ví dụ khoản nợ 2,400,000đ với "Nhà cung cấp A".

**Thao tác thực hiện như sau:**

* **Bước 1: Truy cập danh sách Nhà cung cấp:** Từ menu chính, vào **Mua hàng** → chọn **Nhà cung cấp**.

* **Bước 2: Xem chi tiết công nợ:** Tìm và nhấn vào tên "Nhà cung cấp A" → chuyển sang tab **Nợ cần trả nhà cung cấp**.

* **Bước 3: Thực hiện thanh toán:** Nhấn vào nút ***Thanh toán***. Một cửa sổ Phiếu chi sẽ hiện ra. Nhập ***Số tiền*** cần trả là 2,400,000 và nhấn ***Tạo phiếu chi*** để hoàn tất.

### **2. Khai báo công nợ ban đầu (công nợ cũ)**

**Tình huống:** Khi bạn cần ghi nhận một khoản nợ cũ đã có từ trước khi bắt đầu sử dụng KiotViet, ví dụ khoản nợ 2,000,000đ với một nhà cung cấp, để quản lý tập trung.

**Thao tác thực hiện như sau**:

* **Bước 1: Truy cập chi tiết Nhà cung cấp**: Vào danh sách nhà cung cấp, tìm và chọn nhà cung cấp tương ứng.
* **Bước 2: Điều chỉnh công nợ**: Trên tab **Nợ cần trả nhà cung cấp** và nhấn ***Điều chỉnh***.

* **Bước 3: Nhập thông tin công nợ cũ:** Nhập số tiền 2,000,000 vào ô ***Giá trị nợ điều chỉnh***, ghi lý do vào ***Mô tả*** (nếu cần) (ví dụ: "Công nợ tồn đầu kỳ") và nhấn ***Chỉnh sửa***.
