...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-lam-quen-voi-kiotviet/buoc-1-them-moi-hang-hoa/
---
...
Thêm mới hàng hóa là bước khởi đầu thiết yếu, tạo ra nền tảng dữ liệu sản phẩm cho mọi hoạt động như bán hàng, quản lý kho, nhập hàng và kiểm kho trên KiotViet. Việc thiết lập danh mục sản phẩm một cách chính xác sẽ giúp bạn vận hành kinh doanh hiệu quả ngay từ đầu.

**Lợi ích nổi bật của tính năng**:

* **Nền tảng cho mọi hoạt động**: Giúp chủ cửa hàng tạo dữ liệu gốc về sản phẩm, là cơ sở cho toàn bộ quy trình quản lý và bán hàng về sau.
* **Quản lý tồn kho chính xác**: Hỗ trợ chủ cửa hàng và quản lý khai báo tồn kho ban đầu, tạo tiền đề cho việc theo dõi xuất-nhập-tồn chính xác, tránh thất thoát.
* **Linh hoạt trong quản lý sản phẩm**: Cho phép nhân viên bán hàng và quản lý dễ dàng thiết lập sản phẩm với nhiều phiên bản (màu sắc, kích cỡ, hương vị) và bán theo nhiều đơn vị tính khác nhau trên cùng một mã hàng.  
  ​

## **II. Thao tác Thêm mới hàng hóa**

Để dễ hình dung, các ví dụ dưới đây sẽ minh họa những tình huống bán hàng thực tế.

**Tình huống:** Khi bạn cần thêm một sản phẩm mới, ví dụ "Sữa tươi Ba Vì", vào hệ thống. Sản phẩm này có nhiều phiên bản (Hương vị: Dâu, Vani) và có thể bán theo nhiều đơn vị khác nhau (hộp, lốc, thùng) với các mức giá riêng. Bạn cần khai báo tất cả thông tin này trên KiotViet để quản lý tồn kho và giá bán chính xác.

**Thao tác thực hiện như sau**:

* **Bước 1: Truy cập màn hình Thêm hàng hóa**:
  + Từ màn hình **Tổng quan**, vào menu **Hàng hóa** → chọn **Danh sách hàng hóa**.

* Tại góc trên bên phải, nhấn nút **Tạo mới** → chọn **Hàng hóa**.

* **Bước 2: Nhập thông tin cơ bản**:
  + ***Mã hàng***: Để trống để hệ thống tự sinh, hoặc điền mã vạch của sản phẩm nếu có.
  + ***Tên hàng***: Điền "Sữa tươi Ba Vì".
  + ***Nhóm hàng***: Chọn nhóm "Sữa" từ danh sách có sẵn (hoặc nhấn Tạo mới nếu chưa có).
  + ***Giá vốn***: Nhập 5,000.
  + ***Giá bán***: Nhập 7,000.
  + ***Tồn kho***: Nhập số lượng tồn kho ban đầu.

* **Bước 3: Thiết lập phiên bản và đơn vị tính**: Tìm đến khu vực ***Quản lý theo đơn vị tính và thuộc tính***.
  + **Đơn vị tính**
    - ***Nhập tên đơn vị cơ bản***: Hộp; ***Giá bán***: 7,000
    - ***Thêm đơn vị***:
      * ***Tên đơn vị***: Lốc; Giá trị quy đổi: 4; Giá bán: 27,000.
      * ***Tên đơn vị***: Thùng; Giá trị quy đổi: 48, Giá bán: 32,0000.

* **Thuộc tính**i:
  + Nhấn ***+ Thêm thuộc tính***
  + Chọn hoặc Tạo thuộc tính mới (VD: Hương vị).
  + Giá trị thuộc tính: Nhập Dâu, nhấn Enter, sau đó nhập Vani, nhấn Enter.

* Hệ thống đã tự động tạo ra các phiên bản sản phẩm Sữa tươi Ba Vì - Dâu và Sữa tươi Ba Vì - Vani với thông tin về giá, tồn kho.

* **Bước 4: Hoàn tất**: Bạn nhấn ***Lưu*** ở cuối trang.
