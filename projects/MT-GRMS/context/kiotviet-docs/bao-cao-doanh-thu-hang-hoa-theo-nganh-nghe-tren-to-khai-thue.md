...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-to-khai-thue-hkd/bao-cao-doanh-thu-hang-hoa-theo-nganh-nghe-tren-to-khai-thue/
---
...
Hỗ trợ
Tờ khai Thuế HKDBáo cáo doanh thu hàng hóa theo ngành nghề trên Tờ khai thuế
...
Tính năng Báo cáo doanh thu hàng hóa theo ngành nghề là báo cáo chi tiết, được mở trực tiếp từ tờ khai thuế. Tính năng này giúp hộ kinh doanh dễ dàng xem ngay nguồn gốc số liệu bằng cách bấm vào bất kỳ con số doanh thu hoặc thuế nào trên tờ khai mà không cần phải tra cứu thủ công hay nhờ bộ phận hỗ trợ.

**Lợi ích nổi bật của tính năng:**

* **Đối soát tức thì:** Bấm thẳng vào số liệu trên tờ khai để xem chi tiết theo từng hàng hóa hoặc từng giao dịch ngay trong màn hình hiện tại, giúp bạn không bị gián đoạn mạch công việc.
* **Truy xuất chứng từ gốc:** Cho phép bấm trực tiếp vào số phiếu hoặc hóa đơn trên báo cáo để mở và kiểm tra chi tiết chứng từ gốc.
* **Xuất Excel nhanh chóng:** Hỗ trợ tải tệp dữ liệu về máy tính để thuận tiện đối soát ngoài phần mềm khi có nhu cầu.

## **II. Các thao tác cơ bản**

Để dễ hình dung, các ví dụ dưới đây sẽ minh họa những tình huống thực tế trong ngành Bán buôn, Bán lẻ.

### **Xem chi tiết báo cáo từ tờ khai**

**Tình huống:** Bạn đang làm tờ khai thuế và cần xác minh con số doanh thu hoặc tiền thuế của một ngành nghề cụ thể hiển thị trên tờ khai có chính xác không, bắt nguồn từ những hàng hóa hay giao dịch nào.

**Thao tác thực hiện như sau:**

* **Bước 1:** Truy cập vào menu **Thuế & Kế toán** → **Thuế & Kế toán**.

* **Bước 2:** Chọn **Tờ khai thuế** → nhấn ***Xem chi tiết*** tại tờ khai theo kỳ kê khai tương ứng.

* **Bước 3:** Tại mục **Kê khai thuế giá trị gia tăng (GTGT), thuế thu nhập cá nhân (TNCN)** → bạn nhấn vào giá trị trên các cột ***Doanh thu, Thuế GTGT, Thuế TNCN***.

* **Bước 4:** Hệ thống hiển thị popup **Báo cáo doanh thu hàng hóa theo ngành nghề**.

**Lưu ý**: Bộ lọc dữ liệu sẽ tự động điền sẵn theo Nhóm ngành nghề, Thời gian kê khai và Địa điểm kinh doanh tương ứng với ô bạn vừa nhấn chọn. Bạn có thể lựa chọn 2 chế độ xem:

* **Chế độ xem theo Hàng hóa:** Doanh thu được tổng hợp theo các hàng hóa.

* **Chế độ xem theo Giao dịch:** Doanh thu được tổng hợp theo các giao dịch.

* **Bước 5:** Tại chế độ xem theo **Hàng hóa**, bạn có thể nhấn vào dòng hàng hóa để xem trực tiếp danh sách các giao dịch của hàng hóa đó.

## **III. Các tính năng nâng cao**

### **Xuất Excel báo cáo đối soát**

**Tình huống:** Bạn cần lưu trữ dữ liệu báo cáo ra file Excel.

**Thao tác thực hiện như sau:**

* **Bước 1:** Tại popup **Báo cáo doanh thu hàng hóa theo ngành nghề** → nhấn ***Xuất Excel***.

* **Bước 2:** Chờ hệ thống xử lý dữ liệu và nhấn ***Tải file...*** để lưu tệp về máy.

* **Bước 3:** Mở file excel đã tải về. File có cấu trúc dữ liệu tương tự như giao diện bạn xem trên màn hình.

## **IV. Thao tác trên Điện thoại**

Tính năng Báo cáo doanh thu hàng hóa theo ngành nghề trên ứng dụng KiotViet hỗ trợ cửa hàng xem thông tin theo hàng hóa và theo giao dịch.

**Tình huống:** Bạn cần sử dụng điện thoại để xem báo cáo doanh thu hàng hóa theo ngành nghề.
...
* **Bước 3:** Chọn kỳ kê khai → chọn chi nhánh (nếu có nhiều chi nhánh).

* **Bước 4**: Xem doanh thu theo nhóm ngành nghề. Bạn chạm vào dòng nhóm ngành tương ứng để xem thông tin báo cáo theo **Hàng hóa** hoặc theo **Giao dịch**.
