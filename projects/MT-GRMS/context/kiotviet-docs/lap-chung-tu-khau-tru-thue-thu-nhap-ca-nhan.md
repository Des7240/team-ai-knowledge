...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-chung-tu-dien-tu-phieu-xuat-kho/lap-chung-tu-khau-tru-thue-thu-nhap-ca-nhan/
---
...
Hỗ trợ
Chứng từ điện tử & Phiếu xuất khoLập chứng từ khấu trừ thuế thu nhập cá nhân
...
Tính năng Lập chứng từ khấu trừ thuế thu nhập cá nhân (TNCN) cho phép tổ chức chi trả thu nhập tiến hành lập, ký số và phát hành chứng từ điện tử ngay trên phần mềm KiotViet. Chứng từ được tạo theo đúng định dạng chuẩn mẫu 03/TNCN, bao gồm đầy đủ thông tin định danh của người bị khấu trừ cùng chi tiết các khoản thu nhập, giảm trừ và số thuế trong kỳ.

*Lưu ý: Điều kiện tiên quyết để sử dụng tính năng này là cửa hàng/doanh nghiệp phải có tờ khai đăng ký sử dụng chứng từ điện tử đã được CQT chấp nhận, trong đó có đăng ký loại "Chứng từ điện tử khấu trừ thuế TNCN".*

**Lợi ích nổi bật của tính năng:**

* **Phát hành nhanh chóng, hợp lệ pháp lý:** Thay thế hoàn toàn chứng từ giấy truyền thống. Hệ thống tự động gán số chứng từ, sinh mã ký hiệu đúng chuẩn (VD: 03/TNCN - CT/26E), thực hiện ký số và gửi lên Cơ quan Thuế (CQT) trong một luồng liền mạch.
* **Quản lý trọn vòng đời với 2 trạng thái song song:** Màn hình danh sách hiển thị đồng thời Trạng thái gửi CQT (Đã gửi / CQT chấp nhận / Không hợp lệ...) và Trạng thái gửi người nộp thuế (Đã gửi / Chưa gửi), giúp kế toán kiểm soát chặt chẽ tiến độ của từng chứng từ.
* **Tra cứu MST tự động, hạn chế tối đa sai sót:** Tích hợp tính năng tra cứu tự động từ Tổng cục Thuế. Chỉ cần nhập Mã số thuế, hệ thống sẽ tự động điền Họ tên và Địa chỉ, đồng thời vẫn cho phép người dùng linh hoạt chỉnh sửa hoặc nhập thủ công khi cần thiết.

## **II. Các thao tác cơ bản**

Để dễ hình dung, các ví dụ dưới đây sẽ minh họa những tình huống thực tế trong ngành Bán buôn, Bán lẻ.

### **1. Khai báo thông tin và lập chứng từ TNCN**

**Tình huống:** Kế toán cửa hàng cần xuất chứng từ khấu trừ thuế TNCN cho một cộng tác viên vừa nhận khoản hoa hồng bán sỉ lớn trong tháng.

**Thao tác thực hiện như sau:**

* **Bước 1 -** **Truy cập tính năng**:
  + Truy cập menu **Chứng từ**.
  + Hệ thống hiển thị màn hình danh sách **Chứng từ**.
  + Nhấn ***+ Lập chứng từ***.

* Hệ thống sẽ mở màn hình **Chứng từ khấu trừ thuế thu nhập cá nhân**

* **Lưu ý**: Menu **Chứng từ** chỉ hiển thị khi đơn vị đã có tờ khai đăng ký sử dụng chứng từ điện tử được ***CQT chấp nhận*** và tờ khai đó đã đăng ký loại ***Chứng từ điện tử khấu trừ thuế thu nhập cá nhân***. Nếu tờ khai đang ở trạng thái ***Chờ CQT duyệt***, menu **Chứng từ** sẽ không hiển thị.

* **Bước 2 -** **Kiểm tra Thông tin chung**: Hệ thống tự động điền
  + ***Mẫu chứng từ***: Dạng 03/TNCN - CT/XXE với XX là 2 số cuối của năm.
  + ***Số chứng từ***: Được hệ thống tự động sinh khi bạn chính thức xuất phát hành.
  + ***Ngày chứng từ***: Mặc định là ngày hiện tại, không được chọn ngày tương lai và phải nằm trong kỳ khấu trừ thuế.

* **Bước 3 -** **Khai báo Thông tin cá nhân, hộ kinh doanh, cá nhân kinh doanh**:
  + Bạn nhập các thông tin bắt buộc
  + **Lưu ý**: Bạn có thể nhập ***Mã số thuế*** và nhấn ***Tra cứu MST*** để hệ thống tự động điền thông tin ***Họ và tên***, ***Địa chỉ*** từ Tổng cục Thuế.

* **Bước 4 - Thông tin thuế thu nhập cá nhân khấu trừ**: Chọn đầy đủ các thông tin bắt buộc
  + Khoản thu nhập: Mặc định chọn Thu nhập từ tiền lương, tiền công. Bạn có thể chọn 1 trong 4 tùy chọn
    - Thu nhập từ tiền lương, tiền công
    - Thu nhập từ kinh doanh
    - Thu nhập từ trúng thưởng
    - Thu nhập khác: Cho phép người dùng nhập thủ công.
  + Năm: Chọn năm, không được lớn hơn năm hiện tại.
  + Từ tháng: Chọn tháng bắt đầu trả thu nhập, 1-12.
  + Đến tháng:  Chọn tháng cuối cùng trả thu nhập, 1-12. Không được nhỏ hơn Từ tháng.
  + Bảo hiểm (bắt buộc, ≥0): Khoản đóng bảo hiểm bắt buộc.
  + Khoản từ thiện, nhân đạo, khuyến học (bắt buộc, ≥0).
  + Quỹ hưu trí tự nguyện được trừ (không bắt buộc, ≥0).
  + Tổng thu nhập chịu thuế (bắt buộc, ≥0): Tổng thu nhập chịu thuế phải khấu trừ.
  + Tổng thu nhập tính thuế (bắt buộc, ≥0): Thu nhập sau khi trừ các khoản giảm trừ.
  + Số thuế (bắt buộc, ≥0): Số thuế TNCN đã khấu trừ.
  + **Lưu ý:** Tất cả trường số chỉ nhận ký tự số, không âm*.*

### **2. Lưu nháp/Xuất chứng từ và Theo dõi trạng thái**

**Tình huống:** Sau khi điền xong thông tin chứng từ cho cộng tác viên, bạn cần xuất chứng từ ngay, ký số và gửi dữ liệu lên Cơ quan Thuế.

**Thao tác thực hiện như sau:**

* **Bước 1 - Lựa chọn thao tác**: Tại thanh hành động dưới cùng của màn hình **Chứng từ khấu trừ thuế thu nhập cá nhân**, bạn có thể nhấn:
  + ***Xem trước***: Để kiểm tra bản PDF.
  + ***Lưu & Tạo mới***: Nếu muốn lưu dưới dạng nháp, chưa muốn phát hành ngay (chưa có số chứng từ) đồng thời mở màn hình lập chứng từ mới mà không cần quay về danh sách.
  + Nhấn biểu tượng mũi tên cạnh nút ***Lưu & Tạo mới*** chọn ***Lưu*** nếu muốn lưu nháp chứng từ hiện tại và quay về màn hình danh sách.
  + ***Hủy bỏ***: Đóng màn hình, quay về danh sách mà không lưu.
  + ***Xuất chứng từ***: Phát hành chứng từ ngay.

* **Bước 2 - Xuất chứng từ và Ký số**
  + Nếu dữ liệu đã chuẩn xác, bạn nhấn ***Xuất chứng từ***.

* Chọn loại ***Chữ ký số*** gian hàng đang sử dụng (Chữ ký số từ xa KiotViet IntrustCA hoặc USB Token).
* Nhấn ***Ký và phát hành***.

* **Bước 3 - Theo dõi trạng thái**: Trên màn hình danh sách **Chứng từ**, hệ thống hiển thị 2 cột thông tin độc lập với trạng thái tương ứng như sau.
  + ***Trạng thái gửi CQT***: Đã gửi CQT, CQT chấp nhận, CQT kiểm tra không hợp lệ, Phát hành lỗi.
  + ***Trạng thái gửi NNT***: Chưa gửi, Đã gửi (sau khi gửi email cho NNT).

## **III. Các tính năng nâng cao**

### **1. Sao chép chứng từ**

**Tình huống:** Bạn có một nhân sự nhận mức lương và khấu trừ cố định hàng tháng, bạn muốn tạo chứng từ cho kỳ mới nhanh nhất mà không phải nhập lại toàn bộ thông tin cá nhân.

**Thao tác thực hiện như sau:**

* Trên màn hình **Chứng từ** → tìm và chọn chứng từ cụ thể → nhấn ***Sao chép***.

* Hệ thống sẽ mở màn hình lập chứng từ mới, tự động sao chép toàn bộ thông tin từ chứng từ gốc (trừ ***Ngày chứng từ*** mặc định về ngày hiện tại).

### **2. Tìm kiếm và lọc đa điều kiện**

**Tình huống:** Cuối năm, bạn cần rà soát lại toàn bộ các chứng từ thay thế hoặc các chứng từ bị Cơ quan Thuế từ chối để có phương án xử lý kịp thời.

**Thao tác thực hiện như sau:**

* **Tìm kiếm nhanh và Lọc**: Sử dụng thanh tìm kiếm để tìm nhanh theo Số chứng từ, MST, Họ tên, số điện thoại và bộ lọc bên trái, bạn có thể kết hợp lọc đồng thời nhiều tiêu chí: Thời gian, Ký hiệu, Trạng thái gửi CQT (chọn CQT kiểm tra không hợp lệ), Tính chất chứng từ (chọn Chứng từ thay thế), Trạng thái gửi NNT và Người lập chứng từ.

* **Tùy chọn hiển thị**: Bạn nhấn biểu tượng tùy chọn hiển thị  → tích /bỏ tích các thông tin cần hiển thị trên danh sách (như Địa chỉ, CCCD, Từ tháng, Đến tháng, Số thuế...) giúp đối chiếu dễ dàng hơn.

* **Xuất file**: Nhấn ***Xuất file*** nếu bạn cần tải dữ liệu danh sách chứng từ về máy tính dưới dạng Excel.

### **3. Điều kiện pháp lý và xử lý lỗi chữ ký số**

**Tình huống:** Quản lý cửa hàng cần nắm rõ nguyên nhân tại sao đôi khi hệ thống từ chối cho phép xuất chứng từ dù nhân viên đã điền đầy đủ thông tin.

**Thao tác thực hiện như sau:**

* **Bước 1 - Kiểm tra Tờ khai đăng ký**: Menu **Chứng từ** chỉ hiển thị khi đơn vị đã có tờ khai đăng ký sử dụng chứng từ điện tử được ***CQT chấp nhận*** và tờ khai đó đã đăng ký loại ***Chứng từ điện tử khấu trừ thuế thu nhập cá nhân***. Nếu tờ khai đang ở trạng thái ***Chờ CQT duyệt***, menu **Chứng từ** sẽ không hiển thị.
* **Bước 2 -** **Xử lý lỗi đồng bộ Chữ ký số (CKS)**: Gian hàng cần đảm bảo CKS đang sử dụng trùng khớp hoàn toàn với hồ sơ pháp lý đã gửi CQT. Khi nhấn ***Xuất chứng từ***, hệ thống sẽ đối chiếu nghiêm ngặt CKS. Hệ thống sẽ báo lỗi và chặn phát hành nếu:
  + CKS chưa được đăng ký trong tờ khai.
  + CKS đã hết hạn hiệu lực.
  + Mã số thuế trên CKS không khớp với MST của đơn vị kinh doanh.

### **4. Gửi email chứng từ cho người nộp thuế**

**Tình huống:** Khi bạn cần gửi trực tiếp chứng từ khấu trừ thuế TNCN cho người nộp thuế qua email

**Thao tác thực hiện như sau:**

* Gửi từ màn hình chi tiết:
  + **Bước 1:** Mở chi tiết một chứng từ, nhấn ***Gửi chứng từ cho NNT***.
...
* Gửi hàng loạt:
  ...
  + **Bước 2:** Nhấn ***Gửi chứng từ cho NNT***.
