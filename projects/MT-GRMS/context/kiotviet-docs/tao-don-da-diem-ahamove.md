...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-giao-van/tao-don-da-diem-ahamove/
---
...
- Để tối ưu giao hàng, tiết kiệm chi phí, KShip tích hợp tính năng Tạo đơn đa điểm của hãng vận chuyển Ahamove. Tính năng này cho phép ghép nhiều điểm giao trên cùng tuyến đường vào 1 vận đơn ahamove để tối ưu việc giao hàng và giảm chi phí giao hàng cho khách.

- Thao tác cụ thể như sau:

## **I. Tạo vận đơn**

- Để tạo đơn đa điểm Ahamove, trước tiên bạn cần tạo hóa đơn có giao hàng nhưng không chọn dịch vụ giao hàng.

- Trên màn hình **Quản lý** -> **Giao dịch** -> **Hóa đơn**, bạn tích chọn các hóa đơn cần ghép tuyến (1) -> chọn ***Thao tác*** (2) -> chọn ***Tạo đơn đa điểm Ahamove*** (3)

*- Lưu ý:*

* *Hệ thống chỉ cho phép chọn các hóa đơn chưa có vận đơn hoặc có vận đơn ở trạng thái Đã hủy.*
* *Hệ thống chỉ cho phép chọn tối đa 50 hóa đơn/1 lần tạo. Nếu chọn nhiều hơn 50 hệ thống tự động chỉ lấy 50 hóa đơn đầu tiên.*

- Hệ thống hiển thị pop-up **Tạo đơn đa điểm Ahamove**. Bạn thực hiện theo 3 bước sau:

* **Thông tin đơn hàng**:
  + Hiển thị danh sách các hóa đơn đã được lấy vào tạo đơn đa điểm. Tại đây bạn có thể: sửa thông tin Địa chỉ lấy hàng (1), chọn lại dịch vụ giao hàng (2) hoặc sửa thông tin của từng điểm giao hoặc xóa điểm giao (3).
  + *Lưu ý: Trường hợp khách hàng sửa thông tin địa chỉ gửi/nhận, tiền thu hộ COD trên popup này, thông tin sẽ chỉ được ghi nhận trên vận đơn Ahamove mà không được đồng bộ về KiotViet.*

* Bạn kích ***Tiếp tục*** để chuyển sang bước 2
* **Cài đặt tối ưu**:
  + Bạn chọn **Số điểm giao** tối thiểu và tối đa: tối thiểu là 1, tối đa sẽ tùy theo dịch vụ giao hàng mà bạn chọn ở bước Thông tin đơn hàng.
  + *Lưu ý: Ngoài **Số điểm giao**, bạn không được sửa các thông tin khác tại bước này.*

* Bạn kích ***Tiếp tục*** để chuyển sang bước 3
* **Duyệt đơn hàng**: bạn có thể nhìn thấy các thông tin sau
  + Tổng tiền phí cho tất cả các điểm giao, cho 1 đơn, cho 1 điểm giao
  + Số lượng đơn hàng được tạo tương ứng với các điểm giao
  + Dịch vụ giao của từng đơn

* Bạn có thể đổi dịch vụ giao hàng và chọn thêm các dịch vụ mở rộng

* Cuối cùng, bạn chọn ***Xác nhận tạo đơn hàng*** để hoàn thành

## **II. Danh sách vận đơn**

- Các đơn được tạo đa điểm sẽ có mã vận đơn theo cú pháp: Mã vận đơn-số thứ tự điểm giao.

- Tracking 1 đơn sẽ là tracking đơn tổng của vận đơn đa điểm.

Như vậy, KiotViet đã thực hiện xong phần hướng dẫn tính năng Tạo đơn đa điểm Ahamove.
