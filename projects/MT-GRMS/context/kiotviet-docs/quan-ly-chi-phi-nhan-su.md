...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-ke-toan-hkd-hach-toan/quan-ly-chi-phi-nhan-su/
---
...
Hỗ trợ
Kế toán HKD - Hạch toánQuản lý Chi phí nhân sự
...
Theo quy định tại Nghị định số 68/2026/NĐ‑CP của Chính phủ quy định về chính sách thuế và quản lý thuế đối với hộ kinh doanh, cá nhân kinh doanh và Nghị định số 141/2026/NĐ‑CP của Chính phủ về quy định mới về chính sách thuế đối với hộ kinh doanh, doanh nghiệp, cá nhân kinh doanh, hộ kinh doanh áp dụng tính thuế thu nhập cá nhân (TNCN) theo lợi nhuận là các hộ có doanh thu trên 3 tỷ đồng/năm, hoặc từ 1 tỷ đến 3 tỷ đồng/năm lựa chọn phương pháp tính thuế này.

Khi hộ kinh doanh thiết lập hồ sơ khai thuế thuộc nhóm tính thuế TNCN theo lợi nhuận, trong nhóm chức năng "Thuế - Kế toán", phần mềm hỗ trợ tính năng Quản lý Chi phí nhân sự cho phép bạn tạo và quản lý bảng lương thủ công ngay trong phần mềm kế toán. Sau khi ghi sổ bảng lương, bạn có thể tạo nhanh các phiếu chi thanh toán lương, bảo hiểm và thuế TNCN trực tiếp từ bảng lương mà không cần nhập lại dữ liệu.

**Đối tượng áp dụng:** Các Chủ Hộ kinh doanh (HKD) đóng thuế theo thu nhập cần tính lương, hạch toán chi phí nhân sự và theo dõi nghĩa vụ bảo hiểm, thuế TNCN hàng tháng.

**Lợi ích nổi bật của tính năng:**

* Tạo bảng lương thủ công trong phần mềm kế toán, hệ thống tự động tính BHXH/BHYT/BHTN và thuế TNCN lũy tiến theo luật hiện hành — không cần tính tay phức tạp.

## **II. Các thao tác cơ bản**

### **1. Xem danh sách bảng lương**

**Tình huống:** Khi bạn cần xem lại danh sách tất cả các bảng lương do bạn tự tạo thủ công trên hệ thống.

Hệ thống sẽ hiển thị danh sách bảng lương và hỗ trợ bạn tìm kiếm nhanh theo tên bảng lương hoặc kỳ kê khai.

**Thao tác thực hiện như sau:**

* **Bước 1**: Trên màn hình **Quản lý**, truy cập vào menu **Thuế & Kế toán** → **Thuế & Kế toán** → chọn **Chi phí nhân sự**.
* **Bước 2**: Hệ thống sẽ hiển thị toàn bộ bảng lương, mặc định tất cả các kỳ.

* **Bước 3:** Sử dụng bộ lọc để tìm kiếm các bảng lương cần thiết. Bạn có thể lọc theo:
  + Bảng lương
  + Kỳ kế toán
  + Địa điểm
  + Nguồn (Thủ công/Đồng bộ):
    - Các bảng lương do bạn tự tạo trên màn hình **Chi phí nhân sự** sẽ hiển thị nhãn ***Thủ công***.
    - Các bảng lương được tự động chuyển từ phần mềm Quản lý bán hàng KiotViet sang sẽ hiển thị nhãn ***Đồng bộ*** (tính năng đang hoàn thiện).

### **2. Tạo bảng lương thủ công**

**Tình huống:** Khi bạn cần lập bảng lương cho một tháng làm việc cụ thể, nhập số liệu tiền lương cho nhân viên và để hệ thống tự động tính toán các khoản trích nộp bảo hiểm, thuế một cách chính xác.

**Thao tác thực hiện như sau:**

* **Bước 1**: Trên màn hình **Chi phí nhân sự** → nhấn ***+ Tạo bảng lương***.
* **Bước 2**: Hệ thống hiển thị popup **Tạo bảng lương mới**. Tại đây, bạn thao tác:
  + Chọn kỳ lương (tháng/năm)
  + Nhập ***Số ngày làm việc trong kỳ***.
  + Chọn ***Địa điểm*** (nếu có nhiều địa điểm).
  + Nhập ***Tên bảng lương*** (nếu cần): Hệ thống sẽ gợi ý tên mặc định là "Bảng lương tháng MM/YYYY".
  + Tùy chọn ***Dùng lại thông tin nhân viên và mức lương từ bảng lương đã có***: Nếu tích chọn, bạn tìm kiếm và chọn bảng lương mẫu cần dùng.

* **Bước 3**: Nhấn ***Tạo bảng lương***. Lúc này, bảng lương sẽ được tạo ở trạng thái ***Lưu tạm*** và hệ thống chuyển bạn vào màn hình chi tiết bảng lương với 2 ***Chế độ hiển thị***:

* Chế độ ***Đơn giản***: Bạn chỉ cần nhập ***Lương đóng BH***, ***Số người phụ thuộc*** (nếu có).
* Chế độ ***Chi tiết***: Bạn có thể nhập chi tiết ***Lương chính***, các khoản ***Phụ cấp***, ***Giảm trừ***, ***Số ngày làm việc hưởng lương***, ***Lương đóng BH***, ***Số người phụ thuộc***.

* **Bước 4**: Nhập thông tin nhân viên: Bạn có thể chọn nhân viên từ danh sách có sẵn hoặc nhập mới hoàn toàn. Nhấn ***+ Thêm nhân viên*** để thêm dòng.

* **Bước 5**: Sau khi nhập, hệ thống sẽ tự động tính tỷ lệ phần trăm các khoản BHXH, BHYT, BHTN, phí công đoàn (PCĐ) (cho cả người lao động và hộ kinh doanh/doanh nghiệp), Thuế TNCN, Lương thực nhận và Tổng chi phí ghi nhận của hộ kinh doanh/doanh nghiệp.

* **Bước 6**: Nhấn ***Xác nhận và Ghi sổ*** → ***Xác nhận***. Hệ thống sẽ tự động hạch toán chi phí cho từng nhân viên và chuyển bảng lương sang trạng thái ***Đã ghi sổ*** (ghi nhận vào **Sổ doanh thu & chi phí (S2c-HKD)**).

**Lưu ý**: Bạn có thể tạo nhiều bảng lương khác nhau trong cùng một kỳ.

## **III. Các tính năng nâng cao**

Đối với các bảng lương được tạo thủ công, sau khi bạn thao tác ghi sổ thành công, hệ thống sẽ cho phép tạo nhanh các phiếu chi liên quan như: phiếu chi lương, phiếu chi các khoản trích nộp và phiếu chi thuế TNCN.

### **1. Tạo phiếu chi lương thực nhận**

**Tình huống:** Khi đến kỳ thanh toán, bạn cần lập phiếu chi để ghi nhận dòng tiền trả lương thực tế cho nhân viên dựa trên bảng lương đã được chốt và ghi sổ.

**Thao tác thực hiện như sau:**

* **Bước 1**: Trên màn hình **Chi phí nhân sự**, bạn chọn bảng lương ***Đã ghi sổ*** cần lập phiếu chi → nhấn ***Xem chi tiết***.

* **Bước 2**: Tại khu vực ***Tổng lương thực nhận*** → nhấn ***+ Tạo phiếu chi***.
* **Bước 3**: Hệ thống hiển thị popup **Tạo phiếu chi lương**, bạn kiểm tra, điền các thông tin:
  + ***Ngày giao dịch***: Mặc định là ngày hiện tại.
  + ***Tên người nộp***: Nhập tên người nộp.
  + ***Phương thức thanh toán***: Bắt buộc chọn Tiền mặt hoặc Chuyển khoản.
  + ***Số tiền***: Mặc định bằng tổng lương thực nhận. Bạn có thể chỉnh sửa nhưng không được vượt quá tổng lương thực nhận.
  + ***Diễn giải***: Mặc định là "Trả lương tháng MM/YYYY — [Tên bảng lương]".
* **Bước 4**: Nhấn ***Lưu***.

* **Bước 5**: Hệ thống sẽ tạo phiếu chi, ghi nhận vào phân hệ **Thu - Chi** và hiển thị mã phiếu chi trong bảng lương.

Bạn nhấn vào mã phiếu chi để chuyển tới phân hệ **Thu - Chi**.

**Lưu ý:** Bạn có thể tạo nhiều phiếu chi lương trên cùng một bảng lương để hỗ trợ việc trả lương chia thành nhiều đợt khác nhau.

### **2. Tạo phiếu chi bảo hiểm**

**Tình huống:** Khi hộ kinh doanh/doanh nghiệp cần xuất quỹ để đóng các khoản bảo hiểm bắt buộc cho cơ quan nhà nước, bạn tạo phiếu chi dựa trên phần trích nộp đã ghi nhận ở bảng lương.

**Thao tác thực hiện như sau:**

* **Bước 1**: Trên màn hình **Chi phí nhân sự**, bạn chọn bảng lương ***Đã ghi sổ*** cần lập phiếu chi → nhấn ***Xem chi tiết***.

* **Bước 2**: Tại khu vực ***Tổng các khoản BHXH, BHYT, BHTN, PCĐ***  → nhấn ***+ Tạo phiếu chi***.

* **Bước 3**: Hệ thống hiển thị popup **Tạo phiếu chi bảo hiểm/trích nộp** bạn kiểm tra, điền các thông tin:
  + ***Ngày giao dịch***: Mặc định là ngày hiện tại.
  + ***Tên người nộp***: Nhập tên người nộp.
  + ***Phương thức thanh toán***: Bắt buộc chọn Tiền mặt hoặc Chuyển khoản.
  + ***Số tiền***: Mặc định bằng tổng lương thực nhận. Bạn có thể chỉnh sửa nhưng không được vượt quá tổng lương thực nhận.
  + ***Diễn giải***: Mặc định là "Trích nộp bảo hiểm, phí công đoàn tháng MM/YYYY".
* **Bước 4**: Nhấn ***Lưu***.
...
### **3. Tạo phiếu chi thuế TNCN**

**Tình huống:** Khi doanh nghiệp thực hiện nộp thuế TNCN (đã khấu trừ của người lao động) cho cơ quan thuế, bạn cần tạo phiếu chi ghi nhận dòng tiền này.

**Thao tác thực hiện như sau:**

* **Bước 1**: Trên màn hình **Chi phí nhân sự**, bạn chọn bảng lương ***Đã ghi sổ*** cần lập phiếu chi → nhấn ***Xem chi tiết***.

* **Bước 2**: Tại khu vực ***Tổng thuế TNCN nhân viên*** → nhấn ***+ Tạo phiếu chi***.
* **Bước 3**: Hệ thống hiển thị popup **Tạo phiếu chi thuế TNCN** bạn kiểm tra, điền các thông tin:
  + ***Ngày giao dịch***: Mặc định là ngày hiện tại.
  + ***Tên người nộp***: Nhập tên người nộp.
  + ***Phương thức thanh toán***: Bắt buộc chọn Tiền mặt hoặc Chuyển khoản.
  + ***Số tiền***: Mặc định bằng tổng lương thực nhận. Bạn có thể chỉnh sửa nhưng không được vượt quá tổng lương thực nhận.
  + ***Diễn giải***: Mặc định là "Nộp thuế TNCN tháng MM/YYYY — [Tên bảng lương]".
* **Bước 4**: Nhấn ***Lưu***.
...
### **4. Sửa bảng lương đã ghi sổ**

**Tình huống:** Khi bạn phát hiện có sai sót về ngày công hoặc mức lương sau khi bảng lương đã được ghi sổ và cần điều chỉnh lại cho chính xác.

**Thao tác thực hiện như sau:**

* **Bước 1**: Trên màn hình **Chi phí nhân sự**, bạn chọn bảng lương ***Đã ghi sổ*** cần lập phiếu chi → nhấn ***Xem chi tiết***.

* **Bước 2**: Nhấn ***Chỉnh sửa*** → bảng lương sẽ quay về trạng thái ***Lưu tạm*** để bạn có thể thay đổi số liệu.

* **Bước 3**: Chỉnh sửa các số liệu cần thiết trên bảng lương → nhấn ***Xác nhận thay đổi***.

* **Bước 4**: Nhấn ***Xác nhận*** → hệ thống sẽ tự động hủy các phiếu chi đã liên kết tại phân hệ **Thu - Chi** (nếu có) và cập nhật **Sổ doanh thu & chi phí (S2c-HKD)** theo dữ liệu mới.

### **5. Xóa bảng lương**

**Tình huống:** Khi bạn tạo nhầm một bảng lương hoặc không còn nhu cầu lưu trữ bảng lương đó trên hệ thống và muốn xóa bỏ hoàn toàn.

**Thao tác thực hiện như sau:**

* **Bước 1**: Trên màn hình **Chi phí nhân sự**, bạn chọn bảng lương ***Đã ghi sổ*** cần lập phiếu chi → nhấn ***Xóa***.
* **Bước 2**: Nhấn ***Xác nhận***.

* **Bước 3**: Hệ thống sẽ xử lý việc xóa tùy thuộc vào trạng thái hiện tại của bảng lương:

* **Bảng lương đang Lưu tạm**: Sau khi xác nhận xóa, hệ thống xóa bình thường do chưa có ghi nhận chi phí hay phiếu chi nào được tạo.
* **Bảng lương Đã ghi sổ, không có phiếu chi**: Xóa bảng lương đồng thời xóa chi phí nhân sự tương ứng trong sổ doanh thu chi phí.
* **Bảng lương Đã ghi sổ, có phiếu chi liên kết**: Xóa bảng lương sẽ ghi nhận lại chi phí trong sổ doanh thu chi phí và hủy toàn bộ phiếu chi lương đã tạo.

### **6. Tham khảo quy định tính toán các khoản trích nộp**

**Tình huống:** Bạn cần biết các công thức tính toán và ý nghĩa các trường dữ liệu trên bảng lương để đối chiếu số liệu tự động của hệ thống.

**Quy tắc hệ thống tự động tính toán Các khoản BHXH, BHYT, BHTN, PCĐ như sau**:

* **BHXH**:
  + Khấu trừ vào lương 8% mức Lương đóng BH (tối đa 46,800,000 đồng).
  + Hộ kinh doanh/ doanh nghiệp đóng 17,5% mức Lương đóng BH (tối đa 46,800,000 đồng).
* **BHYT**:
  + Khấu trừ vào lương 1.5% mức Lương đóng BH (tối đa 46,800,000 đồng).
  + Hộ kinh doanh/ doanh nghiệp đóng 3% mức Lương đóng BH (tối đa 46,800,000 đồng).
* **BHTN**:
  + Khấu trừ vào lương 1% mức Lương đóng BH (tối đa không quá 99,200,000 đồng).
  + Hộ kinh doanh/ doanh nghiệp đóng 1% mức Lương đóng BH (tối đa không quá 99,200,000).
* **Phí công đoàn (PCĐ)**:
  + Khấu trừ vào lương 1% mức Lương đóng BH (tối đa 46,800,000 đồng).
  + Hộ kinh doanh/ doanh nghiệp đóng 2% mức Lương đóng BH (tối đa 46,800,000 đồng).
* Khi số ngày làm việc không hưởng lương từ 14 ngày trở lên trong tháng → Các khoản BHXH, BHYT, BHTN, PCĐ khấu trừ vào lương và hộ kinh doanh/doanh nghiệp đóng = 0.
* **Thuế TNCN**: Tính lũy tiến 5 bậc theo quy định hiện hành. Mức giảm trừ bản thân là 15.5 triệu/tháng và người phụ thuộc là 6.2 triệu/người/tháng.

**Quy tắc tính Thuế TNCN lũy tiến**:

* **Bậc 1** (Thu nhập tính thuế (TNTT)/tháng **đến 10 triệu đồng**): TNTT × 5%.
* **Bậc 2** (TNTT/tháng **trên 10 đến 30 triệu đồng**): 500,000 + (TNTT – 10 triệu) × 10%.
* **Bậc 3** (TNTT/tháng **trên 30 đến 60 triệu đồng**): 2,500,000 + (TNTT – 30 triệu) × 20%.
* **Bậc 4** (TNTT/tháng **trên 60 đến 100 triệu đồng**): 8,500,000 + (TNTT – 60 triệu) × 30%.
* **Bậc 5** (TNTT/tháng **trên 100 triệu đồng**): 20,500,000 + (TNTT – 100 triệu) × 35%.

Chú thích dữ liệu cho từng nhân viên trên bảng lương:

* **Lương chính:** Bạn tự điền khi thêm nhân viên. Đây là căn cứ đóng bảo hiểm mặc định.
* **Phụ cấp / Giảm trừ**: Bạn có thể thêm nhiều dòng và tự đặt tên, hệ thống sẽ gộp chung khi hiển thị.
* **Số ngày làm việc hưởng lương**: Bạn tự nhập.
* **Số ngày làm việc không hưởng lương** = Số ngày làm việc trong kỳ - Số ngày làm việc hưởng lương.
* **Tổng lương** = Lương chính \* Số ngày làm việc hưởng lương ÷ Số ngày làm việc trong kỳ + Phụ cấp - Giảm trừ.
* **Lương đóng BH**: Hệ thống tự động lấy bằng Lương chính hoặc bạn tự nhập.
* **Các khoản BHXH, BHYT, BHTN, PCĐ khấu trừ vào lương**: Gồm BHXH (8%), BHYT (1.5%), BHTN (1%) và phí công đoàn (1%).
* **Thuế TNCN**: Dựa trên thu nhập trước giảm trừ và số người phụ thuộc bạn nhập, hệ thống tự tính mức giảm trừ gia cảnh, thu nhập tính thuế và số thuế TNCN phải nộp theo quy định.
* **Lương thực nhận** = Thu nhập trước giảm trừ gia cảnh - Thuế TNCN.
* **Các khoản BHXH, BHYT, BHTN, PCĐ hộ kinh doanh đóng**: Gồm BHXH (17.5%), BHYT (3%), BHTN (1%) và PCĐ (2%).
* **Tổng chi phí ghi nhận** của hộ kinh doanh/doanh nghiệp = Lương thực nhận + các khoản hộ kinh doanh/doanh nghiệp đóng + Thuế TNCN.

### **7. Các tình huống đặc biệt**

**Tình huống:** Trong quá trình vận hành, bạn có thể gặp một số trường hợp nhân sự đặc thù cần lưu ý khi hệ thống xử lý.

Hệ thống sẽ tự động xử lý các trường hợp sau:

* **Nhân viên vắng không lương từ 14 ngày trở lên**: Toàn bộ khoản bảo hiểm (của người lao động và công ty) sẽ tự động bằng 0. Hệ thống không tạo dòng ghi nhận chi phí bảo hiểm cho nhân viên này.

* **Tổng thuế TNCN nhân viên bằng 0**: Hệ thống không hiển thị nút ***+ Tạo phiếu chi*** tại khu vực ***Tổng thuế TNCN nhân viên***.

* **Tạo 2 bảng lương cùng một kỳ tháng/năm**: Điều này giúp hỗ trợ các cửa hàng có nhu cầu làm nhiều bảng lương cùng kỳ cho nhiều phòng ban hoặc trả lương theo nhiều đợt.
