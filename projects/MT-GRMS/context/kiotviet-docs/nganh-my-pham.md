...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-chuyen-nganh/nganh-my-pham/
---
...
Để đáp ứng những yêu cầu đặc thù của ngành, KiotViet đã phát triển một bộ tính năng chuyên ngành, được thiết kế riêng để giúp các cửa hàng mỹ phẩm vận hành hiệu quả, chuyên nghiệp và tối ưu hóa việc quản lý sản phẩm. Bộ tính năng này không chỉ là một công cụ quản lý bán hàng thông thường mà còn là một giải pháp toàn diện, tập trung vào việc quản lý sản phẩm theo **Lô – Hạn sử dụng**, quản lý **chương trình khách hàng thân thiết (tích điểm)** và thiết lập các **bảng giá linh hoạt**. Tất cả đều nhằm mục đích giúp chủ cửa hàng kiểm soát chặt chẽ hàng tồn kho, giảm thiểu rủi ro, tăng cường sự gắn kết của khách hàng và nâng cao chất lượng phục vụ.

**Lợi ích nổi bật của tính năng:**

* **Quản lý sản phẩm hiệu quả theo Lô – Hạn sử dụng:** Hệ thống tự động gợi ý xuất bán các lô mỹ phẩm có hạn sử dụng gần nhất trước (theo nguyên tắc FEFO), giúp giảm thiểu rủi ro kinh doanh, tránh lãng phí và thất thoát do hàng hóa hết hạn.
* **Kiểm soát tồn kho chính xác, minh bạch:** Dễ dàng theo dõi số lượng tồn kho và giá vốn của từng lô hàng riêng biệt. Mọi giao dịch đều được ghi nhận chi tiết theo lô, giúp bạn truy xuất lịch sử và quản lý hàng hóa một cách minh bạch, tránh thất thoát.
* **Tối ưu hóa bán hàng và chăm sóc khách hàng:** Nhanh chóng xác định sản phẩm sắp hết hạn để lên chương trình khuyến mại, kết hợp với các chính sách giá và chương trình tích điểm linh hoạt để giữ chân khách hàng và gia tăng doanh thu.

Tài liệu này hướng dẫn anh chị các tính năng phổ biến liên quan tới ngành hàng Mỹ phẩm mà KiotViet gợi ý cửa hàng tham khảo và lựa chọn các giải pháp phù hợp.
...
Để dễ hình dung, các ví dụ dưới đây sẽ minh họa những tình huống thực tế tại cửa hàng mỹ phẩm.
...
### **2. Thêm mới hàng hóa theo Lô - Hạn sử dụng**
...
* **Tình huống:** Bạn vừa nhập một lô "Kem dưỡng ẩm" mới và cần ghi nhận số lượng, hạn sử dụng và giá vốn của lô đó vào hệ thống.
* **Thao tác thực hiện như sau:**
...
* **Tình huống:** Khách hàng mua một sản phẩm, bạn cần xuất bán từ lô hàng có hạn sử dụng gần nhất, áp dụng bảng giá sỉ và cho phép khách dùng điểm tích lũy để thanh toán.
* **Thao tác thực hiện như sau:**

(1) Khi thêm sản phẩm vào hóa đơn, hệ thống sẽ tự động gợi ý lô có hạn sử dụng gần nhất (nguyên tắc FEFO).

(2) Bạn có thể chọn lại lô hoặc nhấn vào danh sách thả xuống dưới tên sản phẩm để chọn một lô khác nếu muốn. Hệ thống sẽ cảnh báo bằng màu sắc: **màu vàng** cho lô sắp hết hạn và **màu đỏ** cho lô đã hết hạn.

(3) **Áp dụng Bảng giá sỉ:** Chọn khách hàng thuộc nhóm "Khách sỉ", hệ thống sẽ tự động áp dụng bảng giá tương ứng đã thiết lập.

(4) **Sử dụng điểm tích lũy:** Tại thông tin thanh toán bên phải màn hình, hệ thống sẽ hiển thị số điểm khách có và giá trị quy đổi. Bạn bật xanh ***Điểm*** → nhập số tiền muốn quy đổi (không vượt quá tổng tiền khách phải trả).
...
* **Tình huống:** Bạn muốn kiểm tra xem có loại mỹ phẩm nào trong kho sắp hết hạn trong 3 tháng tới để lên kế hoạch khuyến mại, tặng kèm hoặc xả hàng.
* **Thao tác thực hiện như sau:**
...
Tính năng quản lý mỹ phẩm theo Lô - Hạn sử dụng trên ứng dụng KiotViet hỗ trợ các thao tác cốt lõi ngay trên thiết bị di động.
...
(1) Khi thêm một sản phẩm vàohóa đơn trên máy POS, một pop-up chọn lô sẽ tự động hiện ra.
...
​*Tài liệu được cập nhật mới nhất ngày 08/10/2025*
