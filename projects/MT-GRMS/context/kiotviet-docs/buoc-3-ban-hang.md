...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-lam-quen-voi-kiotviet/buoc-3-ban-hang/
---
...
Sau khi đã có dữ liệu hàng hóa và tồn kho, thao tác Bán hàng là hoạt động diễn ra thường xuyên nhất tại cửa hàng. Tính năng này giúp tạo hóa đơn nhanh chóng, chính xác và chuyên nghiệp. Mỗi giao dịch thành công sẽ tự động trừ tồn kho và ghi nhận doanh thu, giúp hệ thống luôn phản ánh đúng tình hình kinh doanh thực tế.

**Lợi ích nổi bật của tính năng**:

* **Tăng tốc độ thanh toán**: Giúp nhân viên bán hàng và thu ngân tối ưu việc tìm kiếm sản phẩm, tính tiền và thanh toán chỉ trong vài cú nhấp chuột, giảm thời gian chờ đợi cho khách.
* **Đảm bảo dữ liệu tồn kho chính xác**: Hỗ trợ chủ cửa hàng quản lý kho hiệu quả bằng cách tự động trừ tồn kho ngay sau khi hoàn tất hóa đơn, tránh sai lệch dữ liệu.
* **Linh hoạt trong thanh toán**: Cho phép thu ngân dễ dàng áp dụng nhiều phương thức thanh toán (tiền mặt, thẻ, chuyển khoản,...) và kết hợp chúng trên cùng một hóa đơn, đáp ứng mọi nhu-cầu của khách hàng.

## **II. Thao tác Bán hàng**

Để dễ hình dung, các ví dụ dưới đây sẽ minh họa những tình huống kinh doanh thực tế.

**Tình huống**: Khi bạn cần bán hàng cho một khách mới và khách muốn thanh toán bằng nhiều phương thức. Ví dụ, khách mua một thùng "Sữa tươi Ba Vì - Vani" giá 320.000đ, thanh toán 300.000đ bằng tiền mặt và phần còn lại 20.000đ bằng chuyển khoản.

**Thao tác thực hiện như sau**:

* **Bước 1:** **Tìm kiếm và chọn sản phẩm**:
  + Từ màn hình bán hàng, tại ô tìm kiếm, gõ "Sữa tươi Ba Vì Vani" để tìm sản phẩm.
  + Chọn đơn vị bán là **Thùng** và nhập số lượng là 1. Giá bán 320,000đ sẽ được tự động áp dụng.

* **Bước 2:** **Thêm thông tin khách hàng**:
  + Tại ô tìm kiếm khách hàng, nhấn vào biểu tượng dấu cộng (+) để thêm khách mới.
  + Điền tên khách hàng và nhấn **Lưu**.

* **Bước 3:** **Xử lý thanh toán kết hợp**:
  + Dưới thông tin **Khách thanh toán**, nhấn vào biểu tượng ba chấm (...).
  + Nhập 300,000 và chọn phương thức là **Tiền mặt**.
  + Hệ thống sẽ hiển thị số tiền còn lại là 20,000đ. Chọn phương thức là **Chuyển khoản** cho phần tiền này.
  + Nhấn ***Xong***.

* **Bước 4:** **Hoàn tất và In hóa đơn**:
  + Nhấn vào nút **Thanh toán** để hoàn tất giao dịch.
  + Hệ thống sẽ tạo hóa đơn để bạn có thể in và gửi cho khách hàng. Tồn kho sản phẩm cũng sẽ tự động được trừ đi.
