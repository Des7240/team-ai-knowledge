...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-hang-hoa/hang-hoa-serial-imei/
---
...
Việc áp dụng quản lý theo Serial/IMEI trên KiotViet mang lại cho cửa hàng của bạn những lợi ích vượt trội, giúp tối ưu hóa quy trình và nâng cao hiệu quả kinh doanh:

**Lợi ích nổi bật của việc quản lý Hàng hóa theo Serial/IMEI trên KiotViet:**

* **Kiểm soát chính xác đến từng đơn vị sản phẩm:** Mỗi sản phẩm được quản lý bằng một mã Serial/IMEI duy nhất, giúp bạn theo dõi chính xác vòng đời của từng mặt hàng từ lúc nhập kho đến khi bán hàng, đảm bảo không có sự nhầm lẫn hay thất thoát.
* **Tối ưu hóa quy trình bảo hành và xử lý khiếu nại:** Hệ thống ghi nhận chính xác mã Serial/IMEI của sản phẩm đã bán cho khách, giúp việc tra cứu thông tin và áp dụng chính sách bảo hành, sửa chữa trở nên nhanh chóng và chuyên nghiệp.
* **Minh bạch hóa giao dịch, chống gian lận và thất thoát:** Việc quản lý chặt chẽ từng mã Serial/IMEI trong mọi giao dịch giúp bạn dễ dàng phát hiện các trường hợp tráo đổi hàng hóa hoặc sai lệch tồn kho, giảm thiểu tối đa rủi ro cho cửa hàng.
...
* **Tình huống:** Để bắt đầu sử dụng, bạn cần kích hoạt tính năng quản lý theo Serial/IMEI cho cửa hàng của mình.
* **Thao tác thực hiện như sau:** Bạn vào menu **Thiết lập** → **Hàng hóa** → bật tùy chọn **Quản lý tồn kho theo Serial/IMEI**.

### **2. Thêm mới hàng hóa theo Serial/IMEI**

* **Tình huống:** Bạn cần tạo một sản phẩm mới, ví dụ như một chiếc điện thoại, và quản lý nó theo từng mã IMEI duy nhất.
* **Thao tác thực hiện như sau:**

1. Tại màn hình **Hàng hóa** → **Danh sách hàng hóa**, bạn nhấn **Tạo mới** → **Thêm hàng hóa**.

2. Điền các thông tin cơ bản về sản phẩm (tên, giá bán, giá vốn, nhóm hàng...). Chọn **Có** vào ô **Quản** **lý theo Serial/IMEI** để kích hoạt tính năng quản lý theo Serial/IMEI.

3. Nhấn ***Lưu***.

**Lưu ý**: Tồn kho ban đầu sẽ không được nhập ở bước này, bạn cần tạo phiếu nhập hàng.

### **2. Nhập hàng theo Serial/IMEI**

* **Tình huống:** Lô hàng điện thoại "iPhone 16" mới về, bạn cần nhập từng mã IMEI vào hệ thống để ghi nhận tồn kho.
* **Thao tác thực hiện như sau:**
...
Ngoài ra, bạn cũng có thể nhập hàng loạt qua file Excel.

### **3. Bán hàng theo Serial/IMEI**

* **Tình huống:** Khách hàng mua một chiếc điện thoại "iPhone 16", bạn cần quét đúng mã IMEI của chiếc máy đó để xuất bán và ghi nhận bảo hành.
* **Thao tác thực hiện như sau:**

1. Trên màn hình **Bán hàng**, tìm kiếm sản phẩm "iPhone 16"  hoặc quét mã Serial/IMEI bán cho khách.

2. Thêm thông tin khách hàng vào hóa đơn để lưu lại lịch sử mua hàng và phục vụ cho việc bảo hành sau này.
3. Nhấn ***Thanh toán*** để hoàn tất giao dịch.

## **III. Các tính năng nâng cao**

* **Tình huống:** Bạn cần xử lý các nghiệp vụ kho khác như khách trả hàng, chuyển hàng giữa các chi nhánh, kiểm kê kho hoặc xuất hủy hàng hỏng.
* **Thao tác thực hiện như sau:** 
  + **Trả hàng:** Tìm lại hóa đơn gốc theo Serial/IMEI để hệ thống ghi nhận đúng mã đó được trả về kho.

* **Chuyển hàng**, **Xuất hủy:** Chọn chính xác các mã Serial/IMEI cần thực hiện giao dịch.

* **Kiểm kho:** Nhập hoặc quét các mã Serial/IMEI thực tế có trong kho. Hệ thống sẽ tự động đối chiếu và thống kê chi tiết các mã bị thiếu hoặc thừa.

## **IV. Thao tác trên Điện thoại**

Tính năng quản lý hàng hóa theo Serial/IMEI trên ứng dụng KiotViet hỗ trợ cửa hàng thực hiện các thao tác: Thêm mới, Nhập hàng, Bán hàng, Chuyển hàng, Kiểm kho, Xuất hủy.

### **1. Thêm mới hàng hóa**

* **Tình huống:** Bạn cần tạo nhanh một sản phẩm mới có quản lý IMEI khi đang ở ngoài cửa hàng.
* **Thao tác thực hiện như sau:**

1. Trong menu **Hàng hóa** trên ứng dụng KiotViet, chạm vào biểu tượng dấu **+** → nhấn ***Thêm hàng hóa***
2. Bật tùy chọn **Quản lý theo Serial/IMEI**.

### **2. Thực hiện các giao dịch (Nhập, Bán, Chuyển, Kiểm, Hủy)**

* **Tình huống:** Bạn cần thực hiện các nghiệp vụ nhập hàng, bán hàng, trả hàng, chuyển hàng, kiểm kho, xuất hủy với hàng hóa IMEI ngay trên điện thoại.
* **Thao tác thực hiện như sau:** Khi tạo các giao dịch nhập/xuất, ứng dụng cho phép bạn chọn các mã Serial/IMEI sau khi tìm kiếm theo tên/mã hàng

Hoặc quét chính xác các mã Serial/IMEI
