...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-thiet-lap/tro-ly-kici/
---
...
Trợ lý KiCi là trợ lý trí tuệ nhân tạo (AI) được tích hợp trực tiếp trên KiotViet, hỗ trợ bạn tra cứu số liệu kinh doanh và giải đáp nghiệp vụ tức thì bằng ngôn ngữ tự nhiên như nhắn tin thông thường mà không cần tìm kiếm thủ công qua nhiều màn hình báo cáo.

**Lợi ích nổi bật của tính năng:**

* **Tra cứu số liệu tức thì:** Cung cấp số liệu kinh doanh theo câu hỏi tự nhiên, loại bỏ thao tác lọc kỳ, chọn chi nhánh hay tìm báo cáo phức tạp.
* **Phân tích và gợi ý hành động:** Tự động trực quan hóa bằng biểu đồ, chỉ rõ nguyên nhân biến động (mặt hàng kéo số, chi nhánh sụt giảm doanh thu...) và đề xuất giải pháp tiếp theo.
* **Hướng dẫn thao tác tại chỗ:** Chỉ dẫn từng bước sử dụng tính năng ngay trong ca làm việc, bám sát đúng nền tảng bạn đang dùng mà không cần chờ đợi tổng đài viên.
* **Sàng lọc và chẩn đoán sự cố:** Hỗ trợ nhận diện nhanh nguyên nhân lỗi (do thao tác, phân quyền, dữ liệu hay sự cố hệ thống) để đưa ra hướng xử lý phù hợp.

**Đối tượng sử dụng:** Tài khoản admin của chủ gian hàng.

**Phạm vi áp dụng:** Khung chat tương tác trực tiếp trên phiên bản Web KiotViet có thể hướng dẫn chi tiết quy trình thao tác cho cả 3 nền tảng: website, ứng dụng KiotViet trên điện thoại và máy bán hàng.

**Lưu ý:**

* **Quyền riêng tư hội thoại:** Lịch sử trò chuyện gắn liền với từng tài khoản đăng nhập. Thành viên khác trong cửa hàng không thể tra cứu, xem hay xóa hội thoại của bạn.
* **Quyền hạn hệ thống:** KiCi không tự ý thay đổi dữ liệu (không tạo đơn, không sửa/xóa dữ liệu, không nhập hàng, không thu nợ, không tạo khuyến mại). Bạn luôn là người trực tiếp thực hiện thao tác trên màn hình chức năng của KiotViet.
* **Phạm vi dữ liệu truy xuất:** KiCi chỉ làm việc trên dữ liệu nội bộ của cửa hàng bạn; không truy cập dữ liệu gian hàng khác, không có số liệu thị trường và không so sánh với đối thủ cạnh tranh cụ thể.
* **Thời hạn lưu trữ:** Lịch sử trò chuyện và hình ảnh tải lên được lưu trữ trong 90 ngày. Cuộc hội thoại đã xóa sẽ mất vĩnh viễn và không thể khôi phục.
* **Bảo mật thông tin:** Ảnh chụp màn hình gửi lên có thể chứa dữ liệu nhạy cảm (SĐT khách hàng, giá vốn, công nợ). Bạn nên khoanh vùng và cắt bỏ thông tin thừa trước khi tải lên. Tuyệt đối không nhập mật khẩu, mã OTP hoặc thông tin thẻ vào khung chat, KiCi không bao giờ yêu cầu các dữ liệu này.

## **II. Các thao tác cơ bản**

### **1. Mở và làm quen với Trợ lý KiCi**

**Tình huống:** Bạn muốn tìm hiểu phạm vi hỗ trợ và bắt đầu tương tác với trợ lý ảo KiCi.

**Thao tác thực hiện như sau:**

* **Bước 1:** Tại màn hình **Quản lý →** trên thanh menu đầu trang → bạn nhấn nút **Trợ lý KiCi** → khung chat trượt vào từ bên phải màn hình, hiển thị **KiCi xin chào!** cùng các gợi ý nhanh mặc định.

**Lưu ý:** Khung chat được tự động mở khi bạn truy cập vào màn **Tổng quan** / **Phân tích** / **Báo cáo** nếu còn nhiệm vụ đặt lịch chưa xem - tối đa 1 lần/ngày. Giao diện phía sau vẫn thao tác bình thường.

* **Bước 2:** Bạn nhấn vào gợi ý **Xem trợ lý AI có thể hỗ trợ những gì?** → KiCi liệt kê toàn bộ các tác vụ có thể hỗ trợ.

* **Bước 3:** Để trở lại màn hình **KiCi xin chào!** ban đầu, bạn nhấn biểu tượng ***Cuộc hội thoại mới*** hình cây bút  góc trên bên phải.

* **Bước 4:** Để đóng khung chat, bạn có thể:
  + Nhấn dấu **X** ở góc trên bên phải.
  + Nhấn nút **Trợ lý KiCi** ngay trên thanh menu đầu trang.
  + Nhấp chuột ra ngoài vùng khung chat.
  + Hoặc nhấn **Esc** trên bàn phím.

**Lưu ý:**

* Nếu đã đóng khung chat, bạn nhấn nút **Trợ lý KiCi** ngay trên thanh menu đầu trang để mở lại.

* Bạn có thể rê chuột vào cạnh trái khung chat và kéo sang trái để mở rộng kích thước hiển thị.

* Danh sách gợi ý nhanh mặc định sẽ tự động điều chỉnh linh hoạt theo quy mô và ngành hàng của cửa hàng bạn.

### **2. Câu hỏi kinh doanh**

**Tình huống:** Khi bạn cần nắm nhanh số liệu kinh doanh thuộc 5 mảng: Bán hàng, Chi phí & Lợi nhuận, Hàng hóa, Tồn kho, Khách hàng & Công nợ mà không cần mở từng báo cáo chi tiết.

**Thao tác thực hiện như sau:**

* **Bước 1:** Mở **Trợ lý KiCi** → chọn câu gợi ý có sẵn hoặc nhập trực tiếp câu hỏi bằng ngôn ngữ tự nhiên vào ô chat ở cuối màn hình rồi nhấn mũi tên  (hoặc nhấn Enter) gửi đi.

* **Bước 2:** Xem phản hồi của KiCi. Cấu trúc câu trả lời chuẩn gồm:
  + Câu mở đầu (kèm mốc thời gian).
  + Số liệu chính (in đậm kèm tỷ lệ tăng/giảm).
  + Biểu đồ/bảng số liệu trực quan.
  + Phân tích nguyên nhân.
  + Gợi ý hành động thực tế.
  + Câu gợi ý đào sâu tiếp theo.

* **Bước 3:** Nhấn vào câu gợi ý bên dưới hoặc tiếp tục nhập câu hỏi mới để khai thác sâu hơn (Ví dụ: sau khi xem doanh thu tháng này, bạn gõ tiếp *"còn tháng trước?"*, KiCi sẽ tự liên kết ngữ cảnh trước đó để phản hồi).

**Lưu ý:**

* Nếu câu hỏi không nêu mốc thời gian, KiCi mặc định tổng hợp dữ liệu trong 30 ngày gần nhất.
* Các chỉ số doanh thu, tồn kho hàng hóa, công nợ khách hàng phục vụ vận hành có thể hỏi dữ liệu mới nhất.
* Các báo cáo phân tích chi phí, lợi nhuận, xu hướng, hiệu quả kinh doanh... sẽ tính đến hết ngày hôm qua, nếu hỏi kỳ chứa hôm nay, KiCi tự lùi mốc cuối về hôm qua.
* Đối với kỳ kinh doanh dở dang, hệ thống tự động đối chiếu chéo với kỳ liền trước và cùng kỳ để đảm bảo tính chuẩn xác.
* Mỗi câu hỏi lớn, KiCi tra cứu tối đa 5 lượt dữ liệu rồi tạm dừng để xin ý kiến của bạn trước khi tra cứu tiếp.

### **3. Hướng dẫn sử dụng phần mềm**

**Tình huống:** Khi bạn chưa rõ thao tác, muốn tìm vị trí chức năng, cần các bước thiết lập nghiệp vụ hoặc xử lý tình huống vướng mắc phát sinh trong quá trình sử dụng KiotViet.

**Thao tác thực hiện như sau:**

* **Bước 1:** Mở **Trợ lý KiCi** → chọn câu gợi ý có sẵn hoặc nhập tác vụ bạn cần thực hiện vào ô chat (Ví dụ: Cách tạo cửa hàng trên zalo) → nhấn mũi tên  (hoặc nhấn Enter).

* **Bước 2:** Thực hiện lần lượt theo các bước hướng dẫn cụ thể của KiCi (chỉ rõ đường dẫn menu và nút thao tác).

* **Bước 3:** Nếu giao diện thực tế khác với mô tả, nhấn câu gợi ý bên dưới hoặc mô tả lại điểm vướng mắc để KiCi điều chỉnh hướng dẫn.

**Lưu ý:**

* KiCi mặc định hướng dẫn theo nền tảng Web. Nếu tính năng chỉ hỗ trợ trên App điện thoại hoặc Máy bán hàng, KiCi sẽ thông báo rõ.
* KiCi chưa hỗ trợ tính toán và báo cáo liên quan đến tiền thuế phải nộp.
* KiCi không tư vấn về chính sách giá gói phần mềm, thiết bị phần cứng, đối tác giao vận hay chính sách thuế chuyên sâu. Khi cần hỗ trợ các nội dung này, bạn vui lòng liên hệ tổng đài 1800.6162.

## **III. Các tính năng nâng cao**

### **1. Quản lý cuộc hội thoại**

**Tình huống:** Khi bạn muốn mở cuộc trò chuyện mới theo từng chủ đề riêng biệt, tra cứu lại các số liệu ở phiên trước hoặc xóa các cuộc hội thoại không còn nhu cầu lưu trữ.

**Thao tác thực hiện như sau:**

* **Bước 1:** Tại khung chat → nhấn biểu tượng menu ba gạch  ở góc trên bên trái.

* **Bước 2:** Để bắt đầu chủ đề mới → nhấn ***Cuộc hội thoại mới***.

* **Bước 3:** Hệ thống hiển thị Lịch sử hội thoại tối đa trong 90 ngày. Bạn có thể nhập từ khóa tìm kiếm và nhấn vào cuộc hội thoại cần mở lại. Khi mở lại hội thoại cũ, KiCi sẽ tiếp tục ghi nhớ và duy trì đúng mạch trao đổi trước đó.

* **Bước 4:** Để xóa hội thoại
  + Nhấn biểu tượng dấu ba chấm **…** → chọn ***Xóa hội thoại***.

* Xác nhận ***Xóa***. Cuộc hội thoại đã xóa sẽ không thể phục hồi.

### **2. Câu hỏi kèm ảnh chụp màn hình**

**Tình huống:** Khi gặp thông báo lỗi hoặc phát sinh tình huống phức tạp khó diễn đạt bằng lời, bạn muốn gửi ảnh chụp màn hình để KiCi nhận diện, chẩn đoán nguyên nhân và hướng dẫn xử lý.

**Thao tác thực hiện như sau:**

* **Bước 1:** Tại ô nhập tin nhắn ở cuối khung chat, bạn nhấn dấu cộng **+** → ***Thêm hình ảnh*** để tải ảnh từ máy tính hoặc dán (Ctrl + V) trực tiếp ảnh chụp màn hình vào ô nhập.
* **Bước 2:** Nhập nội dung câu hỏi hoặc mô tả vướng mắc đi kèm với ảnh → nhấn mũi tên  (hoặc nhấn Enter) để gửi.

* **Bước 3:** Thực hiện theo chỉ dẫn xử lý từ KiCi. Nếu sự cố bắt nguồn từ lỗi hệ thống, KiCi sẽ gợi ý nút chức năng để bạn kết nối trực tiếp với chuyên viên hỗ trợ.

**Lưu ý:**

* Mỗi lượt gửi chỉ đính kèm 01 ảnh (định dạng JPG, PNG, WebP; dung lượng tối đa 20MB) và bắt buộc phải có nội dung văn bản gửi kèm.
* Nếu ảnh mờ hoặc thiếu chi tiết, KiCi không tự suy đoán mà sẽ gửi câu hỏi làm rõ.
* Khi bạn gửi ảnh thuộc chủ đề khác với nội dung đang trao đổi, KiCi sẽ yêu cầu xác nhận trước khi chuyển ngữ cảnh hội thoại.
* KiCi không tự động chuyển hướng cuộc gọi, bạn là người trực tiếp quyết định có bấm nút kết nối chuyên viên hay không.

### **3. Tùy biến truy vấn số liệu kinh doanh**

**Tình huống:** Khi bạn muốn bóc tách số liệu chuyên sâu theo từng chi nhánh, nhân viên, mặt hàng cụ thể; phân tích mối quan hệ giữa nhiều mảng kinh doanh hoặc yêu cầu định dạng hiển thị trực quan theo ý muốn.

**Thao tác thực hiện như sau:**

* **Bước 1:** Để truy vấn theo đối tượng cụ thể, nhập kèm tên đối tượng vào câu hỏi (Ví dụ: "Chi nhánh trung tâm tháng này lãi bao nhiêu?", "Phân tích sản phẩm túi tote").

* **Bước 2:** Để truy vấn liên kết nhiều mảng, lồng ghép các nội dung cần đối chiếu vào câu hỏi (Ví dụ: "Giá vốn tháng này tăng do nhóm hàng nào?") → KiCi sẽ tự động trích xuất đồng thời dữ liệu Bán hàng, Chi phí và Hàng hóa để trả lời logic theo nguyên nhân - kết quả.

* **Bước 3:** Để thay đổi cách trình bày số liệu, nhập trực tiếp yêu cầu định dạng vào ô chat (Ví dụ: "Vẽ biểu đồ cột", "Kẻ bảng số liệu").

**Lưu ý:**

* Bạn không bắt buộc phải nhập chính xác 100% tên đối tượng đã lưu. Nếu từ khóa khớp với nhiều đối tượng, KiCi sẽ hiển thị danh sách để bạn chọn lại.
* Trường hợp định dạng yêu cầu không tương thích với tập dữ liệu, KiCi sẽ tự động chọn dạng trực quan tối ưu nhất kèm giải thích lý do cụ thể.

### **4. Hỏi cách làm cho nền tảng khác**

**Tình huống:** Khi bạn đang thao tác trên Web KiotViet nhưng muốn tra cứu quy trình thực hiện nghiệp vụ trên ứng dụng điện thoại hoặc trên máy POS bán hàng.

**Thao tác thực hiện như sau:**

* **Bước 1:** Nêu rõ tên nền tảng mục tiêu ngay trong câu hỏi (Ví dụ: "Trên app", "Trên điện thoại", "Trên máy POS", "Trên máy tính tiền").
* **Bước 2:** KiCi sẽ nhận diện ngữ cảnh và hướng dẫn chi tiết từng bước theo đúng nền tảng ứng dụng **KiotViet** trên điện thoại hoặc máy bán hàng.

**Lưu ý:**

* Bạn bắt buộc phải nêu rõ từ khóa chỉ định nền tảng để KiCi nhận diện và chuyển đổi tài liệu hướng dẫn.
* Sau khi chuyển đổi, KiCi sẽ duy trì hướng dẫn theo nền tảng đó cho các câu hỏi tiếp theo cho đến khi bạn yêu cầu đổi sang nền tảng khác.

### **5. Đổi ngôn ngữ trả lời**

**Tình huống:** Khi bạn muốn KiCi phân tích số liệu hoặc hướng dẫn thao tác bằng tiếng Anh hoặc một ngôn ngữ khác phù hợp với nhu cầu sử dụng.

**Ngôn ngữ mặc định:** KiCi hiển thị theo cài đặt ngôn ngữ của tài khoản bạn đang đăng nhập, bao gồm danh sách câu gợi ý lúc mới mở.

**Thao tác thực hiện như sau:**

* **Bước 1:** Trực tiếp nhập câu hỏi bằng ngôn ngữ bạn muốn giao tiếp vào khung chat.
* **Bước 2:** KiCi tự động phát hiện ngôn ngữ và phản hồi hoàn toàn bằng ngôn ngữ đó (hỗ trợ Tiếng Việt, Tiếng Anh cùng cùng các ngôn ngữ Đông Nam Á theo thị trường KiotViet mở rộng).

**Lưu ý:**

* Ngôn ngữ giao tiếp sẽ được lưu lại cho các phiên làm việc tiếp theo.
* KiCi đảm bảo tính đồng nhất, không pha trộn nhiều ngôn ngữ trong cùng một câu trả lời.
* Các danh từ riêng trong hệ thống dữ liệu (tên chi nhánh, tên mặt hàng, tên nhân viên...) luôn được bảo lưu nguyên gốc, không tự động dịch.

### **6. Nhiệm vụ đặt lịch**

**Tình huống:** Khi bạn muốn KiCi tự động tổng hợp dữ liệu và gửi báo cáo kinh doanh theo các chỉ số quan trọng (doanh thu, hóa đơn, giá vốn, lợi nhuận, hàng sắp hết, công nợ tồn đọng...) định kỳ hàng ngày/ hàng tuần/ hàng tháng.

**Thao tác thực hiện như sau:**

* **Bước 1:** Nhận thông báo. Thông báo nhiệm vụ được hiển thị ngay tại màn hình bắt đầu của KiCi. Nội dung có dạng: “Báo cáo … đã sẵn sàng”.

* **Bước 2:** Bạn nhấn vào thông báo cụ thể trong danh sách để KiCi khởi tạo phiên hội thoại riêng và hiển thị báo cáo.
* **Bước 3:** Đọc báo cáo chi tiết kèm biểu đồ trực quan, phân tích đánh giá và các câu hỏi gợi ý đào sâu số liệu.

* **Bước 4:** Đặt lịch định kỳ.
  + Tại khung chat → nhấn biểu tượng menu ba gạch  ở góc trên bên trái.

* Tại khu vực ***Nhiệm vụ đặt lịch*** **→** nhấn ***Xem tất cả***.

* Trên từng nhiệm vụ, nhấn biểu tượng 3 chấm **→** chọn ***Điều chỉnh***.

* Chọn lịch gửi gồm:
  + ***Lặp lại***: Chọn Hàng ngày/Hàng tuần/Hàng tháng.
  + ***Ngày***: Chọn thứ trong tuần hoặc ngày trong tháng muốn nhận báo cáo.
  + ***Giờ chạy*:** Chọn mốc thời gian cụ thể muốn nhận thông báo.
* Nhấn ***Lưu lịch gửi*** để hoàn tất cài đặt. Nhiệm vụ sẽ chuyển sang trạng thái **Đang chạy**.

* **Bước 5:** Tắt nhiệm vụ. Khi không muốn hiển thị thông báo nhiệm vụ, bạn thao tác tắt nhiệm vụ.
  + Trên từng nhiệm vụ tại màn hình **Nhiệm vụ đặt lịch**, nhấn biểu tượng 3 chấm **→** chọn ***Tắt nhiệm vụ***.

* Xác nhận ***Tắt nhiệm vụ***.

* Thao tác tương tự và chọn ***Bật nhiệm vụ*** nếu muốn bật lại.

**Lưu ý:**

* Báo cáo chỉ thực sự khởi tạo khi bạn chủ động xem thông tin; các lần xem lại tiếp theo giữ nguyên không chạy lại số liệu.
* Thông báo cáo trên màn hình bắt đầu sau khi xem sẽ tự động ẩn và hiển thị cho nhiệm vụ tiếp theo trong hàng đợi.
* Mỗi nhiệm vụ báo cáo sở hữu bộ chỉ số đo lường cố định, giúp bạn dễ dàng đối chiếu số liệu qua các chu kỳ mà không bị sai lệch phương pháp tính.
* Hệ thống chưa hỗ trợ chạy báo cáo tự động trước 8h sáng. Nếu chọn 8h → hệ thống có thể gửi báo cáo trễ hơn một chút do chờ tổng hợp đủ dữ liệu kinh doanh kỳ trước (khoảng 8h–9h), đảm bảo hoàn tất gửi trong ngày.
* Nếu chọn ngày nhận khác ngày mặc định: Hệ thống vẫn thống kê trọn vẹn số liệu của kỳ trước đó (Ví dụ: Báo cáo tuần cài đặt nhận vào Thứ Tư thì số liệu vẫn tính trọn vẹn từ Thứ Hai đến hết Chủ nhật tuần trước, không phải 7 ngày gần nhất).
* Kỳ nào cửa hàng không phát sinh gì thì hệ thống bỏ qua lần chạy, không gửi thông báo rỗng — trừ khi có cảnh báo cần biết như hàng bán chạy sắp hết.
* Tắt rồi bật lại, nhiệm vụ chạy từ kỳ kế tiếp và không chạy bù các kỳ đã bỏ lỡ. Báo cáo đã gửi trước đó vẫn xem lại được.
* Báo cáo tính trên toàn bộ chi nhánh tài khoản bạn được phân quyền; giai đoạn này chưa chọn riêng được một chi nhánh.
