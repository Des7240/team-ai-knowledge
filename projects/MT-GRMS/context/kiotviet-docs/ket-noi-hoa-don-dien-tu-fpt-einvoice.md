...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-thiet-lap-ban-dau-hddt/ket-noi-hoa-don-dien-tu-fpt-einvoice/
---
...
Hỗ trợ
Thiết lập ban đầu HĐĐTKết nối Hóa đơn điện tử - FPT eInvoice
...
- Trên pop-up **Thiết lập kết nối hóa đơn điện tử**, bạn chọn **Nhà cung cấp khác** -> chọn **FPT.eInvoice** -> kích ***Tiếp tục***

- Bạn nhập thông tin -> kích ***Kết nối***

* Tùy chọn **Cho phép phát hành hóa đơn điện tử ngay trên màn hình bán hàng** trên KiotViet:
  + **Nếu bạn tích chọn**: Hệ thống hỗ trợ phát hành hóa đơn điện tử ngay khi thanh toán trên màn hình bán hàng với điều kiện trên hệ thống FPT.eInvoice gian hàng có Loại HĐ: **từ máy tính tiền** với trạng thái **Hiệu lực**.

* Với gian hàng chưa thiết lập điều kiện thỏa mãn trên hệ thống FPT.eInvoice -> KiotViet không hỗ trợ phát hành hóa đơn điện tử ngay trên màn hình bán hàng
* **Nếu không tích chọn**: gian hàng chủ động tạo hóa đơn và thực hiện thao tác phát hành trên FPT.eInvoice.
...
- Sau khi phát hành hóa đơn điện tử thành công trên KiotViet, để gửi thông tin đến cơ quan Thuế, gian hàng cần thực hiện thao tác trên FPT.eInvoice như sau:

*​*- Thao tác phát hành hóa đơn điện tử thực hiện trên các giao diện của phần mềm Quản lý bán hàng KiotViet như sau:
...
- Nếu tắt : hệ thống chỉ tạo hóa đơn trên KiotViet và không gửi thông tin sang hệ thống FPT.eInvoice.

- Nếu bật :

* Khi người dùng thanh toán hóa đơn -> KiotViet sẽ đồng thời gửi thông tin sang hệ thống FPT.eInvoice để phát hành hóa đơn điện tử.
...
* Tại đây, bạn có thể:
  ...
  + Xem tình trạng các hóa đơn điện tử bao gồm:
    - ***Đã phát hành***: phát hành hóa đơn điện tử thành công trên hệ thống FPT.eInvoice.
...
* Nếu tích chọn và chọn mẫu phát hành: Khi người dùng thanh toán hóa đơn -> KiotViet sẽ đồng thời gửi thông tin sang hệ thống FPT.eInvoice để phát hành hóa đơn điện tử.
* Nếu KHÔNG tích chọn: hệ thống chỉ tạo hóa đơn trên KiotViet và không gửi thông tin sang hệ thống FPT.eInvoice
...
- **Trạng thái** của việc chuyển hóa đơn qua FPT tương ứng bao gồm:
...
- Trong chi tiết hóa đơn, nếu bạn cần xem hóa đơn điện tử đã phát hành, hoặc lấy thông tin tra cứu của hóa đơn đó, bạn kích chọn 
...
*-* ***Cách tra cứu hóa đơn điện tử***: bạn kích ***Sao chép*** để sao chép thông tin gửi đến khách mua tra cứu trên website của FPT:
