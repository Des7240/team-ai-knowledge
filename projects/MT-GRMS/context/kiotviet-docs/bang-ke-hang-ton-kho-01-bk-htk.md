...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-to-khai-thue-hkd/bang-ke-hang-ton-kho-01-bk-htk/
---
...
Hỗ trợ
Tờ khai Thuế HKDBảng kê Hàng tồn kho 01/BK-HTK
...
**Bảng kê hàng tồn kho** (01/BK-HTK) là một tiện ích được tích hợp trực tiếp bên trong tờ khai 01/CNKD trên hệ thống KiotViet. Tính năng này hỗ trợ các Hộ kinh doanh tự động tổng hợp số liệu về hàng hóa tồn kho cũng như các loại máy móc, thiết bị tại thời điểm cuối ngày 31/12 của năm tính thuế. Dữ liệu được trích xuất và trình bày tuân thủ nghiêm ngặt theo đúng mẫu biểu quy định hiện hành của cơ quan Thuế.

**Đối tượng sử dụng tính năng:** Tính năng này được thiết kế để hỗ trợ tối đa cho các đối tượng sau:

* **Chủ hộ kinh doanh:** Áp dụng đối với các hộ kinh doanh có doanh thu từ 1 tỷ đến 3 tỷ đồng/năm (thuộc nhóm 2 – thu nhập tính thuế) hoặc từ 3 đến 50 tỷ đồng/năm (thuộc nhóm 3.1). Đây là các đối tượng bắt buộc phải đính kèm bảng kê khi thực hiện nộp tờ khai thuế Quý 1 theo quy định.
* **Kế toán hộ kinh doanh:** Bao gồm các cá nhân trực tiếp thực hiện việc rà soát, đối chiếu, điều chỉnh số liệu và xác nhận tính hợp lệ của bảng kê trước khi hoàn tất việc tải và nộp tờ khai cho cơ quan thuế.

**Lưu ý quan trọng:** Tính năng **Bảng kê hàng tồn kho** chỉ hoạt động ở kỳ khai Quý 1/2026.

**Lợi ích nổi bật của tính năng:**

* **Tự động hóa dữ liệu:** Hệ thống tự động truy xuất và tổng hợp dữ liệu tồn kho thực tế, giúp cửa hàng loại bỏ hoàn toàn thao tác tính toán, cộng trừ thủ công từ nhiều nguồn sổ sách khác nhau.
* **Kiểm soát chính xác:** Cung cấp giao diện trực quan cho phép người dùng dễ dàng kiểm tra, bổ sung và điều chỉnh các số liệu trước khi chốt nộp, đảm bảo tính chính xác tuyệt đối cho báo cáo thuế.
* **Tiết kiệm thời gian:** Dữ liệu bảng kê sau khi được lưu sẽ tự động đính kèm tích hợp vào file tải về của tờ khai 01/CNKD, giúp bạn không cần tốn thời gian xuất nhiều file riêng lẻ.

## **II. Các thao tác cơ bản**

Để dễ hình dung, các ví dụ dưới đây sẽ minh họa những tình huống thực tế trong ngành Bán buôn, Bán lẻ.

### **1. Theo dõi và xác nhận bảng kê với dữ liệu đã đồng bộ**

**Tình huống:** Cửa hàng của bạn đã sử dụng phần mềm KiotViet từ trước nên hệ thống đã tự động ghi nhận và đồng bộ chuẩn xác số liệu hàng tồn kho. Bạn chỉ cần vào xem, rà soát lại dữ liệu để xác nhận bảng kê nộp thuế.

**Thao tác thực hiện như sau:**

* **Bước 1**: Mở tờ khai **01/CNKD** kỳ Quý 1/2026 và chọn tab **Bảng kê hàng tồn kho**.

* **Bước 2**: Hệ thống sẽ tự động đồng bộ toàn bộ dữ liệu vào mục **I. Hàng hóa, Sản phẩm tồn kho**. Bạn rà soát lại các thông tin hiển thị (Tên sản phẩm, Đơn vị tính, Số lượng, Giá trị (VNĐ)).

* **Quy tắc lấy dữ liệu đồng bộ tự động**: Tùy thuộc vào thời điểm khách hàng bắt đầu tạo hồ sơ kê khai thuế, hệ thống sẽ tự động đồng bộ số liệu theo các nguyên tắc sau:
  + **Nếu bạn tạo hồ sơ trước hoặc đúng ngày 01/01/2026**: Hệ thống sẽ tự động lấy dữ liệu từ **Sổ kế toán** → **Sổ hàng hóa (S2d-HKD)** (cụ thể là ghi nhận số tồn đầu kỳ của ngày 01/01/2026 lúc 0h00').
  + **Nếu bạn tạo hồ sơ sau ngày 01/01/2026** và **đã có** dữ liệu từ **Phần mềm Quản lý bán hàng KiotViet**: Hệ thống sẽ đồng bộ dữ liệu trực tiếp từ Phần mềm Quản lý bán hàng KiotViet (cụ thể là ghi nhận số tồn cuối kỳ ngày 31/12/2025 lúc 23h59').
  + **Nếu bạn tạo hồ sơ sau ngày 01/01/2026** nhưng **chưa** có dữ liệu từ **Phần mềm Quản lý bán hàng KiotViet**: Hệ thống sẽ không có sẵn dữ liệu để đồng bộ. Trong trường hợp này, bạn vui lòng tự nhập tay các thông tin thủ công.

### **2. Chỉnh sửa dữ liệu**

**Tình huống:** Trong trường hợp bạn cần điều chỉnh lại số liệu hàng hóa đã đồng bộ, cần khai báo thêm máy móc thiết bị, hoặc cửa hàng mới sử dụng chưa có sẵn dữ liệu trên hệ thống, bạn sẽ thao tác nhập và chỉnh sửa thủ công.

**Thao tác thực hiện như sau:**

* **Bước 1**: Tại mục **I. Hàng hóa, Sản phẩm tồn kho**:
  + Bạn nhấn ***Chỉnh sửa***.

* **Thêm hàng hóa**:
  + Chọn ***+ Thêm hàng hóa***.
  + Điền đầy đủ thông tin: ***Tên sản phẩm***, ***Đơn vị tính***, ***Số lượng***, ***Giá trị (VNĐ)***.
* **Chỉnh sửa:** Nhập thông tin chỉnh sửa trên ô dữ liệu tương ứng.
* **Xóa:** Nhấn vào biểu tượng thùng rác trên dòng dữ liệu cần xóa.
* Nhấn ***Lưu*** để ghi nhận thông tin.
* **Lưu ý**:
  + Dữ liệu mục I được tổng hợp từ tồn kho thực tế, nếu bạn chỉnh sửa thủ công, số liệu trên bảng kê có thể sẽ khác với trên sổ kế toán.
  + Số lượng và giá trị không được nhập số âm.

* **Bước 2**: Tại mục **II. Máy móc, Thiết bị**: Bạn bắt buộc tiến hành nhập liệu thủ công:
  + Bạn nhấn ***Chỉnh sửa***.

​

* Chọn ***+ Thêm thiết bị***.
* Điền đầy đủ thông tin: ***Tên thiết bị***, ***Đơn vị tính***, ***Số lượng***, ***Giá trị (VNĐ)***.
* Nhấn ***Lưu***.

* Để chỉnh sửa thông tin sau khi đã lưu, bạn tiếp tục nhấn ***Chỉnh sửa*** → thay đổi thông tin hoặc nhấn biểu tượng thùng rác để xóa thiết bị khỏi bảng kê → nhấn ***Lưu*** để ghi nhận thông tin.

## **III. Các tính năng nâng cao**

### **1. Lấy lại số liệu trước khi chỉnh sửa**

**Tình huống:** Trong quá trình đối soát lại, bạn nhận ra mình đã chỉnh sửa sai số liệu ở Mục I. Bạn muốn hủy bỏ các thao tác nhập thủ công và khôi phục lại số liệu chuẩn mà hệ thống đã đồng bộ ban đầu.

**Thao tác thực hiện như sau:**

* **Bước 1**: Tại mục **I. Hàng hóa, Sản phẩm tồn kho**, bạn nhấn ***Lấy lại số liệu trước khi chỉnh sửa*** (tính năng này chỉ hiển thị khi cửa hàng có dữ liệu tự động).

* **Bước 2**: Xác nhận ***Đồng ý*** → toàn bộ các chỉnh sửa thủ công sẽ được xóa và trả về dữ liệu gốc.

### **2. Xem trước bảng kê đính kèm tờ khai**
...
* **Bước 1**: Đảm bảo **Bảng kê hàng tồn kho** đã được điền đầy đủ và nhấn ***Lưu***.
* **Bước 2**: Nhấn vào nút ***Xem trước*** trên màn hình tờ khai.

​

* **Bước 3**: Hệ thống sẽ hiển thị bản xem trước, trong đó Bảng kê 01/BK-HTK với số liệu mới nhất sẽ tự động được đính kèm vào tờ khai, giúp bạn dễ dàng rà soát tổng thể trước khi tải xuống.

### **3. Tải bảng kê đính kèm cùng tờ khai**

**Tình huống:** Bạn đã xác nhận số liệu bảng kê chính xác và cần tải file tờ khai về máy tính để tiến hành nộp cho cơ quan thuế.

**Thao tác thực hiện như sau:**

* **Bước 1**: Đảm bảo **Bảng kê hàng tồn kho** đã được nhấn ***Lưu*** thành công.
* **Bước 2**: Thực hiện thao tác ***Tải tờ khai*** 01/CNKD như bình thường. Bảng kê 01/BK-HTK với số liệu mới nhất sẽ tự động được đính kèm bên trong file tải về.
...
**Tình huống:** Bạn gặp cảnh báo từ hệ thống hoặc không tìm thấy thông tin trong quá trình làm bảng kê.

**Thao tác thực hiện như sau:**

* **Không tìm thấy Bảng kê hàng tồn kho**: Bạn cần kiểm tra lại các thông tin sau:
  + ***Kỳ kê khai***: Tính năng này chỉ hiển thị ở tờ khai kỳ Quý 1/2026.
  + ***Nhóm doanh thu*** và ***Phương pháp tính thuế TNCN***: Chỉ áp dụng với các hộ kinh doanh có doanh thu từ 1 tỷ đến 3 tỷ đồng/năm (thuộc nhóm 2 – thu nhập tính thuế) hoặc từ 3 đến 50 tỷ đồng/năm (thuộc nhóm 3.1)
* **Tải file tờ khai không thấy số liệu vừa nhập**: Nguyên nhân do bảng kê chưa được lưu. Bạn cần nhấn ***Lưu*** Bảng kê hàng tồn kho trước rồi mới tải lại tờ khai.

## **IV. Thao tác trên Điện thoại**

Tính năng **Bảng kê hàng tồn kho** trên ứng dụng di động hỗ trợ cửa hàng thực hiện các thao tác: Xem chi tiết hàng hóa/thiết bị, Thêm, Sửa, Xóa và Khôi phục dữ liệu gốc.

**Tình huống:** Bạn cần kiểm tra nhanh hoặc bổ sung một vài thiết bị máy móc vào bảng kê tồn kho ngay trên điện thoại di động.

**Thao tác thực hiện như sau:**

* Mở ứng dụng **KiotViet**, truy cập vào **Tờ khai thuế Quý 1/2026** và chọn **Bảng kê hàng tồn kho**.

​

* Tại mục **I. Hàng hóa, sản phẩm**: Bạn chạm vào để xem chi tiết. Tại đây bạn có thể thao tác:

​

* **Thêm hàng hóa**: Bạn chạm ***Thêm hàng hóa*** → nhập đầy đủ thông tin → xác nhận ***Thêm hàng hóa***.

​​

* **Sửa thông tin**: Bạn chạm vào dòng hàng hóa → thay đổi thông tin → xác nhận ***Sửa hàng hóa***.

* **Xóa hàng hóa**: Bạn chạm ***Chọn nhiều*** → tích chọn hàng cần xóa → chạm **Xóa →** xác nhận ***Xóa***.

* **Lấy lại số liệu trước khi chỉnh sửa**: Bạn chạm ***Lấy lại số liệu trước khi chỉnh sửa*** **→** chọn ***Đồng ý*** để xác nhận thông tin.

* Tại mục **II. Máy móc, thiết bị**: Bạn chạm vào để xem chi tiết. Tại đây bạn có thể thao tác:

* **Thêm thiết bị**: Bạn chạm ***Thêm máy móc, thiết bị*** → nhập đầy đủ thông tin → xác nhận ***Thêm máy móc, thiết bị***.

* **Sửa thông tin**: Bạn chạm vào dòng thiết bị → thay đổi thông tin → xác nhận ***Sửa máy móc, thiết bị***.

​

* **Xóa thiết bị**: Bạn chạm ***Chọn nhiều*** → tích chọn thiết bị cần xóa → chạm ***Xóa*** **→** xác nhận ***Xóa***.
