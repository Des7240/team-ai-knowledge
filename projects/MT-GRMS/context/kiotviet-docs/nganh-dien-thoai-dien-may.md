...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-chuyen-nganh/nganh-dien-thoai-dien-may/
---
...
Để đáp ứng những yêu cầu đặc thù của ngành Điện thoại - Điện máy, KiotViet đã phát triển một bộ tính năng chuyên ngành, được thiết kế riêng để giúp các cửa hàng vận hành hiệu quả, chuyên nghiệp và tối ưu hóa việc quản lý sản phẩm. Bộ tính năng này không chỉ là một công cụ quản lý bán hàng thông thường mà còn là một giải pháp toàn diện, tập trung vào việc quản lý từng thiết bị riêng lẻ theo **IMEI/Serial**, kiểm soát chặt chẽ **quy trình bảo hành, sửa chữa**, quản lý **tồn kho chính xác** và **chăm sóc khách hàng** hiệu quả. Tất cả đều nhằm mục đích giúp chủ cửa hàng kiểm soát chặt chẽ hàng hóa, tránh thất thoát, nâng cao chất lượng dịch vụ và xây dựng uy tín thương hiệu.

**Lợi ích nổi bật của tính năng:**

* **Quản lý sản phẩm chi tiết theo IMEI/Serial:** Dễ dàng theo dõi vòng đời của từng thiết bị từ lúc nhập kho, bán ra cho đến khi bảo hành. Mọi giao dịch đều được ghi nhận chi tiết, giúp bạn truy xuất lịch sử và quản lý hàng hóa một cách minh bạch, tránh nhầm lẫn.
* **Quy trình Sửa chữa và Bảo hành chuyên nghiệp:** Cung cấp công cụ tạo và theo dõi phiếu yêu cầu sửa chữa, quản lý thời hạn bảo hành cho từng sản phẩm, giúp nâng cao chất lượng dịch vụ và sự hài lòng của khách hàng.
* **Tối ưu hóa bán hàng và chăm sóc khách hàng:** Lưu trữ lịch sử mua hàng chi tiết của từng khách (mua máy nào, IMEI gì), giúp việc tư vấn và hỗ trợ sau bán hàng trở nên dễ dàng và chuyên nghiệp hơn.

*Tài liệu này hướng dẫn anh chị các tính năng phổ biến liên quan tới ngành hàng Điện thoại - Điện máy mà KiotViet gợi ý, cửa hàng tham khảo và lựa chọn các giải pháp phù hợp.*
...
Để dễ hình dung, các ví dụ dưới đây sẽ minh họa những tình huống thực tế tại cửa hàng điện thoại, điện máy.

### **1. Thiết lập ban đầu**

* **Tình huống:** Trước khi bắt đầu nhập và bán sản phẩm, bạn cần kích hoạt các tính năng cần thiết như **Quản lý tồn kho theo Serial/IMEI** và **Bảo hành, bảo trì**.
* **Thao tác thực hiện như sau:**

1. **Bật tính năng** **Quản lý tồn kho theo Serial/IMEI:** Vào menu **Thiết lập** → **Hàng hóa** → bật tùy chọn **Quản lý tồn kho theo Serial/IMEI**.

1. **Thiết lập Bảo hành, bảo trì:**
   * Vào menu **Thiết lập** → **Hàng hóa**.
   * Trên thông tin **Bảo hành, bảo trì, yêu cầu sửa chữa** → nhấn ***Đang tắt***

* Bật xanh **Bảo hành, bảo trì, yêu cầu sửa chữa** và thiết lập nhắc lịch:
...
### **2. Thêm mới hàng hóa theo IMEI/Serial**

* **Tình huống:** Bạn cần tạo một sản phẩm mới như "iPhone 16" và muốn quản lý từng chiếc máy bán ra theo số IMEI riêng biệt.
* **Thao tác thực hiện như sau:**

1. Tại màn hình **Hàng hóa** -> **Danh sách hàng hóa**, bạn nhấn **Tạo mới** -> **Thêm hàng hóa**.

1. Điền các thông tin cơ bản về sản phẩm (tên, giá bán, giá vốn, nhóm hàng...). Chọn **Có** vào ô **Quản** **lý theo Serial/IMEI** để kích hoạt tính năng quản lý theo Serial/IMEI.

1. Bạn có thể thiết lập **Thời hạn bảo hành** cho sản phẩm (ví dụ: 12 tháng) ngay tại bước này.

1. Nhấn ***Lưu***.

### **3. Nhập hàng theo từng IMEI/Serial**

* **Tình huống:** Bạn vừa nhập một lô "iPhone 16" mới và cần ghi nhận số IMEI của từng máy vào hệ thống.
* **Thao tác thực hiện như sau:**

1. Khi tạo phiếu **Nhập hàng**, bạn tìm kiếm sản phẩm "iPhone 16".
2. Một ô nhập liệu sẽ hiện ra yêu cầu bạn ***Nhập số Serial/Imei***. Bạn có thể nhập thủ công từng số hoặc dùng máy quét để quét mã vạch trên hộp sản phẩm.
3. Số lượng hàng nhập sẽ tự động tăng lên tương ứng với số lượng Serial/Imei bạn đã nhập.
4. ***Hoàn thành*** phiếu nhập để tăng tồn kho chính xác cho từng thiết bị.

### **4. Bán hàng và Thanh toán**

* **Tình huống:** Khách hàng mua một chiếc "iPhone 16", bạn cần chọn đúng máy (theo IMEI) để xuất bán và ghi nhận giao dịch.
* **Thao tác thực hiện như sau:**

1. Trên màn hình **Bán hàng**, tìm kiếm sản phẩm "iPhone 16".
2. Bạn chọn đúng số IMEI của chiếc máy bán cho khách.

1. Với sản phẩm có thiết lập thời gian bảo hành, hệ thống mặc định thời gian theo thiết lập, bạn có thể thay đổi khi nhấn vào biểu tượng bảo hành bên cạnh tên hàng

1. Thêm thông tin khách hàng vào hóa đơn để lưu lại lịch sử mua hàng và phục vụ cho việc bảo hành sau này.
2. Nhấn ***Thanh toán*** để hoàn tất giao dịch.

## **III. Các tính năng nâng cao**

### **1. Quản lý Sửa chữa và Bảo hành**

* **Tình huống:** Một khách hàng mang chiếc "iPhone 16" đã mua trước đó đến để yêu cầu sửa chữa dịch vụ (ví dụ: thay pin).
* **Thao tác thực hiện như sau:**

1. Trên màn hình **Bán hàng** → nhấn mũi tên xanh  chọn **Thêm mới sửa chữa**

1. Nhấn biểu tượng danh sách hàng bảo hành đã bán  trên ô tìm hàng hóa (F3)

1. Tìm kiếm và chọn hàng hóa cần bảo hành

1. Thêm thông tin hàng hóa như: ***Model***, ***Kỹ thuật viên***, ***Ghi chú***, ***Hình ảnh***, ***Mật khẩu*** (nếu có).
2. Thêm các dịch vụ hoặc linh kiện cần thiết vào phiếu (ví dụ: Pin).

1. Lưu lại phiếu và giao cho kỹ thuật viên xử lý.
2. Sau khi sửa xong, bạn có thể tạo hóa đơn trực tiếp từ phiếu sửa chữa này để khách thanh toán.

### **2. Quản lý Khách hàng và Công nợ**

* **Tình huống:** Bạn muốn xem lại lịch sử mua hàng của một khách để kiểm tra thời hạn bảo hành hoặc xem các khoản công nợ của họ.
* **Thao tác thực hiện như sau:**

1. Vào menu **Khách hàng →** chọn **Khách hàng**.

1. Tìm và chọn khách hàng cần xem.
2. Trong trang chi tiết, bạn có thể xem toàn bộ lịch sử giao dịch (mua máy nào, IMEI gì) và các khoản nợ cần thu của khách hàng đó.

### **3. In tem mã vạch**

* **Tình huống:** Bạn muốn in tem mã vạch cho các sản phẩm phụ kiện không có sẵn mã để dán lên sản phẩm, giúp việc thanh toán nhanh hơn.
* **Thao tác thực hiện như sau:**
...
1. Trong menu **Hàng hóa** trên ứng dụng, chạm vào biểu tượng dấu **+** → nhấn ***Thêm hàng hóa***, bật tùy chọn **Quản lý theo Serial/IMEI**.

1. Khi tạo phiếu **Nhập hàng**, sau khi chọn sản phẩm, ứng dụng sẽ cho phép bạn dùng camera để quét hoặc nhập thủ công số IMEI/Serial.
...
1. Khi tạo hóa đơn trên ứng dụng, sau khi chạm vào một sản phẩm quản lý theo IMEI, màn hình **Chọn Serial/IMEI** sẽ hiện ra.
2. Bạn chạm vào số IMEI của máy cần bán để thêm vào hóa đơn.
