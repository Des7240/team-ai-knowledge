...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-chuyen-nganh/dang-ky-tai-khoan-he-thong-co-so-du-lieu-ve-duoc/
---
...
*(Ngành Bán buôn, Bán lẻ - Nhà thuốc)*

## **I. Giới thiệu chung**

Nhằm đồng hành cùng các cơ sở bán buôn, bán lẻ thuốc và chuỗi nhà thuốc trong việc tuân thủ quy định, tham gia hệ thống, khởi tạo dữ liệu và thực hiện kết nối liên thông dữ liệu lên Hệ thống cơ sở dữ liệu về dược, KiotViet trân trọng thông tin và hướng dẫn các bước thực hiện chi tiết.

Tài liệu này được xây dựng căn cứ vào:

* Công văn 934/TTYQG-DA ngày 12/08/2026 của Trung tâm Thông tin Y tế Quốc gia — Bộ Y tế về việc triển khai Hệ thống cơ sở dữ liệu về dược.
* Quyết định 232/QĐ-TTYQG ngày 17/07/2026 của Trung tâm Thông tin Y tế Quốc gia — Bộ Y tế về việc ban hành "Tài liệu kỹ thuật đặc tả API Hệ thống cơ sở dữ liệu về dược" phiên bản 1.1 và "Hướng dẫn sử dụng Hệ thống cơ sở dữ liệu về dược".

## **II. Các thao tác cơ bản**

### **1. Đăng ký tài khoản Hệ thống cơ sở dữ liệu về dược**

**Tình huống:** Khi bạn cần tạo tài khoản mới trên cổng thông tin của Bộ Y tế để tham gia hệ thống và chuẩn bị cho việc liên thông dữ liệu dược quốc gia.

**Thao tác thực hiện như sau:**

* **Bước 1:** Truy cập cổng thông tin csdlduoc.com.vn và chọn **Đăng ký**.

* **Bước 2:** Hệ thống hiển thị màn hình **Đăng ký tài khoản**, bạn chọn loại hình kinh doanh tương ứng: Cơ sở bán lẻ / Cơ sở bán buôn / Chuỗi nhà thuốc.
* **Bước 3:** Khai báo đầy đủ thông tin tại màn hình đăng ký (các trường có dấu \* là thông tin bắt buộc).
  + Trường hợp bạn khai báo chính xác Tỉnh/Thành phố và Số giấy chứng nhận đủ điều kiện kinh doanh thuốc, hệ thống sẽ tự động điền các thông tin còn lại (bạn có thể chỉnh sửa nếu cần thiết)
  + Nhập mã captcha trên màn hình.
  + Nhấn ***Đăng ký***.

* **Lưu ý:**
  + Sau khi khai báo chính xác ***Số giấy chứng nhận đủ điều kiện kinh doanh thuốc***, bạn chọn biểu tượng tìm kiếm cạnh ô nhập liệu để hệ thống tự động điền các trường liên quan (Tên cơ sở, Địa chỉ, Ngày cấp và Nơi cấp giấy chứng nhận…), sau đó kiểm tra và bổ sung các trường còn thiếu.
  + ***Số định danh cơ quan, tổ chức*** không phải là thông tin bắt buộc. Trường hợp cơ sở chưa được cấp mã này, bạn có thể để trống; việc để trống không ảnh hưởng đến kết quả đăng ký.
  + Tệp đính kèm (giấy chứng nhận đủ điều kiện sản xuất/kinh doanh thuốc) chỉ hỗ trợ định dạng .pdf với dung lượng tối đa 5MB.

* **Bước 4:** Sau khi Sở Y tế thực hiện rà soát và phê duyệt hoặc từ chối phê duyệt, kết quả sẽ được gửi về địa chỉ thư điện tử mà cơ sở kinh doanh dược đã đăng ký.
  + Trường hợp được phê duyệt: Cơ sở kinh doanh dược sẽ nhận được tài khoản kèm mật khẩu đăng nhập.

* Trường hợp không được phê duyệt: Cơ sở kinh doanh dược sẽ nhận được lý do từ chối và thực hiện đăng ký lại từ Bước 1.
* **Lưu ý:** ***Tên đăng nhập*** được cấp mặc định là ***Mã số thuế*** của cơ sở.

* **Bước 5:** Tại lần đăng nhập đầu tiên, hệ thống yêu cầu thiết lập mật khẩu mới. Bạn nhập mật khẩu, nhập lại để xác nhận và nhấn ***Lưu***.

* **Bước 6:** Sau khi đổi mật khẩu thành công → bạn ***Quay về trang chủ*** và sử dụng tên đăng nhập và mật khẩu đã thiết lập để đăng nhập chính thức vào hệ thống.

**Lưu ý:**

* Sau khi đăng nhập thành công, bạn **CHƯA CẦN** thực hiện thêm thao tác trên **Hệ thống cơ sở dữ liệu về dược**. Bạn chỉ cần lưu giữ thông tin đăng nhập để khai báo trên KiotViet khi tính năng kết nối chính thức triển khai (dự kiến ngày 25/08/2026). Các nội dung như khởi tạo tồn đầu kỳ và liên thông dữ liệu sẽ được KiotViet hỗ trợ thực hiện tự động.
* Việc tự khai báo tồn đầu kỳ thủ công trên Hệ thống cơ sở dữ liệu về dược trước khi kết nối với KiotViet có thể làm phát sinh chênh lệch số liệu tồn giữa hai hệ thống.
* Đối với nhà thuốc thuộc chuỗi (có tài khoản cơ sở chính quản lý), việc đăng ký do cơ sở chính thực hiện thông qua chức năng thêm thành viên và cấp tài khoản cho từng nhà thuốc. Quy trình này có một số bước khác biệt, do đó bạn vui lòng liên hệ đầu mối quản lý chuỗi để được cấp tài khoản thay vì tự thực hiện đăng ký theo các bước nêu trên.
* Hỗ trợ trong quá trình đăng ký trên Hệ thống cơ sở dữ liệu về dược: Bạn vui lòng liên hệ đường dây nóng 1900 8255 hoặc thư điện tử nhic.hotro@moh.gov.vn (Trung tâm Thông tin Y tế Quốc gia - Bộ Y tế).
* Nội dung hướng dẫn chi tiết được quy định tại Phụ lục 3, Quyết định 232/QĐ-TTYQG ngày 17/07/2026. Trong quá trình đăng ký và thực hiện kết nối, nếu cần hỗ trợ, bạn vui lòng liên hệ tổng đài chăm sóc khách hàng KiotViet.

### **2. Liên thông dữ liệu từ KiotViet lên Hệ thống cơ sở dữ liệu về dược**

**Tình huống:** Khi bạn đã được cấp tài khoản từ Hệ thống cơ sở dữ liệu về dược và cần chuẩn bị các bước để đồng bộ dữ liệu từ phần mềm KiotViet.

Sau khi được cấp tài khoản, cơ sở kinh doanh dược tiếp tục thực hiện liên thông dữ liệu từ phần mềm quản lý bán hàng KiotViet. Tại bước này, KiotViet hỗ trợ bạn các nội dung sau:

* Xác thực và lưu kết nối với tài khoản Hệ thống cơ sở dữ liệu về dược của cơ sở.
* Đồng bộ danh mục thuốc chuẩn từ Hệ thống cơ sở dữ liệu về dược và hỗ trợ đối chiếu với danh mục thuốc hiện có trên KiotViet.
* Khởi tạo tồn đầu kỳ, đẩy dữ liệu tồn kho hiện tại lên hệ thống nhằm bảo đảm điểm bắt đầu chính xác trước khi phát sinh giao dịch.
* Tự động đồng bộ các giao dịch nhập, xuất, bán mới lên Hệ thống cơ sở dữ liệu về dược, hạn chế việc nhập liệu thủ công trùng lặp.

**Lưu ý:**

* Dự kiến từ ngày 25/08/2026, KiotViet sẵn sàng hỗ trợ bạn thực hiện việc liên thông dữ liệu từ KiotViet lên Hệ thống cơ sở dữ liệu về dược.
* Để công tác liên thông được triển khai đúng kế hoạch, KiotViet đề nghị bạn khẩn trương hoàn tất việc đăng ký tài khoản Hệ thống cơ sở dữ liệu về dược theo hướng dẫn tại Mục 1.

​

## **III. Hướng dẫn xử lý các vấn đề thường gặp**

### **1. Xử lý tài khoản đã đăng ký trên hệ thống Dược cũ**

**Tình huống:** Khi cơ sở của bạn đã từng đăng ký tài khoản trên hệ thống Dược cũ và bạn thắc mắc có cần đăng ký lại trên hệ thống mới hay không.

**Hướng dẫn:** Có. Do hệ thống cũ đã ngừng hoạt động hoàn toàn, tài khoản cũ không còn giá trị sử dụng trên hệ thống mới. Bạn cần thực hiện đăng ký tài khoản mới tại cổng thông tin csdlduoc.com.vn theo 6 bước hướng dẫn.

**Lưu ý:** Tên đăng nhập của tài khoản mới được cấp mặc định là mã số thuế của cơ sở, không phải tên đăng nhập cũ.

### **2. Bảo lưu dữ liệu đã đồng bộ trước đây**

**Tình huống:** Khi bạn cần biết liệu các dữ liệu đã đồng bộ trên hệ thống Dược cũ có được tự động chuyển sang hoặc bảo lưu trên hệ thống mới hay không.

**Hướng dẫn:** Dữ liệu đã đồng bộ trên hệ thống Dược cũ sẽ không được chuyển sang hệ thống mới. Dữ liệu bán hàng và tồn kho trên KiotViet vẫn được lưu giữ đầy đủ. Khi thực hiện kết nối với hệ thống mới, bạn chỉ cần thực hiện khởi tạo tồn đầu kỳ (đẩy dữ liệu tồn hiện tại lên hệ thống mới) nhằm bảo đảm điểm bắt đầu chính xác. Các giao dịch phát sinh trước thời điểm này không thuộc phạm vi và không thể đẩy lại lên hệ thống mới.

### **3. Hỗ trợ từ KiotViet sau khi đăng ký và kết nối**

**Tình huống:** Khi bạn muốn tìm hiểu chi tiết các thao tác tự động mà hệ thống KiotViet sẽ hỗ trợ sau khi bạn hoàn tất đăng ký và kết nối tài khoản.

**Hướng dẫn:** Kể từ mốc 25/08/2026, sau khi bạn khai báo tài khoản Hệ thống cơ sở dữ liệu về dược trên KiotViet, hệ thống sẽ tự động thực hiện: xác thực kết nối, đồng bộ danh mục thuốc chuẩn, hỗ trợ khởi tạo tồn đầu kỳ và tự động đồng bộ các giao dịch nhập, xuất, bán mới lên Hệ thống cơ sở dữ liệu về dược, thay cho việc nhập liệu thủ công từng giao dịch như trước đây.

### **4. Thao tác trên hệ thống sau khi được cấp tài khoản**

**Tình huống:** Khi bạn vừa nhận được tài khoản từ Hệ thống cơ sở dữ liệu về dược và cần biết các bước tiếp theo cần thực hiện trực tiếp trên hệ thống này.

**Hướng dẫn:** Bạn CHƯA CẦN thực hiện thao tác nào tại thời điểm này. Bạn chỉ cần lưu giữ thông tin đăng nhập (tên đăng nhập và mật khẩu) để khai báo trên KiotViet khi tính năng kết nối chính thức triển khai. Trường hợp bạn đã tự khai báo tồn đầu kỳ thủ công trên Hệ thống trước khi kết nối với KiotViet, số liệu tồn giữa hai hệ thống có thể phát sinh chênh lệch (do Hệ thống cơ sở dữ liệu về dược ghi nhận theo số liệu khai báo thủ công, trong khi KiotViet khởi tạo theo số tồn thực tế tại thời điểm kết nối).

### **5. Xử lý thuốc đã liên kết với cơ sở dữ liệu cũ**

**Tình huống:** Khi bạn có các mặt hàng thuốc đang kinh doanh đã từng được liên kết với mã định danh trên hệ thống cũ và cần biết KiotViet sẽ xử lý việc đồng bộ này như thế nào.

**Hướng dẫn:** Do hệ thống mới sử dụng mã định danh thuốc khác với hệ thống cũ, sau khi thực hiện kết nối, KiotViet sẽ tự động đối chiếu và đề xuất phương án liên kết các thuốc này với danh mục thuốc chuẩn từ Hệ thống cơ sở dữ liệu về dược. Bạn chỉ cần thực hiện kiểm tra và điều chỉnh cho phù hợp.

### **6. Khôi phục mật khẩu tài khoản Hệ thống cơ sở dữ liệu về dược**

**Tình huống:** Khi bạn vô tình quên mật khẩu đăng nhập vào tài khoản trên Hệ thống cơ sở dữ liệu về dược và cần khôi phục lại quyền truy cập.

**Thao tác thực hiện như sau:**

* **Bước 1:** Tại màn hình đăng nhập csdlduoc.com.vn, bạn chọn ***Quên mật khẩu***.

* **Bước 2:** Nhập ***Tên đăng nhập*** (là mã số thuế của cơ sở) và chọn ***Gửi đi***.

* **Bước 3:** Hệ thống sẽ gửi thông tin về thư điện tử của bạn → nhấn ***Đặt lại mật khẩu***.

* **Bước 4:** Thiết lập mật khẩu mới → nhấn ***Lưu***.
