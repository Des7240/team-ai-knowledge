...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-giao-dich/vat-nhap-hang-phuong-phap-thue-truc-tiep/
---
...
# **VAT Nhập hàng - Phương pháp thuế trực tiếp**

*(Ngành Bán buôn, Bán lẻ)*

## **I. Giới thiệu chung**

Tính năng **VAT nhập hàng** được thiết kế nhằm hỗ trợ các hộ kinh doanh đang áp dụng phương pháp thuế trực tiếp có thể ghi nhận chính xác thuế GTGT đầu vào từ nhà cung cấp. Tính năng này cho phép bạn linh hoạt lựa chọn loại phiếu (Có VAT hoặc Không có VAT) cho từng giao dịch nhập hàng cụ thể, đảm bảo chứng từ phản ánh đúng thực tế hóa đơn mà không làm thay đổi phương pháp tính thuế chung của toàn gian hàng.

**Lợi ích nổi bật của tính năng:**

* **Ghi nhận đúng chứng từ, không cần tính toán thủ công:** Bạn có thể nhập đúng đơn giá trước thuế và %VAT theo từng dòng hàng, hệ thống sẽ tự động tính toán giá nhập sau thuế, giúp giảm thiểu sai sót so với việc cộng gộp thủ công trước đây.
* **Lưu vết VAT đầu vào minh bạch:** Toàn bộ thông tin thuế được bóc tách rõ ràng, hiển thị chi tiết trong từng phiếu nhập, hỗ trợ đắc lực cho việc đối soát với nhà cung cấp và giải trình dữ liệu khi cần thiết.
* **Linh hoạt theo từng giao dịch:** Hệ thống cho phép bạn tùy chọn chế độ VAT riêng biệt cho mỗi lần nhập hàng, không gây ảnh hưởng đến luồng bán hàng, tồn kho hay các báo cáo hiện có của cửa hàng.

## **II. Các thao tác cơ bản**

Để dễ hình dung, các ví dụ dưới đây sẽ minh họa những tình huống thực tế trong ngành Bán buôn, Bán lẻ.

### **1. Thiết lập và tạo phiếu nhập hàng có VAT**

**Tình huống:** Bạn nhập một lô hàng từ nhà cung cấp có xuất hóa đơn GTGT và muốn ghi nhận tiền thuế này để theo dõi chi phí giá vốn chính xác.

**Thao tác thực hiện như sau:**

* **Bước 1 -** **Kiểm tra điều kiện**: Đảm bảo gian hàng của bạn đang sử dụng phương pháp **Thuế trực tiếp** (kiểm tra tại **Thiết lập** → **Xem tất cả thiết lập** → **Thuế & Kế toán**).

* **Bước 2 - Tạo phiếu nhập**: Vào menu **Mua hàng** → **Nhập hàng** → chọn ***+ Nhập hàng***.

* **Bước 3 - Bật VAT**: Tại màn hình tạo phiếu, bật xanh biểu tượng ***VAT*** .

* **Lưu ý:** Bạn có thể thay đổi chế độ bật/tắt VAT trong quá trình soạn thảo. Tuy nhiên, sau khi nhấn ***Hoàn thành***, chế độ này sẽ bị khóa và không thể chỉnh sửa.

### **2. Nhập thông tin thuế VAT**

**Tình huống:** Bạn nhập một hóa đơn hàng tiêu dùng từ nhà phân phối, trong đó các mặt hàng thực phẩm (bánh kẹo, nước giải khát) được áp dụng thuế suất ưu đãi 8%, còn các mặt hàng hóa mỹ phẩm (dầu gội, sữa tắm) vẫn áp dụng mức thuế suất 10%.

**Thao tác thực hiện như sau:**

* **Bước 1**: Với mỗi dòng hàng hóa đã chọn, bạn nhập **Đơn giá trước thuế** (giá chưa có VAT trên hóa đơn).

* **Bước 2**: Tại cột **VAT (%)** → chọn mức thuế suất tương ứng: ***0%****,* ***5%****,* ***8%****,* ***10%****,* ***KCT*** (Không chịu thuế) hoặc ***KKKNT*** (Không kê khai nộp thuế).

* **Bước 3**: Hệ thống tự động hiển thị ***Giá nhập có VAT*** (Giá nhập sau VAT = Đơn giá trước thuế × (1 + VAT%)).

* **Bước 4**: Nhấn vào ô ***VAT nhập hàng*** ở phần tổng tiền để xem popup chi tiết. Nếu có giảm giá hóa đơn, hệ thống sẽ tự động phân bổ giảm giá này xuống từng dòng theo tỷ lệ thành tiền trước thuế.

* **Bước 5**: Nhấn **Hoàn thành**. Hệ thống ghi nhận giá vốn hàng hóa theo **Giá nhập sau VAT**.

## **III. Các tính năng nâng cao**

### **1. Đặt hàng nhập và Trả hàng nhập có VAT**

**Tình huống:** Bạn muốn ghi nhận thông tin thuế ngay từ khi lên đơn đặt hàng với nhà cung cấp hoặc cần trả lại hàng đã nhập có thuế.

**Thao tác thực hiện như sau:**

* **Đặt hàng nhập:** Khi tạo phiếu **Đặt hàng nhập**, bạn thực hiện chọn chế độ VAT tương tự như phiếu **Nhập hàng**. Khi chuyển từ Đặt hàng sang Nhập hàng, các thông tin thuế sẽ được tự động kế thừa.
...
### **2. Nhập hàng từ Hóa đơn đầu vào**

**Tình huống:** Bạn đã kết nối và đồng bộ hóa đơn từ hệ thống của Tổng cục Thuế về KiotViet.

**Thao tác thực hiện như sau:**

* Vào màn hình **Hóa đơn đầu vào**, chọn hóa đơn GTGT cần xử lý → nhấn **Tạo phiếu nhập**.

* Hệ thống sẽ tự động nhận diện chế độ **VAT**, khớp hàng hóa và điền sẵn các thông tin đơn giá, thuế suất (nếu có) mà bạn không cần nhập tay.

### **3. Theo dõi VAT trên danh sách giao dịch**

**Tình huống:** Bạn cần xem nhanh tổng tiền thuế của các phiếu nhập, đặt hàng nhập hoặc trả hàng trong danh sách mà không muốn mở chi tiết từng phiếu.

**Thao tác thực hiện như sau:**

* Tại màn hình danh sách phiếu, nhấn biểu tượng tùy chọn hiển thị cột.
* Tích chọn cột tương ứng:
  + Danh sách **Nhập hàng** và **Đặt hàng nhập** → tích chọn ***VAT nhập hàng***.

* Danh sách **Trả hàng nhập** → tích chọn ***VAT hoàn lại***.

### **4. Xử lý lỗi xung đột cấu hình thuế**

**Tình huống:** Cửa hàng cập nhật phiếu Nhập hàng/Đặt hàng nhập/Trả hàng nhập có chế độ VAT khác với cấu hình thuế hiện tại của gian hàng.

**Thao tác thực hiện như sau:**

* Khi bạn nhấn ***Mở phiếu*** và nhận được thông báo:

**Không thể [Nhập hàng / Đặt hàng nhập / Trả hàng nhập]**

Phiếu [mã phiếu] dùng cách tính thuế khác với cách tính hiện tại của cửa hàng. Hãy chuyển phương pháp tính thuế về Thuế [trực tiếp/ khấu trừ] để xử lý giao dịch này.

* Bạn cần chuyển phương pháp tính thuế trong **Thiết lập** → **Xem tất cả thiết lập** → **Thuế & Kế toán** về đúng loại phù hợp với phiếu cần sửa, thực hiện cập nhật rồi chuyển lại cấu hình mong muốn.

## **IV. Thao tác trên Điện thoại**

Ứng dụng **KiotViet** hỗ trợ cửa hàng ghi nhận VAT nhập hàng trên từng hàng hóa ngay khi tạo phiếu nhập hàng, xem lại VAT nhập hàng trên chi tiết phiếu.

**Tình huống:** Bạn đang kiểm hàng tại kho và muốn dùng điện thoại để tạo nhanh phiếu nhập có VAT.

**Thao tác thực hiện như sau:**

* Mở ứng dụng **KiotViet**, trên menu **Nhiều hơn** → chọn **Nhập hàng** → nhấn biểu tượng dấu +.
* Chọn loại phiếu ***Có VAT***.

* Quét mã vạch sản phẩm hoặc tìm kiếm tên hàng.
* Nhập đơn giá trước thuế và chọn mức VAT (%).
* Chạm ***Xong*** và tiếp tục thêm hàng hóa vào phiếu nhập (nếu cần).

* Nhấn ***Tiếp tục*** → kiểm tra thông tin phiếu trước khi ***Hoàn thành***.
* Nếu cần xem chi tiết VAT nhập hàng trước khi hoàn thành phiếu, bạn chạm vào giá trị ***VAT nhập hàng***.

* Trên chi tiết phiếu nhập hàng đã tạo, bạn chạm biểu tượng mũi tên trên thông tin VAT nhập hàng để xem cụ thể giá trị từng mức thuế suất
