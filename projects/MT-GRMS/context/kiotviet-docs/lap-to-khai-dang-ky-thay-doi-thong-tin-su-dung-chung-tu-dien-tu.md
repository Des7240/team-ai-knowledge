...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-chung-tu-dien-tu-phieu-xuat-kho/lap-to-khai-dang-ky-thay-doi-thong-tin-su-dung-chung-tu-dien-tu/
---
...
Hỗ trợ
Chứng từ điện tử & Phiếu xuất khoLập tờ khai đăng ký/thay đổi thông tin sử dụng chứng từ điện tử
...
Tính năng cho phép người nộp thuế lập và nộp tờ khai đăng ký hoặc thay đổi thông tin sử dụng chứng từ điện tử trực tiếp trên phần mềm KiotViet. Tờ khai sẽ bao gồm các thông tin về loại chứng từ sử dụng, hình thức gửi dữ liệu và chữ ký số. Sau khi được Cơ quan Thuế (CQT) phê duyệt, cửa hàng có thể phát hành chứng từ điện tử hợp lệ.

**Lợi ích nổi bật của tính năng:**

* **Đăng ký sử dụng chứng từ điện tử nhanh chóng, đúng quy định:** Thay vì làm thủ tục giấy tờ phức tạp trên cổng thuế, cửa hàng có thể khai báo và nộp tờ khai cho nhiều loại chứng từ (khấu trừ TNCN, thương mại điện tử, biên lai...) ngay trên phần mềm.
* **Tự động điền dữ liệu đơn vị, tiết kiệm thời gian:** Các thông tin như Tên đơn vị, Mã số thuế, Cơ quan thuế quản lý được hệ thống tự động trích xuất từ phân hệ Thông tin đơn vị (khi thay đổi thông tin, hệ thống tự động điền lại từ tờ khai gần nhất).
* **Theo dõi trạng thái CQT minh bạch:** Trạng thái phê duyệt (Chấp nhận/Từ chối) được cập nhật theo thời gian thực. Nếu CQT từ chối, hệ thống hiển thị popup mã lỗi chi tiết để cửa hàng biết chính xác cần điều chỉnh gì.

## **II. Các thao tác cơ bản**

Để dễ hình dung, các ví dụ dưới đây sẽ minh họa những tình huống thực tế trong ngành Bán buôn, Bán lẻ.

### **Lập và nộp tờ khai đăng ký chứng từ điện tử**

* **Tình huống:** Cửa hàng của bạn cần đăng ký sử dụng chứng từ khấu trừ thuế TNCN lần đầu tiên với Cơ quan Thuế để cấp cho nhân viên.
* **Thao tác thực hiện như sau:**
  + **Bước 1: Truy cập màn hình Tờ khai chứng từ điện tử**
    - Truy cập menu **Tờ khai** → chọn **Tờ khai SD chứng từ điện tử**.

* Hệ thống hiển thị màn hình danh sách **Tờ khai đăng ký/thay đổi thông tin sử dụng chứng từ điện tử**.

* **Lưu ý đặc biệt:** Tờ khai chứng từ điện tử là phân hệ hoàn toàn tách biệt với tờ khai hóa đơn điện tử. Bạn cần có quyền **Đăng ký phát hành mẫu hóa đơn** (hoặc quyền tương đương quản lý chứng từ) mới có thể truy cập được.
* **Bước 2: Tạo tờ khai mới và xác định loại tờ khai**
  + Tại màn hình danh sách, nhấn ***+ Tạo tờ khai***.

* Hệ thống tự động xác định loại tờ khai:
  + Chưa có tờ khai nào trước đó: Tự động chọn ***Đăng ký mới***.
  + Đã có ít nhất 1 tờ khai: Tự động chọn ***Thay đổi thông tin***.
* Bạn có thể chuyển đổi loại tờ khai theo đúng thực tế cần gửi CQT.

* **Bước 3: Kiểm tra thông tin đơn vị**
  + Các thông tin (Tên đơn vị, Mã số thuế, Cơ quan thuế quản lý) được điền tự động.

* Nếu thông tin chưa chính xác, bạn nhấn vào ***Thông tin đơn vị***.

* Hệ thống chuyển sang màn hình **Thiết lập** → **Thông tin đơn vị**, bạn nhấn ***Chỉnh sửa*** để cập nhật hồ sơ, sau đó quay lại để tiếp tục tạo tờ khai.

* **Bước 4: Nhập Thông tin liên hệ**
  + Điền đầy đủ 4 trường bắt buộc: ***Người liên hệ***, ***Điện thoại liên hệ***, ***Thư điện tử*** và ***Địa chỉ liên hệ***.
  + **Lưu ý:** ***Thư điện tử*** là địa chỉ email quan trọng để nhận thông báo phê duyệt/từ chối từ CQT, cần kiểm tra kỹ trước khi nhập.

* **Bước 5: Khai Thông tin đăng ký**
  + ***Đối tượng phát hành***: Tích chọn 1 trong 2 loại:
    - Tổ chức, cá nhân phát hành.
    - Cơ quan thuế phát hành.
  + ***Loại hình sử dụng***: Tích chọn ít nhất 1 loại chứng từ cần dùng:
    - Chứng từ điện tử khấu trừ thuế thu nhập cá nhân (hệ thống tự động chọn).
    - Chứng từ điện tử khấu trừ thuế đối với hoạt động kinh doanh trên nền tảng thương mại điện tử, nền tảng số.
    - Biên lai điện tử.
  + ***Hình thức gửi dữ liệu***: Chọn ít nhất 1 hình thức
    ...
    - **Lưu ý**: Mặc định thường chọn Thông qua tổ chức cung cấp dịch vụ hóa đơn điện tử (tức là qua KiotViet).

* **Bước 6: Khai thông tin chữ ký số (CKS)**
  + Hệ thống tự động hiển thị danh sách CKS liên kết với tài khoản.
  + Nhấn ***+ Thêm chữ ký số*** để bổ sung nếu cần.
  + Chọn ***Hình thức đăng ký*** tương ứng cho từng dòng CKS:
  ...
  + **Lưu ý:** Danh sách CKS không được để trống và ***Số serial CKS*** phải khớp với MST của cửa hàng. Tờ khai chứng từ điện tử dùng chung CKS với tờ khai hóa đơn điện tử.

* **Bước 7: Xác nhận và nộp tờ khai cho CQT**
  + Nhấn ***Nộp tờ khai cho CQT*** .
  + Bạn rà soát lại Email và Tên đơn vị một lần nữa, sau đó nhấn ***Tiếp tục***.

* Chọn loại CKS cửa hàng đang dùng (IntrustCA hoặc USB Token) và nhấn ***Xác nhận***.

* **Bước 8: Theo dõi trạng thái và xem chi tiết tờ khai**
  + Tờ khai vừa nộp xuất hiện đầu danh sách với trạng thái **Đã gửi CQT**.
  + Khi CQT phản hồi, trạng thái tờ khai sẽ tự động cập nhật tương ứng:
    - ***Đã gửi CQT***: Tờ khai đã gửi, đang chờ CQT xử lý.
    - ***CQT chấp nhận***: CQT tiếp nhận và phê duyệt thành công. Cột ***Ngày chấp nhận*** hiển thị ngày CQT phản hồi.
    - ***CQT không chấp nhận***: CQT từ chối tờ khai.
    - ***Gửi lỗi***: Tờ khai chưa được gửi tới CQT.

* **Lưu ý:** Khác với tờ khai HĐĐT yêu cầu xác thực sinh trắc học qua eTax Mobile cho lần đầu đăng ký, với tờ khai chứng từ điện tử, sau khi nộp bạn chỉ cần chờ CQT xử lý.
...
* **Tình huống:** Cửa hàng của bạn có sự thay đổi về chữ ký số mới, hoặc muốn đăng ký bổ sung thêm Biên lai điện tử so với tờ khai cũ.
* **Thao tác thực hiện như sau:**
  + **Bước 1:** Nhấn ***+ Tạo tờ khai***. Nếu đã có tờ khai trước, hệ thống tự động chuyển sang chế độ **Thay đổi thông tin**.
  + **Bước 2:** Toàn bộ thông tin từ tờ khai gần nhất (thông tin liên hệ, chữ ký số...) sẽ được tự động điền sẵn.
  + **Bước 3:** Chỉnh sửa các trường cần thay đổi và nộp lại cho CQT.
  + **Bước 4**: Thực hiện ký số tương tự quy trình tạo mới.

### **2. Đăng ký đồng thời nhiều loại chứng từ**

* **Tình huống:** Cửa hàng vừa cần xuất biên lai điện tử cho khách hàng, vừa cần chứng từ khấu trừ thuế cho nhân viên nên muốn đăng ký gộp một lần để tiết kiệm thời gian.
* **Thao tác thực hiện như sau:**
  + Tại phần ***Loại hình sử dụng***, bạn có thể tích chọn cùng lúc nhiều loại chứng từ:
    - Chứng từ điện tử khấu trừ thuế thu nhập cá nhân
    - Chứng từ điện tử khấu trừ thuế đối với hoạt động kinh doanh trên nền tảng thương mại điện tử, nền tảng số
    - Biên lai điện tử

* Trên màn hình danh sách **Tờ khai**, cột ***Loại chứng từ*** sẽ liệt kê đầy đủ các loại đã khai (cách nhau bằng dấu phẩy).

### **3. Xem lý do Cơ quan Thuế từ chối và xử lý**

* **Tình huống:** Bạn nộp tờ khai nhưng bị CQT từ chối. Bạn cần biết nguyên nhân chi tiết để khắc phục.
* **Thao tác thực hiện như sau:**
  + **Bước 1:** Tại dòng tờ khai có trạng thái ***CQT không chấp nhận***, nhấn vào **biểu tượng (i)** màu xám ngay cạnh.
  + **Bước 2:** Popup **Thông báo** sẽ hiển thị bảng mã lỗi kỹ thuật từ cổng thuế.

* **Bước 3:** Dựa vào nội dung lỗi, bạn tạo tờ khai ***Thay đổi thông tin*** mới để điều chỉnh thông tin sai lệch và nộp lại.

### **4. Xem chi tiết tờ khai đã nộp**

* **Tình huống:** Bạn hoặc kế toán cần xem lại toàn bộ nội dung của một tờ khai đã nộp thành công trước đó.
* **Thao tác thực hiện như sau:**
  + Tại cột ***Tác vụ*** trên danh sách **Tờ khai**, bạn nhấn ***Xem chi tiết***.

* Hệ thống sẽ mở toàn bộ nội dung tờ khai ở chế độ chỉ đọc, kèm trạng thái tờ khai ở cuối trang.
* **Lưu ý:** Không có nút ***Chỉnh sửa*** ở màn hình này. Mọi thay đổi bắt buộc phải tạo mới tờ khai loại ***Thay đổi thông tin***.

### **5. Quản lý danh sách chữ ký số trên tờ khai**

* **Tình huống:** Cửa hàng ngừng sử dụng một chữ ký số cũ và thay bằng một chứng thư số mới.
* **Thao tác thực hiện như sau:** Tại phần ***Thông tin chữ ký số*** trên **Tờ khai**, bạn có thể linh hoạt chọn **Hình thức đăng ký** cho từng dòng: Chọn *Thay thế* nếu đổi CKS cũ sang mới, hoặc *Hủy* nếu ngừng sử dụng CKS đó. Nhấn biểu tượng thùng rác để xóa dòng CKS vừa thêm nhầm.
  + **Thêm CKS**: Nhấn ***+ Thêm chữ ký số*** để tạo thêm dòng nhập liệu mới → chọn 1 trong 2 tùy chọn:
...
* Cập nhật trạng thái CKS: Trên dòng thông tin CKS, bạn chọn hình thức đăng ký phù hợp với nhu cầu: ***Thêm mới***/***Gia hạn***/***Ngừng sử dụng***.

* Nhấn biểu tượng thùng rác → chọn ***Xác nhận*** để xóa các dòng chữ ký số bạn tự thêm nếu thao tác sai.
