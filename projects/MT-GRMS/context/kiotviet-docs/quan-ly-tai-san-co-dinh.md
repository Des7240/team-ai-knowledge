...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-ke-toan-hkd-hach-toan/quan-ly-tai-san-co-dinh/
---
...
Hỗ trợ
Kế toán HKD - Hạch toánQuản lý Tài sản cố định
...
Khi hộ kinh doanh thiết lập hồ sơ khai thuế thuộc nhóm tính thuế TNCN theo lợi nhuận, trong nhóm chức năng "Thuế - Kế toán", phần mềm hỗ trợ tính năng Quản lý Tài sản cố định giúp bạn quản lý các tài sản có giá trị lớn (từ 30 triệu đồng trở lên). Hệ thống sẽ tự động phân loại các mặt hàng này thành Tài sản cố định và hỗ trợ kế toán thiết lập thông tin khấu hao hàng tháng.

**Lợi ích nổi bật của tính năng:**

* Không cần nhập thông tin tài sản thủ công vì hệ thống tự động nhận diện và đồng bộ từ Quản lý Mua hàng (đối với hàng hóa loại Tài sản cố định có giá trị từ 30 triệu trở lên).
* Tự động sinh bút toán khấu hao vào sổ S2c hàng tháng.
* Theo dõi sát sao được giá trị còn lại của tài sản và tiến độ đã khấu hao được bao nhiêu kỳ.

**Đối tượng áp dụng:** Kế toán "Hộ kinh doanh áp dụng tính thuế TNCN theo lợi nhuận" có phát sinh giao dịch mua sắm tài sản cố định. **Lưu ý:** Dữ liệu nhận tự động từ Quản lý Mua hàng, kế toán không tạo mới Tài sản cố định trực tiếp tại chức năng Quản lý này.

## **II. Các thao tác cơ bản**

### **Thiết lập thông tin khấu hao cho tài sản cố định**

**Tình huống:** Là hộ kinh doanh áp dụng tính thuế TNCN theo lợi nhuận, khi bạn đã có phiếu mua hàng với ***Tính chất hàng hóa, dịch vụ*** được phân loại là ***Công cụ dụng cụ*** có giá trị từ 30 triệu đồng trở lên, bạn cần thiết lập thông tin để hệ thống bắt đầu tính khấu hao.

**Thao tác thực hiện như sau:**

* **Bước 1:** Trên màn hình **Quản lý**, truy cập vào menu **Thuế & Kế toán** → **Thuế & Kế toán** → chọn **Tài sản cố định.**
* **Bước 2:** Hệ thống hiển thị danh sách **Tài sản cố định** (mặc định trong tháng này).

* **Bước 3:** Sử dụng thanh tìm kiếm và bộ lọc Theo tên tài sản, chi nhánh và thời gian để tìm kiếm thông tin.

​

* **Bước 4**: Chọn tab **Chưa thiết lập khấu hao** → trên dòng tài sản cố định cần thiết lập khấu hao → nhấn ***Thiết lập khấu hao***.

​

* **Bước 5:** Chọn ***Địa điểm sử dụng*** nếu gian hàng có nhiều địa điểm.
* **Bước 6:** Nhập ***Ngày bắt đầu khấu hao***.
* **Bước 7:** Nhập ***Thời gian khấu hao*** ***(tháng)*** với thời gian tối thiểu là 12 tháng.
* **Bước 8:** Nhấn ***Lưu*** để ghi nhận khấu hao.

* **Bước 9:** Hệ thống sẽ tự động sinh lịch khấu hao cho tài sản này và ghi nhận tại tab **Đã thiết lập khấu hao**.

Tại đây, bạn có thể:

* Nhấn biểu tượng cây bút  để chỉnh sửa thông tin thiết lập khấu hao.

* Nhấn biểu tượng con mắt  để xem chi tiết tài sản khấu hao, giá trị đã khấu hao, chưa khấu hao, trạng thái ghi sổ S2C, ngày ghi.

**Lưu ý** về ***Ngày ghi***:

* Với tháng đầu tiên → hệ thống ghi nhận theo ***Ngày bắt đầu khấu hao***.
* Các tháng tiếp theo → hệ thống tự động ghi nhận vào ngày 1 hàng tháng.

## **III. Các tính năng nâng cao**

### **Xử lý các tình huống đặc biệt về tài sản**

**Tình huống:** Là hộ kinh doanh áp dụng tính thuế TNCN theo lợi nhuận, khi nguyên giá tài sản bị sai, quên thiết lập khấu hao hoặc kỳ kế toán tính khấu hao đã bị khóa.

* **Nguyên giá hiển thị sai:** Bạn không thể sửa thông tin này tại phân hệ Tài sản cố định vì nguyên giá được lấy trực tiếp từ giao dịch mua hàng.
* **Tài sản cố định chưa thiết lập khấu hao:** Hệ thống sẽ không tự ghi bút toán. Bạn bắt buộc cần thiết lập thông tin trước khi kỳ kế toán kết thúc.
* **Kỳ kế toán đã khóa:** Bút toán khấu hao của tháng đã khóa sẽ bị bỏ qua và hệ thống không hỗ trợ ghi bù sang tháng sau.
