...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-giao-van/dich-vu-doi-soat-nhanh/
---
...
Nhằm nâng cao chất lượng dịch vụ, với mục đích giúp cho dòng tiền hàng hóa được luân chuyển liên tục và nhanh chóng nhất, kể từ ngày 1/10/2023, KiotViet cùng các đối tác vận chuyển Best Express, SPX Express, Giao hàng nhanh và Viettel Post đã cho ra mắt dịch vụ Đối soát nhanh. Dịch vụ này hoàn toàn miễn phí cho các đơn hàng có COD dưới 1 triệu, tiền đối soát sẽ được gửi tới Khách hàng nhanh chóng, chính xác ngay sau khi đơn hàng giao thành công trước 13h30, liên tục từ thứ 2 tới thứ 6.

## **II. Các thao tác cơ bản**

Để bật dịch vụ Đối soát nhanh, Quý khách hàng cần truy cập vào tài khoản Admin và làm theo hướng dẫn sau:

**- Cách 1**: Bật dịch vụ Đối soát nhanh từ màn hình **Bán hàng**: bạnchọn **Thiết lập giao hàng** (1) -> tích chọn dịch vụ **Đối soát nhanh** (2) -> kích ***Lưu*** (3)

**- Cách 2**: Bật dịch vụ Đối soát nhanh từ màn hình **Quản lý**: bạn chọn **Giao hàng** (1) -> chọn **Thiết lập chi tiết** (2) **-**> tích chọn ***Sử dụng dịch vụ Đối soát nhanh***(3)-> kích ***Lưu*** (4)

*\*Lưu ý: Chỉ người dùng có vai trò là admin mới có quyền bật hoặc tắt dịch vụ Đối soát nhanh.*

Mọi thắc mắc Quý khách vui lòng liên hệ tống đài **19006522** nhánh **3** để được hỗ trợ và giải đáp nhanh nhất.

Trân trọng cảm ơn!

*Tài liệu được cập nhật mới nhất ngày 04/10/2023*
