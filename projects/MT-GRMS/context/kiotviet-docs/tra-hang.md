...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-tra-hang/tra-hang/
---
...
Tính năng Trả hàng trên KiotViet được thiết kế để tối ưu hóa quy trình nghiệp vụ tại cửa hàng

Tính năng Trả hàng mang lại những lợi ích thiết thực sau:

* **Linh hoạt và chính xác trong mọi tình huống**: KiotViet hỗ trợ hai hình thức trả hàng là "Trả theo hóa đơn" và "Trả hàng nhanh", đồng thời cho phép khách đổi sang sản phẩm khác ngay trong giao dịch, đảm bảo số liệu tồn kho và công nợ luôn chính xác.
* **Quản lý toàn diện và minh bạch**: Mỗi giao dịch trả hàng đều tạo ra một phiếu trả hàng riêng biệt, giúp bạn dễ dàng theo dõi và đối soát. Hệ thống cũng tự động xử lý các đơn hàng giao đi bị hoàn về, tạo phiếu trả tương ứng để quản lý liền mạch.
* **Nâng cao trải nghiệm và sự hài lòng của khách hàng**: Quy trình trả và đổi hàng nhanh chóng, chuyên nghiệp giúp giải quyết vấn đề của khách hàng một cách hiệu quả, tạo dựng niềm tin và giữ chân khách hàng thân thiết.

## **II. Các thao tác cơ bản**

Để dễ hình dung, các ví dụ dưới đây sẽ minh họa những tình huống bán hàng thực tế trên máy tính (Website).

### **1. Trả hàng theo hóa đơn**

* **Tình huống:** Khách hàng còn giữ hóa đơn hoặc bạn có thể tìm lại giao dịch gốc qua thông tin của khách để thực hiện trả hàng.
* **Thao tác thực hiện như sau:**

1. **Tìm hóa đơn gốc**: 
   * Từ màn hình **Bán hàng**, nhấn vào biểu tượng mũi tên  hoặc vào **Tùy chọn** (ba dấu gạch ngang) góc trên bên phải màn hình  → **Chọn hóa đơn trả hàng** để vào mục **Trả hàng**

* Tìm kiếm hóa đơn theo mã, thông tin khách hàng, sản phẩm hoặc thời gian, sau đó nhấn ***Chọn***.

2. **Nhập thông tin hàng trả**: Hệ thống sẽ hiển thị các sản phẩm trong hóa đơn gốc. Bạn nhập ***Số lượng*** thực tế khách trả và có thể cập nhật lại ***Giá trả hàng***.

3. **Hoàn tất phiếu trả**: Kiểm tra lại thông tin, nhập số **Tiền trả khách** (nếu có) và chọn phương thức thanh toán. Nhấn **Trả hàng (F9)** để hoàn tất.

### **2. Trả hàng nhanh (không cần hóa đơn gốc)**

* **Tình huống**: Khách không còn hóa đơn và bạn không tìm lại được giao dịch gốc, cần thực hiện một giao dịch trả hàng độc lập.
* **Thao tác thực hiện như sau**:

1. Tại pop-up **Chọn hóa đơn trả hàng**, nhấn vào nút **Trả nhanh**.

2. Tìm kiếm và thêm các sản phẩm khách muốn trả vào phiếu, nhập số lượng và giá trả lại.
3. **Hoàn tất phiếu trả**: Kiểm tra lại thông tin, nhập số **Tiền trả khách** (nếu có) và chọn phương thức thanh toán. Nhấn **Trả hàng (F9)** để hoàn tất.

### **3. Đổi trả hàng**

* **Tình huống**: Khách hàng muốn trả một sản phẩm và đổi lấy một sản phẩm khác trong cùng một giao dịch.
* **Thao tác thực hiện như sau**:

1. Thực hiện các bước để tạo phiếu trả hàng bằng một trong hai cách trên.
2. **Thêm hàng hóa đổi**: Sử dụng ô tìm kiếm (phím tắt F7) để thêm sản phẩm mới mà khách muốn đổi vào phiếu.
3. **Thanh toán**: Hệ thống sẽ tự động đối trừ giữa tổng tiền hàng trả và tổng tiền hàng đổi. Bạn xử lý phần chênh lệch (trả lại tiền cho khách hoặc thu thêm) và nhấn **Trả hàng (F9)** để hoàn tất.

## **III. Các tính năng nâng cao**

### **1. Quản lý phiếu trả hàng**

* **Tình huống**: Bạn cần xem lại, chỉnh sửa hoặc hủy các giao dịch trả hàng đã thực hiện.
* **Thao tác thực hiện như sau**: 
  + **Xem danh sách**: Vào **Đơn hàng** -> **Trả hàng** để xem toàn bộ các phiếu trả hàng.

* **Cập nhật**: Mở một phiếu trả hàng để cập nhật lại các thông tin như ***Người nhận trả***, ***Ngày trả***, ***Ghi chú***.

* **Hủy bỏ**: Mở phiếu trả hàng cần hủy và nhấn **Hủy** → chọn **Đồng ý**. Hệ thống sẽ cộng lại tồn kho và cập nhật lại công nợ.

* **Sao chép**: Mở phiếu trả hàng và nhấn **Sao chép** để tạo một phiếu mới với thông tin tương tự.

### **2. Xử lý đơn hàng giao bị hoàn về**

* **Tình huống**: Một đơn hàng giao qua đối tác vận chuyển bị trả về và bạn cần cập nhật lại tồn kho.
* **Thao tác thực hiện như sau**: 
  + Khi trạng thái vận đơn được cập nhật thành **Đã chuyển hoàn**, KiotViet sẽ tự động tạo một giao dịch **Trả hàng** tương ứng với hóa đơn gốc.

* Hàng hóa trong đơn sẽ được cộng trả lại tồn kho. Hóa đơn gốc được chuyển sang trạng thái **Hoàn thành**.

* Phiếu trả hàng tự động từ hóa đơn chuyển hoàn không thể hủy.

## **IV. Thao tác trên điện thoại**

Tính năng **Trả hàng** trên ứng dụng KiotViet hỗ trợ cửa hàng thực hiện các thao tác: Trả hàng theo hóa đơn, Trả hàng nhanh, Đổi hàng.

### **1. Trả hàng theo hóa đơn**

* **Tình huống**: Bạn cần xử lý trả hàng cho khách ngay trên điện thoại di động bằng cách tìm lại hóa đơn cũ.
* **Thao tác thực hiện như sau**:

1. Mở ứng dụng, vào menu **Hóa đơn** → tìm và chọn hóa đơn cần trả hàng → chạm 3 chấm → chọn ***Trả hàng***.
2. Nhập số lượng sản phẩm khách trả lại.
3. Chạm vào **Thanh toán**, kiểm tra thông tin và chạm **Hoàn thành**.

### **2. Trả hàng nhanh**

* **Tình huống:** Khách hàng trả hàng không có hóa đơn và bạn cần tạo phiếu trả nhanh trên điện thoại.
* **Thao tác thực hiện như sau:**

1. Tại màn hình **Trả hàng**, chạm vào nút **Trả nhanh**.

2. Tìm và chọn các sản phẩm khách trả, nhập số lượng và giá.

3. Chạm **Thanh toán** và **Hoàn thành**.

### **3. Đổi hàng trong khi trả**

* **Tình huống**: Khách hàng muốn đổi hàng và bạn thực hiện giao dịch ngay trên điện thoại.
* **Thao tác thực hiện như sau**:

1. Bắt đầu quy trình trả hàng bằng một trong hai cách trên.
2. Tại màn hình trả hàng, chạm vào nút ***Thêm hàng +*** → chọn ***+ Hàng mua*** để thêm sản phẩm khách muốn đổi → chọn ***Xong***.

3. Ứng dụng sẽ hiển thị tiền hàng trả và hàng đổi để bạn tính toán chênh lệch → chạm ***Thanh toán***
4. Nhập thông tin về Phí trả hàng, Giảm giá, Thu khác, Tiền trả khách,... (nếu cần) → tiếp tục chạm **Hoàn thành** để kết thúc.

## **V. Thao tác trên máy POS**

Tính năng Trả hàng trên Máy POS Android hỗ trợ cửa hàng thực hiện các thao tác: Trả hàng theo hóa đơn, Trả hàng nhanh.

### **1. Trả hàng theo hóa đơn**

* **Tình huống**: Nhân viên thu ngân cần xử lý trả hàng tại quầy trên máy POS.
* **Thao tác thực hiện như sau**:

1. Trên màn hình bạn chạm vào biểu tượng mũi tên trả hàng  hoặc chạm biểu tượng tùy chọn  (3 gạch) góc phải màn hình, chọn **Trả hàng**.

2. Tìm kiếm hóa đơn gốc theo Mã hóa đơn, tên hoặc SĐT khách → chọn hóa đơn

3. Nhập số lượng hàng trả.

4. Chạm **Thanh toán**, kiểm tra thông tin và chạm **Hoàn thành**.

### **2. Trả hàng nhanh**

* **Tình huống**: Nhân viên thu ngân cần thực hiện trả hàng không cần hóa đơn gốc trên máy POS.
* **Thao tác thực hiện như sau**:
...
3. Tìm và thêm các sản phẩm khách trả vào phiếu, nhập số lượng và giá.

4. Chạm **Thanh toán** và **Hoàn thành** để kết thúc giao dịch.
