...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-thanh-toan/thanh-toan-qua-vpbank/
---
...
Nhằm hỗ trợ các gian hàng thúc đẩy việc thanh toán phi tiền mặt, KiotViet kết hợp cùng ngân hàng VPBank đã ra mắt tính năng thanh toán chuyển khoản bằng phương pháp quét mã VietQR và nhận thông báo kết quả ngay trên phần mềm.

* **Đối tượng áp dụng:** Tất cả gian hàng trên KiotViet (bao gồm cả gian hàng dùng thử và gian hàng chính thức) có tài khoản cá nhân hoặc hộ kinh doanh tại ngân hàng VPBank.
* **Lợi ích nổi bật của tính năng:**
  + **Giúp chủ cửa hàng và quản lý:** Dễ dàng đăng ký và quản lý tài khoản VPBank nhận thanh toán cho cửa hàng, giúp tập trung theo dõi dòng tiền và đối soát giao dịch một cách hiệu quả.
...
**Tóm tắt luồng hoạt động:** Về cơ bản, luồng hoạt động của tính năng bao gồm 2 bước chính: 1. Đăng ký dịch vụ nhận thông báo thanh toán của VPBank -> 2. Nhận thông báo kết quả giao dịch trên màn hình **Bán hàng**.
...
* **Lưu ý về nguyên tắc liên kết tài khoản VPBank**:
  + Một gian hàng KiotViet tại một thời điểm **chỉ có thể liên kết với một tài khoản VPBank duy nhất**.
  + Ngược lại, một tài khoản VPBank có thể được sử dụng để đăng ký dịch vụ cho **nhiều gian hàng KiotViet khác nhau**.

Quá trình này được thực hiện như sau:

#### **1.1. Đăng ký dịch vụ trên KiotViet**

– Tài khoản admin của chủ gian hàng đăng nhập vào màn hình **Quản lý**, chọn mục **Thanh toán** và nhấn ***Đăng ký*** tại thẻ **VPBank**.

- Hoặc trên màn hình **Bán hàng**, khi tạo đơn hàng, bạn chọn phương thức thanh toán ***Chuyển khoản*** -> chọn tài khoản ***VPBank*** -> nhấn ***Nhận thông báo tiền về***

- Tiếp theo, bạn chọn số tài khoản VPBank cần đăng ký, điền đầy đủ các thông tin giao dịch và chọn ***Đăng ký***.

- **Lưu ý**: Nếu đăng ký

* Với tài khoản cá nhân, bạn điền thông tin CCCD/CMT hoặc hộ chiếu.
* Với tài khoản hộ kinh doanh, bạn điền số ĐKKD hoặc MST.

#### **1.2. Xác thực bằng mã OTP**

– Sau khi nhấn Đăng ký, hệ thống sẽ gửi một mã OTP đến số điện thoại bạn đã đăng ký với ngân hàng VPBank.
...
* **Thao tác trên màn hình Bán hàng**:
  + Khi tạo hóa đơn, bạn chọn phương thức thanh toán ***Chuyển khoản*** để hiển thị mã QR của tài khoản VPBank đã liên kết.
...
* Để gia tăng hiệu quả và tốc độ xử lý đơn hàng, bạn có thể kết hợp dịch vụ thông báo thanh toán của VPBank với các tiện ích như:
...
### **1. Xem tài khoản đã đăng ký dịch vụ**

* **Tình huống:** Khi bạn muốn kiểm tra thông tin tài khoản VPBank nào đang được liên kết để nhận thông báo tự động.
* **Thao tác thực hiện như sau**:

(1) Tại màn hình **Quản lý**, vào menu **Thanh toán**.

(2) Chọn thẻ **VPBank** và nhấn **Xem chi tiết** để xem thông tin tài khoản đã liên kết.

### **2. Hủy dịch vụ thông báo thanh toán**

* **Tình huống**: Khi bạn không còn nhu cầu sử dụng tính năng nhận thông báo tự động cho tài khoản VPBank hiện tại.
* **Thao tác thực hiện như sau**:

(1) Tại mục ***Xem chi tiết*** tài khoản, nhấn vào nút ***Hủy đăng ký***.

(2) Hệ thống sẽ hiển thị thông báo xác nhận hủy dịch vụ thành công.

## **IV. Thao tác trên Điện thoại**

Tại ứng dụng KiotViet trên điện thoại, bạn có thể thực hiện các thao tác tương tự giao diện trên website bao gồm đăng ký, nhận thông báo kết quả giao dịch và quản lý tài khoản đã liên kết.

### **1. Đăng ký dịch vụ**

* Từ menu **Nhiều hơn** hoặc **Tổng quan**, bạn chọn mục **Thanh toán** -> nhấn ***Đăng ký ngay***.

* Chọn thẻ **VPBank**, điền các thông tin cần thiết và nhấn ***Tiếp tục***.
...
* Truy cập mục **Thanh toá**n và chọn thẻ **VPBank**.
* Ứng dụng sẽ hiển thị tài khoản đã liên kết thành công.

* Để hủy dịch vụ, bạn chỉ cần nhấn ***Hủy đăng ký*** và xác nhận.
