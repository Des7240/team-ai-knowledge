...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-thiet-lap-ban-dau-hddt/xu-ly-loi-hddt-theo-ma-loi/
---
...
Hỗ trợ
Thiết lập ban đầu HĐĐTXử lý lỗi HĐĐT theo mã lỗi

# **Xử lý lỗi HĐĐT theo mã lỗi**

*(Ngành Bán buôn, Bán lẻ)*

## **Hướng dẫn Xử lý lỗi HĐĐT theo mã lỗi**
...
Lỗi 20001: Sai định dạng dữ liệu 

Khi gặp lỗi này, đơn vị cần tra cứu lại tình trạng hoạt động của Người  
nộp thuế (NNT) tại trang tra cứu NNT  
https://tracuunnt.gdt.gov.vn/

*- 1:* Lỗi số điện thoại người bán

* **Nguyên nhân**: Số điện thoại  
  người bán vượt quá 20 ký tự
* **Cách khắc phục**:
  + Vào Hệ thống -> Hồ sơ hóa đơn điện tử
  + Tại mục Thông tin hiển thị trên hóa đơn điện tử
  + Điền số điện thoại không quá 20 ký tự

*- 2:* Lỗi email người mua

* **Nguyên nhân**:
  + Email không đúng định dạng
  + Email vượt quá 50 ký tự
  + Khai báo nhiều email
* **Cách khắc phục**:
  + Khai báo email đúng định dạng: abc@xyz.nm
  + Email tối đa 50 ký tự
  + Chỉ khai báo 1 địa chỉ email, không viết nhiều email cách nhau  
    dấu ";"

*- 3:* Lỗi tên người mua

* **Nguyên nhân**: Có điền mã số thuế nhưng bỏ trống tên  
  người mua
* **Cách khắc phục**:
  + Điền đầy đủ tên đơn vị nếu có điền mã số thuế người mua
  + Trường hợp khách vãng lai: Bỏ trống cả mã số thuế và tên đơn  
    vị

*- 4:* Lỗi mã số thuế người mua

* **Nguyên nhân**: Mã số thuế không đúng định dạng
* **Cách khắc phục**:
  + Điền mã số thuế đúng 10 hoặc 14 ký tự (bao gồm cả dấu –)
  + Ví dụ đúng:
    - 0101243150
    - 0101243150-001

*- 5:* Lỗi số tài khoản ngân hàng

* **Nguyên nhân**: Số tài khoản vượt quá 30 ký tự
* **Cách khắc phục**: Điền số tài khoản ngân hàng người  
  mua tối đa 30 ký tự

*- 6:* Lỗi thuế suất

* **Nguyên nhân**: Bỏ trống thuế suất cho hàng hóa/dịch  
  vụ
* **Cách khắc phục**:
  + Bắt buộc điền thuế suất cho các tính chất khác "Ghi chú" và  
    "Diễn giải"
  + Nếu không chịu thuế thì điền 0%

*- 7:* Lỗi tổng tiền trước thuế

* **Nguyên nhân**: Hóa đơn GTGT thiếu thông tin tổng tiền  
  trước thuế
* **Cách khắc phục**: Đối với hóa đơn GTGT, bắt buộc phải  
  có thông tin Tổng tiền trước thuế

*- 8:* Lỗi tổng tiền thuế

* **Nguyên nhân**: Hóa đơn GTGT thiếu thông tin tổng tiền  
  thuế
* **Cách khắc phục**:
  + Tổng tiền thuế phải có giá trị với loại hóa đơn GTGT
  + Trường hợp không chịu thuế, không phải kê khai thuế, 0% thì  
    giá trị là 0

*- 9:* Lỗi phương tiện vận chuyển

* **Nguyên nhân**: Thiếu thông tin phương tiện vận chuyển  
  trên phiếu xuất kho
* **Cách khắc phục**:
  + Bắt buộc điền thông tin phương tiện vận chuyển trên:
  + Phiếu xuất kho kiêm vận chuyển nội bộ
  + Phiếu xuất kho kiêm hàng gửi bán đại lý

 Lỗi 20019: Chữ ký số chưa được đăng ký 

**Nguyên nhân:** Thông tin chữ ký số không khớp với đăng ký

**Cách khắc phục**:

* Kiểm tra lại thông tin chữ ký số ký hóa đơn
* So sánh với thông tin chữ ký số trong đăng ký phát hành
* Đảm bảo thông tin trùng khớp

 Lỗi 20037: Chứng thư số không hợp lệ 

**Nguyên nhân**: Serial chứng thư số không đồng bộ với Tổng cục Thuế

**Cách khắc phục**:

* Kiểm tra số serial đăng ký với thuế đã chính xác chưa
* Kiểm tra có ký tự đặc biệt nào không
* Sau khi sửa xong:
  + Vào đăng ký phát hành
  + Chọn "Thay đổi thông tin"
  + Cập nhật chứng thư số cho chuẩn

 Lỗi 20610: Mã của Cơ quan thuế không duy nhất 

**Nguyên nhân**: NNT đã xuất hóa đơn trước đó qua 1 đơn vị khác và đã  
sử dụng 1 số lượng mã CQT nhất định, nhưng sang KiotViet Einvoice lại  
xuất lại từ dải mã số 1, dẫn đến trùng mã CQT

**Cách khắc phục**:

* Kiểm tra mã CQT cuối cùng xuất thành công tại phần mềm cũ
* Liên hệ tổng đài hỗ trợ để được cập nhật mã tịnh tiến CQT cho các hóa  
  đơn cũ và hóa đơn tiếp theo phát hành

 Các lỗi cần liên hệ Cơ quan Thuế 

* Lỗi chưa xác định (mã lỗi …-1)
* Chưa hỗ trợ (mã lỗi …-2)
* Lỗi kết nối cơ sở dữ liệu (mã lỗi …-3)
