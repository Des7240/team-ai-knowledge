...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-coupon/coupon/
---
...
Coupon là một dạng phiếu giảm giá trực tiếp trên hóa đơn, giúp cửa hàng triển khai các chương trình marketing, chăm sóc và gắn kết khách hàng thân thiết. KiotViet hỗ trợ quản lý chặt chẽ từng coupon từ việc tạo các đợt phát hành với những điều kiện sử dụng riêng, đến việc phát hành, áp dụng khi thanh toán và theo dõi hiệu quả trên các báo cáo kinh doanh.

**Lợi ích nổi bật của tính năng Coupon trên KiotViet:**

* **Công cụ marketing và CSKH hiệu quả:** Coupon là phương tiện marketing hữu hiệu, giúp bạn dễ dàng triển khai các chương trình chăm sóc, tri ân khách hàng thân thiết và thu hút khách hàng mới.
* **Quản lý linh hoạt, kiểm soát chặt chẽ:** Cho phép quản lý tập trung từng coupon theo các đợt phát hành với các điều kiện sử dụng linh hoạt về giá trị, thời gian, phạm vi áp dụng và các sản phẩm/nhóm sản phẩm được hưởng ưu đãi.
* **Tích hợp giảm giá và báo cáo hiệu quả:** Giá trị giảm giá từ coupon được áp dụng trực tiếp trên màn hình bán hàng và được ghi nhận đầy đủ trên các báo cáo kinh doanh, giúp bạn phân tích rõ hiệu quả của từng đợt phát hành.

## **II. Các thao tác cơ bản**

Để dễ hình dung, các ví dụ dưới đây sẽ minh họa những tình huống bán hàng thực tế.

### **1. Thiết lập ban đầu cho tính năng Coupon**

* **Tình huống:** Để bắt đầu sử dụng coupon, trước tiên bạn cần kích hoạt và cấu hình các tùy chọn chung cho tính năng này trên toàn bộ hệ thống của mình.
* **Thao tác thực hiện như sau:**

1. Tại màn hình **Quản lý,** bạn vào menu **Thiết lập →** chọn **Khách hàng** **→** bật xanh tính năng **Coupon**
2. Tích chọn ***Áp dụng gộp với các chương trình khuyến mại khác*** nếu cho phép sử dụng gộp cùng với các chương trình khuyến mại khi đã dùng coupon để thanh toán hóa đơn.

### **2. Tạo và phát hành đợt coupon mới**

* **Tình huống:** Khi bạn muốn tạo một loạt coupon mới cho một chiến dịch marketing nhằm kích cầu tiêu dùng.
* **Thao tác thực hiện như sau:**

1. Tại màn hình **Quản lý,** bạn vào menu **Thiết lập →** chọn **Khách hàng → Coupon →** nhấn **Quản lý Coupon**

Hoặc từ menu **Khách hàng** → chọn **Coupon**

1. Hệ thống chuyển sang màn hình **Coupon**, bạn nhấn ***+ Đợt phát hành coupon***, điền các thông tin: ***Tên đợt phát hành***, ***Hiệu lực***, ***Giá trị coupon***, ***Điều kiện mua hàng***, ***Ghi chú*** (nếu có) → chọn ***Lưu & Tạo mã coupon***.
...
2. Hệ thống mở màn hình **Tạo mã coupon**, bạn nhập các thông tin bắt buộc bao gồm: ***Số lượng coupon***, ***Số lượng ký tự ngẫu nhiên*** → nhấn ***Lưu và Phát hành***.

### **3. Áp dụng coupon khi bán hàng**

* **Tình huống:** Khi khách hàng thanh toán, bạn cần áp dụng phiếu giảm giá từ coupon vào hóa đơn của họ.
* **Thao tác thực hiện như sau:**

1. Tại màn hình bán hàng, khi Thanh toán, bạn nhập mã coupon hợp lệ của khách và nhấn Enter.
2. Hệ thống sẽ tự động kiểm tra và áp dụng giá trị giảm giá của coupon vào hóa đơn.

***Lưu ý quan trọng:*** *Tính năng* *coupon không được hỗ trợ đối với các hóa đơn thanh toán offline.*

## **III. Các tính năng nâng cao**

### **1. Quản lý và theo dõi các Đợt phát hành**

* **Tình huống:** Khi bạn cần xem lại thông tin, cập nhật, sao chép nhanh hoặc xóa một đợt phát hành coupon đã tạo trước đó.
* **Thao tác thực hiện như sau:**
* Tại màn hình **Quản lý,** bạn vào menu **Thiết lập →** chọn **Khách hàng → Coupon →** nhấn **Quản lý Coupon**

Hoặc từ menu **Khách hàng** → chọn **Coupon**

1. Tại đây, bạn có thể sử dụng bộ lọc để tìm kiếm đợt phát hành mong muốn.

2. Để xem chi tiết, bạn nhấn vào tên đợt phát hành. Các tab **Thông tin**, **Danh sách coupon** và **Đơn hàng dùng coupon** sẽ cung cấp đầy đủ dữ liệu.

3. Để thực hiện **Chỉnh sửa**, **Sao chép** hoặc **Xóa** đợt phát hành, trên thông tin coupon, bạn chọn các thao tác tương ứng

***Lưu ý****: Hệ thống không cho xóa đợt phát hành đã có coupon được phát hành hoặc sử dụng.*

4. Khi xem **Danh sách coupon**, bạn có thể ***Tạo mã coupon*** và ***Xuất file*** danh sách mã coupon trong đợt phát hành

### **2. Áp dụng đồng thời với các chương trình khuyến mại khác**

* **Tình huống:** Khi bạn muốn linh hoạt hơn trong các chương trình khuyến mại, cho phép khách hàng được áp dụng cả coupon và các ưu đãi khác trên cùng một hóa đơn.
* **Thao tác thực hiện như sau:**

1. Tại màn hình **Quản lý,** bạn vào menu **Thiết lập →** chọn **Khách hàng**
2. Trên tính năng **Coupon** → tích chọn ***Áp dụng đồng thời với các chương trình khuyến mại khác***.

### **3. Xử lý các trường hợp đặc biệt**

* **Tình huống:** Bạn cần xử lý các tình huống khi khách hàng trả hàng, đổi hàng hoặc hủy hóa đơn đã áp dụng coupon.
* **Thao tác thực hiện như sau:** 
  + **Trả hàng:** Giá trị giảm giá trên phiếu trả hàng sẽ bao gồm cả giá trị coupon đã áp dụng trên hóa đơn gốc.
  + **Đổi trả hàng:** Phần trả hàng tính giá trị giảm giá có coupon, phần mua hàng mới chưa hỗ trợ giảm giá từ coupon.
  + **Hủy hóa đơn:** Mã coupon đã áp dụng sẽ không được sử dụng lại.

### **4. Báo cáo và Phân quyền**

* **Tình huống:** Bạn cần theo dõi hiệu quả của các đợt phát hành coupon và thiết lập quyền truy cập tính năng cho nhân viên.
* **Thao tác thực hiện như sau:** 
  + **Báo cáo:** Giá trị giảm giá từ coupon được ghi nhận trên tất cả các báo cáo có thông tin giảm giá (Báo cáo cuối ngày, Báo cáo tài chính, Báo cáo bán hàng,...).

* **Phân quyền:** Hệ thống hỗ trợ 4 quyền: Xem danh sách, Thêm mới, Cập nhật, Xóa cho tính năng quản lý coupon.
