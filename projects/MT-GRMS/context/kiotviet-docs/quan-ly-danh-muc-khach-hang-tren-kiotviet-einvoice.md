...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-phat-hanh-hddt/quan-ly-danh-muc-khach-hang-tren-kiotviet-einvoice/
---
...
Hỗ trợ
Phát hành HĐĐTQuản lý danh mục khách hàng trên KiotViet eInvoice
...
Chức năng quản lý danh mục Khách hàng cho phép người dùng lưu trữ, tra cứu và duy trì toàn bộ thông tin đối tác — bao gồm cả khách hàng cá nhân và doanh nghiệp — trực tiếp trên phần mềm KiotViet. Dữ liệu này được sử dụng để tự động điền thông tin khi phát hành hóa đơn điện tử, giúp đảm bảo chứng từ luôn chính xác, đúng quy định và đồng nhất tuyệt đối với hồ sơ đã khai báo thuế.

**Lợi ích nổi bật của tính năng:**

* **Tiết kiệm thời gian, giảm sai sót hóa đơn:** Khi xuất hóa đơn điện tử, hệ thống sẽ tự động gọi dữ liệu (tên, mã số thuế, địa chỉ, người đại diện...) từ danh mục khách hàng. Điều này giúp nhân viên bán hàng/kế toán tiết kiệm thời gian nhập liệu thủ công và hạn chế tối đa rủi ro gõ sai thông tin.
* **Quản lý tập trung, tra cứu nhanh chóng:** Toàn bộ thông tin khách hàng được quản lý tập trung trên một giao diện. Công cụ tìm kiếm real-time kết hợp cùng bộ lọc thông minh giúp bạn tra cứu hồ sơ đối tác tức thì, đồng thời hỗ trợ tải lên/tải xuống dữ liệu hàng loạt qua Excel.
* **Kiểm soát danh sách linh hoạt:** Hệ thống cho phép phân loại khách hàng theo nhóm, theo loại hình (cá nhân/doanh nghiệp) và theo trạng thái (hoạt động/ngừng hoạt động). Điều này hỗ trợ chủ cửa hàng dễ dàng khoanh vùng danh sách khi cần xử lý công nợ hoặc thực hiện chiến dịch chăm sóc.

## **II. Các thao tác cơ bản**

Để dễ hình dung, các ví dụ dưới đây sẽ minh họa những tình huống thực tế trong ngành Bán buôn, Bán lẻ.

### **1. Truy cập và mở form tạo khách hàng mới**

* **Tình huống:** Cửa hàng vừa chốt được một hợp đồng cung cấp sỉ dài hạn cho một doanh nghiệp mới. Bạn cần thêm thông tin doanh nghiệp này vào hệ thống để chuẩn bị xuất hóa đơn kỳ đầu tiên.
* **Thao tác thực hiện như sau:**
  + **Bước 1:** Truy cập menu **Danh mục** → chọn **Khách hàng**.

* **Bước 2:** Màn hình danh sách **Khách hàng** sẽ hiện ra. Tại đây, bạn nhấn ***+ Thêm khách hàng***.

* **Bước 3:** Hệ thống hiển thị popup **Tạo khách hàng**.

### **2. Khai báo thông tin khách hàng**

* **Tình huống:** Bạn tiến hành điền các thông tin của doanh nghiệp đối tác vào form, tận dụng tính năng tự động tra cứu để đảm bảo thông tin khớp với Cơ quan Thuế.
* **Thao tác thực hiện như sau:**
  + **Bước 1 - Chọn loại khách hàng**: ***Cá nhân*** hoặc ***Doanh nghiệp*** để hiển thị các thông tin tương ứng bên dưới.
    - Giao diện khách hàng ***Cá nhân***

* Giao diện khách hàng ***Doanh nghiệp***

* **Bước 2 - Điền các thông tin bắt buộc**:
  + ***Mã khách hàng***: Là mã duy nhất, không trùng lặp trong hệ thống.
  + ***Tên khách hàng***/ ***Tên tổ chức, doanh nghiệp***.
  + ***Địa chỉ***/ ***Địa chỉ ĐKKD***.
* **Bước 3 -**  **Thông tin** **bổ sung**: Điện thoại, Email (hỗ trợ nhiều email), Tên ngân hàng, Số tài khoản, Họ tên người mua, Ghi chú.

### **3. Lưu thông tin và kiểm tra danh sách**

* **Tình huống:** Sau khi điền xong thông tin khách hàng, bạn lưu lại và muốn kiểm tra xem khách hàng này đã sẵn sàng để chọn khi xuất hóa đơn chưa.
* **Thao tác thực hiện như sau:**
  + **Bước 1 - Lưu dữ liệu**: Bạn nhấn ***Lưu*** ở góc dưới bên phải popup. (Nếu muốn đóng popup không lưu thông tin, bạn nhấn ***Hủy bỏ***).

* **Bước 2 -** **Kiểm tra trên danh sách**: Khách hàng mới tạo sẽ xuất hiện ngay ở vị trí đầu tiên của trang danh sách (do hệ thống mặc định sắp xếp theo thời gian tạo mới nhất).

## **III. Các tính năng nâng cao**

### **1. Tìm kiếm, lọc và tùy chỉnh hiển thị danh sách**

* **Tình huống:** Bạn cần tìm lại thông tin của một khách lẻ dựa trên số điện thoại, đồng thời muốn bật thêm cột "Email" ra ngoài màn hình để dễ theo dõi.
* **Thao tác thực hiện như sau:**
  + **Bước 1 -** **Tìm kiếm nhanh và Lọc**: Sử dụng thanh tìm kiếm trên cùng và nhập ***tên, mã khách hàng, mã số thuế, tên người mua, số điện thoại*** (kết quả sẽ lọc ngay khi nhập). Bạn cũng có thể dùng bộ lọc bên trái để khoanh vùng theo ***Nhóm khách hàng***, ***Loại khách hàng*** hoặc ***Trạng thái***.

* **Bước 2 -** **Tùy chỉnh cột hiển thị**: Bạn nhấn ***Ẩn/Hiện cột*** ở góc trên bên phải màn hình → tích/bỏ tích chọn các thông tin (Mã khách hàng, Nhóm khách hàng, Email, Số CMND/Hộ chiếu, Mã ĐVQHNS, Ghi chú, Trạng thái) muốn hiển thị/ẩn trên danh sách **Khách hàng**.

* **Bước 3 - Sắp xếp và phân trang**: Bạn nhấn vào tiêu đề cột (VD: Tên khách hàng) để sắp xếp A-Z (tăng dần) hoặc Z-A (giảm dần). Nếu muốn xem nhiều hơn 10 dòng/trang, bạn kéo xuống cuối trang và chọn 20/50 dòng.

### **2. Xem chi tiết, cập nhật và quản lý trạng thái**

* **Tình huống:** Một khách hàng vừa thay đổi địa chỉ và bạn cần cập nhật lại hệ thống, đồng thời muốn xóa các khách hàng do nhập thử nghiệm.
* **Thao tác thực hiện như sau:**
  + **Bước 1 -** **Cập nhật thông tin**:
    - Nhấn vào khách hàng cụ thể trên danh sách để mở ra chi tiết → chọn ***Chỉnh sửa***.

* Cập nhật thông tin và nhấn ***Lưu***. Mọi thay đổi đều được hệ thống lưu vết (thời gian, người thực hiện, giá trị cũ/mới).

* **Bước 2 -** **Tạm ngừng hoạt động**:
  + Nếu khách hàng không còn giao dịch, khi xem chi tiết bạn nhấn ***Ngừng hoạt động*** → xác nhận ***Đồng ý***.

* Khách hàng này sẽ không hiển thị khi lập hóa đơn, nhưng vẫn có thể ***Cho phép hoạt động*** tiếp tục giao dịch.

* **Bước 3 -** **Xóa khách hàng**: Để xóa khách hàng khỏi danh mục, bạn có thể nhấn Xóa khi xem chi tiết. Nếu cần xóa nhiều khách hàng cùng lúc, bạn tích chọn khách hàng → chọn ***Xóa khách hàng*** → nhấn ***Xác nhận***.

### **3. Import / Export hàng loạt bằng Excel**

* **Tình huống:** Cửa hàng mới chuyển đổi sang dùng KiotViet e-invoice và bạn cần nhập danh sách 500 khách hàng từ phần mềm cũ sang.
* **Thao tác thực hiện như sau:**
  + **Bước 1 - Tải file mẫu và chuẩn bị dữ liệu**: Bạn nhấn ***Import file***, sau đó nhấn vào link Tải về file mẫu: ***Excel file*** trong popup. Điền thông tin khách hàng của bạn vào file mẫu này theo đúng định dạng cột.

* **Bước 2 - Tải dữ liệu lên hệ thống**: Trên popup, bạn chọn quy tắc xử lý nếu ***Xử lý trùng mã khách hàng, khác tên khách hàng*** (Báo lỗi và dừng import hoặc Thay thế tên khách hàng cũ bằng tên khách hàng mới). Sau đó, nhấn ***Chọn file dữ liệu*** → kéo thả file hoặc tiếp tục nhấn ***Chọn file*** để đưa thông tin lên hệ thống.
