...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-ke-toan-hkd-hach-toan/quan-ly-cong-cu-dung-cu-dich-vu/
---
...
Hỗ trợ
Kế toán HKD - Hạch toánQuản lý Công cụ dụng cụ & Dịch vụ
...
Khi hộ kinh doanh thiết lập hồ sơ khai thuế thuộc nhóm tính thuế TNCN theo lợi nhuận, trong nhóm chức năng "Thuế - Kế toán", phần mềm hỗ trợ tính năng quản lý **Công cụ dụng cụ & Dịch vụ** giúp bạn quản lý các khoản chi phí cần phải phân bổ dần theo nhiều kỳ kế toán. Ví dụ: tiền thuê mặt bằng trả theo quý, tiền mua phần mềm trả theo năm, hoặc các công cụ dụng cụ mua một lần nhưng ghi nhận chi phí rải rác từng tháng.

**Lợi ích nổi bật của tính năng:**

* Tự động sinh lịch phân bổ và bút toán hàng tháng, giúp bạn không cần nhập tay thủ công.
* Dễ dàng theo dõi được tiến độ của từng khoản: đã phân bổ bao nhiêu tháng, giá trị còn lại là bao nhiêu.
* Tránh việc bỏ sót chi phí trong kỳ do quên ghi nhận bút toán.

**Đối tượng áp dụng:** Kế toán "Hộ kinh doanh áp dụng tính thuế TNCN theo lợi nhuận" có phát sinh các chi phí mua sắm công cụ dụng cụ hoặc sử dụng dịch vụ kéo dài nhiều kỳ.

**Lưu ý:** Dữ liệu được đẩy tự động từ phân hệ **Mua hàng** sang, bạn không cần và không thể tạo trực tiếp giao dịch trong chức năng này.

## **II. Các thao tác cơ bản**

### **1. Quản lý danh sách công cụ dụng cụ & dịch vụ**

**Tình huống:** Để kiểm soát các khoản chi phí cần phân bổ, bạn cần nắm được cách truy cập danh sách, tìm kiếm nhanh các bản ghi và xem thông tin chi tiết về tiến độ phân bổ của từng khoản công cụ dụng cụ hoặc dịch vụ.

**Thao tác thực hiện như sau:**

* **Bước 1:** Trên màn hình **Quản lý**, truy cập vào menu **Thuế & Kế toán** → **Thuế & Kế toán** → chọn **CCDC & Dịch vụ**
* **Bước 2:** Hệ thống hiển thị danh sách **Công cụ dụng cụ & Dịch vụ** (mặc định trong tháng này).

* **Bước 3:** Sử dụng thanh tìm kiếm và bộ lọc Theo tên CCDC, Dịch vụ, chi nhánh, thời gian, loại (CCCD/ Dịch vụ) và trạng thái thiết lập (Chưa phân bổ/ Phân bổ 1 phần/ Hoàn thành) để tìm kiếm thông tin.

* **Bước 4:** Bạn nhấn vào từng dòng CCCD/ Dịch vụ để xem chi tiết → hệ thống hiển thị:

* Thông tin tổng quan, bao gồm: Số lượng, Tổng giá trị, Số lượng đã phân bổ, Giá trị đã phân bổ, Còn lại.
* Danh sách các đợt ghi nhận chi phí với thông tin cụ thể về: Số lượng, Địa điểm sử dụng, Hình thức (dùng 1 kỳ hay phân bổ nhiều kỳ), Ngày bắt đầu, Số tháng, Tiến độ kỳ, Trạng thái của đợt đó. Tại đây, bạn có thể thực hiện các thao tác:
  + Nhấn biểu tượng con mắt  để mở **Chi tiết đợt ghi nhận**.

* Nhấn biểu tượng thùng rác  để hủy đợt ghi nhận.

### **2. Thiết lập thông tin phân bổ cho công cụ dụng cụ & dịch vụ**

**Tình huống:** Là hộ kinh doanh áp dụng tính thuế TNCN theo lợi nhuận, khi bạn đã có phiếu mua hàng với ***Tính chất hàng hóa, dịch vụ*** được phân loại là ***Công cụ dụng cụ*** có giá trị dưới 30 triệu đồng hoặc ***Dịch vụ***, bạn cần phân bổ khoản chi phí này.

**Thao tác thực hiện như sau:**

* **Bước 1:** Trên màn hình **Quản lý**, truy cập vào menu **Thuế & Kế toán** → **Thuế & Kế toán** → chọn **CCDC & Dịch vụ**
* **Bước 2**: Nhấn vào dòng CCCD/ Dịch vụ có ***Trạng thái thiết lập***: ***Chưa phân bổ***/ ***Phân bổ 1 phần*** để mở chi tiết → chọn ***Ghi nhận chi phí***.

* **Bước 3:** Chọn ***Hình thức ghi nhận*** theo 1 trong 2 loại:
  + ***Dùng 1 kỳ***: Toàn bộ chi phí sẽ được ghi nhận là chi phí tháng hiện tại trong **Sổ doanh thu, chi phí (S2c-HKD)**.

* ***Phân bổ nhiều kỳ***: Bạn nhập
  + ***Ngày bắt đầu phân bổ*** chi phí.
  + ***Thời gian phân bổ (theo tháng)***.

* **Bước 4:** Chọn ***Địa điểm sử dụng*** (nếu gian hàng có nhiều địa điểm) và ***Số lượng Công cụ dụng cụ*** tương ứng cần ghi nhận trong đợt này.

* **Bước 5:** Nhấn ***Lưu*** để ghi nhận chi phí.
* **Bước 6:** Hệ thống ghi nhận chi phí tương ứng vào các tab **Dùng một kỳ** và **Phân bổ nhiều kỳ**. Bạn chọn tab cần xem thông tin.

Tại đây, bạn có thể:

* Nhấn biểu tượng cây bút  để chỉnh sửa thông tin ghi nhận chi phí.

* Nhấn biểu tượng con mắt  để xem chi tiết khoản chi phí, giá trị đã phân bổ, chưa phân bổ, trạng thái ghi sổ S2C, ngày ghi.

**Lưu ý**

* Về ***Ngày ghi*** khi phân bổ nhiều kỳ:
  + Với tháng đầu tiên → hệ thống ghi nhận theo ***Ngày bắt đầu phân bổ***.
  + Các tháng tiếp theo → hệ thống tự động ghi nhận vào ngày 1 hàng tháng.
* Khi bạn thao tác chỉnh sửa phiếu mua hàng → hệ thống cũng hiển thị các đợt ghi nhận chi phí (có thể thu/mở) ngay dưới dòng hàng hóa để bạn tiện theo dõi.

## **III. Các tính năng nâng cao**

### **Xử lý các tình trạng phân bổ đặc biệt**

**Tình huống:** Là hộ kinh doanh áp dụng tính thuế TNCN theo lợi nhuận, khi bạn cần xử lý các khoản chi phí chưa được phân bổ vào cuối kỳ hoặc các kỳ kế toán đã bị khóa sổ.

* **Đối với khoản chi phí Chưa ghi nhận:** Hệ thống sẽ không tự động ghi bút toán. Kế toán cần phải thực hiện ***Ghi nhận chi phí*** trước thời điểm cuối kỳ để chi phí được ghi nhận đúng kỳ kế toán.
* **Đối với kỳ kế toán đã khóa:** Hệ thống KHÔNG ghi bút toán vào kỳ đã bị khóa. Bút toán của kỳ đó sẽ bị bỏ qua, không bù vào kỳ sau.
