...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-thiet-lap/ap-dung-dia-ban-hanh-chinh-moi/
---
...
Tính năng này cho phép cửa hàng quản lý địa chỉ theo chuẩn địa bàn hành chính mới 2 cấp (Tỉnh/Thành phố - Phường/Xã) theo quy định mới, đồng thời vẫn hỗ trợ song song địa chỉ cũ 3 cấp (Tỉnh/Thành phố - Quận/Huyện - Phường/Xã) để đảm bảo hoạt động kinh doanh diễn ra liên tục.

**Lợi ích nổi bật của tính năng:**

* **Tuân thủ quy định pháp luật:** Giúp bạn đảm bảo thông tin địa chỉ trên hóa đơn điện tử và chứng từ chính xác theo quy định, hạn chế rủi ro pháp lý.
* **Không gián đoạn vận hành:** Bạn có thể linh hoạt xử lý giao dịch với cả địa chỉ cũ và mới, đặc biệt hữu ích khi các đối tác vận chuyển hoặc bản đồ chưa cập nhật đồng bộ.
* **Chuyển đổi linh hoạt:** Hệ thống cho phép cập nhật dữ liệu từ từ theo lộ trình của cửa hàng, hỗ trợ gợi ý chuyển đổi thông minh mà không bắt buộc thay đổi ngay lập tức.

**Phạm vi áp dụng:** Tính năng được cập nhật đồng bộ trên toàn hệ thống, tập trung vào các nhóm chức năng chính sau:

* **Quản lý Đối tác (Khách hàng, Nhà cung cấp, Đối tác giao hàng, Bác sĩ):**
  + Áp dụng cho toàn bộ các thao tác: Thêm mới, Chỉnh sửa, Xem chi tiết, Tìm kiếm, Lọc, Import, Xuất file và Gộp trùng.
  + Hỗ trợ đồng bộ trên cả Màn hình Quản lý và Màn hình Bán hàng.
* **Quản lý Giao dịch (Hóa đơn, Đặt hàng, Vận đơn, Nhập hàng, Trả hàng nhập, Đặt hàng nhập):**
  + Cập nhật thông tin địa chỉ trong các thao tác: Tìm kiếm, Lọc, Xem danh sách/Chi tiết, Import, Xuất file, Gộp đơn và In phiếu.
  + Đặc biệt áp dụng cho thông tin **Địa chỉ lấy hàng** và **Địa chỉ nhận hàng** khi tạo vận đơn hoặc bán giao hàng.
* **Quản trị & Thiết lập:**
  + Cập nhật thông tin địa chỉ trong: **Thông tin cửa hàng**, **Quản lý chi nhánh**, **Quản lý người dùng**.
  + Tự động hiển thị đúng định dạng địa chỉ trên các **Mẫu in**.
* **Các tiện ích khác:**
  + **Voucher:** Áp dụng khi phát hành voucher và tạo mới người mua.
  + **Sổ quỹ:** Áp dụng khi tạo phiếu thu/chi kèm thông tin người nộp/nhận.
  + **Báo cáo:** Hiển thị chính xác thông tin địa chỉ chi nhánh.

**Lưu ý quan trọng khi sử dụng tính năng:** Trong quá trình thao tác (nhập địa chỉ cũ, cập nhật dữ liệu, xử lý địa bàn chia tách), hệ thống sẽ hỗ trợ tính năng tự động gợi ý địa chỉ mới. Khi sử dụng tính năng này, bạn cần lưu ý:

* **Độ chính xác:** Địa chỉ gợi ý có thể không chính xác tuyệt đối trong một số trường hợp địa bàn hành chính bị chia tách phức tạp.
* **Kiểm tra kỹ:** Luôn đối chiếu lại thông tin thực tế trước khi nhấn **Cập nhật**.
* **Giao hàng:** Đặc biệt lưu ý với các **địa chỉ giao hàng/nhận hàng**, việc sai lệch địa chỉ chuyển đổi có thể dẫn đến thất lạc đơn hàng hoặc sai lệch cước phí vận chuyển.

## **II. Các thao tác cơ bản**

Để dễ hình dung, các ví dụ dưới đây sẽ minh họa những tình huống thực tế trong hoạt động quản lý cửa hàng bán lẻ.

### **1. Nhập địa chỉ MỚI khi thêm mới đối tượng**

* **Tình huống:** Bạn đang thêm mới một khách hàng hoặc nhà cung cấp vào hệ thống và muốn sử dụng địa chỉ mới 2 cấp.
* **Thao tác thực hiện như sau:**

(1) Trên màn hình thêm mới (Khách hàng, Nhà cung cấp, Chi nhánh...), tại ô ***Khu vực*** → bạn nhập từ khóa tìm kiếm để ***Chọn Tỉnh/Thành phố*** (ví dụ: "Hà Nội").

(2) Hệ thống hiển thị danh sách gợi ý. Bạn chọn giá trị chỉ có tên Tỉnh/Thành phố (ví dụ: "Thành phố Hà Nội" - thường hiển thị đầu tiên).

(3) Tại ô ***Phường/Xã***, hệ thống sẽ tự động tải danh sách theo chuẩn địa bàn hành chính mới 2 cấp trực thuộc Tỉnh/Thành phố bạn đã chọn tại ô ***Khu vực*** →  bạn nhập từ khóa để ***Chọn Phường/Xã*** phù hợp từ danh sách.

(4) Điền các thông tin còn lại và nhấn ***Lưu*** để hoàn tất.

### **2. Nhập địa chỉ CŨ và sử dụng gợi ý chuyển đổi**

* **Tình huống:** Bạn quen thuộc với cách nhập địa chỉ cũ (có Quận/Huyện) và muốn hệ thống tự động gợi ý chuyển đổi sang chuẩn mới để đảm bảo chính xác.
* **Thao tác thực hiện như sau:**

(1) Trên màn hình thêm mới, tại ô **Khu vực**, bạn nhập từ khóa và chọn giá trị có kèm Quận/Huyện theo thói quen (ví dụ: "Hà Nội - Quận Hoàn Kiếm").

(2) Chọn **Phường/Xã** tương ứng theo chuẩn cũ.

(3) Ngay sau khi chọn xong, hệ thống sẽ hiển thị thông báo gợi ý: ***Địa điểm này đã cập nhật thành*** *[Địa chỉ mới tương ứng]*.

(4) Nếu địa điểm gợi ý đã chính xác như thực tế → bạn nhấn ***Cập nhật*** để hệ thống tự động điền địa chỉ mới vào các ô ***Khu vực***, ***Phường/Xã***.

(5) Nhấn ***Lưu*** để hoàn tất.

### **3. Cập nhật địa chỉ từ cũ sang mới cho dữ liệu có sẵn**

* **Tình huống:** Bạn rà soát danh sách đối tác cũ và muốn cập nhật lại thông tin địa chỉ 3 cấp của họ sang chuẩn mới 2 cấp.
* **Thao tác thực hiện như sau:**

(1) Xem thông tin chi tiết đối tác (Khách hàng, Nhà cung cấp, Đối tác giao hàng, Bác sĩ).

(2) Hệ thống sẽ tự động kiểm tra và hiển thị gợi ý chuyển đổi ngay tại khu vực thông tin địa chỉ nếu phát hiện địa chỉ cũ có thể cập nhật.

(3) Bạn kiểm tra địa chỉ mới được gợi ý.

(4) Nhấn ***Cập nhật*** để thay đổi sang chuẩn mới.

## **III. Các tính năng nâng cao**

### **1. Lọc và Tìm kiếm theo địa bàn hành chính**

* **Tình huống:** Bạn cần lọc danh sách đơn hàng hoặc khách hàng theo khu vực địa lý để lên kế hoạch giao hàng hoặc chăm sóc, bao gồm cả các dữ liệu cũ và mới.
* **Thao tác thực hiện như sau:**

**​**(1) Tại bộ lọc **Khu vực giao hàng/Địa chỉ** trên các màn hình danh sách, bạn nhập từ khóa.

(2) Hệ thống cho phép chọn lọc theo địa chỉ mới (ví dụ: "Thành phố Hà Nội") hoặc địa chỉ cũ (ví dụ: "Hà Nội - Huyện Ba Vì").

(3) Kết quả sẽ hiển thị tương ứng với loại địa chỉ bạn đã chọn.

### **2. Xử lý khi một địa chỉ cũ tách thành nhiều địa chỉ mới**

* **Tình huống:** Một số Quận/Huyện hoặc Phường/Xã cũ bị chia tách hoặc sáp nhập, khiến một địa bàn cũ có thể tương ứng với nhiều địa bàn mới khác nhau.
* **Thao tác thực hiện như sau:**

(1) Khi bạn chỉnh sửa một đối tượng thuộc trường hợp này, hệ thống sẽ gợi ý một địa chỉ mới.

(2) Bạn cần **đối chiếu kỹ** thông tin thực tế của khách hàng/đối tác.

(3) Chọn địa chỉ chính xác trước khi nhấn ***Lưu***.

### **3. Tạo vận đơn giao hàng**

* **Tình huống:** Bạn tạo vận đơn qua các đối tác vận chuyển (GHN, GHTK, Viettel Post,...) và cần đảm bảo tính cước chính xác.
* **Thao tác thực hiện như sau:**
  + Bạn cần lưu ý: **Địa chỉ lấy hàng** và **Địa chỉ nhận hàng** bắt buộc cùng một định dạng (cùng 2 cấp mới hoặc cùng 3 cấp cũ) mới có thể tra cước và tạo vận đơn.
  + Hệ thống sẽ hiển thị cảnh báo yêu cầu cập nhật nếu:
    - Địa chỉ lấy và giao hàng thuộc 2 loại khác nhau.

* Hoặc địa chỉ không tương thích với đối tác vận chuyển.

* Đối với **Tạo vận đơn hàng loạt** (qua KShip):
  + Hệ thống hiển thị thông báo số đơn đang dùng địa chỉ nhận hàng khác định dạng lấy hàng và có thông tin cụ thể loại địa chỉ trên từng đơn.

* Bạn chỉ có thể xem trước phí và tạo vận đơn cho các đơn hàng có địa chỉ nhận hàng cùng loại với địa chỉ lấy hàng.

### **4. Import và Xuất file dữ liệu**

* **Tình huống:** Bạn cần nhập liệu hàng loạt từ file Excel hoặc xuất dữ liệu ra để báo cáo.
* **Thao tác thực hiện như sau:**
  + **Import:** File import cần đảm bảo định dạng địa chỉ đúng theo chuẩn (cũ hoặc mới), tránh trường hợp địa chỉ sai chính tả hoặc không tồn tại. Hệ thống sẽ tự động nhận diện, lưu trữ đúng loại địa chỉ bạn nhập.

* **Export:** Khi xuất file, hệ thống sẽ giữ nguyên định dạng địa chỉ đang được lưu trữ (cũ ra cũ, mới ra mới).

## **IV. Thao tác trên Điện thoại**

Tính năng **Áp dụng địa bàn hành chính mới** trên ứng dụng **KiotViet** giúp bạn tạo đơn giao hàng nhanh chóng.

* **Tình huống:** Bạn cần tạo đơn giao hàng trên ứng dụng điện thoại.
* **Thao tác thực hiện như sau:**
  + Khi tạo vận đơn, bạn cần lưu ý **Địa chỉ lấy hàng** và **Địa chỉ nhận hàng** bắt buộc cùng một định dạng (cùng 2 cấp mới hoặc cùng 3 cấp cũ) để có thể tra cước và tạo đơn. Hệ thống sẽ hiển thị cảnh báo yêu cầu cập nhật nếu:
    - Địa chỉ lấy và giao hàng thuộc 2 loại khác nhau.
...
*Tài liệu được cập nhật mới nhất ngày 12/12/2025*
