...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-ke-toan-hkd-hach-toan/hach-toan-nghiep-vu-khac-phieu-ke-toan-tong-hop/
---
...
Hỗ trợ
Kế toán HKD - Hạch toánHạch toán Nghiệp vụ khác (Phiếu Kế toán tổng hợp)
...
Khi hộ kinh doanh thiết lập hồ sơ khai thuế thuộc nhóm tính thuế TNCN theo lợi nhuận, trong nhóm chức năng "Thuế - Kế toán", phần mềm hỗ trợ tính năng Nghiệp vụ khác cho phép bạn lập phiếu kế toán tổng hợp thủ công để ghi nhận các khoản chi phí phát sinh ngoài quy trình bán hàng trên phần mềm KiotViet (ví dụ: chi phí dịch vụ mua ngoài, lãi vay).

Hệ thống tự động sinh các ghi nhận hạch toán kế toán theo từng loại chi phí và hỗ trợ khai báo thanh toán ngay trên phiếu mà không cần tạo phiếu chi riêng lẻ.

**Đối tượng áp dụng:** Chủ Hộ kinh doanh (HKD) đóng thuế theo thu nhập cần ghi nhận các khoản chi phí không đi qua luồng bán hàng thông thường (dịch vụ mua ngoài, lãi vay, chi phí khác) để đảm bảo sổ kế toán đầy đủ số liệu và tính đúng thuế Thu nhập doanh nghiệp (TNDN) cuối kỳ.

**Lợi ích nổi bật của tính năng:**

* Ghi nhận đầy đủ chi phí thực tế phát sinh ngoài phần mềm, không bị thiếu số liệu trên sổ kế toán.
* Tự động hạch toán chi phí và dòng tiền — bạn không cần phải tự nhập tay các tài khoản kế toán.
* Phân loại tính chất chi phí (Hợp lệ / Không hợp lệ) để phục vụ việc tính thuế TNDN một cách chính xác.

## **II. Các thao tác cơ bản**

### **1. Lập phiếu kế toán tổng hợp mới**

**Tình huống:** Khi bạn cần ghi nhận một khoản chi phí phát sinh bên ngoài luồng vận hành thông thường của phần mềm vào sổ kế toán.

Tại màn hình danh sách phiếu Kế toán tổng hợp, hệ thống hỗ trợ bạn tìm kiếm và lọc theo các tiêu chí như: số chứng từ, diễn giải, địa điểm kinh doanh, thời gian, loại chi phí, tính chất chi phí (hợp lệ hay không) và trạng thái thanh toán.

**Thao tác thực hiện như sau:**

* **Bước 1**: Trên màn hình **Quản lý**, truy cập vào menu **Thuế & Kế toán** → **Thuế & Kế toán** → chọn **Nghiệp vụ khác**.

* **Bước 2**: Nhấn ***+ Thêm mới*** ở góc trên bên phải để mở màn hình lập phiếu.
* **Bước 3**: Chọn ***Ngày giao dịch***. Đây là thông tin bắt buộc, hệ thống sẽ để mặc định là ngày hiện tại.
* **Bước 4**: Chọn ***Địa điểm kinh doanh*** (nếu cửa hàng có nhiều địa điểm). Hệ thống sẽ hiển thị địa điểm gắn với Mã số thuế của bạn. Trường thông tin này sẽ tự động ẩn đi nếu bạn chỉ có 1 địa điểm kinh doanh.
* **Bước 5**: Nhập ***Thông tin giao dịch***. Đây là các thông tin bắt buộc.
  + ***Số tiền*** nhập vào phải lớn hơn 0.
  + Chọn ***Loại chi phí*** (Dịch vụ mua ngoài, Lãi vay hoặc Khác).
  + Chọn ***Tính chất chi phí*** (Chi phí hợp lệ hoặc Chi phí không hợp lệ). Việc lựa chọn này sẽ ảnh hưởng trực tiếp đến việc tính thuế TNDN, vì hệ thống chỉ tính thuế trên các khoản được đánh dấu là chi phí hợp lệ.
* **Bước 6**: Khai báo ***Thông tin thanh toán***: Chưa thanh toán (mặc định) hoặc Đã thanh toán.
* **Bước 7**: Nhấn ***Lưu***.

* **Bước 8**: Hệ thống sẽ tự động sinh số chứng từ và ghi nhận chi phí này vào **Sổ doanh thu & chi phí (S2c-HKD)**.

### **2. Sửa thông tin phiếu kế toán tổng hợp**

**Tình huống:** Khi bạn cần thay đổi hoặc cập nhật thông tin trên phiếu đã lập (ví dụ: cập nhật trạng thái thanh toán nếu thực tế thanh toán khác lúc lập phiếu ban đầu) mà không cần phải xóa đi và tạo lại phiếu mới.

**Thao tác thực hiện như sau:**

* **Bước 1**: Trên màn hình **Nghiệp vụ khác**, bạn tìm và chọn phiếu cần sửa → nhấn ***Chỉnh sửa***.
* **Bước 2**: Thay đổi thông tin.
* **Bước 3**: Nhấn ***Lưu***.

**Lưu ý**: Bạn không thể sửa thông tin của các phiếu thuộc kỳ kế toán đã khóa sổ.

### **3. Xóa phiếu kế toán tổng hợp**

**Tình huống:** Khi bạn lập sai phiếu hoặc không còn nhu cầu ghi nhận khoản chi phí đó và muốn xóa bỏ hoàn toàn khỏi hệ thống.

**Thao tác thực hiện như sau:**

* **Bước 1**: Trên màn hình **Nghiệp vụ khác**, bạn tìm và chọn phiếu cần xóa → nhấn ***Xóa***.
* **Bước 2**: Xác nhận ***Đồng ý***.

**Lưu ý**: Bạn không thể xóa các phiếu thuộc kỳ kế toán đã khóa sổ.

## **III. Các tính năng nâng cao**

### **1. Khai báo thanh toán ngay khi lập phiếu**

**Tình huống:** Nếu khoản chi phí đã được thanh toán ngay tại thời điểm bạn lập phiếu, bạn có thể khai báo luôn thông tin này để hệ thống tự động sinh thêm phiếu chi mà không cần bạn phải ra ngoài tạo một phiếu chi riêng lẻ.

**Thao tác thực hiện như sau:**

* **Bước 1**: Tại khu vực ***Thông tin thanh toán*** trên màn hình lập phiếu, chọn ***Đã thanh toán***.
* **Bước 2**: Bắt buộc chọn ***Phương thức***: Tiền mặt hoặc Chuyển khoản.
* **Bước 3**: Nếu chọn hình thức ***Chuyển khoản***, bạn cần chọn ***Tài khoản ngân hàng*** từ danh sách các tài khoản đã được cấu hình trước đó trong **Sổ quỹ**.
* **Bước 4**: Chọn ***Ngày thanh toán***. Mặc định hệ thống lấy bằng ngày giao dịch, nhưng bạn có thể chọn một ngày khác nếu thực tế ngày thanh toán khác với ngày bạn lập phiếu.
* **Bước 5**: Nhấn ***Lưu***.

* **Bước 6**: Hệ thống sẽ tự sinh đồng thời:
  + Bút toán chi phí ghi **Sổ doanh thu & chi phí (S2c-HKD)**.

* Bút toán tiền ghi **Sổ tiền (S2e-HKD)**.

* Phiếu chi tương ứng trong phân hệ **Thu - Chi**.
