...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-thanh-toan/thanh-toan-qua-vietinbank/
---
...
Nhằm hỗ trợ các gian hàng thúc đẩy việc thanh toán phi tiền mặt, KiotViet kết hợp cùng ngân hàng VietinBank đã ra mắt tính năng thanh toán chuyển khoản bằng phương pháp quét mã VietQR và nhận thông báo kết quả ngay trên phần mềm.

* **Đối tượng áp dụng:** Tất cả gian hàng trên KiotViet (bao gồm cả gian hàng dùng thử và gian hàng chính thức) có tài khoản cá nhân, hộ kinh doanh tại ngân hàng VietinBank.
* **Lợi ích nổi bật của tính năng:**
  + **Giúp chủ cửa hàng và quản lý**: Dễ dàng đăng ký và quản lý nhiều tài khoản VietinBank trên cùng một gian hàng, giúp việc đối soát và theo dõi dòng tiền trở nên đơn giản và tập trung.
...
**Tóm tắt luồng hoạt động:** Về cơ bản, luồng hoạt động của tính năng bao gồm 2 bước chính: 1. Đăng ký dịch vụ nhận thông báo thanh toán của VietinBank -> 2. Nhận thông báo kết quả giao dịch trên màn hình **Bán hàng**.
...
* **Lưu ý về nguyên tắc liên kết tài khoản VietinBank**:
  + Một gian hàng KiotViet có thể liên kết với **nhiều tài khoản VietinBank**.
  + Một tài khoản VietinBank tại một thời điểm **chỉ có thể liên kết với một gian hàng KiotViet duy nhất**. Nếu muốn sử dụng tài khoản cho gian hàng khác, bạn cần hủy liên kết ở gian hàng cũ trước.

Quá trình này được thực hiện như sau:

#### **1.1. Đăng ký dịch vụ trên KiotViet**

– Tài khoản admin của chủ gian hàng đăng nhập vào màn hình **Quản lý**, chọn mục **Thanh toán** và nhấn ***Đăng ký*** tại thẻ **VietinBank**.
...
* Hoặc trên màn hình **Bán hàng**,
  ...
  + Hay khi tạo đơn hàng, bạn chọn phương thức thanh toán ***Chuyển khoản*** -> chọn tài khoản Vietinbank -> nhấn ***Nhận thông báo tiền về***

– Tiếp theo, bạn chọn số tài khoản VietinBank cần đăng ký, điền đầy đủ các thông tin giao dịch và chọn ***Đăng ký***.

**​Lưu ý**: Với tài khoản hộ kinh doanh, bạn vui lòng nhập số đăng ký kinh doanh tại ô ***Số CCCD***.

#### **1.2. Xác thực bằng mã OTP**

– Sau khi nhấn **Đăng ký**, hệ thống sẽ gửi một mã OTP đến số điện thoại bạn đã đăng ký với ngân hàng VietinBank.
...
* **Thao tác trên màn hình** **Bán hàng**:  
  – Khi tạo hóa đơn, bạn chọn phương thức thanh toán ***Chuyển khoản*** để hiển thị mã QR của tài khoản VietinBank đã liên kết.  
...
* Để gia tăng hiệu quả và tốc độ xử lý đơn hàng, bạn có thể kết hợp dịch vụ thông báo thanh toán của Vietinbank với các tiện ích như:
...
### **1. Xem danh sách tài khoản VietinBank đã đăng ký dịch vụ**

* **Tình huống**: Khi bạn cần kiểm tra lại thông tin các tài khoản VietinBank nào đang được kết nối để nhận thông báo tự động trên KiotViet.
* **Thao tác thực hiện như sau**:

1. Tại màn hình **Quản lý**, vào menu **Thanh toán**.
2. Chọn thẻ **Vietinbank** và nhấn **Xem chi tiết** để xem danh sách các tài khoản đã liên kết.

### **2. Hủy dịch vụ nhận thông báo thanh toán VietinBank**

* **Tình huống**: Khi bạn không còn nhu cầu sử dụng dịch vụ nhận thông báo tự động cho một tài khoản VietinBank cụ thể hoặc muốn chuyển sang gian hàng khác.
* **Thao tác thực hiện như sau**:
...
3. Nhập mã **OTP** được gửi về số điện thoại đăng ký tài khoản VietinBank và nhấn **Xác nhận** để hoàn tất.
...
* Chọn thẻ VietinBank, điền các thông tin cần thiết và nhấn ***Tiếp tục***.
...
* Truy cập mục **Thanh toán** và chọn thẻ **VietinBank**.
* Ứng dụng sẽ hiển thị danh sách các tài khoản đã liên kết thành công.

* Để đăng ký mới hoặc hủy dịch vụ, bạn thực hiện các thao tác tương tự như trên website, bao gồm cả bước xác thực bằng OTP khi hủy.
