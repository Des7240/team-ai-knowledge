...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-thiet-bi-phan-cung/ngan-keo-dung-tien/
---
...
Tài liệu này cung cấp hướng dẫn chi tiết để kết nối và sử dụng ngăn kéo đựng tiền chuyên dụng với hệ thống bán hàng KiotViet. Ngăn kéo đựng tiền là một thiết bị thiết yếu tại quầy thu ngân, giúp bảo quản tiền mặt an toàn và tối ưu hóa quy trình thanh toán.

**3 Lợi ích nổi bật của tính năng:**

* **Bảo mật và an toàn:** Giúp chủ cửa hàng quản lý tiền mặt hiệu quả, hạn chế thất thoát nhờ chất liệu thép chắc chắn và chỉ mở khi có lệnh thanh toán hoặc dùng chìa khóa cơ.
* **Tối ưu quy trình thanh toán:** Hỗ trợ nhân viên thu ngân thao tác nhanh hơn khi ngăn kéo tự động bật ra sau mỗi lần in hóa đơn, giúp giảm thời gian phục vụ khách hàng.
* **Quản lý tiền mặt khoa học:** Giúp nhân viên dễ dàng phân loại và sắp xếp các mệnh giá tiền trong 7 ngăn riêng biệt, giúp việc thối tiền cho khách trở nên chính xác và nhanh chóng.

## **II. Các Thao Tác Cơ Bản**

Để dễ hình dung, các ví dụ dưới đây sẽ minh họa những tình huống thực tế.

**1. Giới thiệu tổng quan về ngăn kéo đựng tiền**

* **Tình huống:** Trước khi lắp đặt, bạn cần nắm rõ các thông số, ưu điểm và phụ kiện đi kèm của thiết bị.
* **Thông tin thiết bị:** 
  + **Thông số kỹ thuật:** 
    - Chất liệu: Thép dày, mạ kẽm, sơn tĩnh điện.
    - Kích thước: 405mm (ngang) x 420mm (sâu) x 100mm (cao).
    - Số ngăn: 7 ngăn đựng tiền giấy.
    - Kết nối: Tương thích với tất cả các loại máy in hóa đơn có cổng RJ11.
    - Độ bền: Tối thiểu 1 triệu lần đóng mở.
    - Trọng lượng: 6 kg.

* **Ưu điểm nổi bật:** 
  + **Thiết kế chắc chắn:** Vỏ thép dày và sơn tĩnh điện chống gỉ sét, đảm bảo độ bền cao trong môi trường kinh doanh.
  + **Hoạt động tin cậy:** Cơ chế đóng mở bằng cơ học có độ bền cao, đảm bảo hoạt động trơn tru sau hàng triệu lần sử dụng.
  + **Kết nối đơn giản:** Dễ dàng kết nối với máy in hóa đơn qua một cổng kết nối duy nhất.
* **Phụ kiện đi kèm:** 
  + 1 ngăn kéo đựng tiền.
  + 2 chìa khóa cơ.

**2. Kết nối vật lý**

* **Tình huống:** Bạn cần kết nối ngăn kéo đựng tiền vào hệ thống bán hàng để có thể kích hoạt tự động.
* **Thao tác thực hiện:** 
  1. Lấy dây cáp kết nối (đầu cắm giống dây điện thoại bàn).
  2. Cắm vào cổng **Cash Drawer (hoặc có biểu tượng ngăn kéo)** trên máy in hóa đơn của bạn.

**3. Cấu hình tự động mở trên máy tính**

* **Tình huống:** Bạn muốn ngăn kéo tự động bật ra mỗi khi hoàn tất một giao dịch và in hóa đơn từ máy tính Windows.
* **Thao tác thực hiện:**

1. Trên máy tính, mở **Control Panel** và chọn mục **View devices and printers**.

2. Nhấn tượng máy in hóa đơn bạn đang sử dụng, chọn **Printer Properties**.

3. Trong cửa sổ mới, chuyển qua tab **Device Settings**.

4. Tìm đến mục **Cash** Select (hoặc tương tự), chọn tùy chọn **After Printing** (Mở sau khi in) từ danh sách thả xuống.

5. Nhấn **Apply** -> **OK** để lưu lại cấu hình.

## **IV. Thao tác trên Điện thoại**

* **Tình huống:** Bạn muốn ngăn kéo đựng tiền tự động mở khi bạn in hóa đơn từ ứng dụng quản lý bán hàng KiotViet trên điện thoại.
* **Thao** tác trên **ứng dụng KiotViet:**

1. ​Trong ứng dụng, vào menu **Nhiều hơn -> Ứng dụng và thiết bị** -> **Cài đặt máy in hóa đơn.**

2. Tìm và bật tùy chọn **"Mở ngăn kéo đựng tiền "**. Thao tác này đơn giản hơn nhiều so với trên máy tính.

3. Khi tạo đơn hàng trên điện thoại và in hóa đơn thành công, ngăn kéo đựng tiền sẽ tự động mở.​

## **V. Thao tác trên Máy POS**

* **Tình huống:** Bạn muốn ngăn kéo đựng tiền kết nối với máy in tự động mở khi bạn in hóa đơn từ máy POS Android của KiotViet.
* **Thao tác trên ứng dụng KiotViet:** 
  1. Trên màn hình ứng dụng bán hàng của máy POS, vào mục **Cài đặt**.

2. Chọn **Cài đặt máy in**.
3. Trong phần cấu hình của máy in đang kết nối, tìm và bật tùy chọn **"Mở ngăn kéo đựng tiền"**.​

4. Khi tạo đơn hàng trên máy POS và in hóa đơn thành công, ngăn kéo đựng tiền sẽ tự động mở​
