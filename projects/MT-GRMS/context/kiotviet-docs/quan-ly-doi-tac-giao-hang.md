...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-giao-van/quan-ly-doi-tac-giao-hang/
---
...
Tính năng Quản lý Đối tác giao hàng giúp bạn theo dõi và quản lý tập trung tất cả các đơn vị vận chuyển, bao gồm cả các hãng vận chuyển (hãng vận chuyển) có tích hợp sẵn với KiotViet và các đối tác giao hàng riêng của cửa hàng.

**Lợi ích nổi bật của tính năng Quản lý Đối tác giao hàng trên KiotViet:**

* **Quản lý tập trung:** Dễ dàng theo dõi thông tin, lịch sử giao dịch và công nợ của tất cả các đối tác vận chuyển tại một nơi duy nhất.
* **Đối soát tự động:** Đối với các đối tác tích hợp, KiotViet hỗ trợ xem lịch sử đối soát và xác nhận thanh toán nhanh chóng, giảm thiểu sai sót thủ công.
* **Linh hoạt và chủ động:** Dễ dàng thêm mới, cập nhật hoặc ngừng hoạt động các đối tác giao hàng riêng, không tích hợp để phù hợp với mô hình kinh doanh.
* **Quản lý mọi lúc, mọi nơi:** Thực hiện các thao tác quản lý cơ bản ngay trên **ứng dụng KiotViet**, giúp bạn nắm bắt tình hình vận hành ngay cả khi không ở cửa hàng.

## **II. Quản lý đối tác giao hàng tích hợp**

Các thao tác trong phần này dành riêng cho việc quản lý các hãng vận chuyển đã được tích hợp sẵn trên hệ thống KiotViet.

### **1. Theo dõi lịch sử giao hàng**

* **Tình huống:** Khi bạn sử dụng các hãng vận chuyển có tích hợp sẵn với KiotViet, bạn muốn xem toàn bộ lịch sử giao hàng qua các đối tác này ở một nơi duy nhất.
* **Thao tác thực hiện như sau:**

1. Trong mục **Đối tác giao hàng**, chọn tab **Tích hợp**.
2. Nhấn vào **Lịch sử giao hàng**.
3. Hệ thống sẽ hiển thị danh sách tất cả hóa đơn được giao qua các hãng vận chuyển tích hợp. Bạn có thể tìm kiếm theo mã hóa đơn, mã đối tác giao hàng, mã vận đơn và trạng thái.
4. Sử dụng nút **Xuất file** để tải về báo cáo chi tiết.

### **2. Xem và xử lý Lịch sử đối soát**

* **Tình huống:** Các đối tác giao hàng tích hợp sẽ gửi các phiếu đối soát định kỳ. Bạn cần kiểm tra, xác nhận và thực hiện thanh toán các khoản tiền COD thu hộ và phí dịch vụ một cách chính xác.
* **Thao tác thực hiện như sau:**

1. Trong tab **Tích hợp**, chọn **Lịch sử đối soát**.

2. Hệ thống hiển thị danh sách các phiếu đối soát. Bạn có thể nhấn vào mã đối soát để xem chi tiết.

3. Trong chi tiết phiếu, hệ thống sẽ phân tích rõ các khoản: COD kỳ này, Phí phải trả, Phát sinh kỳ trước, và số tiền Thanh toán kỳ này.
4. **Nếu thông tin đã chính xác:** 
   * Nhấn **Xác nhận** (với số tiền bạn nhận về ≥ 0).
   * Nhấn **Thanh toán** (với số tiền bạn phải trả < 0).
   * Nhấn **Đồng ý** để hệ thống tự động tạo các phiếu thu/chi tương ứng vào Sổ quỹ.
5. **Nếu có vận đơn bị lệch thông tin:** Hệ thống sẽ thông báo. Bạn cần khớp lại thông tin phí hoặc yêu cầu hỗ trợ từ KiotViet trước khi có thể thanh toán.

## **III. Quản lý đối tác giao hàng riêng của cửa hàng**

Các thao tác trong phần này áp dụng cho các đối tác giao hàng riêng, không nằm trong danh sách tích hợp sẵn của KiotViet.

### **1. Thêm mới một đối tác giao hàng**

* **Tình huống:** Khi bạn bắt đầu hợp tác với một đơn vị vận chuyển mới chưa có sẵn trên KiotViet, bạn cần thêm thông tin của họ vào hệ thống để quản lý các đơn hàng và công nợ liên quan.
* **Thao tác thực hiện như sau:**

1. Tại màn hình **Quản lý**, bạn vào mục **Đơn hàng** → **Đối tác giao hàng**.
2. Chọn tab **Khác**, sau đó nhấn nút ***+ Đối tác giao hàng***.

3. Điền các thông tin cần thiết (***Tên đối tác*** là bắt buộc) và nhấn ***Lưu***.

### **2. Cập nhật thông tin đối tác giao hàng**

* **Tình huống:** Khi đối tác giao hàng của bạn có sự thay đổi về thông tin liên hệ hoặc các chi tiết khác, bạn cần cập nhật lại trên hệ thống để đảm bảo dữ liệu luôn chính xác.
* **Thao tác thực hiện như sau:**

1. Tại tab **Khác**, tìm và chọn đối tác giao hàng bạn muốn chỉnh sửa.
2. Nhấn ***Chỉnh sửa***.
3. Thay đổi các thông tin cần thiết.
4. Nhấn ***Lưu*** để xác nhận.

### **3. Ngừng hoặc cho phép hoạt động đối tác giao hàng**

* **Tình huống:** Khi bạn tạm thời không sử dụng dịch vụ của một đối tác, bạn có thể tạm ngưng hoạt động của họ thay vì xóa hẳn để giữ lại lịch sử giao dịch.
* **Thao tác thực hiện như sau:**

1. Tại tab **Khác**, tìm và chọn đối tác bạn muốn xử lý.
2. Nhấn ***Ngừng hoạt động*** và ***Đồng ý*** để xác nhận. Đối tác sẽ không thể được chọn cho các giao dịch mới nhưng thông tin cũ vẫn được lưu trữ.

3. Để kích hoạt lại, bạn chỉ cần chọn đối tác đó và nhấn ***Cho phép hoạt động***.

### **4. Xóa đối tác giao hàng**

* **Tình huống:** Khi bạn không còn hợp tác với một đối tác và muốn xóa họ khỏi danh sách, bạn có thể thực hiện thao tác này.
* **Thao tác thực hiện như sau:**

1. Tại tab **Khác**, tìm và chọn đối tác bạn muốn xóa.
2. Nhấn ***Xóa*** và ***Đồng ý*** để xác nhận. **Lưu ý**: Hệ thống sẽ xóa hoàn toàn thông tin đối tác, nhưng các giao dịch lịch sử liên quan vẫn được giữ lại và tên đối tác sẽ có thêm hậu tố {DEL}.

### **5. Theo dõi và cập nhật lịch sử giao hàng**

* **Tình huống:** Bạn cần xem lại danh sách các đơn hàng đã gửi qua một đối tác cụ thể và cập nhật trạng thái mới cho một số đơn hàng (ví dụ: đã giao thành công, đang chuyển hoàn).
* **Thao tác thực hiện như sau:**

1. Tại tab **Khác**, chọn đối tác giao hàng cần xem.
2. Chuyển sang tab **Lịch sử giao hàng** để xem danh sách các phiếu giao hàng.
3. Để cập nhật hàng loạt, nhấn nút ***Cập nhật giao hàng***.

4. Chọn các hóa đơn cần thay đổi, chỉnh sửa thông tin trạng thái.
5. Nhấn ***Lưu*** để hoàn tất.

### **6. Thanh toán cho đối tác giao hàng**

* **Tình huống:** Đến kỳ hạn, bạn cần tổng hợp các hóa đơn và thực hiện thanh toán phí giao hàng cho đối tác.
* **Thao tác thực hiện như sau:**

1. Trong tab **Lịch sử giao hàng** của đối tác, nhấn nút **Thanh toán**.

2. Chọn các hóa đơn bạn muốn thanh toán trong kỳ này → nhấn ***Thanh toán***.

3. Hệ thống sẽ hiển thị tổng số tiền cần thanh toán tương ứng với **Loại thanh toán**: ***Thanh toán COD và phí trả đối tác giao hàng*** → nhấn ***Tạo phiếu thu, chi*** để ghi nhận giao dịch vào **Sổ quỹ**.

Bạn có thể chọn lại **Loại thanh toán**: ***Tiền thu hộ (COD)*** hoặc P***hí trả đổi tác giao hàng*** để ***Tạo phiếu thu*** hoặc ***Tạo phiếu chi*** tương ứng.

### **7. Điều chỉnh phí cần trả**

* **Tình huống:** Có một sự thay đổi về công nợ với đối tác giao hàng (ví dụ: chiết khấu, phụ phí) không gắn liền với một hóa đơn cụ thể. Bạn cần điều chỉnh lại tổng nợ phải trả cho họ.
* **Thao tác thực hiện như sau:**

1. Tại tab **Khác**, chọn đối tác và chuyển sang tab **Phí cần trả đối tác GH**.
2. Nhấn nút **Điều chỉnh**.

3. Nhập số tiền nợ mới và lý do điều chỉnh.
4. Nhấn ***Chỉnh sửa***. Hệ thống sẽ tự động sinh một phiếu điều chỉnh nợ.

### **8. Nhập và Xuất danh sách qua file Excel**

* **Tình huống:** Khi bạn mới bắt đầu sử dụng KiotViet và đã có sẵn một danh sách các đối tác giao hàng, bạn muốn nhập hàng loạt danh sách này vào hệ thống để tiết kiệm thời gian. Hoặc bạn cần xuất danh sách ra để làm báo cáo.
* **Thao tác thực hiện như sau:** 
  + **Để nhập file:**

1. Tại tab **Khác**, nhấn nút **Import**.
2. Tải về file mẫu để điền thông tin theo đúng định dạng.
3. Nhấn ***Chọn file dữ liệu*** và ***Thực hiện*** tải file đã chuẩn bị lên.

* **Để xuất file:** Tại tab **Khác**, nhấn nút **Xuất file**. Hệ thống sẽ tải về một file Excel chứa danh sách các đối tác đang hiển thị trên màn hình.

### **9. Tìm kiếm và Sắp xếp danh sách**

* **Tình huống:** Khi danh sách đối tác giao hàng của bạn ngày càng nhiều, bạn cần một công cụ để nhanh chóng tìm thấy thông tin của một đối tác cụ thể hoặc sắp xếp danh sách theo một tiêu chí nhất định (ví dụ: sắp xếp theo nợ hiện tại).
* **Thao tác thực hiện như sau:**

1. Sử dụng thanh tìm kiếm theo mã, tên, số điện thoại cửa đối tác giao hàng và bộ lọc như: Nhóm ĐTGH, Tổng phí giao hàng, Thời gian, Nợ hiện tại, Trạng thái để tìm kiếm thông tin.
2. Nhấn vào tiêu đề của các cột (Mã đối tác, Tên đối tác, Nợ cần trả,...) để sắp xếp danh sách theo thứ tự tăng dần hoặc giảm dần.

## **IV. Thao tác trên Điện thoại**

Tính năng Quản lý Đối tác giao hàng trên ứng dụng di động hỗ trợ cửa hàng thực hiện các thao tác: xem danh sách, xem chi tiết thông tin, tra cứu lịch sử giao dịch và công nợ.

* **Tình huống:** Bạn đang ở ngoài và cần gấp số điện thoại của một đối tác giao hàng để xử lý đơn hàng. Bạn cũng muốn xem nhanh công nợ hiện tại với họ.
* **Thao tác thực hiện như sau:**

1. Mở **ứng dụng KiotViet**, vào menu **Nhiều hơn** → **Đối tác GH**.

2. Sử dụng thanh tìm kiếm hoặc bộ lọc để nhanh chóng tìm thấy đối tác cần tra cứu.

3. Chạm vào tên đối tác để xem **Thông tin** chi tiết, **Lịch sử** giao dịch, **Phí cần trả**.
