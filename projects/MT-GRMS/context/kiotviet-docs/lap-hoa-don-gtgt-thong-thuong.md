...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-phat-hanh-hddt/lap-hoa-don-gtgt-thong-thuong/
---
...
Hỗ trợ
Phát hành HĐĐT​Lập hóa đơn GTGT (Thông thường)
...
* **Bước 1:** Truy cập menu **Hóa đơn** → chọn **Hóa đơn giá trị gia tăng**

* **Bước 2:** Nhấn ***+ Lập hóa đơn*** → chọn ***Hóa đơn GTGT***.

* **Bước 3:** Hệ thống hiển thị màn hình **Lập hóa đơn GTGT**.
...
* **Bước 3:** Nhập Mã số thuế vào ô **Mã số thuế**, sau đó nhấn nút **Tra cứu MST** để hệ thống tự động lấy dữ liệu điền Tên khách hàng/Đơn vị và Địa chỉ.
* **Bước 4:** Kiểm tra và bổ sung các trường còn lại: Địa chỉ, Email, Số điện thoại, Hình thức thanh toán, Tên ngân hàng, Số tài khoản.
...
**Lưu ý**: Nếu bạn phát hành hóa đơn có ngày lập khác với ngày hiện tại (hóa đơn ghi lùi ngày) → hệ thống sẽ hiển thị cảnh báo yêu cầu bạn xác nhận trước khi tiếp tục. Điều này giúp tránh việc vô tình phát hành sai thời điểm quy định.
...
* Sau khi phát hành hóa đơn điện tử, hệ thống ký số và gửi hóa đơn lên CQT theo cấu hình thiết lập. Danh sách hóa đơn hiển thị gồm các trạng thái sau:
  ...
  + ***CQT từ chối cấp mã***: Cửa hàng cần kiểm tra thông báo sai sót.
...
* **Bước 1: Truy cập và chuẩn bị file dữ liệu**
  + Trên màn hình **Hóa đơn giá trị gia tăng** bạn nhấn nút ***Import file*** ở góc trên bên phải màn hình.
...
### **7. Chỉnh sửa và phát hành hàng loạt hóa đơn nháp**
...
### **10. Xem thông báo phản hồi từ Cơ quan Thuế (mẫu 01/TB-SSĐT)**
