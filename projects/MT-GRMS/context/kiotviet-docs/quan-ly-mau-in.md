...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-thiet-lap/quan-ly-mau-in/
---
...
Tính năng **Mẫu in** cho phép bạn tùy chỉnh nội dung và hình thức của các loại phiếu in (hóa đơn, đơn đặt hàng, phiếu trả hàng...) cho phù hợp với đặc thù kinh doanh. Bạn có thể chủ động thiết kế các mẫu in vừa ngắn gọn, đầy đủ thông tin, vừa thể hiện được hình ảnh thương hiệu của cửa hàng.

**Lợi ích nổi bật của tính năng Mẫu in trên KiotViet:**

* **Chủ động thiết kế:** Bạn có thể tự tạo và chỉnh sửa nhiều mẫu in khác nhau cho cùng một loại giao dịch (ví dụ: hóa đơn A4, hóa đơn K80), đáp ứng đa dạng nhu cầu sử dụng.
* **Cung cấp đầy đủ thông tin:** Đảm bảo các phiếu in có đủ thông tin cần thiết để bạn và khách hàng dễ dàng tra cứu, đối soát khi cần.
* **Tăng nhận diện thương hiệu:** Bạn có thể thêm logo, thông tin cửa hàng, hoặc các thông điệp quảng cáo lên mẫu in, biến mỗi hóa đơn thành một công cụ marketing hiệu quả.
...
**Tình huống:** Cửa hàng của bạn muốn tạo thêm một mẫu in hóa đơn khổ K80 để sử dụng tại quầy thu ngân, trên đó có hiển thị logo và thông tin khuyến mại mới.

**Thao tác thực hiện như sau:**

* **Bước 1:** Tại màn hình **Quản lý**, bạn vào **Thiết lập** → **Xem tất cả** **thiết lập** → chọn **Mẫu in**.

* **Bước 2:** Nhấn ***+ Tạo mẫu in***  → chọn loại giao dịch cần thêm mẫu (ví dụ: **Hóa đơn**).

* **Bước 3:** Bạn điền ***Tên mẫu in***, ***chọn*** ***mẫu in gợi ý*** và tùy chỉnh nội dung chi tiết trong trình soạn thảo.

* Hệ thống hỗ trợ các "token" (mã dữ liệu) có sẵn để bạn chèn thông tin động vào mẫu in.
  + Để chèn token vào mẫu in, bạn gõ / → nhập tên token → chọn trên danh sách.

* Để xem danh sách các token, bạn nhấn ***chèn thông tin***.

* Để khôi phục mẫu in về trạng thái ban đầu, bạn nhấn ***Đặt lại*** → xác nhận ***Đặt lại*** → tất cả thay đổi hiện tại sẽ bị xóa và không thể hoàn tác.

* Tại khung ***Xem trước mẫu in*** bên phải màn hình, bạn có thể chọn ***Khổ*** giấy để xem trước mẫu in theo khổ giấy tương ứng.

* Bạn có thể nhấn ***In thử*** để kiểm tra mẫu in thể hiện thực tế trên giấy.

* **Bước 4:** Nhấn ***Lưu mẫu*** để hoàn tất.

**Lưu ý**:

* Với các loại mẫu in **Đặt hàng**, **Hóa đơn**, **Hóa đơn sửa chữa**, **Yêu cầu sửa chữa**, **Phiếu bảo hành mỗi hàng**, **Phiếu bảo hành DS hàng**, **Trả hàng**, **Đổi trả hàng**, hệ thống hỗ trợ tối đa 5 mẫu in mỗi loại.
* Với các loại mẫu in khác, hệ thống hỗ trợ chỉnh sửa, không hỗ trợ tạo mới.

### **2. Sửa mẫu in**

**Tình huống:** Do thay đổi địa chỉ kinh doanh, bạn cần cập nhật lại thông tin này trên tất cả các mẫu hóa đơn đang sử dụng.

**Thao tác thực hiện như sau:**

* **Bước 1:** Tại màn hình **Quản lý** **mẫu in**, chọn mẫu in cần sửa → nhấn ***Sửa***.
...
**Tình huống:** Bạn đã tạo một vài mẫu in hóa đơn nháp để thử nghiệm. Để dọn dẹp và tránh gây nhầm lẫn cho nhân viên, bạn muốn xóa các mẫu không còn sử dụng.

**Thao tác thực hiện như sau:**

* **Bước 1:** Tại màn hình **Quản lý** **mẫu in**, chọn mẫu in cần xóa.
* **Bước 2:** Nhấn ***Xóa***.
* **Bước 3:** Xác nhận ***Đồng ý***.

## **III. Các tính năng nâng cao**

### **1. Lựa chọn mẫu in trực tiếp tại màn hình Bán hàng**

**Tình huống:** Cửa hàng của bạn có 2 mẫu hóa đơn: một mẫu chi tiết đầy đủ cho khách hàng doanh nghiệp và một mẫu rút gọn cho khách lẻ. Khi thanh toán, nhân viên cần chọn đúng mẫu để in.

**Thao tác thực hiện như sau:**

* **Bước 1:** Tại màn hình **Bán hàng**, bạn nhấn vào biểu tượng máy in.
* **Bước 2:** Một danh sách các mẫu in đã thiết lập cho giao dịch Hóa đơn sẽ hiện ra.
* **Bước 3:** Chọn mẫu in mong muốn và nhấn **Xong**. Biểu tượng máy in sẽ thay đổi để hiển thị ký hiệu của mẫu đã chọn (A, B, hoặc C), giúp bạn dễ dàng nhận biết.
* **Bước 4:** Tiến hành thanh toán và in hóa đơn như bình thường.

### **2. In lại giao dịch với mẫu in tùy chọn**

**Tình huống:** Một khách hàng quay lại và yêu cầu in lại hóa đơn của giao dịch tuần trước. Bạn cần tìm lại hóa đơn đó trong hệ thống và có thể chọn một mẫu in khác (ví dụ: mẫu A4 thay vì K80) để in cho khách.

**Thao tác thực hiện như sau:**

* **Bước 1:** Từ màn hình **Quản lý**, bạn truy cập vào danh sách các giao dịch (ví dụ: **Đơn hàng** → **Hóa đơn**).
* **Bước 2:** Tìm và mở chi tiết hóa đơn cần in lại.
* **Bước 3:** Nhấn vào nút **In**.
* **Bước 4:** Hệ thống sẽ hiển thị cửa sổ **Chọn mẫu in**. Bạn lựa chọn mẫu in phù hợp và nhấn **In**.

* **Bước 5:** Đối với việc in hàng loạt nhiều giao dịch, bạn chỉ cần tích chọn các giao dịch cần in từ màn hình danh sách → chọn ***In*** và thực hiện chọn mẫu in tương tự.
