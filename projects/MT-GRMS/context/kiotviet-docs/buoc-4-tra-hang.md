...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-lam-quen-voi-kiotviet/buoc-4-tra-hang/
---
...
Trong kinh doanh, việc khách hàng trả lại sản phẩm là không thể tránh khỏi. Tính năng Trả hàng của KiotViet giúp bạn xử lý các tình huống này một cách chuyên nghiệp và chính xác, đảm bảo số lượng tồn kho và dòng tiền của cửa hàng được cập nhật lại đúng với thực tế.

**Lợi ích nổi bật của tính năng**:

* **Tự động cập nhật lại tồn kho**: Giúp chủ cửa hàng và nhân viên kho đảm bảo sản phẩm được trả lại sẽ tự động cộng vào tồn kho, cung cấp số liệu chính xác để bán hàng.
* **Quản lý dòng tiền chính xác**: Hỗ trợ thu ngân và chủ cửa hàng ghi nhận rõ ràng số tiền hoàn lại cho khách, giúp việc đối soát thu - chi cuối ngày trở nên dễ dàng.
* **Minh bạch hóa giao dịch**: Giúp nhân viên bán hàng và quản lý liên kết giao dịch trả hàng với hóa đơn gốc, đảm bảo tính chính xác và tránh gian lận.

## **II. Thao tác Trả hàng**

Để dễ hình dung, các ví dụ dưới đây sẽ minh họa những tình huống kinh doanh thực tế.

**Tình huống**: Khi bạn cần xử lý trường hợp khách hàng trả lại một sản phẩm đã mua (ví dụ: 1 thùng "Sữa tươi Ba Vì - Vani") và cửa hàng của bạn có chính sách thu phí dịch vụ (ví dụ: 20,000đ) cho mỗi lần trả hàng.

**Thao tác thực hiện như sau**:

* **Bước 1:** **Truy cập màn hình Trả hàng**: Từ màn hình **Bán hàng**, nhấn vào biểu tượng mũi tên để vào mục **Trả hàng**.

* **Bước 2:** **Tìm và chọn hóa đơn gốc**: Sử dụng ô tìm kiếm để tra cứu theo mã hóa đơn, tên khách hàng hoặc tên sản phẩm. Chọn hóa đơn gốc tương ứng.

* **Bước 3:** **Nhập số lượng hàng trả**. Chọn sản phẩm khách trả và nhập số lượng là 1 thùng. Hệ thống sẽ tự động hiển thị số tiền cần hoàn là 320,000đ.

* **Bước 4:** **Áp dụng phí trả hàng (nếu có)**:
  + Nhập 20,000 vào ô **Phí trả hàng**.
  + Hệ thống sẽ tự động tính lại số tiền cuối cùng cần hoàn cho khách chỉ còn 300,000đ.

* **Bước 5:** **Chọn phương thức hoàn tiền và Hoàn tất**:
  + Chọn phương thức hoàn tiền, ví dụ: **Tiền mặt**.
  + Nhấn nút **Trả hàng** để hoàn tất.

* Sau khi hoàn tất, tồn kho của sản phẩm sẽ được tự động cộng lại. Giao dịch trả hàng và khoản phí cũng được ghi nhận vào hệ thống báo cáo.
