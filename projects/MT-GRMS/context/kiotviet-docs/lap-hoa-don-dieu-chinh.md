...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-xu-ly-sai-sot-hddt/lap-hoa-don-dieu-chinh/
---
...
Hỗ trợ
Xử lý sai sót HĐĐTLập hóa đơn điều chỉnh
...
* Bạn cần bổ sung thông tin ***Lý do điều chỉnh***, ***Nội dung trước điều chỉnh***, ***Nội dung sau điều chỉnh***.

* Nhấn ***Lưu*** để ghi nhận biên bản.
* Để ký số và gửi biên bản điều chỉnh ngay cho người mua, bạn nhấn ***Ký và gửi →*** thực hiện ký số → nhập email người mua → nhấn ***Gửi***.

* Link biên bản được đính kèm ngay trên màn hình (ví dụ: Biên bản điều chỉnh: 1123245/2026/BB-ĐCHĐ)
...
* **Bước 1 - Phát hành hóa đơn điều chỉnh**:
  + Nhấn ***Phát hành*** để mở bản PDF hóa đơn.
...
* Nếu có biên bản đính kèm chưa gửi cho người mua → hệ thống hiển thị thêm popup **Gửi biên bản** → bạn điền mail người mua và nhấn ***Gửi*** hoặc nhấn ***Bỏ qua*** nếu chỉ lưu trữ nội bộ.
...
* **Bước 2 - Hoàn thiện nội dung biên bản** **khi chọn** **Lập biên bản:**
  + Nhập nội dung tương tự như khi đang lập hóa đơn mới → nhấn ***Lưu*** hoặc ***Ký và gửi*** → chọn loại chữ ký số → nhấn ***Xác nhận*** và thực hiện ký số.
...
* **Bước 1 - Ràng buộc tính chất hóa đơn**: Bạn KHÔNG THỂ lập hóa đơn điều chỉnh cho các hóa đơn có tính chất sau:
  ...
  + Hóa đơn thay thế.
  + Hóa đơn điều chỉnh.
* **Bước 2 - Cơ chế tự động gọi lại bản nháp**: Nếu bạn đã lập một hóa đơn điều chỉnh, nhấn ***Lưu*** rồi thoát ra. Lần tiếp theo, khi bạn nhấn ***Lập hóa đơn điều chỉnh*** trên đúng hóa đơn gốc đó, hệ thống sẽ thông minh tự động mở lại bản nháp cũ với đầy đủ dữ liệu đang nhập dở, thay vì tạo ra một bản nháp trống mới.
