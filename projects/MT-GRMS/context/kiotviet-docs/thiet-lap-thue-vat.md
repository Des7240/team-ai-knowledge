...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-thiet-lap-ban-dau-hddt/thiet-lap-thue-vat/
---
...
Hỗ trợ
Thiết lập ban đầu HĐĐTThiết lập Thuế VAT
...
Thuế VAT (thuế giá trị gia tăng) là thuế tính trên giá trị tăng thêm của hàng hóa, dịch vụ phát sinh trong quá trình từ sản xuất, lưu thông đến tiêu dùng. Để hỗ trợ các chủ cửa hàng thực hiện đúng nghĩa vụ thuế, KiotViet đã ra mắt tính năng Thuế VAT, cho phép người dùng thiết lập, quản lý và áp dụng các mức thuế suất khác nhau cho hàng hóa một cách tự động và chính xác.

Tính năng Thiết lập Thuế & Kế toán được cải tiến để phân biệt rõ ràng giữa hai loại hình kinh doanh (Hộ kinh doanh và Doanh nghiệp) và hai phương pháp tính thuế (Trực tiếp và Khấu trừ). Thay vì hiển thị chung một màn khó phân biệt như trước, hệ thống nay dẫn dắt người dùng từng bước theo đúng loại hình. Sau khi thiết lập, màn Chi tiết cho phép xem lại và chỉnh sửa bất cứ lúc nào. Tính năng cập nhật hàng loạt giúp cập nhật VAT cho nhiều sản phẩm cùng lúc — không cần vào từng sản phẩm thủ công.

**Lợi ích nổi bật của tính năng:**

* **Phân biệt rõ ràng, không còn cấu hình nhầm:** Trước đây, Hộ kinh doanh và Doanh nghiệp hiển thị chung một màn — dễ gây nhầm lẫn khi Hộ kinh doanh chọn sang thuế khấu trừ (vốn không được phép theo quy định). Luồng mới bắt buộc người dùng xác định loại hình kinh doanh ngay từ bước đầu, sau đó tự động dẫn đến đúng màn cài đặt tương ứng — không có cơ hội chọn sai.
* **Màn chi tiết và tính năng cập nhật hàng loạt tiết kiệm thời gian:** Sau khi thiết lập xong, màn Chi tiết hiển thị đầy đủ thông tin cấu hình hiện tại — không cần mở lại popup để kiểm tra như trước. Đặc biệt, màn hình Danh sách hàng hóa cho phép cập nhật VAT hàng loạt cho nhiều sản phẩm cùng lúc, thay vì phải vào từng sản phẩm riêng lẻ.
* **Tuân thủ quy định pháp luật:** Giúp chủ cửa hàng áp dụng thuế VAT một cách chính xác, đầy đủ, tránh các rủi ro pháp lý. Tính năng luôn được cập nhật theo các quy định mới nhất như Nghị quyết giảm thuế GTGT.
* **Tính toán chính xác và hiệu quả:** Hệ thống tự động tính toán thuế VAT cho cả giao dịch bán hàng và nhập hàng, hỗ trợ nhiều mức thuế trên cùng một hóa đơn và phân bổ giảm giá một cách hợp lý trước khi tính thuế.
* **Tích hợp liền mạch:** Giúp tiết kiệm thời gian sàng lọc thông tin khi xuất hóa đơn GTGT. Dữ liệu thuế được tích hợp trực tiếp với tính năng Hóa đơn điện tử và Tờ khai thuế, giúp việc phát hành và kê khai thuế trở nên nhanh chóng và đồng bộ.

## **II. Phân biệt các Phương pháp tính thuế**

Trước khi đi vào cài đặt, bạn cần xác định phương pháp tính thuế mà cửa hàng của mình đang áp dụng. KiotViet hỗ trợ cả hai phương pháp theo quy định:

### **1. Phương pháp Trực tiếp (Tính trên doanh thu)**

* **Đối tượng áp dụng:** Thường là các Hộ kinh doanh, cá nhân kinh doanh có doanh thu hàng năm dưới mức quy định, hoặc doanh nghiệp không đáp ứng đủ điều kiện của phương pháp khấu trừ.
* **Cách tính:** Thuế VAT phải nộp = Tỷ lệ % x Doanh thu.
* **Ví dụ minh họa:** Hộ kinh doanh của bạn (ngành bán lẻ) bán được một đơn hàng 1,000,000đ. Với tỷ lệ thuế trực tiếp là 1%, số VAT phải nộp là: 1,000,000đ x 1% = 10,000đ.
* **Đặc điểm:** Phương pháp này đơn giản, chỉ cần xác định doanh thu và áp dụng một tỷ lệ thuế suất cố định. Bạn không cần quản lý VAT đầu vào.

### **2. Phương pháp Khấu trừ (Tính trên giá trị gia tăng)**

* **Đối tượng áp dụng:** Thường là các Doanh nghiệp (công ty TNHH, cổ phần...) thực hiện đầy đủ sổ sách kế toán, hóa đơn, chứng từ.
* **Cách tính:** Thuế VAT phải nộp = VAT đầu ra - VAT đầu vào được khấu trừ.
* **Ví dụ minh họa:** Doanh nghiệp của bạn nhập một lô hàng (VAT đầu vào 10%) với giá trị trước thuế là 10,000,000đ, tương đương VAT đầu vào là 1,000,000đ. Bạn bán hết lô hàng đó (VAT đầu ra 10%) với giá trị trước thuế là 15,000,000đ, tương đương VAT đầu ra là 1,500,000đ. Số VAT phải nộp = 1,500,000đ (đầu ra) - 1,000,000đ (đầu vào) = 500,000đ.
* **Đặc điểm:** Phương pháp này yêu cầu bạn phải quản lý chi tiết cả thuế VAT khi bán hàng (đầu ra) và thuế VAT khi nhập hàng (đầu vào) để xác định phần chênh lệch phải nộp.
...
Phần này hướng dẫn chi tiết quy trình thiết lập và sử dụng thuế VAT cho các đơn vị áp dụng phương pháp tính thuế trực tiếp trên doanh thu.

### **1. Thiết lập quản lý thuế**

**Tình huống:** Hộ kinh doanh của bạn cần cài đặt KiotViet để tính thuế VAT theo phương pháp trực tiếp với tỷ lệ phổ biến là 1% trên tổng doanh thu.

**Thao tác thực hiện như sau:**

* **Bước 1**: Tại màn hình **Quản lý**, tài khoản admin của chủ gian hàng vào menu **Thiết lập → Xem tất cả thiết lập** → chọn **Thuế & Kế toán**.

* **Bước 2**: Bật xanh **Thuế VAT** → xác nhận ***Bật tính năng***.

* **Bước 3**: Hệ thống hiển thị popup **Thiết lập thuế VAT** → bạn chọn loại hình ***Cá nhân/Hộ kinh doanh*** → nhấn ***Tiếp tục***.

* **Bước 4**: Chọn **Tỷ lệ thuế mặc định**:

* Hệ thống mặc định loại hình **Cá nhân/Hộ kinh doanh** sử dụng **phương pháp thuế Trực tiếp**.
* Tại mục ***Tỷ lệ thuế mặc định***, chọn ***1% GTGT, 0,5 % TNCN (Phân phối, cung cấp hàng hóa)***.
* Tích chọn ***Giảm thuế GTGT theo Nghị quyết 204/2025/QH15 và Nghị định 174/2025/NĐ-CP***.
* Nhấn ***Lưu*** để hệ thống hoàn tất thiết lập thuế VAT cho gian hàng.

* **Bước 5**: Sau khi lưu thành công hệ thống hiển thị chi tiết thiết lập thuế VAT.

### **2. Quản lý thuế suất trên hàng hóa**

**Tình huống:** Sau khi thiết lập, tất cả hàng hóa đều được áp dụng đúng tỷ lệ tính thuế là GTGT 1% nhưng có một số hàng hóa có tỷ lệ tính thuế khác là GTGT 3% và bạn cần thực hiện đổi tỷ lệ tính thuế cho những hàng hóa đó.
...
* Tại khu vực ***Danh mục thuế của hàng hóa***, bạn nhấn ***Chỉnh sửa***.

* Hệ thống hiển thị popup **Danh sách hàng hóa** với tỷ lệ thuế tương ứng. Tại đây, bạn có thể tìm kiếm theo mã hàng, tên hàng; lọc theo nhóm hàng, nhóm ngành chịu thuế, trạng thái kê khai (Sẵn sàng thiết lập; Bán mẫu / Chưa chốt thuế suất).

* Trên dòng hàng hóa cụ thể cần thay đổi thuế suất → bạn chọn tỷ lệ tính thuế phù hợp.

* Hoặc tích chọn các hàng hóa cần thay đổi → chọn ngành nghề và tình trạng kê khai phù hợp → nhấn ***Áp dụng***.

* Nhấn ***Lưu*** để ghi nhận thay đổi.

* **Cách 2: Thao tác tại menu Hàng hóa → Danh sách hàng hóa**
  + Khi ***Tạo mới*** hoặc ***Chỉnh sửa*** hàng hóa, hệ thống sẽ tự động gán tỷ lệ thuế bạn đã thiết lập, bạn có thể thay đổi mức thuế phù hợp.

* Để thay đổi hàng loạt:
  + Bạn tích chọn các hàng hóa → nhấn 3 chấm → chọn ***Đổi tỷ lệ tính thuế***.

* Chọn ***Tỷ lệ tính thuế*** → nhấn ***Thay đổi***.

### **3. Áp dụng thuế trong giao dịch nhập hàng (VAT đầu vào)**

**Tình huống:** Cửa hàng sử dụng phương pháp tính thuế trực tiếp, khi nhập hàng từ nhà cung cấp, cần ghi nhận thuế VAT đầu vào để theo dõi chi phí giá vốn chính xác.

**Thao tác thực hiện như sau:**

* **Khi tạo phiếu Nhập hàng:** Bật xanh bật xanh biểu tượng ***VAT*** .

* **Trả hàng nhập:** Khi thực hiện trả hàng từ một phiếu nhập có VAT, hệ thống sẽ tự động khóa chế độ ***VAT*** theo phiếu gốc và hiển thị thông tin ***VAT hoàn lại***.

### **4. Ghi nhận dữ liệu bán hàng**

Sau khi thiết lập thuế VAT, toàn bộ dữ liệu bán hàng sẽ được ghi nhận đầy đủ, sẵn sàng phục vụ cho việc:

* Phát hành Hóa đơn điện tử.
* Tổng hợp số liệu lên Tờ khai thuế, Sổ kế toán.

## **IV. Phương pháp Khấu trừ**

Phần này hướng dẫn chi tiết quy trình thiết lập và sử dụng thuế VAT cho các đơn vị áp dụng phương pháp tính thuế khấu trừ.

### **1. Thiết lập quản lý thuế**

**Tình huống:** Doanh nghiệp của bạn cần cài đặt KiotViet để tính thuế VAT theo phương pháp khấu trừ, với mức thuế suất phổ biến hiện nay là 8%.
...
* **Bước 3**: Hệ thống hiển thị popup **Thiết lập thuế VAT** → bạn chọn loại hình ***Doanh nghiệp*** → nhấn ***Tiếp tục***.

* **Bước 4**: Chọn phương pháp tính thuế: ***Thuế khấu trừ*** → nhấn ***Tiếp tục***.

* **Bước 5**: Thiết lập thuế VAT:
  + VAT cho bán hàng
    - Chọn 1 trong 2 loại ***Giá bán trên danh mục hàng hóa*** là ***Giá trước thuế*** hoặc ***Giá sau thuế***.
    - Chọn ***Thuế suất mặc định*** (VD 8%).
    - Tích ***Tự động tính thuế khi bán hàng*** (nếu cần).
  + Tùy chọn VAT cho nhập hàng
    - Bật xanh nếu sử dụng tính năng.
    - Chọn ***Thuế suất mặc định*** (VD 8%).
    - Tích ***Tự động tính thuế khi nhập hàng*** (nếu cần).
  + Nhấn ***Lưu*** để hệ thống thiết lập thuế VAT cho gian hàng.

* **Bước 6**: Sau khi lưu thành công hệ thống hiển thị chi tiết thiết lập thuế VAT.

**Lưu ý:** Doanh nghiệp có thể đổi phương pháp tính thuế sau khi đã thiết lập, nhưng cần xác nhận ***Thay đổi*** do ảnh hưởng đến toàn bộ dữ liệu thuế hàng hóa.

### **2. Quản lý thuế suất trên hàng hóa**

**Tình huống:** Doanh nghiệp kinh doanh nhiều mặt hàng với các mức thuế suất khác nhau (ví dụ: 8%, 10%, 5%). Bạn cần gán đúng mức thuế cho từng sản phẩm.
...
* Trên dòng hàng hóa cụ thể cần thay đổi → bạn chọn thuế suất phù hợp.

* Hoặc tích chọn các hàng hóa cần thay đổi → chọn ***VAT nhập hàng*** và ***VAT bán hàng*** phù hợp → nhấn ***Áp dụng***.

* Nhấn ***Lưu*** để ghi nhận thay đổi.

* **Cách 2: Thao tác tại menu Hàng hóa** → **Danh sách hàng hóa**.
  + **Cập nhật cho từng hàng hóa:** Khi ***Tạo mới*** hoặc ***Chỉnh sửa*** hàng hóa tại **Hàng hóa → Danh sách sản phẩm**, bạn có thể chọn lại mức thuế trong trường ***VAT hàng nhập (%)***, ***VAT hàng bán (%)*** cho phù hợp.
...
* Chọn mức thuế ***VAT hàng bán (%), VAT hàng nhập (%)*** → nhấn ***Thay đổi***.

### **3. Áp dụng thuế trong giao dịch nhập hàng (VAT đầu vào)**

**Tình huống:** Doanh nghiệp sử dụng phương pháp tính thuế khấu trừ, khi nhập hàng từ nhà cung cấp, doanh nghiệp cần ghi nhận thuế VAT đầu vào để phục vụ cho việc khấu trừ thuế.

**Thao tác thực hiện như sau:**

* **Khi tạo phiếu Nhập hàng:** Bật xanh **VAT nhập hàng** để tính thuế vào giá trị phiếu nhập.

* **Khi tạo phiếu Trả hàng nhập:** Hệ thống hiển thị nút **VAT hoàn lại** để tính toán lại số thuế được hoàn từ nhà cung cấp.

### **4. Quản lý giá bán sau thuế**

**Tình huống:** Doanh nghiệp của bạn chủ yếu bán lẻ (B2C) và muốn niêm yết, giao dịch bằng giá cuối cùng đã bao gồm VAT để khách hàng dễ hiểu.
...
* Khi thiết lập **Thuế khấu trừ**, bạn chọn ***Giá bán trên danh mục hàng hóa*** là ***Giá sau thuế***.

* Khi đó, tất cả các thao tác từ thêm mới hàng hóa, tạo hóa đơn, đến quản lý bảng giá đều sẽ hoạt động dựa trên giá bán sau thuế.

* Hệ thống sẽ tự động tính ngược giá trị trước thuế để đảm bảo các báo cáo và hóa đơn điện tử luôn chính xác.

### **5. Điều chỉnh Thuế VAT khi bán hàng (Giá bán trước thuế)**

Tính năng tùy chỉnh %VAT và giá trị VAT trên màn hình **Bán hàng** giúp quy trình bán hàng linh hoạt và chính xác hơn khi xử lý các giao dịch có yêu cầu thuế đặc biệt. Hệ thống cho phép người dùng điều chỉnh linh hoạt mức thuế hoặc tự nhập giá trị VAT trực tiếp trên từng dòng hàng hóa thông qua popup **Chi tiết VAT**, tự động tính toán dữ liệu mà không làm gián đoạn luồng bán hàng.

Với tính năng này, người dùng có thể:

* Điều chỉnh %VAT hoặc nhập thẳng giá trị VAT ngay tại chỗ, đảm bảo hóa đơn phản ánh đúng nghĩa vụ thuế của từng giao dịch hiện hành.
* Linh hoạt áp các mức thuế phù hợp với từng đối tượng khách hàng và thực tế chứng từ mà không ảnh hưởng đến thiết lập VAT gốc của hàng hóa trong danh mục.
* Kiểm soát và xác nhận thông tin VAT minh bạch, chính xác trước khi hoàn tất thanh toán.

**Điều kiện áp dụng**:

* Gian hàng đang sử dụng phương pháp **Thuế khấu trừ** – chế độ **Giá bán trước thuế**.
* Tài khoản có quyền ***Chỉnh sửa VAT***.

**Tình huống**: Khi thực hiện giao dịch, bạn cần điều chỉnh nhanh mức thuế suất hoặc số tiền thuế của một mặt hàng cụ thể để phù hợp với thỏa thuận riêng với khách hàng hoặc yêu cầu đặc thù của hóa đơn mà không muốn thay đổi cấu hình mặc định trong danh mục hàng hóa.

**Thao tác thực hiện như sau**:

* **Thêm hàng vào đơn**: Hệ thống áp dụng VAT mặc định. Tại khu vực thanh toán, bạn nhấn vào giá trị tiền tại trường VAT.

* **Điều chỉnh thuế**:
  + Bạn có thể chọn mức thuế từ danh sách tại cột ***VAT(%)*** (0%, 5%, 8%, 10%, KCT, KKKNT).

* Hoặc nhấn vào giá trị tại cột ***VAT*** (tiền) → nhập số tiền cụ thể → nhấn ***Lưu***.

* **Hoàn tất**: Kiểm tra tổng tiền đã cập nhật và nhấn ***Thanh toán***.
* **Lưu ý**:
  + VAT luôn được tính trên thành tiền sau khi đã trừ chiết khấu/khuyến mãi/coupon.

* Mọi điều chỉnh VAT thủ công đều được ghi lại trong ***Lịch sử thao tác*** (Ví dụ: VAT từ 8% → 5%).

* Tính năng này cũng áp dụng tương tự khi thực hiện nghiệp vụ **Trả hàng nhanh** để điều chỉnh VAT hoàn trả chính xác.

## **V. Các tính năng nâng cao**

Phần này hướng dẫn các nghiệp vụ điều chỉnh cấu hình thuế sau khi đã thiết lập lần đầu.

### **1. Đổi loại hình kinh doanh sau khi đã thiết lập**

**Tình huống:** Bạn đã hoàn tất thiết lập thuế nhưng sau đó gian hàng thay đổi mô hình hoạt động và bạn cần cập nhật lại loại hình kinh doanh (từ Hộ kinh doanh sang Doanh nghiệp hoặc ngược lại).

**Thao tác thực hiện như sau:**

* **Bước 1**: Trong menu **Thiết lập** → **Xem tất cả thiết lập** → **Thuế & Kế toán**, bạn nhấn ***Xem chi tiết***.

* **Bước 2**: Tại dòng thông tin loại hình kinh doanh, nhấn ***tại đây***.

* **Bước 3:** Chọn loại hình mới → nhấn ***Tiếp tục*** và thực hiện thao tác thiết lập thuế tương ứng như hướng dẫn tại các mục trên.

### **2. Đổi phương pháp thuế (chỉ Doanh nghiệp)**

**Tình huống:** Doanh nghiệp của bạn quyết định chuyển đổi phương pháp kê khai thuế giữa Trực tiếp và Khấu trừ, và bạn cần cập nhật hệ thống để đồng bộ dữ liệu tính toán.

**Thao tác thực hiện như sau:**

* **Bước 1**: Trong menu **Thiết lập** → **Xem tất cả thiết lập** → **Thuế & Kế toán**, bạn nhấn ***Xem chi tiết***.

* **Bước 2**: Tại dòng thông tin phương pháp thuế, nhấn ***tại đây***.

* **Bước 3:** Chọn phương pháp tính thuế mới → nhấn ***Tiếp tục***.

* **Bước 4:** Sau khi thiết lập thuế → nhấn ***Lưu*** → hệ thống hiển thị popup **Thay đổi phương pháp tính thuế** → bạn cần đọc kỹ cảnh báo ảnh hưởng → nhấn ***Thay đổi*** để xác nhận thông tin.

### **3. Đổi mức thuế mặc định**

**Tình huống:** Chính sách thuế thay đổi hoặc có quyết định nội bộ mới về mức thuế chung áp dụng cho hàng hóa, bạn cần thay đổi tỷ lệ thuế mặc định của gian hàng.

**Thao tác thực hiện như sau:**

* **Bước 1**: Trong menu **Thiết lập** → **Xem tất cả thiết lập** → **Thuế & Kế toán**, bạn nhấn ***Xem chi tiết***.

* **Bước 2**: Tại dòng ***Thông tin chung của VAT***, nhấn ***Chỉnh sửa***.

* **Bước 3:** Thay đổi thuế suất mặc định → nhấn ***Lưu***.

* **Bước 4**: Hệ thống hiển thị popup **Thay đổi thuế suất**.
* **Bước 5**: Nhấn ***Thay đổi***:
  + Với phương pháp tính **Thuế trực tiếp**: Hệ thống ghi nhận thay đổi.
  + Với phương pháp tính **Thuế khấu trừ**: Hệ thống hiển thị thêm popup để bạn chọn phạm vi áp dụng VAT mới (***Toàn bộ hàng hóa*** hoặc ***Chỉ hàng hóa chưa chỉnh sửa VAT***)→ nhấn ***Đồng ý*** để hoàn tất thay đổi*.*

### **4. Tắt/bật lại tính năng Thuế**

**Tình huống:** Trong quá trình sử dụng, bạn muốn tạm ngưng áp dụng tính năng Thuế VAT để kiểm tra, điều chỉnh dữ liệu hoặc chưa tiếp tục sử dụng. Sau đó, khi cần quản lý thuế trở lại, bạn có thể bật lại tính năng mà không cần thiết lập từ đầu.

**Thao tác thực hiện như sau:**

* Tại màn hình **Quản lý**, bạn truy cập menu **Thiết lập** → **Xem tất cả thiết lập** → **Thuế & Kế toán**
* **Để tắt tính năng**: Tại dòng **Thuế VAT**→ tắt xám → xác nhận ***Tắt tính năng***.

* **Để bật lại tính năng**: Tại dòng **Thuế VAT**→ bật xanh → xác nhận ***Bật tính năng***.

**Lưu ý**:

* Việc bật lại tính năng **Thuế VAT** không tạo mới dữ liệu thiết lập.
* Toàn bộ thông tin cấu hình trước đó sẽ được lưu giữ và khôi phục khi bật lại tính năng.
* Nếu cần thay đổi loại hình kinh doanh hoặc phương pháp tính thuế, bạn nhấn ***Xem chi tiết*** và thực hiện điều chỉnh theo hướng dẫn tại các mục tương ứng ở trên.
