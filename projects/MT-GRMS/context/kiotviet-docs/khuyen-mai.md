...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-khuyen-mai/khuyen-mai/
---
...
Tính năng **Khuyến mại** trên KiotViet là công cụ mạnh mẽ giúp bạn thiết lập và áp dụng đa dạng các chương trình ưu đãi cho sản phẩm và hóa đơn. Bạn có thể tùy chỉnh các chương trình theo tổng giá trị hóa đơn, theo từng sản phẩm cụ thể, hoặc kết hợp cả hai, với các điều kiện linh hoạt về thời gian, chi nhánh và nhóm khách hàng áp dụng.

**Lợi ích nổi bật của tính năng Khuyến mại trên KiotViet:**

* **Đa dạng hình thức khuyến mại:** Cung cấp nhiều loại hình ưu đãi khác nhau như giảm giá hóa đơn, tặng hàng, giảm giá trên sản phẩm, tặng điểm, tặng voucher, đáp ứng mọi kịch bản bán hàng và các chiến dịch marketing của bạn.
* **Tự động áp dụng, tăng tốc độ bán hàng:** Hệ thống có thể tự động áp dụng khuyến mại khi đơn hàng thỏa mãn điều kiện, giúp nhân viên thu ngân thao tác nhanh hơn, giảm thời gian chờ đợi của khách và hạn chế sai sót khi tính toán thủ công.
* **Quản lý tập trung, dễ dàng kiểm soát hiệu quả:** Toàn bộ chương trình khuyến mại được tạo và quản lý tại một nơi duy nhất, cho phép bạn kiểm soát chặt chẽ về thời gian, phạm vi áp dụng (chi nhánh, người bán, nhóm khách hàng) và theo dõi lịch sử áp dụng trên từng hóa đơn, đặt hàng.

## **II. Các thao tác cơ bản**

Để dễ hình dung, các ví dụ dưới đây sẽ minh họa những tình huống bán hàng thực tế.

### **1. Thiết lập ban đầu cho tính năng Khuyến mại**

**Tình huống**: Để bắt đầu sử dụng các chương trình khuyến mại, trước tiên bạn cần kích hoạt và cấu hình các tùy chọn chung cho tính năng này trên toàn bộ hệ thống của mình.

**Thao tác thực hiện như sau**:

* Tại màn hình **Quản lý**, bạn vào menu **Thiết lập** → chọn **Khách hàng** → bật xanh tính năng **Khuyến mại**.
* Tiếp theo, bạn có thể tùy chỉnh:
  + ***Áp dụng gộp các chương trình khuyến mại***: Tích chọn nếu bạn muốn cho phép khách hàng được hưởng nhiều khuyến mại cùng lúc trên một đơn hàng.
  + ***Áp dụng khuyến mại khi đặt hàng***: Tích chọn nếu bạn muốn hệ thống cho phép áp dụng chương trình khuyến mại khi đặt hàng.
  + ***Áp dụng tự động khuyến mại cho hóa đơn***: Tích chọn nếu bạn muốn hệ thống tự động áp dụng chương trình khuyến mại khi đơn hàng đáp ứng đủ điều kiện (riêng hình thức giảm giá hàng và tặng hàng, sản phẩm được khuyến mại phải là 1 mã hàng).

### **2. Tạo chương trình khuyến mại**

**Tình huống:** Khi bạn muốn triển khai một chương trình ưu đãi mới cho cửa hàng, ví dụ như "Giảm giá 10% cho hóa đơn từ 500.000đ".

**Thao tác thực hiện như sau:**

* **Bước 1:** Tại màn hình **Quản lý**, bạn vào menu **Thiết lập →** chọn **Khách hàng → Khuyến mại →** nhấn **Quản lý khuyến mại**

Hoặc từ menu **Khách hàng** → chọn **Khuyến mại**

* **Bước 2:** Hệ thống chuyển sang màn hình **Khuyến mại**, bạn nhấn ***+ Khuyến mại*** → điền các **Thông tin** chung:
  + ***Tên chương trình*** (bắt buộc).
  + ***Hiệu lực***: Chọn từ ngày bắt đầu đến ngày kết thúc. Tùy chọn ***Áp dụng vào ngày/tuần/tháng sinh nhật khách hàng***.
  + ***Trạng thái****:* Chọn ***Đang kích hoạt*** để có thể sử dụng ngay.
  + ***Chi tiết lịch khuyến mại***: Có thể lựa chọn áp dụng chương trình khuyến mại theo tháng, ngày, thứ, giờ cụ thể để chạy các chương trình như Giờ vàng giảm giá…
  + **Hình thức khuyến mại**, bạn lựa chọn điều kiện và ưu đãi chi tiết:
    - **Khuyến mại theo:** Chọn **Hóa đơn**, **Hàng hóa**, hoặc **Hóa đơn và Hàng hóa** tùy theo mục tiêu chương trình.
    - **Hình thức:** Chọn một trong các hình thức có sẵn (Giảm giá hóa đơn, Tặng hàng, Giảm giá hàng, Tặng điểm, Tặng voucher, Mua hàng giảm giá hàng, Mua hàng tặng hàng, Mua hàng tặng điểm, Giá bán theo số lượng mua, Mua hàng tặng voucher).
    - **Thiết lập điều kiện:** Điền các thông số cụ thể. Ví dụ, với chương trình "Giảm giá 10% cho hóa đơn từ 500.000đ":
      * **Khuyến mại theo:** Hóa đơn.
      * **Hình thức khuyến mại:** Giảm giá hóa đơn.
      * **Mua từ:** 500,000.
      * **Giảm giá:** 10, chọn đơn vị là "%".
  + ​**Lưu ý**: Với những hình thức tặng hàng, giảm giá hàng, giá bán theo số lượng mua cần áp dụng cho nhiều hàng hóa cùng lúc → hệ thống hỗ trợ thêm nhanh theo các cách sau:
    - Chọn ***Hàng trong nhóm*** → ***Tất cả nhóm hàng*** → toàn bộ hàng hóa của tất cả các nhóm sẽ được chọn.

* Tích chọn ***Hoặc hàng cùng loại*** → khi nhập hàng hóa mua/tặng/giảm giá, bạn chỉ cần nhập 1 trong số mã hàng cùng loại → hệ thống sẽ áp dụng khuyến mại cho tất cả các mã hàng cùng loại khác.

* Thêm danh sách hàng hóa bằng cách copy/ paste danh sách mã hàng. Các mã hàng phải cách nhau bởi dấu “,” hoặc phím Enter. Ví dụ:
  + SP000001, SP000002
  + Hoặc: SP000001

SP000002

* Chọn **Số lần áp dụng khuyến mại với mỗi khách hàng**: ***Cho phép áp dụng 1 lần*** hay ***nhiều lần***. ***Cảnh báo nếu khách hàng đã từng áp dụng khuyến mại*** hay không

* **Bước 3:** Chuyển sang tab **Phạm vi áp dụng** để giới hạn chi nhánh, người bán, hoặc nhóm khách hàng được sử dụng.

* **Bước 4:** Nhấn ***Lưu*** để hoàn tất.

### **3. Áp dụng khuyến mại vào hóa đơn bán hàng**

**Tình huống:** Khi bạn đang tạo hóa đơn cho khách và nhận thấy đơn hàng này đủ điều kiện để nhận một ưu đãi đang diễn ra.

**Thao tác thực hiện như sau:**

* **Bước 1:** Trên màn hình **Bán hàng**, sau khi thêm sản phẩm vào hóa đơn, hệ thống sẽ tự động hiển thị biểu tượng **Hộp quà** nếu hóa đơn hoặc hàng hóa đủ điều kiện khuyến mại và tự động áp dụng khuyến mai nếu gian hàng thiết lập ***Áp dụng tự động khuyến mại cho hóa đơn***.

* **Bước 2:** Nhấn vào biểu tượng **Hộp quà** tương ứng (cạnh hàng hóa hoặc ở phần tổng tiền hàng).
* **Bước 3:** Một danh sách các chương trình khuyến mại hợp lệ sẽ hiện ra. Tích chọn vào chương trình bạn muốn áp dụng.
* **Bước 4:** Nếu chương trình có các lựa chọn (như chọn hàng tặng, chọn hàng giảm giá), hãy thực hiện theo hướng dẫn trên màn hình.
* **Bước 5:** Nhấn **Áp dụng**. Hệ thống sẽ tự động tính lại giá trị ưu đãi trên hóa đơn.

## **III. Các tính năng nâng cao**

### **1. Quản lý và theo dõi các chương trình khuyến mại**

**Tình huống:** Khi bạn cần xem lại thông tin, cập nhật, sao chép nhanh hoặc xóa một chương trình khuyến mại đã tạo trước đó.
...
* **Bước 2:** Tại đây, bạn có thể sử dụng bộ lọc để tìm kiếm chương trình khuyến mại mong muốn.

* **Bước 3:** Để xem chi tiết, bạn nhấn vào tên đợt phát hành. Hệ thống sẽ hiển thị đầy đủ thông tin chi tiết qua các tab: ***Thông tin***, ***Đơn đặt hàng có khuyến mại***, ***Hóa đơn có khuyến mại***.

* **Bước 4:** Để thực hiện **Chỉnh sửa**, **Sao chép** hoặc **Xóa** đợt phát hành, trên **Thông tin** voucher, bạn chọn các thao tác tương ứng.

  ***Lưu ý***:

  + Hệ thống chỉ cho phép ***Chỉnh sửa*** toàn bộ thông tin khi chương trình chưa phát sinh giao dịch. Nếu đã có giao dịch, bạn chỉ có thể sửa các thông tin như ***Tên chương trình***, ***Hiệu lực***, ***Trạng thái***, ***Chi tiết lịch khuyến mại***, ***Phạm vi áp dụng***
  + Bạn chỉ có thể ***Xóa*** một chương trình khuyến mại khi nó chưa phát sinh bất kỳ giao dịch nào.

* **Bước 5:** Khi xem danh sách **Hóa đơn có khuyến mại**, bạn có thể ***Xuất file*** danh sách hóa đơn.

### **2. Xử lý các tình huống với đơn đặt hàng và trả hàng**

**Tình huống:** Khi bạn cần xử lý một đơn đặt hàng đã áp dụng khuyến mại từ trước, hoặc khi khách hàng muốn trả lại một sản phẩm đã mua trong một chương trình khuyến mại.

**Thao tác thực hiện như sau:**

* **Với đơn đặt hàng:** Khi bạn xử lý một đơn đặt hàng để tạo hóa đơn, KiotViet sẽ giữ nguyên chương trình khuyến mại đã được áp dụng tại thời điểm đặt hàng. Hệ thống sẽ có thông báo cho phép bạn tùy chọn hủy khuyến mại cũ để chọn lại theo các chương trình ở thời điểm hiện tại.

* **Với phiếu trả hàng:** Khi khách trả hàng, hệ thống sẽ tự động tính toán lại giá trị trả lại dựa trên giá đã giảm của sản phẩm sau khi áp dụng khuyến mại. Nếu là khuyến mại giảm giá trên toàn hóa đơn, giá trị trả lại cũng sẽ được giảm trừ một cách tương ứng.

### **3. Phân quyền truy cập tính năng cho nhân viên**

**Tình huống:** Khi bạn muốn giới hạn quyền của nhân viên, chỉ cho phép một số người được tạo, sửa, hoặc xóa các chương trình khuyến mại để đảm bảo tính nhất quán.

**Thao tác thực hiện như sau:**

* **Bước 1:** Trong phần thiết lập phân quyền cho vai trò của nhân viên, tìm đến mục **Khuyến mại**.
* **Bước 2:** Tích chọn các quyền bạn muốn cấp cho vai trò đó: ***Xem***, ***Tạo***, ***Chỉnh sửa***, ***Xóa***.

## **IV. Thao tác trên Điện thoại**

Tính năng Khuyến mại trên ứng dụng KiotViet hỗ trợ cửa hàng thực hiện thao tác áp dụng các chương trình khuyến mại khi bán hàng.

**Tình huống:** Bạn đang tạo hóa đơn cho khách trên ứng dụng di động và cần áp dụng các ưu đãi hợp lệ.

**Thao tác thực hiện như sau:**

* **Bước 1:** Trên màn hình **Thanh toán** đơn hàng, bạn nhấn ***Chọn khuyến mại →*** ứng dụng sẽ tự động hiển thị lần lượt các màn hình chọn khuyến mại hợp lệ (theo hàng hóa trước, theo hóa đơn sau).
* **Bước 2:** Bạn tích chọn các chương trình muốn ***Áp dụng***.
* **Bước 3:** Bạn tiếp tục thực hiện các thao tác thanh toán để hoàn tất giao dịch như bình thường.

## **V. Thao tác trên Máy POS**

Tính năng Khuyến mại trên Máy POS Android hỗ trợ cửa hàng thực hiện thao tác: áp dụng một số chương trình khuyến mại theo hàng hóa.

**Tình huống:** Bạn đang bán hàng trên máy POS và cần áp dụng khuyến mại "Giảm giá hóa đơn" và "Giá bán theo số lượng mua" cho khách.

**Thao tác thực hiện như sau:**

* **Bước 1:** Sau khi thêm hàng hóa vào đơn hàng → biểu tượng **Hộp quà** sẽ xuất hiện bên cạnh sản phẩm đủ điều kiện khuyến mại theo hàng hóa và trên dòng ***Tổng tiền*** đủ điều kiện khuyến mại theo hóa đơn.

* **Bước 2:** Chạm vào biểu tượng **Hộp quà** để chọn chương trình.

* **Bước 3:** Hệ thống sẽ tự động thêm hàng tặng hoặc điều chỉnh giá bán.
