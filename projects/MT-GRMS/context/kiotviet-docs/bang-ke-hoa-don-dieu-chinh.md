...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-xu-ly-sai-sot-hddt/bang-ke-hoa-don-dieu-chinh/
---
...
Hỗ trợ
Xử lý sai sót HĐĐTBảng kê hóa đơn điều chỉnh
...
Tính năng Bảng kê hóa đơn điều chỉnh cung cấp báo cáo chuyên biệt phục vụ việc quản lý các hóa đơn điều chỉnh điện tử. Báo cáo hiển thị trực quan 2 nhóm dữ liệu có quan hệ trực tiếp: Hóa đơn điều chỉnh và Hóa đơn bị điều chỉnh. Người dùng có thể dễ dàng lọc dữ liệu theo kỳ, hình thức, ký hiệu, trạng thái CQT; đồng thời có thể xem chi tiết từng hóa đơn kèm nội dung điều chỉnh và xuất toàn bộ báo cáo ra file Excel để phục vụ đối soát và kê khai thuế.

**Lợi ích nổi bật của tính năng:**

* **Xem đối chiếu tức thì trên cùng một màn hình:** Cấu trúc 2 nhóm dữ liệu hiển thị song song giúp kế toán đối chiếu nhanh nội dung điều chỉnh mà không cần tìm kiếm riêng từng hóa đơn. Bộ lọc áp dụng cho nhóm Hóa đơn điều chỉnh sẽ tự động cập nhật kết quả cho nhóm Hóa đơn bị điều chỉnh tương ứng.
* **Theo dõi chặt chẽ trạng thái biên bản điều chỉnh:** Cột "Trạng thái biên bản" hiển thị trực tiếp trên báo cáo cho biết biên bản đã được lập hay chưa. Đây là thông tin quan trọng giúp cửa hàng đảm bảo quy trình điều chỉnh hóa đơn đúng pháp lý.
* **Xuất file Excel chuẩn sẵn sàng kê khai:** Hệ thống tự động đặt tên file theo kỳ lọc. File xuất ra chứa cả 2 nhóm hóa đơn cạnh nhau theo chiều ngang trong 1 sheet duy nhất, cực kỳ tiện lợi cho việc đối chiếu và làm báo cáo thuế mà không cần xử lý thêm.

## **II. Các thao tác cơ bản**

Để dễ hình dung, các ví dụ dưới đây sẽ minh họa những tình huống thực tế trong ngành Bán buôn, Bán lẻ.

### **1. Truy cập và xem danh sách hóa đơn điều chỉnh**

* **Tình huống:** Cuối kỳ, bạn cần rà soát lại toàn bộ danh sách các hóa đơn điện tử đã phát sinh điều chỉnh.
* **Thao tác thực hiện như sau:**
  + **Bước 1 -** **Truy cập Bảng kê hóa đơn điều chỉnh**:
    - Truy cập menu **Báo cáo**.
    - Chọn **Bảng kê hóa đơn điều chỉnh** để chuyển đến màn hình **Bảng kê HĐ thay thế**.
    - **Lưu ý**: Để truy cập vào báo cáo bạn cần có quyền Báo cáo - Bảng kê hóa đơn điều chỉnh.

* **Bước 2 - Xem danh sách hóa đơn**: Báo cáo này chỉ hiển thị hóa đơn điều chỉnh và hóa đơn bị điều chỉnh - không hiển thị hóa đơn gốc hay hóa đơn thay thế, với cấu trúc 2 nhóm hiển thị song song:
  + **Hóa đơn điều chỉnh**: Màn hình hiển thị danh sách các hóa đơn điều chỉnh đã phát hành trong kỳ với các thông tin: Ký hiệu, Số hóa đơn, Ngày hóa đơn (ngày phát hành thực tế), thông tin khách hàng, Tổng tiền, Trạng thái gửi CQT và Trạng thái biên bản.

* **Hóa đơn bị điều chỉnh**: Danh sách các hóa đơn bị điều chỉnh tương ứng. Nhóm này hiển thị thông tin định danh cơ bản của hóa đơn gốc và không có cột Tổng tiền, Trạng thái gửi CQT hay Trạng thái biên bản.

### **2. Tìm kiếm và lọc dữ liệu**

* **Tình huống:** Bạn muốn tìm nhanh các hóa đơn điều chỉnh trong tháng này của một khách hàng thông qua mã số thuế hoặc tên của họ.
* **Thao tác thực hiện như sau:**
  + **Bước 1 -** **Lọc dữ liệu**: Tại bộ lọc bên trái, bạn có thể kết hợp lọc dữ liệu theo các tiêu chí: Kỳ xuất hóa đơn (lọc theo ngày phát hành HĐ điều chỉnh), Hình thức hóa đơn, Ký hiệu và Trạng thái gửi CQT. Bộ lọc này áp dụng trực tiếp cho nhóm Hóa đơn điều chỉnh.

* **Bước 2 -** **Tìm kiếm nhanh**: Tại ô tìm kiếm, bạn nhập Số hóa đơn điều chỉnh, MST (tìm chính xác) hoặc Tên khách hàng (tìm tương đối).

### **3. Xem chi tiết hóa đơn điều chỉnh từ báo cáo**

* **Tình huống:** Bạn cần xem lại chi tiết hàng hóa, dịch vụ của hóa đơn điều chỉnh.
* **Thao tác thực hiện như sau:**
  + **Bước 1:** Bạn nhấn vào **Số hóa đơn** trong nhóm **Hóa đơn điều chỉnh**.

* **Bước 2:** Hệ thống sẽ chuyển sang màn hình chi tiết của hóa đơn đó trong chức năng Hóa đơn tương ứng.

### **4. Xuất file Excel**

* **Tình huống:** Bạn cần xuất danh sách các cặp hóa đơn điều chỉnh - bị điều chỉnh ra Excel để lưu trữ thông tin.
* **Thao tác thực hiện như sau:** 
