...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-thanh-toan/thanh-toan/
---
...
Tính năng Thanh toán là một nghiệp vụ quan trọng giúp hoàn tất giao dịch bán hàng một cách nhanh chóng, chính xác và chuyên nghiệp trên mọi nền tảng của KiotViet.

**Lợi ích nổi bật**:

* **Thanh toán nhanh chóng và tiện lợi**: Giúp thu ngân xử lý giao dịch trong vài giây nhờ giao diện tinh giản, hỗ trợ phím tắt và các tiện ích như gợi ý tiền khách trả, tự động tính tiền thừa, giảm thiểu thời gian chờ đợi của khách hàng.
* **Đa dạng phương thức, đáp ứng mọi nhu cầu**: Hỗ trợ người dùng linh hoạt thanh toán qua nhiều hình thức phổ biến (Tiền mặt, Thẻ, VietQR, Ví điện tử, Điểm tích lũy, Voucher), mang lại sự tiện lợi tối đa cho cả người bán và người mua.
* **Tự động hóa và quản lý chính xác**: Giúp chủ cửa hàng loại bỏ thao tác đối chiếu thủ công, giảm thiểu sai sót và gian lận nhờ tính năng tự động nhận thông báo giao dịch thành công từ ngân hàng/ví điện tử ngay trên màn hình Bán hàng.

## **II. Các thao tác cơ bản**

### **1. Thanh toán bằng một phương thức**

* **Tình huống**: Khi khách hàng thanh toán toàn bộ hóa đơn bằng một hình thức duy nhất như tiền mặt, thẻ ngân hàng hoặc chuyển khoản.
* **Thao tác thực hiện như sau**:

(1) Sau khi thêm hàng hóa, tại khu vực thanh toán, nhập số tiền khách trả vào ô ***Khách thanh toán*** (hoặc nhấn phím F8).

(2) Chọn phương thức thanh toán tương ứng như ***Tiền mặt*, *Chuyển khoản*, *Thẻ*, *Ví***.

(3) Hệ thống sẽ tự động tính toán ***Tiền thừa trả khách*** (nếu có).

(4) Nhấn ***Thanh toán*** (hoặc nhấn phím F9) để hoàn tất giao dịch.

### **2. Thanh toán bằng nhiều phương thức**

* **Tình huống**: Khi khách hàng muốn chia nhỏ số tiền và thanh toán bằng nhiều hình thức khác nhau, ví dụ một phần bằng tiền mặt, một phần chuyển khoản.
* **Thao tác thực hiện như sau**:

(1) Tại khu vực thanh toán, nhấn vào biểu tượng đa phương thức.

(2) Một cửa sổ sẽ hiện ra, cho phép bạn nhập số tiền tương ứng cho từng hình thức thanh toán → nhấn ***Xong***.

(3) Nhấn **Thanh toán** (F9) để kết thúc giao dịch.

## **III. Các tính năng nâng cao**

### **1. Thanh toán bằng quét mã QR**

* **Tình huống**: Cung cấp cho khách hàng một phương thức thanh toán hiện đại, không dùng tiền mặt, chỉ cần quét mã QR để chuyển khoản nhanh chóng và chính xác.
* **Thao tác thực hiện như sau**:

(1) Chọn phương thức thanh toán là **Chuyển khoản** qua một tài khoản ngân hàng/ví điện tử đã lưu thông tin.

(2) Hệ thống sẽ tự động tạo một mã QR động, chứa đầy đủ thông tin số tiền và nội dung chuyển khoản.

(3) Bạn có thể cho khách quét mã trực tiếp trên màn hình, in mã QR, hoặc hiển thị mã qua thiết bị KiotViet QR.

(4) Nếu gian hàng đã đăng ký dịch vụ nhận thông báo qua tài khoản ngân hàng/ ví điện tử có liên kết với KiotViet, màn hình sẽ tự động hiển thị xác nhận khi giao dịch thành công.

### **2. Thanh toán bằng Điểm, Coupon, Voucher**

* **Tình huống**: Áp dụng các chương trình ưu đãi cho khách hàng thành viên, cho phép họ dùng điểm tích lũy hoặc các mã giảm giá để thanh toán.
* **Thao tác được thực hiện như sau**:

(1) Chọn khách hàng thành viên có điểm tích lũy vào hóa đơn.

(2) Bật xanh ***Điểm →***  hệ thống gợi ý số tiền tối đa tương đương với điểm được thanh toán trên đơn. Bạn có thể chỉnh sửa lại theo thực tế.

(3) Để dùng Coupon, nhập mã vào ô **Nhập mã coupon** và nhấn Enter. Với Voucher, bạn cần chọn trong mục thanh toán đa phương thức.

### **3. Thông báo bằng âm thanh**

* Khi kích hoạt tiện ích: ***Đọc số tiền khách thanh toán qua loa thiết bị*** trong ***Tùy chọn hiển thị*** → ***Khác***, khách hàng chuyển khoản thành công đến tài khoản ngân hàng hoặc ví điện tử đã đăng ký nhận thông báo thanh toán QR, phần mềm sẽ đọc số tiền khách đã chuyển khoản qua loa của thiết bị.
* Thiết bị sẽ phát ra âm thanh thông báo ("Ting ting") kèm số tiền vừa nhận được, giúp nhân viên xác nhận giao dịch nhanh chóng mà không cần nhìn vào màn hình.

### **4. Tự động hoàn thành đơn hàng khi quét QR thành công**

* Để tăng tốc độ thanh toán, hệ thống có thể tự động kết thúc giao dịch ngay khi nhận được thông báo chuyển khoản thành công qua tài khoản ngân hàng/ ví điện tử có liên kết với KiotViet
* Trong ***Tùy chọn hiển thị*** → ***Khác***, bạn bật tính năng ***Tự động hoàn thành đơn hàng khi quét QR thành công***.

### **5.  Quản lý và Khớp thanh toán qua mã QR cửa hàng (QR tĩnh)**

* **Tình huống**: Khi bạn nhận được nhiều khoản thanh toán qua mã QR tĩnh đặt tại quầy (QR Cửa hàng) và cần đối chiếu/khớp chính xác từng giao dịch tiền về với đơn hàng tạm đang lưu, đặc biệt trong khung giờ cao điểm để tránh sai sót.
* **Thao tác thực hiện như sau**:

#### **5.1. Thiết lập thông báo thanh toán QR cửa hàng**

(1) Trên màn hình **Bán hàng**, bạn nhấn vào biểu tượng **QR** (cạnh thông tin Khách thanh toán) → **Xem mã QR**.

(2) Trên từng tài khoản ngân hàng hiển thị, bạn chọn ***Tạo mã QR*** (với lần đầu tiên) hoặc ***Xem chi tiết*** (nếu đã nhấn tạo mã QR trước đó).

(3) Tại đây, hệ thống mặc định bật **Thông báo tiền về khi khách quét QR cửa hàng**. Bạn có thể ***Tải QR*** hoặc ***In QR*** để đặt tại quầy.

(4) Chọn ***Xong*** để ghi nhận thông tin.

**Lưu ý**:

* Nếu không muốn nhận thông báo tiền về từ QR tĩnh cửa hàng, bạn chọn **Tắt thông báo**.

* **Tính năng hoạt động độc lập trên từng chi nhánh:** Cùng 1 số tài khoản nhưng mã QR ở các chi nhánh là riêng biệt.
* **Khi thiết lập QR cửa hàng:** Chỉ hiển thị số tài khoản đã đăng ký dịch vụ và phạm vi áp dụng tại chi nhánh.
* **Theo dõi thông báo thanh toán QR theo từng chi nhánh:** Tiền về mã QR của chi nhánh nào thì thông báo tại chi nhánh đó.
* **Khi xóa, ngừng hoạt động chi nhánh:** Không gửi thông báo mới của QR.
* **Khi ngừng áp dụng số tài khoản:** Không nhận thông báo mới, nhưng vẫn hiển thị thông báo cũ và cho phép khớp với đơn tạm.
* Hiện tại hệ thống chưa hỗ trợ tính năng với các ngân hàng: Techcombank, MB Bank, Sacombank.

#### **5.2. Khớp thanh toán QR với đơn tạm**

(1) Khi có giao dịch QR mới thành công, trên màn hình **Bán hàng**, hệ thống sẽ hiển thị **chấm đỏ** tại biểu tượng **QR** (cạnh thông tin Khách thanh toán).

(2) Kích vào biểu tượng **QR** để mở pop-up **Thông báo thanh toán QR**. Pop-up này hiển thị các lượt thanh toán qua QR cửa hàng trong 24 giờ gần nhất ở trạng thái **Chưa khớp** và **Đang khớp**, nhóm theo ngân hàng.

* **Quy tắc Khớp giao dịch:** Chỉ các giao dịch ở trạng thái **Chưa khớp** mới có thể được khớp với đơn tạm.
  + Nhấn ***Khớp*** tại giao dịch QR mong muốn. Hệ thống sẽ ghi nhận số tiền thanh toán QR này trên đơn tạm đang mở và chuyển trạng thái giao dịch QR sang ***Đang khớp***.

* Nếu đơn tạm đã được tạo thành **Đặt hàng/Hóa đơn**, hệ thống sẽ tạo phiếu thu, ghi nhận tiền Khách thanh toán và chuyển trạng thái giao dịch QR là **Đã khớp**.

* **Hủy khớp giao dịch:**
  + Nếu bạn muốn khớp giao dịch QR khác, hoặc thay đổi giao dịch, bạn cần **Hủy khớp** giao dịch QR đang khớp trước đó (nút **Hủy** sẽ hiển thị tại giao dịch đang khớp).

* Tại giao dịch QR đang khớp với đơn tạm khác → hệ thống hiển thị nút ***Hủy*** kèm theo thông tin cụ thể đơn tạm đang khớp.

* **Quy tắc ưu tiên và thay đổi thanh toán:**
  + **Khi kết hợp thanh toán đa phương thức,** hệ thống ưu tiên lấy thông tin thanh toán từ giao dịch QR.
  + **Trước khi Khớp:** Nếu đơn tạm đã có thông tin thanh toán bằng tay hoặc bằng cách quét mã QR động trên từng đơn hàng (chưa khớp với giao dịch QR tĩnh nào), hệ thống vẫn cho phép ***Khớp***.
    - Nếu thanh toán trước đó là ***Chuyển khoản***: Sau khi ***Khớp***, giao dịch QR tĩnh sẽ thay thế thông tin thanh toán này.
    - Nếu thanh toán trước đó là các phương thức khác (Tiền mặt, Ví điện tử, Voucher...): Sau khi ***Khớp***, hệ thống giữ nguyên số tiền của các phương thức đó và thêm giao dịch QR tĩnh vào (đa phương thức).
    - Trường hợp đặc biệt*:* Nếu gian hàng thiết lập ***Mặc định khách thanh toán***, khi ***Khớp*** đơn, giao dịch QR được khớp sẽ tự động thay thế toàn bộ ***Khách thanh toán*** mặc định.
  + **Sau khi Khớp:** Bạn được phép thay đổi Khách thanh toán (phương thức và số tiền) trên đơn tạm.
    - Nếu **thay đổi bằng cách nhập tay**: Hệ thống cho phép thay đổi thông tin bản ghi thanh toán của giao dịch QR đang khớp (số tiền, phương thức, số tài khoản) hoặc xóa bản ghi đó.
    - Nếu **thay đổi bằng cách quét mã QR động trên đơn**: Hệ thống sẽ tự động bỏ ghi nhận đã khớp giao dịch QR tĩnh và ghi nhận số tiền đã quét mã QR động.
  + **Ưu tiên ghi nhận:** Hệ thống chỉ ghi nhận 1 trong 2 cách thanh toán (Khớp giao dịch QR tĩnh hoặc Quét mã QR động trên đơn); hành động cuối cùng thực hiện sẽ được ưu tiên.

## **IV. Thao tác trên Điện thoại**

* Tính năng Thanh toán trên ứng dụng KiotViet hỗ trợ cửa hàng thực hiện các thao tác: chọn một hoặc nhiều phương thức thanh toán, sử dụng điểm hoặc voucher, cùng các tiện ích khi thanh toán qua mã QR.
* **Thao tác thực hiện như sau**:
  + Trên **ứng dụng KiotViet**, sau khi thêm hàng vào đơn, bạn chạm vào nút **Thanh toán**.
  + **Thanh toán một phương thức**: Tại màn hình thanh toán, nhập số tiền khách trả và chọn phương thức.

* **Thanh toán nhiều phương thức**:
  + Chạm vào 3 chấm dưới dòng **Khách thanh toán** để mở màn hình chi tiết và phân bổ số tiền cho từng hình thức (Tiền mặt, Chuyển khoản, Thẻ, Ví, Voucher).
  + Với hình thức thanh toán bằng Điểm, bạn bật xanh để thanh toán. Ứng dụng gợi ý số tiền tối đa tương đương với điểm được thanh toán trên đơn. Bạn có thể chỉnh sửa lại theo thực tế.

* Chạm ***Hoàn thành*** để kết thúc.
* Với các tài khoản ngân hàng hoặc ví điện tử đã đăng ký nhận thông báo thanh toán QR, tương tự như trên giao diện website, khi kết hợp với các **Thiết lập bán hàng** trên ứng dụng, hệ thống sẽ:
  + Hiển thị xác nhận khi giao dịch thành công.
  + Đọc số tiền khách thanh toán qua loa thiết bị.
  + Tự động hoàn thành đơn hàng khi quét QR thành công.

## **V. Thao tác trên Máy POS**

Tính năng Thanh toán trên máy POS Android hỗ trợ cửa hàng thực hiện các thao tác: thanh toán bằng một hoặc nhiều phương thức, thanh toán bằng điểm và quét mã QR trực tiếp.

### **1. Thanh toán bằng một hoặc nhiều phương thức**

* Trên ứng dụng **KiotViet Máy bán hàng**, sau khi thêm hàng, chạm vào nút ***Thanh toán***.

* Trong cửa sổ hiện ra, nhập số tiền khách trả và chọn nhanh các phương thức.

* Nếu khách thanh có điểm và đủ điều kiện thanh toán, bạn bật xanh **Điểm**. Ứng dụng gợi ý số tiền tối đa tương đương với điểm được thanh toán trên đơn. Bạn có thể chỉnh sửa lại theo thực tế.

* Để chia nhỏ thanh toán, chạm vào biểu tượng đa phương thức.

* Chạm ***Hoàn thành*** để kết thúc.

### **2. Thanh toán bằng quét mã QR**

* **Tình huống**: Khách hàng quét mã QR để thanh toán trực tiếp trên màn hình cảm ứng của máy POS.
* **Thao tác thực hiện như sau**:
  + Khi thanh toán bạn chọn phương thức ***Chuyển khoản***. Ứng dụng sẽ hiển thị mã QR động chứa thông tin thanh toán. Bạn có thể nhấn ***Xem mã QR*** để phóng to thông tin giúp khách hàng dễ dàng quét.

* Với các tài khoản ngân hàng hoặc ví điện tử đã đăng ký nhận thông báo thanh toán QR, tương tự như trên giao diện website, khi kết hợp với các **Cài đặt** trên ứng dụng, hệ thống sẽ:
  + Hiển thị xác nhận khi giao dịch thành công.
  + Đọc số tiền khách thanh toán qua loa thiết bị.
  + Tự động hoàn thành đơn hàng khi quét QR thành công.
