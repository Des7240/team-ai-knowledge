...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-thanh-toan/thu-khac/
---
...
Tính năng Quản lý thu khác hỗ trợ cửa hàng quản lý các khoản chi phí phát sinh ngoài giá trị hàng hóa như: phí giao hàng, phí dịch vụ, VAT... Bạn có thể thiết lập các khoản thu này theo một số tiền cố định (VNĐ) hoặc phần trăm (%) giá trị đơn hàng.

**Lợi ích nổi bật của tính năng Quản lý Thu khác trên KiotViet:**

* **Quản lý tập trung:** Dễ dàng tạo mới và quản lý tất cả các khoản thu khác phát sinh tại cửa hàng trên một màn hình duy nhất.
* **Thiết lập linh hoạt:** Cho phép tùy chỉnh giá trị (VNĐ hoặc %), phạm vi áp dụng theo chi nhánh, và thiết lập các quy tắc tự động như tự đưa vào hóa đơn hoặc hoàn lại khi trả hàng.
* **Tăng tính chính xác:** Đảm bảo các khoản thu phụ được tính toán chính xác trên hóa đơn, phiếu trả hàng và được ghi nhận đúng trong các báo cáo tài chính, giúp việc đối soát trở nên minh bạch hơn.

## **II. Các thao tác cơ bản**

Để dễ hình dung, các ví dụ dưới đây sẽ minh họa những tình huống thực tế trong ngành Bán buôn, Bán lẻ.

### **1. Thiết lập và tạo mới khoản thu khác**

* **Tình huống:** Cửa hàng của bạn cần thêm một khoản "Phí giao hàng" cố định là 30.000 VNĐ và một khoản "Phí dịch vụ" 5% tự động áp dụng cho mọi hóa đơn.
* **Thao tác thực hiện như sau:**

1. Đầu tiên, bạn cần kích hoạt tính năng. Tại màn hình **Quản lý**, vào **Thiết lập** → **Đơn hàng** → trên dòng ***Quản lý thu khác*** nhấn ***Đang tắt***.

2. Bật xanh **Quản lý thu khác** và nhấn ***Tạo***.

3. Điền các thông tin cho khoản thu khác (Tên loại thu, Giá trị, Chi nhánh áp dụng...).
4. Tích chọn các ***Tùy chỉnh khác*** (nếu cần) bao gồm: ***Tự động đưa vào hóa đơn***, ***Hoàn lại khi trả hàng***.
5. Nhấn ***Lưu*** để hoàn tất. Khoản thu mới sẽ xuất hiện trong danh sách quản lý.

### **2. Áp dụng thu khác khi bán hàng**

* **Tình huống:** Khi tạo hóa đơn cho khách, bạn cần áp dụng "Phí giao hàng" và kiểm tra lại "Phí dịch vụ" đã được tự động thêm vào hay chưa.
* **Thao tác thực hiện như sau:**

1. Trên màn hình **Bán hàng**, sau khi chọn sản phẩm, bạn nhấn vào mục **Thu khác**.
2. Một cửa sổ sẽ hiện ra liệt kê các khoản thu khác có thể áp dụng. Các khoản thu được thiết lập tự động sẽ được chọn sẵn.
3. Bạn có thể tích hoặc bỏ tích để thêm/bớt các khoản thu, hoặc chỉnh sửa giá trị thu trực tiếp trên hóa đơn đó nếu cần.

### **3. Quản lý các khoản thu khác hiện có**

* **Tình huống:** Bạn cần thay đổi giá trị của "Phí giao hàng", tạm ngưng sử dụng một khoản phí cũ và sắp xếp lại thứ tự hiển thị của chúng trên hóa đơn.
* **Thao tác thực hiện như sau:**

1. Tại màn hình **Quản lý thu khác**, bạn chọn một khoản thu để xem chi tiết.
2. Sử dụng các nút chức năng như **Chỉnh sửa** (để thay đổi thông tin), **Ngừng thu** (để tạm ẩn khỏi màn hình bán hàng), **Cho phép thu** (để sử dụng lại), hoặc **Xóa** (nếu chưa phát sinh giao dịch).

3. Để thay đổi thứ tự, trên danh sách thu khác, bạn nhấn ***Thứ tự hiển thị*** → kéo thả thu khác để thay đổi vị trí → nhấn ***Lưu***.

## **III. Các tính năng nâng cao**

### **1. Xử lý thu khác khi trả hàng**

* **Tình huống:** Khách hàng trả lại một sản phẩm từ hóa đơn có áp dụng "Phí dịch vụ" (được thiết lập hoàn lại). Bạn cần tạo phiếu trả hàng và hoàn lại đúng khoản phí này.
* **Thao tác thực hiện như sau:**

1. Khi tạo phiếu trả hàng từ hóa đơn gốc, hệ thống sẽ tự động gợi ý hoàn trả các khoản thu khác được đánh dấu "Hoàn lại khi trả hàng".
2. Bạn có thể nhấn vào mục **Hoàn trả thu khác** để xem chi tiết, chỉnh sửa giá trị hoặc quyết định không hoàn lại khoản phí đó cho phiếu trả hàng này.

3. Đối với trả hàng nhanh, bạn cần chủ động chọn các khoản thu khác cần hoàn lại.

### **2. Tùy chỉnh mẫu in**

* **Tình huống:** Bạn muốn trên hóa đơn in và phiếu trả hàng phải hiển thị rõ ràng tên và giá trị các khoản thu khác đã áp dụng.
* **Thao tác thực hiện như sau:** 
  + Bạn vào **Thiết lập** → **Xem tất cả thiết lập** → **Mẫu in** và thêm các mã (token) tương ứng vào mẫu in cần hiển thị: 
    - Mẫu in hóa đơn: {Ten\_Loai\_Thu\_Khac} và {Muc\_Thu\_Khac}.

* Mẫu in trả hàng: {Ten\_Loai\_Thu\_Khac\_Hoan\_Lai} và {Muc\_Thu\_Khac\_Hoan\_Lai}.

### **3. Xem báo cáo**

* **Tình huống:** Cuối kỳ, bạn cần xem tổng các khoản thu khác đã thu được trong báo cáo cuối ngày và báo cáo tài chính.
* **Thao tác thực hiện như sau:** 
  + **Báo cáo cuối ngày:** Bạn vào **Phân tích** → **Báo cáo** → **Cuối ngày**. Trong mối quan tâm **Bán hàng**, các khoản thu khác sẽ được ghi nhận.

* **Báo cáo tài chính:** Bạn vào **Phân tích** → **Báo cáo** → **Tài chính**. Các khoản thu khác được tổng hợp trong mục **Thu nhập khác**.

### **4. Phân quyền người dùng**

* **Tình huống:** Bạn muốn chỉ cho phép nhân viên thu ngân áp dụng các khoản thu khác đã có sẵn, nhưng không được phép thêm mới, sửa hoặc xóa các khoản thu này.
* **Thao tác thực hiện như sau:**

1. Bạn vào **Thiết lập** → **Xem tất cả thiết lập** → **Quản lý người dùng** →  chọn tài khoản người dùng cụ thể → nhấn **Phân quyền**

Hoặc ***Chỉnh sửa*** vai trò cho nhiều tài khoản.

2. Trong mục **Đơn hàng** → **Thu khác**, bạn chỉ cấp quyền ***Xem***. Bỏ chọn các quyền ***Tạo****,* ***Chỉnh sửa*** và ***Xóa***.

## **IV. Thao tác trên Điện thoại**

Tính năng Thu Khác trên ứng dụng KiotViet hỗ trợ cửa hàng thực hiện thao tác áp dụng thu khác khi bán hàng.

* **Tình huống:** Khi bạn đang tạo đơn hàng trên ứng dụng KiotViet và cần áp dụng một khoản phí phụ thu.
* **Thao tác thực hiện như sau:**

1. Khi **Thanh toán** đơn hàng, ứng dụng tự động thêm các khoản thu khác được thiết lập ***Tự động đưa vào hóa đơn***.
2. Bạn chạm vào giá trị **Thu khác** để thêm/bớt các khoản thu, hoặc chỉnh sửa giá trị thu trực tiếp trên hóa đơn đó nếu cần → chọn ***Hoàn thành***.

## **V. Thao tác trên Máy POS**

Tính năng Thu Khác trên KiotViet Máy Bán hàng hỗ trợ cửa hàng thực hiện thao tác: áp dụng thu khác khi thanh toán.

* **Tình huống:** Nhân viên thu ngân đang thực hiện thanh toán cho khách tại quầy bằng máy POS và cần áp dụng một khoản thu khác vào hóa đơn.
* **Thao tác thực hiện như sau:**

1. Trong màn hình giao dịch, sau khi thêm hàng hóa, chạm **Thanh toán**.
2. Trong cửa sổ chi tiết thanh toán, mục **Thu khác** sẽ hiển thị các khoản thu được thiết lập tự động.
3. Bạn có thể chạm vào mục này để chỉnh sửa giá trị hoặc áp dụng/bỏ áp dụng các khoản thu khác.
4. Chạm **Hoàn thành** để kết thúc giao dịch.
