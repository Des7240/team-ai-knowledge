...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-lam-quen-voi-kiotviet/buoc-2-nhap-hang/
---
...
Nhập hàng là nghiệp vụ ghi nhận chính xác số lượng hàng hóa nhập về từ nhà cung cấp, giúp tự động cập nhật tồn kho và quản lý công nợ phải trả. Đây là thao tác cốt lõi để đảm bảo dữ liệu tồn kho luôn khớp với thực tế sau khi đã thêm hàng hóa vào hệ thống.

**Lợi ích nổi bật của tính năng:**

* **Cập nhật tồn kho tự động:** Giúp chủ cửa hàng và nhân viên kho đảm bảo số lượng tồn kho tự động tăng ngay sau khi hoàn thành phiếu nhập, giúp việc bán hàng không bị gián đoạn.
* **Quản lý công nợ hiệu quả:** Hỗ trợ chủ cửa hàng và bộ phận kế toán dễ dàng theo dõi các khoản đã thanh toán hoặc còn nợ nhà cung cấp trên từng phiếu, giúp kiểm soát tài chính.
* **Lưu trữ lịch sử giao dịch:** Giúp chủ cửa hàng và quản lý tra cứu lại toàn bộ thông tin về sản phẩm, số lượng, giá nhập và nhà cung cấp, phục vụ việc phân tích kinh doanh.

## **II. Thao tác Nhập hàng**

Để dễ hình dung, các ví dụ dưới đây sẽ minh họa những tình huống kinh doanh thực tế.

**Tình huống**: Khi bạn cần ghi nhận một lô hàng mới nhập về, ví dụ 10 thùng "Sữa tươi Ba Vì - Vani" từ một nhà cung cấp mới, và bạn muốn ghi nhận công nợ do chưa thanh toán ngay cho nhà cung cấp đó.

**Thao tác thực hiện như sau**:

* **Bước 1:** **Truy cập màn hình Nhập hàng**:
  + Từ màn hình chính, vào menu **Mua hàng** → chọn **Nhập hàng**.
  + Tại góc trên bên phải, nhấn vào nút **+ Nhập hàng**.

* **Bước 2:** **Thêm sản phẩm vào phiếu nhập**:
  + Trong ô tìm kiếm, gõ "Sữa tươi Ba Vì Vani" và chọn đúng sản phẩm.
  + Chọn đơn vị tính là **Thùng**.
  + Tại cột **Số lượng**, nhập 10.
  + Tại cột **Giá nhập**, nhập 240,000.

* **Bước 3:** **Thêm thông tin Nhà cung cấp**:
  + Ở góc phải màn hình, nhấn vào biểu tượng dấu cộng (+) bên cạnh ô tìm kiếm nhà cung cấp để thêm nhà cung cấp mới.
  + Điền tên "Nhà cung cấp A" và các thông tin cần thiết rồi lưu lại.

* **Bước 4:** **Xử lý thanh toán và hoàn tất**:
  + Trong phần thanh toán, vì chưa trả tiền, giữ nguyên giá trị 0 ở ô **Tiền trả nhà cung cấp**. Toàn bộ giá trị phiếu nhập sẽ được ghi nhận là công nợ.
  + Nhấn **Hoàn thành** để ghi nhận phiếu nhập vào hệ thống.

* Sau khi hoàn tất, tồn kho của sản phẩm "Sữa tươi Ba Vì - Vani" sẽ tự động được cộng thêm 10 thùng.

* Bạn có thể vào **Hàng hóa** → **Danh sách hàng hóa** để kiểm tra lại.
