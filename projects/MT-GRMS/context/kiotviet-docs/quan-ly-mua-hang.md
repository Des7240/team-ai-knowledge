...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-ke-toan-hkd-giao-dich/quan-ly-mua-hang/
---
...
Hỗ trợ
Kế toán HKD - Giao dịchQuản lý Mua hàng

# **Quản lý Mua hàng**

*(Phần mềm Kế toán Hộ kinh doanh - Ngành Bán buôn, Bán lẻ)*
...
Khi hộ kinh doanh thiết lập hồ sơ khai thuế thuộc nhóm tính thuế TNCN theo lợi nhuận, trong nhóm chức năng "Thuế - Kế toán", phần mềm hỗ trợ tính năng Quản lý Mua hàng giúp kế toán quản lý toàn bộ giao dịch mua hàng hóa, dịch vụ đầu vào. Hệ thống bao gồm cả giao dịch đồng bộ từ phần mềm bán hàng KVS lẫn giao dịch nhập tay thủ công, từ đó tự động hạch toán kế toán và phân loại chi phí hợp lệ để phục vụ tính thuế.

**Lợi ích nổi bật của tính năng:**

* Hệ thống sẽ tự động đồng bộ giao dịch mua hàng, nhập hàng, trả hàng nhập từ phần mềm Quản lý bán hàng KiotViet, không cần nhập liệu thủ công.
* Tự động tạo bút toán kế toán theo từng loại hàng (Nguyên vật liệu, Công cụ dụng cụ, Tài sản cố định, hàng hóa, dịch vụ).
* Xử lý đúng các trường hợp phức tạp như: Công cụ dụng cụ/Dịch vụ đang phân bổ chi phí, Tài sản cố định đang khấu hao, hoặc hàng mua có chiết khấu.
* Theo dõi tập trung các giao dịch Mua hàng và Trả hàng trên cùng một danh sách với bộ lọc riêng biệt.
* Xác định được chi phí hợp lệ để tính thuế chính xác hơn.

**Đối tượng áp dụng:** Kế toán hoặc chủ "Hộ kinh doanh áp dụng tính thuế TNCN theo lợi nhuận" cần ghi nhận chi phí đầu vào, đồng thời kiểm soát các nghiệp vụ trả hàng cho nhà cung cấp để đảm bảo sổ sách khớp với thực tế kho và trạng thái tài sản, phục vụ việc tính thuế theo công thức: Thuế = (Doanh thu − Chi phí hợp lệ) × Thuế suất.

**Lưu ý:** Không dùng cho Hộ kinh doanh Nhóm 1 hoặc Nhóm 2 (tính thuế theo doanh thu).

## **II. Các thao tác cơ bản**

### **1. Xem danh sách giao dịch mua hàng**

**Tình huống:** Là hộ kinh doanh áp dụng tính thuế TNCN theo lợi nhuận, khi bạn cần theo dõi kiểm tra và quản lý tổng thể toàn bộ các giao dịch mua hàng hóa, dịch vụ cũng như các giao dịch trả hàng nhập đã phát sinh theo từng kỳ kế toán.

**Thao tác thực hiện như sau:**

* **Bước 1:** Trên màn hình **Quản lý**, truy cập vào menu **Thuế & Kế toán** → **Thuế & Kế toán** → chọn **Mua hàng**.
* **Bước 2:** Hệ thống hiển thị danh sách chứng từ mặc định theo quý này.

* **Bước 3:** Bạn có thể tìm kiếm, sử dụng bộ lọc để tìm
  + Theo mã phiếu, tên hàng.
  + Theo địa điểm.
  + Thời gian.
  + Nguồn: ***Đồng bộ*** từ phần mềm Quản lý bán hàng KiotViet hoặc tự tạo ***Thủ công*** trên màn hình này.
  + Bảng kê: Có/Không có

​

### **2. Tạo giao dịch mua hàng thủ công**

**Tình huống:** Là Hộ kinh doanh áp dụng tính thuế TNCN theo lợi nhuận, khi bạn phát sinh các giao dịch mua hàng bên ngoài, không được ghi nhận trong phần mềm Quản lý bán hàng KiotViet và cần nhập tay vào hệ thống để tính chi phí.

**Thao tác thực hiện như sau:**

* **Bước 1:** Trên màn hình **Mua hàng** → nhấn ***+ Lập phiếu mua hàng***.

​

* **Bước 2:** Nhập các thông tin chung của giao dịch, bao gồm:
  + ***Chọn mã địa điểm kinh doanh***.
  + ***Ngày mua***.
  + ***Trạng thái thanh toán***.
  + ***Phương thức thanh toán***.
  + ***Chứng từ đầu vào***: Với giao dịch không có hóa đơn đầu vào, bạn cần tích ***Đưa vào*** ***bảng kê 02/TNDN*** để được tính là chi phí hợp lệ → tiếp tục nhập các thông tin bắt buộc của nhà cung cấp (Mã số thuế/CCCD, Tên nhà cung cấp, Địa chỉ).

​

* **Bước 3:** Thêm hàng hóa, dịch vụ vào phiếu mua hàng.
  + Hệ thống mặc định ***Không áp dụng*** ***Chiết khấu***, bạn có thể chọn loại chiết khấu ***Theo từng mặt hàng*** hoặc ***Theo đơn hàng***.
  + Bạn nhấn ***+ Thêm dòng*** →  điền các thông tin:
    - ***Tính chất hàng hóa, dịch vụ***: Chọn 1 trong 2 loại ***Công cụ dụng cụ*** hoặc ***Dịch vụ***.
    - ***Hàng hóa, dịch vụ***: Điền tên hàng hóa, dịch vụ.
    - ***Đơn vị tính***.
    - ***Số lượng***.
    - ***Đơn giá***.
...
**Lưu ý:** Tính chất và đơn giá của hàng hóa, dịch vụ sẽ làm ảnh hưởng đến tài khoản hạch toán và phân hệ nhận dữ liệu, cụ thể như sau:

* Đối với ***Dịch vụ****, **Công cụ dụng cụ*** giá trị nhỏ hơn 30 triệu: Dữ liệu sẽ chuyển về phân hệ **CCDC & Dịch vụ**, hệ thống mặc định chưa ghi nhận.
* Đối với ***Công cụ dụng cụ*** giá trị từ 30 triệu trở lên: Dữ liệu chuyển về phân hệ **Tài sản cố định**, hệ thống mặc định chưa thiết lập khấu hao, bạn cần thiết lập thời gian khấu hao tối thiểu 12 tháng.

* **Bước 4:** Nhấn ***Lưu*** để hoàn tất.

### **3. Tạo giao dịch trả hàng nhập thủ công**

**Tình huống:** Khi bạn chủ động cần tạo phiếu trả hàng cho Công cụ dụng cụ hoặc Dịch vụ (không phát sinh đồng bộ từ phần mềm KiotViet) để ghi nhận hoàn trả chi phí cho nhà cung cấp.

**Thao tác thực hiện như sau:**

* **Bước 1:** Trên màn hình **Mua hàng**, tại tab **Phiếu mua hàng** → mở chi tiết phiếu mua hàng thủ công cần trả → nhấn ***Trả hàng nhập***.

* **Bước 2:** Hệ thống hiển thị popup **Phiếu trả hàng nhập**, bạn chọn các thông tin chung:
  + Ngày trả hàng.
  + Phương thức nhận tiền hoàn
  + Tài khoản nhận tiền hoàn (nếu chọn phương thức Chuyển khoản)
* **Bước 3:** Chọn hàng hóa trả lại.
  + Tích chọn dòng hàng hóa cần trả lại hoặc nhấn ***Trả tất cả hàng hóa***.
  + Trên từng dòng hàng hóa → hệ thống mặc định ***SL trả lần này*** và ***Đơn giá trả*** theo phiếu mua hàng, bạn có thể chỉnh sửa và ***Nhập lý do***.
* **Bước 4:** Kiểm tra lại cột ***Thành tiền trả***. Hệ thống tự động tính theo công thức: Thành tiền trả = (Đơn giá − Giảm giá sản phẩm) × Số lượng trả.
* **Bước 5:** Nếu Công cụ dụng cụ/Dịch vụ/ Tài sản cố định đã phân bổ/ khấu hao, hệ thống sẽ hiển thị một cảnh báo. Bạn cần đọc kỹ thông báo này và nhấn Xác nhận.
* **Bước 6:** (Tùy chọn) Nếu đã nhận lại tiền từ nhà cung cấp, bạn tích chọn Đã nhận hoàn tiền, sau đó chọn phương thức là Tiền mặt hoặc Chuyển khoản.
* **Bước 7:** Nhấn ***Lưu***.

## **III. Các tính năng nâng cao**

### **1. Sửa và xóa giao dịch mua hàng**

**Tình huống:** Là hộ kinh doanh áp dụng tính thuế TNCN theo lợi nhuận, khi bạn phát hiện sai sót trong quá trình nhập liệu hoặc hệ thống đồng bộ và cần chỉnh sửa, xóa bỏ giao dịch.

**Thao tác thực hiện như sau:**

* **Đối với giao dịch tạo thủ công ngay trên màn hình Mua hàng:**
  + Bạn có thể sửa tất cả các trường thông tin hoặc xóa giao dịch.
  + **Lưu ý:** Khi xóa giao dịch thủ công, toàn bộ bản ghi **Công cụ dụng cụ & Dịch vụ** hoặc **Tài sản cố định** có liên kết với giao dịch này cũng sẽ bị xóa theo.
  + Để chỉnh sửa giao dịch, trong chi tiết phiếu, bạn nhấn ***Chỉnh sửa*** → thay đổi thông tin → nhấn ***Lưu***.

* Để xóa giao dịch, trong chi tiết phiếu, bạn nhấn ***Xóa →*** xác nhận ***Xóa***.

* **Đối với giao dịch đồng bộ từ phần mềm Quản lý bán hàng KiotViet:**
  + Bạn chỉ có thể sửa các thông tin: Tên Nhà cung cấp, Địa chỉ, Số CCCD và tích chọn/không tích ***Đưa vào bảng kê 02/TNDN***. **Lưu ý**: Thay đổi tại đây không ảnh hưởng đến chứng từ gốc.
  + Để xóa giao dịch, bạn vui lòng truy cập menu **Mua hàng** → **Nhập hàng** và thực hiện thao tác xóa từ giao dịch gốc.

### **2. Xác định chi phí hợp lệ và không hợp lệ**

**Tình huống:** Là hộ kinh doanh áp dụng tính thuế TNCN theo lợi nhuận, khi bạn cần kiểm tra xem các khoản chi phí mua hàng có đủ điều kiện để được tính là chi phí hợp lệ khi khấu trừ thuế hay không.

Hệ thống sẽ tự động đánh dấu chi phí là "Không hợp lệ" nếu vi phạm các điều kiện sau:

* Giao dịch thiếu chứng từ đầu vào (không có hóa đơn đầu vào hoặc không có bảng kê).
* Phiếu mua hàng có giá trị trên 5 triệu đồng nhưng được thanh toán bằng tiền mặt.

​

### **3. Trả hàng một phần đã phân bổ/ khấu hao**

**Tình huống:** Khi cửa hàng thực hiện trả một phần số lượng hàng hóa đã mua trên phần mềm KiotViet, trong khi Công cụ dụng cụ/ Dịch vụ hoặc Tài sản cố định đó đã có kỳ phân bổ/khấu hao trên hệ thống kế toán, bạn cần cập nhật lại thông tin để ghi nhận đúng chi phí.

**Thao tác thực hiện như sau:**

* **Bước 1:** Khi hệ thống nhận được dữ liệu trả hàng đồng bộ từ phần mềm KiotViet, hệ thống sẽ tự động đảo toàn bộ kỳ phân bổ hoặc khấu hao cũ, đồng thời xóa bản ghi Công cụ dụng cụ & Dịch vụ hoặc Tài sản cố định tương ứng.
* **Bước 2:** Bản ghi Công cụ dụng cụ & Dịch vụ hoặc Tài sản cố định cho phần số lượng còn lại sẽ hiển thị trạng thái ***Chưa phân bổ***/***Chưa thiết lập khấu hao*** → bạn cần truy cập menu **CCDC & Dịch vụ** hoặc **Tài sản cố định** để ***Ghi nhận chi phí*** hoặc ***Thiết lập khấu hao***.

### **4. Xem và xóa phiếu trả hàng nhập**

**Tình huống:** Khi bạn cần kiểm tra lại thông tin chi tiết của một giao dịch trả hàng nhập hoặc phát hiện sai sót cần xóa bỏ phiếu trả hàng đã tạo thủ công để đảm bảo số liệu kế toán chính xác.

**Thao tác thực hiện như sau:**

* Tại màn hình danh sách **Mua hàng**, tìm kiếm và nhấn vào mã phiếu trả hàng nhập để xem chi tiết giao dịch.

* Tại đây, với các phiếu trả hàng nhập từ phiếu mua hàng/ nhập hàng bạn có thể nhấn ***Xem phiếu mua nguồn***.

* Hệ thống sẽ chuyển đến phiếu mua tương ứng.

* **Để xóa phiếu trả hàng nhập thủ công:** Trong chi tiết phiếu trả hàng, nhấn ***Xóa*** và xác nhận ***Đảo bút toán & Hủy phiếu***.

**Lưu ý:** Đối với phiếu trả hàng nhập được đồng bộ tự động từ phần mềm KiotViet, bạn không thể xóa trực tiếp trên hệ thống kế toán. Bạn cần truy cập menu **Mua hàng** → **Trả hàng** **nhập** và thực hiện thao tác xóa từ giao dịch gốc.
