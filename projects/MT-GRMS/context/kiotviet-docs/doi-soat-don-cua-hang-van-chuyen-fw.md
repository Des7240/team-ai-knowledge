...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-giao-van/doi-soat-don-cua-hang-van-chuyen-fw/
---
...
Hiện tại KiotViet chỉ hỗ trợ đối soát thanh toán với các đơn giao hàng được lên đơn qua tài khoản chung của KiotViet, không hỗ trợ đối soát thanh toán với các đơn giao hàng mà khách hàng kết nối trực tiếp bằng tài khoản riêng. Việc này dẫn đến bất tiện cho khách hàng trong quá trình quản lý, đối soát dòng tiền.

Do vậy, KiotViet đã ra mắt tính năng Tạo phiếu đối soát để khách hàng có thể chủ động tạo phiếu đối soát với các đơn hàng lên qua tài khoản riêng với hãng vận chuyển này.

Hiện tại, tính năng mới ra mắt trên Mobile app “KiotViet Quản lý”, chưa có trên giao diện web.

## **II. Các thao tác cơ bản**

## Các bước thực hiện như sau:

- Để tạo phiếu đối soát, trên app KiotViet Quản lý, bạn chọn **Nhiều hơn** (1) ->**Giao hàng** (2)

- Trong mục **Quản lý dòng tiền ->** chọn ***Xem lịch sử đối soát*** (3).

- Trên màn hình **Lịch sử đối soát,** bạn chọn nút  (4) ở góc dưới bên phải màn hình -> màn hình **Tạo phiếu đối soát** (5) hiển thị như sau:

 

- Bạn chọn hãng vận chuyển cần tạo đối soát (6). Lúc này, Mã phiếu (7) sẽ được sinh tự động theo cú pháp [DS\_Hãng vận chuyển\_Ngày tạo\_(STT)\_Gian hàng] -> Bạn chọn ***Chọn vận đơn trong kỳ*** (8)

 

- Ứng dụng sẽ lọc ra danh sách đơn thuộc kỳ đối soát, bạn có thể tích chọn từng vận đơn hoặc tất cả vận đơn để đưa vào phiếu đối soát. Sau đó bạn chọn **Tạo phiếu đối soát** (9) để lưu lại phiếu.

* Danh sách vận đơn trong kỳ sẽ hiển thị thông tin COD đối soát và Phí đối soát được lấy từ hệ thống quản lý đơn hàng của KiotViet đã đồng bộ.
* Nếu muốn sửa COD hoặc phí: Bạn chọn vào biểu tượng bút chì bên cạnh tiền COD đối soát hoặc Phí đối soát -> nhập vào đúng giá trị thực cần đối soát -> ***Xác nhận*** để lưu

 

- Sau khi lưu thành công, phiếu đối soát vừa tạo sẽ hiển thị trên đầu danh sách **Lịch sử đối soát**. Bạn có thể ***Hủy*** (1) hoặc ***Sửa*** (2) các phiếu đối soát chưa thực hiện thanh toán.

 

- Cuối cùng, bạn chọn **Thực hiện thanh toán** (10) để hoàn thành. Khi đó đối soát sẽ được đồng bộ và hiển thị trên web quản lý -> mục **Đối tác giao hàng** -> **Lịch sử đối soát**.

***- Lưu ý:***

* Khi bấm ***Thực hiện thanh toán***, hệ thống sẽ thông báo cần thực hiện tính năng này bản web, vì trên ứng dụng chưa hỗ trợ thanh toán.

* Sau khi bấm ***Thực hiện thanh toán***, phiếu đối soát sẽ không thể sửa hoặc hủy được nữa. Các nút ***Sửa*** và ***Hủy*** sẽ bị ẩn đi.
* Sau khi xác nhận thanh toán xong, nếu đơn trong đối soát có thay đổi tiền COD đối soát hoặc Phí đối soát khác với thông tin trên hệ thống trước đó, hệ thống sẽ tự động cập nhật lại thông tin COD đối soát và phí mới vào vận đơn.
