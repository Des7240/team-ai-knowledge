...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-hang-hoa/hang-hoa-lo-han-su-dung/
---
...
*(Ngành Tạp hóa - Siêu thị, Mỹ phẩm, Mẹ và Bé, Nhà thuốc, Nông sản - Thực phẩm, Khác)*

## **I. Giới thiệu chung**

Tính năng này được thiết kế để giải quyết các bài toán đặc thù trong quản lý hàng hóa có vòng đời theo hạn sử dụng. 

**Lợi ích nổi bật của việc quản lý Hàng hóa theo Lô – Hạn sử dụng trên KiotViet:**

* **Kiểm soát tồn kho chính xác và minh bạch đến từng lô hàng:** Dễ dàng theo dõi số lượng tồn kho, giá vốn của từng lô hàng riêng biệt. Mọi giao dịch xuất, nhập, chuyển, hủy đều được ghi nhận chi tiết theo lô, giúp bạn truy xuất lịch sử và quản lý hàng hóa một cách minh bạch, tránh thất thoát.
* **Tối ưu hóa việc xuất kho, giảm thiểu thất thoát do hàng hết hạn:** Hệ thống tự động gợi ý xuất bán các lô hàng có hạn sử dụng gần nhất theo nguyên tắc FEFO (First Expired, First Out - Hết hạn trước, Xuất trước). Điều này giúp bạn đẩy bán các sản phẩm sắp hết hạn một cách hiệu quả, giảm thiểu rủi ro hàng tồn kho quá hạn gây lãng phí.
* **Chủ động trong kinh doanh với hệ thống báo cáo và cảnh báo thông minh:** KiotViet cung cấp báo cáo chi tiết về các lô hàng sắp hết hạn, đã hết hạn, đồng thời đưa ra cảnh báo bằng màu sắc ngay trên màn hình bán hàng. Nhờ đó, bạn có thể chủ động lên kế hoạch xả hàng, khuyến mại kịp thời.
...
* **Tình huống:** Để bắt đầu sử dụng, bạn cần kích hoạt tính năng quản lý theo Lô - Hạn sử dụng cho cửa hàng của mình.
* **Thao tác thực hiện như sau:** Bạn vào menu **Thiết lập** → **Hàng hóa** → bật tính năng ***Quản lý tồn kho theo Lô, hạn sử dụng***.

### **2. Thêm mới hàng hóa theo Lô - Hạn sử dụng**

* **Tình huống:** Bạn cần tạo một sản phẩm mới và quản lý nó theo từng lô nhập hàng, ví dụ như một lô sữa bột mới.
...
**Lưu ý**: Tồn kho ban đầu sẽ không được nhập ở bước này, bạn cần tạo phiếu nhập hàng.

### **3. Nhập hàng theo Lô - Hạn sử dụng**

* **Tình huống:** Bạn vừa nhập một lô hàng mới và cần ghi nhận số lượng, hạn sử dụng và giá vốn của lô đó vào hệ thống.
* **Thao tác thực hiện như sau:**
...
### **4. Bán hàng theo Lô - Hạn sử dụng**

* **Tình huống:** Khách hàng mua một sản phẩm, bạn cần xuất bán từ lô hàng có hạn sử dụng gần nhất để tối ưu vòng đời sản phẩm.
* **Thao tác thực hiện như sau:**
...
### **1. Xử lý các giao dịch**

* **Tình huống:** Bạn cần xử lý các nghiệp vụ kho khác như trả hàng, chuyển kho, kiểm kê hoặc xuất hủy hàng hết hạn.
* **Thao tác thực hiện như sau:** 
  + **Trả hàng:** Khi khách mang hàng đến trả lại, bạn chọn đúng lô hàng cần nhập trả lại kho.

* **Chuyển hàng:** Tương tự như bán hàng, hệ thống sẽ gợi ý lô xuất chuyển theo nguyên tắc FEFO.

* **Kiểm kho:** Khi tạo phiếu kiểm kho, bạn cần chọn từng lô và nhập số lượng thực tế của lô đó.

* **Xuất hủy:** Khi tạo phiếu xuất hủy, bạn phải chọn chính xác lô hàng cần hủy.

### **2. Xem báo cáo Hạn sử dụng**

* **Tình huống:** Bạn cần một danh sách các lô hàng sắp hết hạn để lên kế hoạch khuyến mại hoặc xả hàng.
* **Thao tác thực hiện như sau:**

1. Vào menu **Phân tích** → **Hàng hóa**.
2. Chọn mối quan tâm **Hạn sử dụng**. Báo cáo sẽ liệt kê chi tiết các lô hàng sắp hết hạn và đã hết hạn.

## **IV. Thao tác trên Điện thoại**

Tính năng quản lý hàng hóa theo Lô - Hạn sử dụng trên ứng dụng KiotViet hỗ trợ cửa hàng thực hiện các thao tác: Thêm mới, Nhập hàng, Bán hàng.

### **1. Thêm mới và Nhập hàng theo Lô - Hạn sử dụng**

* **Tình huống:** Bạn cần tạo mới một sản phẩm và nhập lô hàng đầu tiên cho nó ngay trên ứng dụng di động.
* **Thao tác thực hiện như sau:**

1. Trong menu **Hàng hóa** trên **ứng dụng KiotViet**, chạm dấu **+** để thêm hàng hóa mới, bật tùy chọn **Quản lý theo lô, hạn sử dụng**.

2. Khi tạo phiếu **Nhập hàng**, sau khi chọn sản phẩm, ứng dụng sẽ cho phép bạn nhập thông tin chi tiết về lô hàng.
...
* **Tình huống:** Nhân viên thu ngân cần nhanh chóng xuất bán sản phẩm cho khách theo đúng lô hàng được hệ thống gợi ý.
* **Thao tác thực hiện như sau:**
