...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-chuyen-nganh/nganh-vat-lieu-xay-dung/
---
...
Tính năng Quản lý Hàng hóa Nhiều Đơn vị tính của KiotViet được thiết kế chuyên biệt để giải quyết các thách thức đặc thù của ngành vật liệu xây dựng. Tính năng này giúp bạn quản lý hiệu quả các sản phẩm nhập kho theo quy cách đóng gói (thùng, tấm, cuộn) và bán hàng theo kích thước hoặc trọng lượng mà khách yêu cầu (mét vuông, kg).

**Lợi ích nổi bật của tính năng:**

* **Giúp chủ cửa hàng và quản lý kho quản lý tồn kho chính xác:** Cho phép quản lý tồn kho theo đơn vị đóng gói gốc của nhà sản xuất (viên, hộp, thùng, tấm), đảm bảo dữ liệu nhập xuất tồn được đồng bộ và chính xác tuyệt đối.
* **Hỗ trợ nhân viên bán hàng tư vấn và bán hàng linh hoạt:** Dễ dàng tư vấn và bán hàng theo các đơn vị quy đổi như mét vuông (m²) hoặc kilogram (kg) tùy theo nhu cầu thực tế của khách hàng.
* **Giúp cửa hàng tối ưu hóa quy trình vận hành:** Tự động hóa việc quy đổi giữa các đơn vị khi bán hàng, giúp giảm thiểu sai sót trong tính toán và tiết kiệm thời gian cho nhân viên.

## **II. Các thao tác cơ bản**

Để dễ hình dung, các ví dụ dưới đây sẽ minh họa những tình huống bán hàng thực tế.

### **1. Khai báo kích thước cho hàng hóa**

* **Tình huống:** Khi bạn cần thiết lập thông tin cho các sản phẩm như gạch ốp, sàn gỗ, tôn, kính... để hệ thống có thể hỗ trợ tính toán số lượng khi bán hàng.
* **Thao tác thực hiện như sau:**

1. Bạn truy cập vào menu **Hàng hóa** → **Danh sách hàng hóa**.

2. Chọn **Tạo mới hàng hóa** hoặc ***Chỉnh sửa*** một mặt hàng đã có.
3. Tại thông tin **Kích thước** → nhập thông tin chiều ***Rộng*** và ***Dài*** cho đơn vị cơ bản của sản phẩm.

Đối với hàng hóa có tên chứa từ "gạch", hệ thống sẽ gợi ý các kích thước phổ biến để bạn chọn nhanh.

4. Hoàn tất các thông tin khác và nhấn ***Lưu***.

### **2. Bán hàng theo quy cách Viên/Miếng (Áp dụng cho Gạch, Sàn gỗ,...)**

* **Tình huống:** Khi khách hàng đến mua gạch lát sàn và yêu cầu bạn tính toán số lượng viên (hoặc thùng) cần thiết để lát một diện tích là 30m².
* **Thao tác thực hiện như sau:**

1. Trên màn hình **Bán hàng**, thêm sản phẩm gạch vào hóa đơn.
2. Đưa chuột vào tên hàng hóa và nhấn vào biểu tượng thước .

3. Tại pop-up **Gợi ý bán**:

* Chọn quy cách **Viên/Miếng**
* Trong ô **Khách cần**, bạn nhập 30 (tương ứng 30m²).

4. Hệ thống sẽ tự động tính toán tổng số lượng viên và quy đổi ra số thùng tương ứng cần bán.

5. Bạn có thể điều chỉnh lại số lượng cuối cùng theo thực tế bán cho khách hàng.
6. Nhấn **Xong** để hệ thống cập nhật số lượng vào hóa đơn.

### **3. Bán hàng theo quy cách Tấm/Miếng (Áp dụng cho Tôn, Kính,...)**

* **Tình huống:** Khi bạn cần bán nhiều tấm kính với các kích thước khác nhau cho khách hàng trong cùng một đơn hàng, ví dụ: 1 tấm 1.2m x 1.8m và 2 tấm 1.08m x 1.5m.
* **Thao tác thực hiện như sau:**

1. Trên màn hình **Bán hàng**, thêm sản phẩm kính vào hóa đơn.
2. Đưa chuột vào tên hàng hóa và nhấn vào biểu tượng thước .

3. Chọn quy cách **Tấm/Miếng**.
4. Tại pop-up **Gợi ý bán**: 
   * Dòng 1: Nhập **Rộng** 1.2, **Dài** 1.8, **SL/Hệ số** 1.
   * Dòng 2: Nhập **Rộng** 1.08, **Dài** 1.5, **SL/Hệ số** 2.
5. Hệ thống sẽ tự động tính tổng diện tích (m²) cần bán.

6. Bạn có thể điều chỉnh lại số lượng cuối cùng nếu cần.
7. Nhấn **Xong** để cập nhật số lượng vào hóa đơn. Sau khi hoàn tất, bạn có thể xem lại chi tiết kích thước trong phần ghi chú của dòng hàng hóa.

## **III. Tính năng nâng cao**

**Hiển thị chi tiết kích thước trên mẫu in hóa đơn**

* **Tình huống:** Sau khi tính toán và thêm sản phẩm vào hóa đơn, bạn muốn các thông tin chi tiết về kích thước (ví dụ: "1 ô kính rộng 1.2m x dài 1.8m") được thể hiện rõ ràng trên hóa đơn in ra cho khách hàng.
* **Thao tác thực hiện như sau:** Để thông tin về chiều dài, rộng, cao, hệ số của hàng hóa hiển thị trên hóa đơn, bạn cần đảm bảo mẫu in của mình có chứa token {Rong}, {Dai}, {He\_So}, {Cao}.
...
* **Tình huống:** Khi bạn cần thêm mới một sản phẩm vật liệu xây dựng và khai báo kích thước ngay trên ứng dụng KiotViet.
* **Thao tác thực hiện như sau:**

1. Trong menu **Hàng hóa** trên ứng dụng KiotViet, khi tạo mới/ sửa hàng hóa, bạn nhập thông tin **Rộng** và **Dài** cho sản phẩm.
2. Nhấn ***Lưu*** để hoàn tất.

### **2. Bán hàng vật liệu xây dựng**

* **Tình huống:** Khi bạn đang tư vấn cho khách ngay tại kho và cần dùng điện thoại để tạo hóa đơn, tính toán số lượng gạch hoặc tôn cần bán.
* **Thao tác thực hiện như sau:**

1. Khi bán hàng vật liệu xây dựng cần tính toán theo kích thước, bạn nhấn vào sản phẩm vừa thêm để mở chi tiết.
2. Nhấn ***Gợi ý bán***.
3. Chọn quy cách tính toán (**Viên/Miếng** hoặc **Tấm/Miếng**) và nhập các thông số theo yêu cầu của khách hàng.
4. Ứng dụng sẽ tự động tính toán số lượng cuối cùng.
5. Nhấn **Xong** để cập nhật số lượng vào đơn hàng và hoàn tất thanh toán.

Minh họa thao tác thực hiện với hàng hóa theo quy cách Tấm/Miếng:

Minh họa thao tác thực hiện với hàng hóa theo quy cách Viên/Miếng:
