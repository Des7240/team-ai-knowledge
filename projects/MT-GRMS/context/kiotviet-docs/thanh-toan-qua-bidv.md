...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-thanh-toan/thanh-toan-qua-bidv/
---
...
Nhằm hỗ trợ các gian hàng thúc đẩy việc thanh toán phi tiền mặt, KiotViet kết hợp cùng ngân hàng BIDV đã ra mắt tính năng thanh toán chuyển khoản bằng phương pháp quét mã VietQR và nhận thông báo kết quả ngay trên phần mềm.

**Đối tượng áp dụng:** Tất cả gian hàng trên KiotViet (bao gồm cả gian hàng dùng thử và gian hàng chính thức) có tài khoản tại ngân hàng BIDV.

**Lợi ích nổi bật của tính năng:**

* **Giúp chủ cửa hàng và quản lý**: Dễ dàng đăng ký và quản lý nhiều tài khoản BIDV trên cùng một gian hàng, giúp việc đối soát và theo dõi dòng tiền trở nên đơn giản và tập trung.
...
**Tóm tắt luồng hoạt động**: Về cơ bản, luồng hoạt động của tính năng bao gồm 2 bước chính: 1. Đăng ký dịch vụ nhận thông báo thanh toán của BIDV -> 2. Nhận thông báo kết quả giao dịch trên màn hình **Bán hàng**.

Nội dung dưới đây sẽ hướng dẫn chi tiết các thao tác được thực hiện trên phiên bản KiotViet dành cho website.

### **1. Đăng ký dịch vụ**

Để kích hoạt tính năng nhận thông báo thanh toán tự động, bạn cần đăng ký dịch vụ trực tiếp trên phần mềm KiotViet và xác thực bằng mã OTP.

* **Lưu ý về nguyên tắc liên kết tài khoản BIDV**:
  + Một gian hàng KiotViet có thể liên kết với **nhiều tài khoản BIDV**.
  + Hiện tại, tính năng chỉ hỗ trợ đăng ký tự động cho **tài khoản cá nhân**. Với tài khoản doanh nghiệp, bạn vui lòng liên hệ KiotViet để được hỗ trợ.
  + **Tài khoản định danh**: Mỗi tài khoản BIDV sau khi đăng ký thành công sẽ được gán với một tài khoản định danh trên KiotViet. Khi khách hàng quét mã QR, thông tin trên ứng dụng ngân hàng của họ sẽ hiển thị số tài khoản định danh này thay vì số tài khoản BIDV gốc của bạn.

Quá trình này được thực hiện như sau:

#### **1.1. Đăng ký dịch vụ trên KiotViet**

– Tài khoản admin của chủ gian hàng đăng nhập vào màn hình **Quản lý**, chọn mục **Thanh toán** và nhấn ***Đăng ký*** tại thẻ **BIDV**.

* Hoặc trên màn hình **Bán hàng**,
  + Ngay sau khi ***Lưu*** thông tin thêm tài khoản ngân hàng BIDV -> hệ thống hiển thị popup **Bật thông báo thanh toán QR**, bạn chọn ***Bật ngay***
  + Hay khi tạo đơn hàng, bạn chọn phương thức thanh toán ***Chuyển khoản*** -> chọn tài khoản ***BIDV*** -> nhấn ***Nhận thông báo tiền về***

– Tiếp theo, bạn chọn số tài khoản BIDV cần đăng ký, điền đầy đủ các thông tin giao dịch và chọn ***Đăng ký***.

#### **1.2. Xác thực bằng mã OTP**

– Sau khi nhấn Đăng ký, hệ thống sẽ gửi một mã OTP đến số điện thoại bạn đã đăng ký với ngân hàng BIDV.

– Bạn nhập mã OTP này vào màn hình trên KiotViet để hoàn tất việc xác thực.

– Sau khi thành công, hệ thống sẽ hiển thị thông báo dịch vụ đã được kích hoạt.
...
* **Thao tác trên màn hình Bán hàng**:
  + Khi tạo hóa đơn, bạn chọn phương thức thanh toán ***Chuyển khoản*** để hiển thị mã QR của tài khoản BIDV đã liên kết.
...
* Để gia tăng hiệu quả và tốc độ xử lý đơn hàng, bạn có thể kết hợp dịch vụ thông báo thanh toán của BIDV với các tiện ích như:
...
* **Lưu ý quan trọng**:  
  ...
  – Đối với các đơn hàng có mã QR được tạo ra trước khi bạn đăng ký dịch vụ, bạn cần tải lại trang **Bán hàng** hoặc thay đổi số tiền thanh toán để hệ thống tạo mã QR mới và hiển thị thông báo.

## **III. Tính năng nâng cao**

### **1. Xem danh sách tài khoản BIDV đã đăng ký dịch vụ**

* **Tình huống**: Khi bạn cần kiểm tra lại thông tin các tài khoản BIDV nào đang được kết nối để nhận thông báo tự động trên KiotViet.
* **Thao tác thực hiện như sau**:

1. Tại màn hình **Quản lý**, vào menu **Thanh toán**.
2. Chọn thẻ **BIDV** và nhấn **Xem chi tiết** để xem danh sách các tài khoản đã liên kết.

### **2. Hủy dịch vụ nhận thông báo thanh toán BIDV**

* **Tình huống**: Khi bạn không còn nhu cầu sử dụng dịch vụ nhận thông báo tự động cho một tài khoản BIDV cụ thể.
* **Thao tác thực hiện như sau**:

1. Tại mục xem chi tiết danh sách tài khoản (như thao tác trên), nhấn nút **Hủy đăng ký** tại tài khoản bạn muốn hủy.
2. Xác nhận lại bằng cách nhấn **Hủy đăng ký** một lần nữa để hoàn tất.

## **IV. Thao tác trên Điên thoại**

Tại ứng dụng KiotViet trên điện thoại, bạn có thể thực hiện các thao tác tương tự giao diện trên website bao gồm đăng ký, nhận thông báo kết quả giao dịch và quản lý các tài khoản đã liên kết.

### **1. Đăng ký dịch vụ**

– Từ menu **Nhiều hơn** hoặc **Tổng quan**, bạn chọn mục **Thanh toán** → nhấn ***Đăng ký ngay*** → Chọn thẻ **BIDV**.

– Điền các thông tin cần thiết và nhấn ***Tiếp tục***.

– Nhập mã OTP được gửi đến số điện thoại của bạn để hoàn tất.
...
### **3. Xem, quản lý và hủy liên kết**

– Truy cập mục ***Thanh toán*** và chọn thẻ ***BIDV***.

– Ứng dụng sẽ hiển thị danh sách các tài khoản đã liên kết thành công.

– Để đăng ký mới hoặc hủy dịch vụ, bạn thực hiện các thao tác tương tự như trên website.

## **V. Thao tác trên Máy POS**

Tính năng Thanh toán qua BIDV trên Máy POS Android hỗ trợ cửa hàng thực hiện thao tác thanh toán bằng cách hiển thị mã QR của BIDV cho khách hàng.

* **Tình huống**: Khi bạn đang bán hàng tại quầy và muốn khách hàng thanh toán bằng cách quét mã QR của BIDV trên màn hình máy POS.
* **Thao tác thực hiện như sau**:

1. Đảm bảo bạn đã thêm tài khoản BIDV và đăng ký dịch vụ trên phiên bản máy tính hoặc ứng dụng di động.
2. Khi tạo hóa đơn trên máy POS, chọn phương thức thanh toán là **Chuyển khoản** và chọn tài khoản BIDV đã liên kết.
