...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-thiet-lap/cai-dat-thong-bao-tren-dien-thoai/
---
...
Tính năng thông báo trên ứng dụng KiotViet giúp bạn nhận được cập nhật tức thì về các hoạt động quan trọng của cửa hàng ngay khi chúng phát sinh. Biểu tượng chuông báo trên màn hình sẽ hiển thị số lượng thông báo mới chưa xem.

**Lợi ích nổi bật của tính năng Cài đặt Thông báo trên KiotViet:**

* **Kiểm soát giao dịch:** Nhận thông báo tức thì về Đặt hàng, Hóa đơn, Vận đơn, Trả hàng, Nhập hàng, Chuyển hàng và Xuất hủy.
* **Quản lý hàng hóa:** Nhận cảnh báo về cập nhật tồn kho, kiểm kho, hàng dưới/vượt định mức và hàng sắp hết hạn sử dụng.
* **Theo dõi tài chính:** Cập nhật ngay khi có Phiếu thu hoặc Phiếu chi mới được lập.
* **Chăm sóc khách hàng:** Nhận nhắc nhở về sinh nhật của khách hàng để gửi lời chúc kịp thời.

## **II. Thao tác trên Điện thoại**

- Hệ thống hỗ trợ hiển thị thông báo trên ứng dụng ngay khi giao dịch vừa phát sinh.

- Biểu tượng hình chuông trên màn hình hiện số lượng thông báo mới chưa xem  .

- Để xem danh sách thông báo, trên màn hình **Tổng quan**, bạn chạm vào biểu tượng chuông báo

- Để cài đặt thông báo, bạn chạm vào biểu tượng   -> hệ thống chia làm 4 khối thông tin (2) cụ thể:

* **Giao dịch**: bao gồm các thông báo về:
  + **Đặt hàng**: Thông báo khi Hoàn thành đặt hàng, Hủy đặt hàng.
  + **Hóa đơn**: Thông báo khi Hoàn thành hóa đơn, Hủy hóa đơn, Vận đơn.
  + **Trả hàng**: Thông báo khi có phiếu trả mới.
  + **Nhập hàng**: Thông báo khi hoàn thành phiếu nhập hàng.
  + **Trả hàng nhập**: Thông báo khi hoàn thành phiếu trả hàng nhập.
  + **Chuyển hàng**: Thông báo khi hoàn thành phiếu chuyển hàng và nhận hàng.
  + **Xuất hủy**: Thông báo khi hoàn thành phiếu xuất hủy.
* **Hàng hóa**: bao gồm các thông báo:
  + **Cập nhật tồn kho hàng hóa**.
  + **Kiểm kho**: Thông báo khi hoàn thành phiếu kiểm.
  + **Cảnh báo tồn kho**: Thông báo 1 lần/ ngày vào buổi sáng khi gian hàng có hàng hóa dưới/ vượt định mức tồn.
  + **Cảnh báo sắp hết hạn** (áp dụng với gian hàng quản lý tồn kho theo Lô/Date): Thông báo 1 lần/ ngày vào buổi sáng khi gian hàng có hàng sắp hết hạn sử dụng trong khoảng thời gian thiết lập: Hôm nay, Tuần này, Tháng này, 30 ngày tới, Trong 2 tháng, Trong 3 tháng, Trong 6 tháng, Trong 1 năm.
* **Sổ quỹ**: bao gồm các thông báo:
  + **Phiếu thu**: Thông báo khi lập phiếu thu hặc thanh toán công nợ cho khách hàng thành công.
  + **Phiếu chi**: Thông báo khi lập phiếu chi hặc thanh toán công nợ cho nhà cung cấp, đối tác giao hàng thành công.
* **Khách hàng**: Thông báo 1 lần/ ngày vào buổi sáng khi gian hàng có khách hàng **sinh nhật** trong khoảng thời gian thiết lập: Hôm nay, 1 ngày tới, 2 ngày tới, 3 ngày tới, 7 ngày tới.

 

- Trên các mục cụ thể cần bật/ tắt thông báo, bạn vuốt sang phải  (3) để bật thông báo hoặc vuốt sang trái  (4) để tắt thông báo. 

- Để xem chi tiết thông tin được đề cập trong thông báo về Giao dịch, Hàng hóa, Sổ quỹ, Khách hàng, bạn chạm vào dòng thông báo tương ứng (1) -> hệ thống hiển thị thông tin chi tiết (2)
