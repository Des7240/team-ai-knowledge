...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-xu-ly-sai-sot-hddt/lap-hoa-don-thay-the/
---
...
Hỗ trợ
Xử lý sai sót HĐĐTLập hóa đơn thay thế
...
* Link biên bản được đính kèm ngay trên màn hình (ví dụ: Biên bản thay thế: 1123251/2026/BB-HBHĐ).
...
* **Bước 2 - Cơ chế tự động gọi lại bản nháp**: Vì một hóa đơn gốc chỉ được có 1 hóa đơn thay thế, nên nếu bạn đã lập một bản thay thế và nhấn ***Lưu*** rồi thoát ra, lần tiếp theo nhấn ***Lập hóa đơn thay thế*** trên hóa đơn gốc đó → hệ thống sẽ tự động mở lại chính bản nháp cũ với đầy đủ dữ liệu đang nhập dở.
