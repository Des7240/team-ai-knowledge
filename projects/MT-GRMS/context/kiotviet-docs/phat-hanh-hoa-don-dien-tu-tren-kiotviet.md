...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-phat-hanh-hddt/phat-hanh-hoa-don-dien-tu-tren-kiotviet/
---
...
Hỗ trợ
Phát hành HĐĐTPhát hành Hóa đơn điện tử trên KiotViet
...
Tính năng Phát hành Hóa đơn điện tử (HĐĐT) trên KiotViet là giải pháp hỗ trợ các cửa hàng phát hành HĐĐT khởi tạo từ máy tính tiền, tuân thủ theo các quy định pháp lý hiện hành. KiotViet cho phép kết nối trực tiếp với các nhà cung cấp HĐĐT lớn (như KiotViet KV-EINVOICE, MISA, VIETTEL, VNPT, FPT), giúp quy trình bán hàng và xuất hóa đơn trở nên liền mạch và hiệu quả.

**Lợi ích nổi bật của tính năng:**

* **Chủ động và linh hoạt 24/7:** Giúp **chủ cửa hàng** chủ động trong việc lập hóa đơn hoặc xử lý các sai sót ngay khi có phát sinh giao dịch, bất kể thời gian nào.
* **Xử lý triệt để độ trễ:** Hỗ trợ **cửa hàng** giải quyết vướng mắc về khoảng cách thời gian giữa lúc khách hàng thanh toán và thời điểm lập hóa đơn, đảm bảo tính tức thời.
* **Thao tác đơn giản:** Hỗ trợ **nhân viên bán hàng** thực hiện quy trình phát hành hóa đơn từ máy tính tiền một cách đơn giản và không yêu cầu chữ ký số của người bán trên từng hóa đơn.

## **II. Các thao tác cơ bản**

Phần này sẽ hướng dẫn các thao tác cơ bản của tính năng, được trình bày qua các tình huống nghiệp vụ thực tế dưới đây:

### **1. Phát hành HĐĐT tự động tại màn hình Bán hàng**

* **Tình huống:** Khi bạn đang thực hiện giao dịch tại màn hình Bán hàng, bạn muốn hệ thống tự động phát hành hóa đơn điện tử cho khách ngay sau khi thanh toán thành công để tiết kiệm thời gian và đảm bảo hóa đơn được xuất tức thì.
* **Điều kiện:**

1. Bạn cần tích chọn ***Phát hành hóa đơn điện tử ngay trên Màn hình bán hàng*** khi **Thiết lập kết nối hóa đơn điện tử**.

2. Tài khoản của bạn cần được cấp quyền ***Phát hành hóa đơn điện tử*** (trong mục **Đơn hàng** → **Hóa đơn**).

* **Thao tác thực hiện như sau:**

1. Trên màn hình **Bán hàng**, sẽ có biểu tượng  để bạn bật chế độ ***Tự động phát hành*** hóa đơn điện tử.

2. Khi bạn thực hiện thanh toán thành công cho một đơn hàng, KiotViet sẽ tự động gửi thông tin sang hệ thống của nhà cung cấp HĐĐT để phát hành hóa đơn.
3. Một pop-up **Xử lý hóa đơn điện tử** sẽ xuất hiện ở góc dưới màn hình để bạn theo dõi trạng thái, bao gồm:
   * **Đang xử lý:** Hệ thống đang gửi dữ liệu.
   * **Đã phát hành:** Hóa đơn đã được phát hành thành công.
   * **Phát hành lỗi:** Hệ thống không phát hành được hóa đơn do có lỗi.
4. Tại pop-up này, bạn có thể **In hóa đơn** (bao gồm mã QR và mã tra cứu) hoặc **Xem chi tiết** danh sách các hóa đơn vừa được xử lý.

***Lưu ý****: Sau khi phát hành thành công, bạn cần đăng nhập vào phần mềm của nhà cung cấp HĐĐT để thực hiện thao tác gửi thông tin đến Cơ quan Thuế. (Riêng với nhà cung cấp KV-EINVOICE, bạn có thể thiết lập để hệ thống tự động gửi đi ngay khi phát hành).*

5. Khách mua quét mã QR hóa đơn điện tử hoặc truy cập đường link tra cứu để xem hóa đơn và tải file định dạng PDF/ XML lưu trữ thông tin.

Đường link truy cập và thao tác xem hóa đơn được thực hiện trên trang web của nhà cung cấp hóa đơn điện tử. Dưới đây là minh họa với nhà cung cấp Hóa đơn điện tử KiotViet.

* Tại trang tra cứu: https://tracuuhoadon.kiotviet.vn/ → bạn nhập mã tra cứu → nhấn ***Tìm kiếm***.

* Màn hình hiển thị thông tin hóa đơn. Tại đây, để tải hóa đơn lưu trữ bạn nhấn ***Tải xuống***.

* Hệ thống tải về file zip chứa 2 file: PDF và XML.

### **2. Phát hành hoặc Chuyển HĐĐT hàng loạt trên trang Quản lý**

* **Tình huống:** Khi bạn không sử dụng tính năng phát hành tự động, hoặc bạn muốn cuối ngày/cuối ca xử lý (phát hành/chuyển) đồng thời nhiều hóa đơn cho các giao dịch đã hoàn tất.
* **Thao tác thực hiện như sau:**

1. Bạn truy cập vào màn hình **Quản lý**, vào menu **Đơn hàng** → **Hóa đơn**.

2. Tích chọn các hóa đơn cần xử lý với điều kiện: hóa đơn có trạng thái ***Hoàn thành*** hoặc ***Đang xử lý*** và trạng thái HĐĐT là trống hoặc ***Phát hành lỗi***.
3. Bạn nhấn vào 3 chấm và chọn ***Chuyển*** hoặc ***Phát hành hóa đơn điện tử***

4. Xác nhận thao tác ***Chuyển*** hoặc ***Phát hành***. Hệ thống sẽ xử lý và hiển thị thông báo kết quả.

### **3. Gửi Hóa đơn đã phát hành cho Cơ quan thuế**

* **Tình huống:** Cuối ngày, khi các hóa đơn điện tử của bạn đã phát hành thành công trên phần mềm Hóa đơn điện tử KV eInvoice, bạn cần gửi hóa đơn cho cơ quan thuế theo quy định
* **Thao tác thực hiện như sau:**

(1) Trên màn hình **Quản lý**, tại menu **Thuế & Kế toán** → chọn **Hóa đơn điện tử**.

(2) Tiếp tục vào menu **Hóa đơn** → chọn **Hóa đơn bán hàng từ máy tính tiền** (hoặc **Hóa đơn GTGT từ máy tính tiền**).

(3) Tích chọn các hóa đơn có trạng thái ***Chưa gửi CQT*** → nhấn ***Gửi CQT***.

(4) Hệ thống hiển thị **Danh sách hóa đơn gửi đến CQT** → bạn tiếp tục nhấn ***Gửi CQT*** → chọn ***Xác nhận***.

(5) Chọn ***Chữ ký số*** → nhấn ***Xác nhận***.

(6) Hệ thống phản hồi trạng thái gửi CQT.

## **III. Các tính năng nâng cao**

* **Tình huống:** Sau khi đã phát hành hoặc chuyển hóa đơn, bạn cần theo dõi trạng thái của các HĐĐT, xem lại bản thể hiện hóa đơn, hoặc lấy mã tra cứu để gửi cho khách hàng.
* **Thao tác thực hiện như sau:** 
  + **Theo dõi trạng thái:** Trên danh sách tại **Đơn hàng** → **Hóa đơn**, KiotViet có thêm cột **Trạng thái HĐĐT** để bạn theo dõi tình trạng (Trống, Đã chuyển, Đã phát hành, Phát hành lỗi).

* **Xem và tra cứu:** Trong chi tiết của một hóa đơn đã phát hành, bạn có các tùy chọn trong 3 chấm:

* **Xem hóa đơn điện tử:** Xem bản thể hiện của hóa đơn (ảnh), có thể tải về (PDF) hoặc in ra.

* **Cách tra cứu hóa đơn điện tử:** Sao chép mã tra cứu và đường link để gửi cho khách hàng tự tra cứu trên cổng của nhà cung cấp HĐĐT.

## **IV. Thao tác trên Điện thoại**

Tính năng Phát hành Hóa đơn điện tử trên Điện thoại hỗ trợ cửa hàng thực hiện các thao tác phát hành tự động ngay khi bán hàng và phát hành hàng loạt trên danh sách hóa đơn.

### **1. Phát hành HĐĐT tự động khi bán hàng**

* **Tình huống:** Khi bạn đang sử dụng ứng dụng di động KiotViet để tạo đơn và thanh toán cho khách, bạn muốn hóa đơn điện tử được phát hành tự động ngay khi giao dịch hoàn tất.
* **Thao tác thực hiện như sau:**

1. Khi bạn thực hiện thanh toán cho một đơn hàng, bạn chỉ cần tích ***Hóa đơn điện tử*** và mẫu in hợp lệ → ngay sau khi nhấn ***Hoàn thành***, hệ thống sẽ tự động gửi thông tin để phát hành hóa đơn.

2. Ngoài ra, trong **Thiết lập bán hàng**, ứng dụng còn hỗ trợ thiết lập cho phép mặc định chọn phát hành hóa đơn điện tử tại màn hình thanh toán bằng cách bật xanh  tính năng ***Tự động phát hành hóa đơn điện tử***.

**Lưu ý quan trọng**: Để sử dụng được tính năng này, các thiết lập ban đầu (như kết nối với nhà cung cấp HĐĐT) và việc phân quyền cho nhân viên vẫn cần được thực hiện trên giao diện web của máy tính.

### **2. Phát hành HĐĐT hàng loạt**

* **Tình huống:** Khi bạn không sử dụng tính năng phát hành tự động hóa đơn điện tử khi bán hàng, hoặc bạn muốn cuối ngày/cuối ca xử lý phát hành đồng thời nhiều hóa đơn cho các giao dịch đã hoàn tất.
* **Thao tác thực hiện như sau:**

1. Tại menu **Hóa đơn**, bạn chọn 3 chấm → **Phát hành** **Hóa đơn điện tử**
2. Tích chọn các hóa đơn tối đa 50 hóa đơn/lần → chọn ***Phát hành***

**Lưu ý**: Hiện tại ứng dụng đang hỗ trợ thao tác phát hành hóa đơn điện tử hàng loạt với các nhà cung cấp: KiotViet (KV-EINVOICE), MISA meInvoice, VIETTEL – SInvoice.

### **3. Xem danh sách xử lý hóa đơn điện tử**

* **Tình huống:** Bạn cần kiểm tra lại xem những hóa đơn nào đã được phát hành thành công, hóa đơn nào bị lỗi để xử lý lại.
* **Thao tác thực hiện như sau:**

1. Trên menu **Bán hàng** → bạn chọn biểu tượng chữ e  góc trên bên phải màn hình
2. Ứng dụng chuyển đến màn hình **Xử lý hóa đơn điện tử**. Danh sách này chỉ hiển thị các hóa đơn do chính tài khoản đó phát hành trên chi nhánh đăng nhập.
3. Tại đây, bạn có thể:
   * Xem thông tin hóa đơn: hệ thống hiển thị thông tin hóa đơn theo cú pháp: Mã hóa đơn KiotViet\_Tên khách hàng\_4 số cuối của số điện thoại khách hàng (không hiển thị các thông tin không có dữ liệu).
   * Xem tình trạng các hóa đơn điện tử

* ***In hóa đơn*** điện tử với đơn có trạng thái ***Đã phát hành***.

* Xem ***Chi tiết*** lỗi phát hành.

## **V. Thao tác trên Máy POS**

Trong giai đoạn hiện tại, tính năng phát hành hóa đơn điện tử được hỗ trợ trên cả hai ứng dụng: ứng dụng **KiotViet** (phiên bản tích hợp bán hàng trên POS touch) và **KiotViet Máy bán hàng** (phiên bản hiện tại) giúp cửa hàng phát hành hóa đơn điện tử ngay khi bán hàng. Về cơ bản, thao tác bán hàng và theo dõi trạng thái trên hai ứng dụng là tương đồng, tuy nhiên ứng dụng **KiotViet** có thêm các thiết lập tự động hóa nâng cao giúp tối ưu quy trình.

### **1. Thiết lập Tự động phát hành và In hóa đơn**

So với ứng dụng **KiotViet Máy bán hàng**, ứng dụng **KiotViet** cung cấp thêm các tùy chọn trong biểu tượng 3 gạch → **Cài đặt chung** → ***Thiết lập hóa đơn điện tử*** để tự động hóa quy trình mà không cần thao tác thủ công mỗi lần bán hàng, bao gồm:

* **Tự động phát hành hóa đơn điện tử:** Bạn bật xanh thiết lập → hệ thống mặc định chọn phát hành hóa đơn điện tử tại màn hình thanh toán, bạn không cần thao tác tích chọn từng hóa đơn.
* **In hóa đơn điện tử có mã tra cứu:** Khi bạn bật xanh thiết lập → sau khi phát hành thành công, hệ thống tự động in hóa đơn kèm mã tra cứu hóa đơn điện tử để giao cho khách hàng.

### **2. Phát hành hóa đơn điện tử khi bán hàng (Áp dụng chung)**

* **Tình huống:** Khi bạn đang sử dụng Máy POS Android KiotViet để thanh toán đơn hàng cho khách, bạn muốn hóa đơn điện tử được phát hành tự động ngay lập tức.
* **Thao tác thực hiện như sau:**
  + **Thao tác thủ công (Trên cả 2 ứng dụng)**: Tại màn hình thanh toán, bạn tích chọn Hóa đơn điện tử và chọn mẫu in hợp lệ. Sau khi nhấn ***Hoàn thành***, hệ thống sẽ gửi thông tin phát hành.

* **Thao tác tự động (Chỉ trên ứng dụng KiotViet)**: Nếu bạn đã kích hoạt các thiết lập tự động ở mục 1, bạn chỉ cần hoàn thành đơn hàng như bình thường, hệ thống sẽ tự động thực hiện việc phát hành và in ấn.

### **3. Xem danh sách xử lý (Áp dụng chung)**

* Trên menu **Tùy chọn** (biểu tượng 3 gạch) → bạn nhấn ***Xử lý hóa đơn điện tử***.

* Danh sách này chỉ hiển thị các hóa đơn do chính tài khoản đó phát hành trên chi nhánh đăng nhập.
...
*Tài liệu được cập nhật mới nhất ngày 16/04/2026*
