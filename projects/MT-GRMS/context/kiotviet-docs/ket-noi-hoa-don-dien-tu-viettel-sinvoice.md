...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-thiet-lap-ban-dau-hddt/ket-noi-hoa-don-dien-tu-viettel-sinvoice/
---
...
Hỗ trợ
Thiết lập ban đầu HĐĐTKết nối Hóa đơn điện tử - Viettel SInvoice
...
- Trên pop-up **Thiết lập kết nối hóa đơn điện tử**, bạn chọn **Nhà cung cấp khác** -> chọn **SInvoice** -> kích ***Tiếp tục***
...
* Tùy chọn **Cho phép phát hành hóa đơn điện tử ngay trên màn hình bán hàng** trên KiotViet:
  + **Nếu bạn tích chọn**: Hệ thống hỗ trợ phát hành hóa đơn điện tử ngay khi thanh toán trên màn hình bán hàng với điều kiện trên hệ thống VIETTEL SInvoice gian hàng lập thông báo phát hành được Cơ quan Thuế xác nhận với trạng thái ***Hoạt động*** có:
    - Hình thức hóa đơn: **Hóa đơn có mã từ máy tính tiền**
    - Loại hóa đơn sử dụng:**được khởi tạo từ máy tính tiền**

* Với gian hàng chưa thiết lập điều kiện thỏa mãn trên hệ thống VIETTEL SInvoice -> KiotViet không hỗ trợ phát hành hóa đơn điện tử ngay trên màn hình bán hàng
* **Nếu không tích chọn**: gian hàng chủ động tạo hóa đơn và thực hiện thao tác phát hành trên VIETTEL SInvoice.
...
- Sau khi bạn lưu thông tin đăng nhập trên hệ thống VIETTEL SInvoice thành công, hệ thống sẽ tiếp tục hiển thị danh sách mẫu hóa đơn điện tử theo hình thức tương ứng đang được sử dụng trên tài khoản VIETTEL SInvoice (trong **Quản lý phát hành** -> **Khởi tạo thông tin doanh nghiệp** -> **Quản lý mẫu hóa đơn**), bạn chọn mẫu hóa đơn cần chuyển thông tin từ KiotViet -> chọn ***Lưu***

*- Lưu ý: Nếu có bất kỳ thay đổi nào về thông tin đăng nhập hoặc mẫu hóa đơn ở* VIETTEL*, gian hàng vui lòng đăng nhập lại tài khoản và chọn đúng mẫu hóa đơn* VIETTEL *tại màn hình **Thiết lập** của **KiotViet**.*

## **2. Phát hành hóa đơn điện tử**

- Với Viettel, KiotViet hỗ trợ phát hành hóa đơn điện tử (HĐĐT) và hóa đơn điện tử từ máy tính tiền (HĐĐT từ MTT).

- Nếu gian hàng sử dụng phương pháp thuế VAT khấu trừ trong **Thiết lập** cửa hàng -> hệ thống phát hành HĐĐT/HĐĐT từ MTT với loại mẫu hóa đơn giá trị gia tăng:
...
* Trường hợp trên hóa đơn sử dụng đồng thời tính năng VAT và Thu khác có mã/tên chứa từ khóa là VAT -> hệ thống chỉ ghi nhận VAT, không ghi nhận Thu khác khi phát hành HĐĐT/HĐĐT từ MTT

- Nếu gian hàng sử dụng phương pháp thuế trực tiếp trong **Thiết lập** cửa hàng -> hệ thống phát hành HĐĐT/HĐĐT từ MTT với loại mẫu hóa đơn bán hàng. Trường hợp trên hóa đơn có Thu khác có mã/tên chứa từ khóa là VAT và:

* KHÔNG tích ***Áp dụng giảm thuế theo Nghị quyết 204/2025/QH15***: Phát hành lỗi, hiện thông báo: Mẫu hóa đơn không hợp lệ
* TÍCH chọn ***Áp dụng giảm thuế theo Nghị quyết 204/2025/QH15***: Không ghi nhận Thu khác khi phát hành HĐĐT/HĐĐT từ MTT

- Nếu gian hàng tắt **Thuế VAT** trong **Thiết lập** cửa hàng:

* Phát hành HĐĐT/HĐĐT từ MTT tương ứng theo mẫu hóa đơn được chọn
...
- Sau khi phát hành hóa đơn điện tử thành công trên KiotViet, để gửi thông tin đến cơ quan Thuế, gian hàng cần thực hiện thao tác trên VIETTEL SInvoice như sau:
...
* Nếu tắt : hệ thống chỉ tạo hóa đơn trên KiotViet và không gửi thông tin sang hệ thống VIETTEL SInvoice.

* Nếu bật :
  + Khi người dùng thanh toán hóa đơn -> KiotViet sẽ đồng thời gửi thông tin sang hệ thống VIETTEL SInvoice để phát hành hóa đơn điện tử.
  + KiotViet hiển thị danh sách mẫu hóa đơn điện tử từ VIETTEL SInvoice -> bạn chọn mẫu áp dụng cần sử dụng ở lần đầu tiên. *Lưu ý: thông tin mẫu áp dụng được ghi nhớ theo từng người dùng và từng thiết bị.*
...
* Tại đây, bạn có thể:
  ...
  + Xem tình trạng các hóa đơn điện tử bao gồm:
    - ***Đã phát hành***: phát hành hóa đơn điện tử thành công trên hệ thống VIETTEL SInvoice.
...
* Nếu tích chọn và chọn mẫu phát hành: Khi người dùng thanh toán hóa đơn -> KiotViet sẽ đồng thời gửi thông tin sang hệ thống VIETTEL SInvoice để phát hành hóa đơn điện tử.
* Nếu KHÔNG tích chọn: hệ thống chỉ tạo hóa đơn trên KiotViet và không gửi thông tin sang hệ thống VIETTEL SInvoice
...
- **Trạng thái** của việc chuyển hóa đơn qua VIETTEL tương ứng bao gồm:

* **Trống**: Là các hóa đơn chưa được phát hành hóa đơn điện tử trên màn hình bán hàng.
...
- ***Cách tra cứu hóa đơn điện tử***: bạn kích ***Sao chép*** để sao chép thông tin gửi đến khách mua tra cứu trên website của VIETTEL:

## **4. Chuyển hóa đơn**

Với gian hàng chưa phát hành hóa đơn điện tử ngay trên màn hình bán hàng, để chuyển hóa đơn từ KiotViet sang VIETTEL SInvoice, bạn thao tác như sau:
...
- Bạn tiếp tục chọn ***Chuyển*** (4) để hệ thống thực hiện tiến trình chuyển hóa đơn sang VIETTEL SInvoice

* Nếu hóa đơn được chuyển thành công, hệ thống hiển thị thông báo:

*- Lưu ý:*

* *Hệ thống hỗ trợ 1 lần chuyển tối đa 50 hóa đơn.*
...
- Sau khi chuyển hóa đơn thành công sang VIETTEL, người dùng đăng nhập tài khoản của VIETTEL để thực hiện các nghiệp vụ liên quan đến phát hành, điều chỉnh, thay thế hóa đơn tại **Quản lý hóa đơn** -> **Hóa đơn chưa phát hành**. Hóa đơn được chuyển từ KiotViet qua VIETTEL khi chưa phát hành hiển thị thông tin HÓA ĐƠN NHÁP
