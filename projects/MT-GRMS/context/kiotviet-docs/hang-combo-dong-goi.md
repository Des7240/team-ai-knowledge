...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-hang-hoa/hang-combo-dong-goi/
---
...
Tính năng Hàng Combo – Đóng gói cho phép bạn tạo ra các sản phẩm mới bằng cách gộp nhiều mặt hàng đơn lẻ lại với nhau. Đây là một loại hình hàng hóa đặc biệt, được thiết kế để quản lý các sản phẩm đóng gói một cách hiệu quả.

**Lợi ích nổi bật của tính năng Hàng Combo – Đóng gói trên KiotViet:**

* **Quản lý tồn kho tự động:** Khi bạn bán một hàng combo, hệ thống sẽ tự động trừ tồn kho của các hàng hóa thành phần tương ứng. Bản thân hàng combo không cần quản lý tồn kho.
* **Tính toán giá vốn chính xác:** Giá vốn của hàng combo được tự động tính bằng tổng giá vốn của tất cả các hàng hóa thành phần cấu thành nên nó.
* **Đa dạng hóa sản phẩm:** Giúp bạn dễ dàng tạo ra các sản phẩm mới như giỏ quà, hộp quà... từ những mặt hàng có sẵn, tối ưu hóa chiến lược kinh doanh cho các dịp đặc biệt.

## **II. Thao tác cơ bản**

Để dễ hình dung, các ví dụ dưới đây sẽ minh họa những tình huống thực tế trong ngành Bán buôn, Bán lẻ.

### **1.****Tạo mới hàng Combo – Đóng gói**

* **Tình huống:** Cửa hàng của bạn muốn tạo một sản phẩm "Giỏ quà Tết" bằng cách đóng gói các mặt hàng có sẵn như trà, rượu và bánh kẹo để bán trong dịp lễ.
...
### **2. Thêm hàng combo - đóng gói vào hóa đơn bán hàng**

* **Tình huống:** Khách mua Giỏ quà Tết An Khang, bạn cần ghi nhận thông tin trên hóa đơn cho khách.
* **Thao tác thực hiện như sau:**

1. Truy cập màn hình **Bán hàng**.
2. Tại ô tìm kiếm, bạn nhập tên hoặc mã của hàng combo cần bán.
3. Chọn từ kết quả tìm kiếm để thêm combo vào hóa đơn và tiến hành thanh toán như bình thường.

### **3. Chỉnh sửa/Xóa hàng combo - đóng gói**

* **Tình huống:** Bạn cần thay đổi giá hoặc xóa một hàng combo - đóng gói không còn cung cấp.
* **Thao tác thực hiện như sau:** 
  + **Để chỉnh sửa:** Vào **Hàng hóa** → **Danh sách hàng hóa**, tìm đến hàng combo - đóng gói cần sửa và nhấn ***Chỉnh sửa*** → thay đổi thông tin và nhấn ***Lưu***.
...
* **Tình huống:** Sau khi tạo hàng combo, bạn cần hiểu rõ cách hệ thống ghi nhận các giao dịch bán hàng và báo cáo liên quan đến loại hàng hóa này.
* **Thao tác thực hiện như sau:** 
  + **Khi bán hàng:** Mỗi khi một "Giỏ quà Tết" được bán ra, hệ thống sẽ không trừ tồn kho của chính giỏ quà mà sẽ tự động trừ tồn kho của từng mặt hàng thành phần (rượu, trà, bánh).

* **Trên báo cáo thuế:** Trong bảng kê vật liệu/sản phẩm, hàng combo sẽ được ghi nhận chi tiết theo mã của từng hàng hóa thành phần.
* **Lưu ý:** Hiện tại, hệ thống chưa hỗ trợ thực hiện thao tác Đặt hàng nhập hoặc Nhập hàng trực tiếp cho loại hàng hóa Combo – Đóng gói.

## **IV. Thao tác trên Điện thoại**

Bạn có thể quản lý danh mục hàng combo- đóng gói của mình ngay trên ứng dụng KiotViet một cách tiện lợi.

### **1. Chỉnh sửa/Xóa hàng combo - đóng gói**

* **Tình huống:** Bạn cần chỉnh sửa hoặc xóa một hàng combo - đóng gói không còn sử dụng.
* **Thao tác thực hiện như sau:** 
  + **Chỉnh sửa:**  Tại danh sách **Hàng hóa**, chạm vào combo - đóng gói cần sửa. Tại mỗi khu vực thông tin, chạm ***Sửa*** để cập nhật lại thông tin và ***Lưu***.

**Lưu ý**: Hiện tại hệ thống chưa hỗ trợ chỉnh sửa thành phần combo ngay trên ứng dụng KiotViet

* **Xóa/ Ngừng kinh doanh:** Trong màn hình chi tiết hàng combo - đóng gói, chạm vào biểu tượng ba chấm (**...**) và chọn **Xóa/ Ngừng kinh doanh**.

### **3. Bán hàng dịch vụ**

* **Tình huống:** Bạn cần thêm hàng combo - đóng gói vào hóa đơn khi đang bán hàng bằng ứng dụng di động.
* **Thao tác thực hiện như sau:**

1. Mở ứng dụng KiotViet.
2. Tại màn hình **Bán hàng**, tìm kiếm tên hoặc mã combo - đóng gói.
3. Chọn combo - đóng gói để thêm vào hóa đơn và tiến hành thanh toán.

## **V. Thao tác trên Máy POS**

Trên máy POS, việc bán các sản phẩm combo - đóng gói đã được tạo sẵn trong danh mục được thực hiện rất nhanh chóng.

* **Tình huống:** Nhân viên thu ngân cần thêm combo “Giỏ qu&à tết” vào hóa đơn cho khách ngay tại quầy.
* **Thao tác thực hiện như sau:**

1. Trên ứng dụng KiotViet Máy bán hàng của máy POS, bạn sử dụng ô "Tìm hàng hóa" để nhập tên hoặc mã của hàng combo - đóng gói.
2. Chọn combo - đóng gói từ kết quả tìm kiếm. Sản phẩm sẽ được thêm vào hóa đơn.
3. Bạn có thể điều chỉnh số lượng nếu cần và tiến hành thanh toán cho khách hàng như bình thường.
