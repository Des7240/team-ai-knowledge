...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-cskh/tin-nhan-zalo-oa/
---
...
Tính năng Tích hợp Tin nhắn Zalo cung cấp giải pháp toàn diện giúp các cửa hàng kết nối trực tiếp với khách hàng thông qua nền tảng Zalo Official Account (ZOA). Bằng cách tự động hóa quy trình chăm sóc và đồng bộ dữ liệu, tính năng này không chỉ nâng cao trải nghiệm khách hàng mà còn tối ưu hóa hiệu quả quản lý cho doanh nghiệp.

**Lợi ích nổi bật của tính năng:**

* Đồng bộ thông tin thành viên/khách hàng từ Zalo về KiotViet.
* Cho phép Khách hàng thành viên của gian hàng truy xuất thông tin điểm tích lũy của mình ngay trên Zalo.

**Lưu ý:**

* Zalo Official Account (ZOA) là Trang thông tin chính thức của doanh nghiệp, nhãn hàng, tổ chức và cộng đồng trên Zalo.
* Theo chính sách của Zalo, để sử dụng được các tiện ích khi liên kết với KiotViet, tài khoản doanh nghiệp OA cần được xác thực, đang hoạt động và sử dụng 1 trong các gói **Tăng trưởng** hoặc **Toàn diện**. Chi tiết chính sách OA ***tại đây***.

## **II. Các thao tác cơ bản**

### **1. Tích hợp tài khoản Zalo Official Account**

**Tình huống:** Khi bạn muốn kết nối hệ thống KiotViet với trang Zalo của cửa hàng để tự động hóa việc chăm sóc khách hàng, bạn cần thực hiện thao tác tích hợp tài khoản.

**Lưu ý:** Hệ thống chỉ hỗ trợ kết nối 1 tài khoản ZOA với 1 gian hàng KiotViet.

**Thao tác thực hiện như sau:**

* **Bước 1:** Tại màn hình **Quản lý** bạn nhấn vào biểu tượng bánh răng thiết lập  → chọn **Xem tất cả thiết lập → Gửi SMS, Zalo**.

* **Bước 2:** Tại dòng ***Thiết lập kết nối SMS, Zalo*** nhấn ***Kết nối***.

* **Bước 3:** Chọn tab **ZOA** và nhấn ***+ Thêm kết nối***.

* **Bước 4:** Hệ thống hiển thị yêu cầu đăng nhập Zalo. Tại đây, bạn thực hiện đăng nhập bằng Số điện thoại hoặc quét mã QR code.
* **Bước 5:** Sau khi đăng nhập Zalo thành công, bạn chọn trang cần quản lý, tích chọn ***Tôi đã đọc và hoàn toàn đồng ý…*** → nhấn ***Cấp quyền***.

* **Bước 6:** Hệ thống hiển thị thông báo và thông tin ZOA tại màn hình Thiết lập.

### **2. Đồng bộ thông tin thành viên đăng ký từ Zalo Official Account**

**Tình huống:** Khi khách hàng quan tâm đến Zalo Official Account của cửa hàng và đăng ký thành viên, bạn muốn thông tin này được tự động cập nhật vào danh sách khách hàng trên KiotViet.

**Thao tác thực hiện như sau:**

* **Bước 1:** Tại ZOA, khách hàng chạm vào **Quan tâm**. Nếu chưa là thành viên của ZOA thì ngay lập tức hệ thống sẽ gửi một tin nhắn đề xuất việc ***Đăng ký thành viên***.
* **Bước 2:** Sau đó, khách hàng điền đầy đủ thông tin và chạm vào ***Gửi thông tin***. Thao tác hoàn tất khi hệ thống gửi xác nhận thành công.

* **Bước 3:** Thông tin của khách hàng ngay lập tức được đồng bộ về KiotViet.

### **3. Quản lý nội dung tin nhắn tự động gửi**

**Tình huống:** Bạn muốn hệ thống tự động gửi các tin nhắn chăm sóc khách hàng qua Zalo như chúc mừng sinh nhật, xác nhận đặt hàng hay mua hàng.

**Lưu ý:**

* Hệ thống chỉ hỗ trợ gửi tin nhắn tới các khách hàng đã đăng ký thành viên của ZOA được tích hợp.
* Số lượng tin nhắn được gửi từ KiotViet giới hạn theo hạn mức tin nhắn miễn phí trong chính sách của ZOA (chưa hỗ trợ với các tin nhắn trả phí).

**Thao tác thực hiện như sau:**

* **Bước 1:** Trên màn hình **Thiết lập gửi SMS - Zalo** → tab **OA** → tích chọn các mục cho phép gửi tin nhắn tự động.
  + Hệ thống hỗ trợ mặc định 3 loại tin nhắn:
    - ***Tin nhắn chúc mừng sinh nhật khách hàng***: Hệ thống sẽ tự động gửi tin nhắn Zalo đến khách hàng theo mẫu tin được thiết lập sẵn vào 9h30 sáng ngày sinh nhật của các khách hàng đó.
    - ***Tin nhắn xác nhận đặt hàng***: Hệ thống sẽ tự động gửi tin nhắn Zalo đến khách hàng theo mẫu tin được thiết lập sẵn khi có đơn đặt hàng của khác hàng đó được tạo ra trên hệ thống.
    - ***Gửi tin nhắn xác nhận mua hàng***: Hệ thống sẽ tự động gửi tin nhắn Zalo đến khách hàng theo mẫu tin được thiết lập sẵn khi có đơn mua hàng của khác hàng đó được tạo ra trên hệ thống.
  + Với mỗi nội dung tin nhắn, hệ thống hỗ trợ người dùng các token:
    - {Khach\_Hang}: Họ tên khách hàng.
    - {Ma\_Don\_Hang}: Hiển thị mã đơn hàng.
    - {Ten\_ Hang\_Hóa}: Hiển thị tên hàng.
    - {Tong\_Cong}: Hiển thị tổng cộng thành tiền của hóa đơn.
    - {Ten\_Cua\_Hang}: Hiển thị tên của cửa hàng.
* **Bước 2:** Tại phần nội dung tin nhắn, bạn điều chỉnh nội dung như mong muốn hoặc sử dụng mẫu tin có sẵn và nhấn ***Lưu***.

### **4. Tự soạn thảo và gửi tin nhắn cho khách hàng**

**Tình huống:** Ngoài việc gửi tự động, bạn muốn chủ động soạn các tin nhắn tư vấn hoặc thông báo riêng biệt để gửi cho một hoặc nhiều khách hàng cụ thể.

**Lưu ý:** Theo chính sách của Zalo, điều kiện cần có để gửi Tin tư vấn (tin nhắn tự soạn thảo) là người dùng có phát sinh tương tác hoặc cho phép tương tác và tương tác cuối của người dùng phải trong khoảng thời gian 07 ngày gần nhất.

**Thao tác thực hiện như sau:**

* **Bước 1:** Trong màn hình **Khách hàng**, bạn chọn khách hàng cần gửi tin theo 2 cách.
  + Cách 1: Tích chọn vào khách hàng cần gửi, nhấn 3 chấm → ***Gửi tin nhắn***.

* Cách 2: Nhấn ***Gửi tin nhắn*** → chọn ***Gửi ZOA***, sau đó nhập tên khách hàng.

* **Bước 2:** Màn hình hệ thống hiển thị Gửi tin nhắn Zalo. Tại đây, bạn nhập nội dung tin nhắn mong muốn hoặc lựa chọn sử dụng mẫu tin có sẵn kèm nội dung → nhấn ***Gửi*** → xác nhận ***Đồng ý***.

### **5. Thiết lập mẫu tin nhắn**

**Tình huống:** Bạn muốn lưu lại các mẫu tin nhắn soạn sẵn để tiết kiệm thời gian cho những lần gửi tin nhắn Zalo sau này.

**Thao tác thực hiện như sau:**

* **Bước 1:** Tại màn hình **Quản lý** bạn nhấn vào biểu tượng bánh răng thiết lập  → chọn **Xem tất cả thiết lập → Gửi SMS, Zalo**.
* **Bước 2:** Tại dòng ***Danh sách mẫu tin*** → nhấn ***mẫu tin***.

* **Bước 3:** Hệ thống chuyển sang màn hình **Quản lý SMS - Zalo** → bạn nhấn ***+SMS/ZOA***.
* **Bước 4:** Nhập ***Tiêu đề***, ***Nội dung*** mẫu tin và nhấn ***Lưu***.

### **6. Lịch sử gửi tin**

**Tình huống:** Bạn cần tra cứu và kiểm tra lại trạng thái của các tin nhắn Zalo đã được gửi đi từ hệ thống KiotViet.

Khi bất kỳ tin nhắn Zalo nào được gửi đi thành công, hệ thống sẽ ghi nhận nội dung tin nhắn đó vào lịch sử.

**Thao tác thực hiện như sau:**

* **Bước 1:** Tại màn hình **Quản lý SMS – Zalo**, bạn chọn tab **Lịch sử gửi tin**.
* **Bước 2:** Thực hiện tìm kiếm hoặc lọc thông tin cần xem, hệ thống sẽ hiển thị chi tiết lịch sử gửi tin.

### **7. Khách hàng truy vấn điểm tích lũy từ Zalo Official Account**

**Tình huống:** Bạn muốn cung cấp tiện ích cho phép khách hàng tự kiểm tra điểm tích lũy của họ trên hệ thống KiotViet trực tiếp từ trang Zalo của cửa hàng.

**Thao tác thực hiện như sau:**

* **Bước 1:** Tại màn hình Zalo Official Account, bạn chọn menu **Quản lý** → **Thiết lập tương tác** → **Thiết lập menu** → tại **Menu chính** nhấn ***Thiết lập***.

* **Bước 2:** Nhập đầy đủ thông tin của menu bao gồm:
  + ***Tên menu***: Ví dụ: Điểm tích lũy.
  + ***Chọn hành động***: Truy vấn tự động
  + ***Cú pháp truy vấn***: #xemdiemtichluykiotviet
* **Bước 3:** Nhấn ***Lưu*** để hoàn tất.

* **Bước 4:** Sau khi thiết lập thành công, khi truy cập vào ZOA, khách hàng có thể xem thông tin điểm tích lũy bằng cách chạm vào mục Điểm tích lũy.

### **8. Xóa tích hợp tài khoản Zalo Official Account**

**Tình huống:** Khi bạn muốn đổi sang tài khoản Zalo OA khác hoặc không muốn tiếp tục sử dụng tính năng liên kết Zalo OA với KiotViet nữa, bạn cần thực hiện xóa kết nối.

**Thao tác thực hiện như sau:**

* **Bước 1:** Trên màn hình **Thiết lập gửi SMS - Zalo** → tab **OA** → bạn nhấn ***Xóa kết nối***.
* **Bước 2:** Xác nhận ***Đồng ý***.

**Lưu ý:**

* Để thực hiện kết nối với ZOA khác, bạn bắt buộc cần xóa kết nối với ZOA hiện tại.
* Sau khi kết nối bị xóa, hệ thống sẽ KHÔNG cho phép việc các tin nhắn tự động được gửi qua Zalo, soạn thảo gửi tin nhắn qua Zalo, xem điểm tích lũy từ Zalo hay đồng bộ thông tin thành viên từ Zalo nữa.
