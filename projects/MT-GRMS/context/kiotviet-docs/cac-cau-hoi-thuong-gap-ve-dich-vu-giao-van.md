...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-giao-van/cac-cau-hoi-thuong-gap-ve-dich-vu-giao-van/
---
...
* ## **1. Làm cách nào để có thể sử dụng Tính năng giao hàng trên KiotViet?**

  Hướng dẫn sử dụng tính năng giao hàng trên KiotViet, xem tại: Link
* ## **2. Tôi có thể liên hệ ở đâu khi có thắc mắc về các vấn đề liên quan đến Dịch vụ giao hàng của KiotViet?**

  Khi có thắc mắc hoặc cần hỗ trợ về Dịch vụ giao hàng của KiotViet, người dùng có thể thực hiện qua một hoặc đồng thời các hình thức sau:

  + Tổng đài 1900 6522 (nhánh 3)
  + Kênh chat hỗ trợ trực tiếp khi sử dụng phần mềm
  + Email: giaovan@citigo.com.vn
* ## **3. Quy định về thời gian đối soát, thanh toán của KiotViet với Người dùng**

  - Người Dùng đồng ý ủy quyền cho KiotViet:    
        • Thu hộ tiền hàng (COD) thông qua các Hãng Vận Chuyển   
        • Thanh toán tiền cước phí vận chuyển cho Hãng Vận Chuyển.   
   - Tiền COD và các khoản chi phí Người Dùng phải trả sẽ được tiến hành thanh toán 3 lần/tuần vào thứ 3, thứ 5 và thứ 7 hàng tuần.  
        • Thanh toán ngày thứ 3 gồm toàn bộ các đơn hàng thành công vào các ngày thứ 6, thứ 7, chủ nhật của tuần liền trước đó;  
        • Thanh toán ngày thứ 5 bao gồm toàn bộ các đơn hàng thành công các ngày thứ 2, thứ 3 cùng tuần;  
        • Thanh toán ngày thứ 7 bao gồm toàn bộ các đơn hàng thành công các ngày thứ 4, thứ 5 cùng tuần.

  - Hình thức:   
     • Thông tin về các đơn hàng được đối soát trong kỳ được gửi thông qua email doisoat.kiotviet@citigo.net  
        • Phương thức thanh toán: Chuyển khoản vào tài khoản ngân hàng Người Dùng đã đăng ký với KiotViet.
* ## **4. Quy định về các loại hàng hóa được phép gửi hoặc cấm gửi của các Hãng vận chuyển**

  Tất cả hàng hóa vận chuyển qua Dịch vụ giao hàng của KiotViet đều phải cam kết tuân thủ theo quy định của Pháp luật Việt Nam và quy định riêng của từng Hãng vận chuyển. Với các hàng hóa thuộc danh mục cấm theo quy định của Pháp luật Việt Nam và quy định của từng Hãng vận chuyển, KiotViet sẽ không chịu trách nhiệm nếu hàng hóa bị thu giữ, tiêu hủy, hay hư hỏng trong quá trình vận chuyển. Người dùng sẽ chịu hoàn toàn trách nhiệm đền bù cho KiotViet/Hãng vận chuyển và trách nhiệm trước Pháp luật Việt Nam khi gửi hàng vi phạm Quy Định này và Pháp luật Việt Nam.

  *- GHN*

  *Xem tại:* HÀNG HÓA MÀ GHN KHÔNG NHẬN VẬN CHUYỂN

  *- VTP*

  *Xem tại:*

  + CÁC MẶT HÀNG CẤM GỬI QUA ĐƯỜNG HÀNG KHÔNG
  + CÁC MẶT HÀNG CẤM GỬI VÀ GỬI CÓ ĐIỀU KIỆN​

  *- Grab*

  *Xem tại:* QUY ĐỊNH VỀ CÁC LOẠI HÀNG HÓA GRAB NHẬN
* ## **5. Khu vực cung cấp dịch vụ giao nhận của các Hãng vận chuyển**

  *- GHN*

  + *Khu vực nhận hàng:*
    - Được thể hiện trên Bảng Phạm Vi Nhận – Giao Hàng của GHN website: https://giaohangnhanh.vn/ghn-pham-vi-giao-hang.pdf tại từng thời điểm.
    - Lấy hàng tại khu vực ngoại thành 1 cước phí tính thêm 10.000 VND/đơn hàng
    - Lấy hàng tại khu vực ngoại thành 2 cước phí tính thêm 20.000 VND/đơn hàng, thời gian lấy hàng cộng thêm 01 (một) ngày làm việc.
  + *Khu vực giao hàng:*
    - Được thể hiện trên Bảng Phạm Vi Nhận – Giao Hàng của GHN website: https://giaohangnhanh.vn/ghn-pham-vi-giao-hang.pdf tại từng thời điểm.
    - Giao hàng tại khu vực ngoại thành 2, thời gian toàn trình cộng thêm 01 (một) ngày làm việc.

  *- VTP*

  + *Không giới hạn khu vực giao nhận*

  *- Grab*

  + *Khu vực Hà Nội, Hồ Chí Minh*
* ## **6. Thời gian các Hãng vận chuyển đến lấy hàng như thế nào?**

  *- GHN*

  + Đối với đơn hàng được tạo trước 16h00, GHN lấy hàng trước 17h00 cùng ngày.
  ...
  + Lấy hàng tại khu vực ngoại thành 2, thời gian lấy hàng cộng thêm 01 (một) ngày làm việc.

  *- VTP*

  + Đơn hàng tạo từ 15h00 ngày N-1 tới 8h00 ngày N: Lấy lần đầu tiên trước 12h00 ngày N;
  + Đơn hàng tạo từ 8h00 ngày N tới 15h00 ngày N: Lấy lần đầu tiên trước 18h00 ngày N;
  + **Lưu ý**: Thời gian trên áp dụng với các **đơn hàng nội thành Hà Nội và Hồ Chí Minh**. Các đơn hàng lấy tại các địa chỉ ngoài nội thành Hà Nội và Hồ Chí Minh sẽ được lấy lần đầu tiên trong vòng 24h kể từ khi có mã vận đơn.
* ## **7. Trọng lượng và kích thước tối đa của gói hàng được các Hãng vận chuyển chấp nhận vận chuyển là bao nhiêu?**

  *- GHN*

  |  |  |  |
  | --- | --- | --- |
  | **Trường hợp** | **Trọng lượng tối đa** | **Kích thước 3 chiều tối đa** |
  | Nhân viên đến lấy hàng | 50KG | 50x30x50 (cm) |
  | Khách hàng gửi hàng trực tiếp ngoài điểm | 30KG | 100x100x100 (cm) |

  *- VTP*

  Không giới hạn khối lượng/kích thước lấy hàng.
  ...
  *- Grab*
  ...
  | Cân nặng | 30 (kg) |
* ## **8. Đối với hàng hóa cồng kềnh, công thức quy đổi trọng lượng của các Hãng vận chuyển sẽ như thế nào?**

  *- GHN*

     Số đo (cm): Dài x Rộng x Cao ÷ 5000 = Trọng lượng kg
  ...
  *- VTP*
  ...
                 Số đo (cm): Dài x Rộng x Cao ÷ 4000 = Trọng lượng kg
* ## **9. Tôi có được phép thay đổi thông tin (Tên, SĐT, địa chỉ) của người nhận sau khi đã tạo đơn hàng trên hệ thống không? Cước phí vận chuyển sẽ thay đổi như thế nào sau khi thay đổi thông tin?**

  *- GHN*

  | **STT** | **Yêu cầu** | **Quy định của HVC** | **Cước phí vận chuyển****thay đổi** | **Lưu ý** |
  | --- | --- | --- | --- | --- |
  | 1 | Thay đổi **Tên, SĐT** người nhận | Được phép | Không thay đổi | Không được phép thay đổi thông tin này trong trường hợp người nhận trả phí |
  | 2 | Thay đổi **địa chỉ** người nhận **trong cùng khu vực** (cùng là Nội thành/Ngoại thành 1/Ngoại thành 2 trong cùng tỉnh) | Được phép | Không thay đổi | Chỉ được thay đổi 1 lần/vận đơn |
  | 3 | Thay đổi **địa chỉ** người nhận khác **khu vực** | Được phép | Mức phí sẽ được tính toán lại khi có thông tin địa chỉ thay đổi |

  *- VTP*

  | **STT** | **Yêu cầu** | **Quy định của HVC** | **Cước phí vận chuyển thay đổi** | **Lưu ý** |
  | --- | --- | --- | --- | --- |
  | 1 | Thay đổi **Tên, SĐT** người nhận | Được phép | Không thay đổi | Chỉ được thay đổi 1 lần/đơn hàng |
  | 2 | Thay đổi **địa chỉ** người nhận **trong cùng tỉnh** | Được phép | Không thay đổi |
  | 3 | Thay đổi **địa chỉ** người nhận **khác tỉnh** | Không được phép | | |
* ## **10. Các Hãng vận chuyển có chính sách lưu kho cho các đơn hàng giao không thành công không?**

  *- GHN*

  + Cho phép lưu kho 5 ngày miễn phí kể từ ngày phát hàng đầu tiên
  + Quá thời hạn nêu trên, gói hàng sẽ bị hoàn về cho Người dùng.

  *- VTP*

  + Cho phép lưu kho 7 ngày miễn phí kể từ ngày phát hàng đầu tiên.
  + Quá thời hạn nêu trên, cước phí tính lưu kho như sau:​​

  |  |  |  |
  | --- | --- | --- |
  | **Trọng lượng** | **Mức phí lưu kho** | **Lưu ý** |
  | ≤ 3kg | 1.500 VNĐ/đơn hàng/ngày | Thời gian lưu kho tối đa không quá 15 ngày  Không áp dụng với Dịch vụ vận tải tiết kiệm |
  | Trên 3kg và đến 31,5 kg | 2.500 VNĐ/đơn hàng/ngày |
* ## **11. Quy định về bồi thường của các HVC trong trường hợp hàng hóa mất mát/hư hỏng trong quá trình vận chuyển**

  **KiotViet/HVC không có nghĩa vụ phải bồi thường Người dùng trong các trường hợp sau:**

  + Đơn hàng đã được phát theo thỏa thuận và người nhận không có khiếu nại gì về đơn hàng tại thời điểm nhận.
  + Người dùng không chứng minh được việc gửi và suy suyển, hư hỏng của đơn hàng.
  + Người dùng không thực hiện đúng các quy định về khiếu nại, giải quyết tranh chấp theo thỏa thuận và quy định của Luật Bưu chính.
  + Thiệt hại xảy ra hoàn toàn do lỗi vi phạm của Người dùng hoặc do đặc tính tự nhiên, khuyết tật vốn có của đơn hàng.
  + Đơn hàng/Vật phẩm trong đơn hàng không có hóa đơn, chứng từ hợp pháp, bị tịch thu hoặc tiêu hủy theo quy định của pháp luật Việt Nam hoặc pháp luật nước nhận.
  + Các trường hợp bất khả kháng theo quy định của pháp luật.

  *Chi tiết chính sách đền bù của các HVC, xem tại:*

  *- GHN*

  | **STT** | **Loại bưu phẩm** | **Tình trạng** | **Phương pháp đền bù** | | |
  | --- | --- | --- | --- | --- | --- |
  | 1 | Thư từ, tài liệu, ấn phẩm, giấy tờ, hóa  đơn, hợp đồng, … | Mất/Thất lạc | 04 (bốn) lần Cước phí của Dịch vụ đã sử dụng | | |
  | Hỏng |
  | 2 | Vật phẩm, hàng  hóa hoặc Phiếu có  giá trị quy đổi | Mất/Thất lạc | + **Người dùng*****sử dụng Dịch vụ khai giá và có đầy đủ Hóa đơn***: Bồi thường bằng Giá trị Bưu gửi. Nếu Giá trị Đơn hàng cao hơn Giá trị khai giá thì khoản tiền bồi thường sẽ bằng Giá trị khai giá. Trong mọi trường hợp, khoản tiền bồi thường **sẽ****không vượt quá 1****0.000.000** **VND****(*****Mười*** ***triệu đồng*****).**  + **Người dùng không sử dụng Dịch vụ khai giá và có đầy đủ Hóa đơn:** Bồi thường bằng Giá trị Đơn hàng nhưng **không vượt quá 1.000.000 VND (Một triệu đồng).**  + **Đơn hàng được gửi tại các điểm đại lý, điểm ủy quyền của GHN (như hệ thống Vinmart, Circle K và các cửa hàng khác) và có đầy đủ Hóa đơn:** Bồi thường bằng Giá trị Đơn hàng nhưng **không vượt quá 1.000.000 VND (Một triệu đồng).** | | |
  | Hỏng | **Loại hư hỏng** | **Mức bồi thường** | **Khoản tiền bồi thường** |
  | Hàng hóa trong Bưu gửi còn nguyên, tuy nhiên bao bì bên ngoài của Bưu gửi bị:  + Rách, vỡ, ướt thùng hàng, hộp đựng    hàng. + Rách tem niêm phong của nhà sản xuất, sản phẩm còn nguyên. | 5% | Khoản tiền bồi thường mất hàng  x 5% |
  | Hàng hóa bị bể vỡ, hư hại đến 50% | 50% | Khoản tiền bồi thường mất  hàng  x 50% |
  | Hàng hóa bị bể vỡ, hư hại trên 50% | 100% | Khoản tiền bồi thường mất hàng  x 100% |

  Chi tiết, xem tại link: Chính sách đền bù của GHN

  *- VTP*

  | **STT** | **Điều kiện** | **Mức đền bù** | **Lưu ý** |
  | --- | --- | --- | --- |
  | 1 | Đơn hàng sử dụng dịch vụ bảo hiểm hàng hóa | 100% giá trị thiệt hại | Dịch vụ bảo hiểm tối đa 100 triệu |
  | 2 | Đơn hàng sử dụng dịch vụ COD | 100% giá trị thiệt hại căn cứ số tiền thu hộ | Tối đa không quá 30 triệu đồng |
  | 3 | Đơn hàng trong nước không sử dụng dịch vụ COD, dịch vụ bảo hiểm hàng hóa nhưng Người dùng cung cấp đủ chứng từ chứng minh giá trị thiệt hại trực tiếp | 50% giá trị thiệt hại | Tối đa không quá 30 triệu đồng |
  | 4 | Đơn hàng trong nước không sử dụng dịch vụ COD, dịch vụ bảo hiểm hàng hóa và Người dùng không cung cấp được chứng từ hợp lý, hợp lệ chứng minh giá trị thiệt hại | 04 lần cước (đã bao gồm cước phí dịch vụ VTP hoàn trả cho KH) |  |
* ## **12. Dịch vụ khai giá là gì?**

  + Khai giá là dịch vụ gia tăng dành cho Người dùng sử dụng Dịch vụ vận chuyển của các Hãng vận chuyển.
  + Khi Người dùng có thể sử dụng Dịch vụ bằng cách khai báo giá trị của Hàng hóa, trong trường hợp đơn hàng bị mất mát, hư hỏng, … trong quá trình vận chuyển, Hãng vận chuyển sẽ căn cứ vào Giá trị khai giá để đền bù theo chính sách của từng Hãng.
  + Người dùng có thể tham khảo chính sách bồi thường của các hãng vận chuyển tại câu hỏi số 11 – mục Các câu hỏi thường gặp.
  + Mức phí khai giá hiện hành của các Hãng vận chuyển trên KiotViet như sau:

  *- GHN*

  | Cước phí | Giá trị đơn hàng (VNĐ) |
  | --- | --- |
  | 0 | 0 - 1.000.000 |
  | 11.000 VNĐ | 1.000.001 - 3.000.000 |
  | 0.5% giá trị | 3.000.001 - 10.000.000 |
  | Không áp dụng | > 10.000.000 |

  *- VTP*

  | Cước phí | Giá trị đơn hàng (VNĐ) |
  | --- | --- |
  | Miễn phí | 0 – 3.000.000 VND |
  | 1% | Từ 3.000.001 VND trở lên, tối thiểu 15.000 VNĐ |
