...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-hang-hoa/kiem-kho/
---
...
Việc thực hiện kiểm kho thường xuyên và đúng quy trình trên KiotViet sẽ mang lại cho cửa hàng của bạn những lợi ích thiết thực sau:

**Lợi ích nổi bật của tính năng Kiểm kho trên KiotViet:**

* **Nắm bắt chính xác số lượng tồn kho thực tế:** Tính năng giúp bạn đối chiếu số lượng hàng hóa trên sổ sách (phần mềm) với thực tế tại kho, từ đó phát hiện và xử lý kịp thời các chênh lệch.
* **Hạn chế tối đa thất thoát, gian lận:** Việc kiểm kê định kỳ và ghi nhận các số liệu chênh lệch một cách minh bạch giúp bạn nhanh chóng phát hiện các vấn đề như mất mát, hư hỏng hay gian lận.
* **Cân bằng kho nhanh chóng, hỗ trợ ra quyết định kinh doanh:** Sau khi hoàn thành, bạn có thể cân bằng kho chỉ với một cú nhấp chuột, giúp hệ thống cập nhật lại đúng số tồn thực tế để bạn đưa ra các quyết định kinh doanh kịp thời.
...
* **Tình huống:** Bạn cần ghi nhận kết quả kiểm kê thực tế tại cửa hàng để đối chiếu với số liệu trên phần mềm.
...
3. Thêm hàng hóa vào phiếu bằng một trong các cách: tìm kiếm thủ công, quét mã vạch, chọn theo nhóm hàng, hoặc **Import** từ file Excel.

4. Tại cột **Thực tế**, bạn điền số lượng đếm được của từng mặt hàng. Hệ thống sẽ tự động tính toán và hiển thị số lượng chênh lệch.

5. Nhấn **Lưu tạm** nếu chưa hoàn tất hoặc nhấn **Hoàn thành** để chốt phiếu. Sau khi hoàn thành, hệ thống sẽ tự động cân bằng kho, cập nhật lại số lượng tồn kho về đúng bằng số lượng thực tế.

## **III. Các tính năng nâng cao**

### **1. Quản lý phiếu kiểm kho (Cập nhật, Hủy, Sao chép)**

* **Tình huống:** Bạn cần chỉnh sửa một phiếu kiểm đang dang dở, hủy một phiếu đã hoàn thành để khôi phục tồn kho, hoặc tạo nhanh một phiếu mới dựa trên phiếu cũ.
* **Thao tác thực hiện như sau:** 
  + **Cập nhật:** Mở phiếu kiểm kho ở trạng thái **Phiếu tạm** và nhấn **Cập nhật** để tiếp tục chỉnh sửa.

* **Hủy:** Mở phiếu kiểm kho ở trạng thái **Đã cân bằng kho**, nhấn **Hủy bỏ** và xác nhận để phục hồi lại trạng thái tồn kho trước khi kiểm.

* **Sao chép:** Mở một phiếu kiểm kho bất kỳ và nhấn **Sao chép** để tạo một phiếu mới với danh sách hàng hóa tương tự.

### **2. Gộp nhiều phiếu kiểm kho tạm**

* **Tình huống:** Nhiều nhân viên cùng kiểm kho ở các khu vực khác nhau và bạn muốn gộp các kết quả lại thành một phiếu tổng hợp duy nhất.
* **Thao tác thực hiện như sau:**

1. Tại danh sách phiếu kiểm kho, tích chọn các phiếu ở trạng thái ***Lưu tạm*** cần gộp → nhấn nút ***Gộp phiếu***.
2. Tiếp tục nhấn ***Gộp phiếu*** và xác nhận ***Đồng ý***

3. Hệ thống tạo một phiếu tạm mới với số lượng thực tế được cộng dồn từ các phiếu đã chọn.

### **3. Tìm kiếm và Xuất file**

* **Tình huống:** Bạn cần tìm lại một phiếu kiểm kho cũ hoặc xuất dữ liệu kiểm kho ra file Excel để lưu trữ, báo cáo.
* **Thao tác thực hiện như sau:** 
  + **Tìm kiếm:** Sử dụng các bộ lọc để tìm phiếu theo mã phiếu, mã/tên hàng, thời gian, trạng thái...

* **Xuất file:** Tại danh sách phiếu kiểm kho, nhấn **Xuất file** trên từng phiếu hoặc Xuất file nhiều phiếu với file tổng quan hoặc file chi tiết.

## **IV. Thao tác trên Điện thoại**

Tính năng Kiểm kho trên ứng dụng KiotViet hỗ trợ cửa hàng thực hiện các thao tác: Tạo, Cập nhật, Hủy, In và Tìm kiếm phiếu kiểm kho.

### **1. Tạo phiếu kiểm kho**

* **Tình huống:** Bạn muốn thực hiện việc kiểm kho nhanh chóng, tiện lợi ngay tại kho hàng bằng điện thoại di động.
* **Thao tác thực hiện như sau:**

1. Mở ứng dụng KiotViet, vào menu **Nhiều hơn** → chạm **Kiểm kho**.
2. Chạm vào biểu tượng dấu **+** để tạo phiếu mới.

3. Thêm hàng hóa vào phiếu bằng cách tìm kiếm, chọn theo nhóm, hoặc quét mã vạch.
4. Nhập số lượng thực tế:

* Nếu số lượng thực tế khớp với số lượng trên phần mềm, bạn chỉ cần nhấn ***Khớp***

* Khi nhập số lượng cho hàng hóa, hệ thống hiển thị thêm màn hình chi tiết, bạn chọn: 
  + ***Ghi đè*** *khi cần sửa lại số lượng đã kiểm trước đó hoặc*
  + ***Cộng thêm*** *khi cần cộng thêm vào số lượng hàng hóa đã kiểm.*

5. Chạm ***Hoàn thành*** để cân bằng kho, hoặc ***Lưu tạm*** nếu chưa kiểm xong.

### **2. Quản lý phiếu kiểm kho (Cập nhật, Hủy, In)**

* **Tình huống:** Bạn cần chỉnh sửa, hủy hoặc in một phiếu kiểm kho ngay trên ứng dụng di động.
* **Thao tác thực hiện như sau:** 
  + **Cập nhật:** Chạm vào phiếu ở trạng thái **Phiếu tạm** để tiếp tục chỉnh sửa.

* **Hủy:** Vuốt phiếu kiểm sang trái và chọn **Hủy**, hoặc mở chi tiết phiếu và chọn 3 chấm -> **Hủy phiếu**.

* **In:** Mở chi tiết phiếu kiểm, chạm vào biểu tượng menu và chọn **In** (yêu cầu đã kết nối máy in).
