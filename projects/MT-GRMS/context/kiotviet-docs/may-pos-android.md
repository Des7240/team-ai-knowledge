...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-thiet-bi-phan-cung/may-pos-android/
---
...
**3 Lợi ích nổi bật của tính năng:**

1. **Tối ưu hóa không gian và vận hành:** Giúp chủ cửa hàng thiết lập một quầy thu ngân hiện đại, nhỏ gọn nhưng đầy đủ chức năng, từ bán hàng, in hóa đơn đến thanh toán, thay thế cho các bộ máy tính cồng kềnh.
2. **Tăng trải nghiệm khách hàng và tốc độ xử lý:** Hỗ trợ nhân viên bán hàng xử lý đơn hàng hiệu quả nhờ màn hình chính 15.6 inch, đồng thời hiển thị thông tin đơn hàng cho khách qua màn hình phụ 10.1 inch, giúp giảm thời gian chờ đợi và tăng tính minh bạch.
3. **Kết nối linh hoạt, hệ thống hoàn chỉnh:** Giúp chủ cửa hàng và quản lý dễ dàng xây dựng một hệ thống bán hàng chuyên nghiệp bằng cách kết nối máy POS với máy in hóa đơn, két tiền, màn hình hiển thị QR và các thiết bị ngoại vi khác.
...
* **Thông số kỹ thuật:**
  1. Hệ Điều Hành: Android 13 | MDM
  2. Chipset: Rk3568 – Quad-core 2.0GHz, Cortex A55
  3. Bộ Nhớ: 4GB DDR, 64GB eMMC
  4. Màn hình chính: 15.6” IPS | Full HD | IK06
  5. Màn hình phụ: 10.1” HD (1280\*800)
  6. Kết nối không dây: WiFi (hỗ trợ Wifi 6)/Bluetooth/Ethernet
  7. Cổng Kết Nối: 4 USB Type A, 1 micro USB, 1 RJ11, 1 RJ45, 1 Audio Jack
  8. Nguồn Cấp: 12V/3A
...
### **3. Cài đặt ứng dụng KiotViet Máy bán hàng**
...
2. Sử dụng thanh tìm kiếm, nhập từ khóa "KiotViet Máy bán hàng".

3. Chọn đúng ứng dụng “KiotViet Máy bán hàng” và nhấn **Cài đặt**.

4. Sau khi cài đặt hoàn tất, biểu tượng ứng dụng sẽ xuất hiện trên màn hình chính.

### **4. Đăng nhập tài khoản KiotViet**

**Tình huống:** Sau khi đã cài đặt thành công ứng dụng, bạn cần đăng nhập vào tài khoản của cửa hàng để bắt đầu các thao tác bán hàng và quản lý.

**Thao tác thực hiện:**

1. Mở ứng dụng **KiotViet Máy bán hàng** vừa cài đặt.
2. Nhập đầy đủ thông tin vào 3 trường: **Địa chỉ gian hàng**, **Tên đăng nhập**, và **Mật khẩu**.
3. Nhấn **Đăng nhập** để vào phần mềm.

*Lưu ý: Nếu quên mật khẩu, bạn có thể sử dụng tính năng "Quên mật khẩu?" để nhận mã OTP và đặt lại mật khẩu mới qua email hoặc số điện thoại đã đăng ký.*

### **5. Kết nối máy in hóa đơn**

**Tình huống:** Để có thể in hóa đơn thanh toán cho khách hàng ngay tại quầy, bạn cần kết nối và thiết lập máy in trên máy POS.

**Thao tác thực hiện:**

1. Trên ứng dụng KiotViet Máy bán hàng, vào **Cài đặt**.

2. Chọn **Cài đặt máy in** → Bật **Sử dụng máy in** → **+ Thêm máy in**.

3. Tùy vào kết nối USB hay Wi-Fi/LAN. Hệ thống sẽ dò tìm các máy in khả dụng. Bạn chọn đúng máy in muốn sử dụng và lưu lại để hoàn tất.

### **6. Kết nối Máy quét mã vạch**

**Tình huống:** Bạn muốn trang bị máy quét mã vạch cho thiết bị POS Android của KiotViet để tối ưu hóa thao tác bán hàng.
...
**Tình huống:** Khi sử dụng máy POS 2 màn hình như D68 Dual, bạn muốn màn hình phụ (hướng về phía khách hàng) hiển thị thông tin đơn hàng (danh sách sản phẩm, tổng tiền, thông tin khuyến mãi) một cách chuyên nghiệp, thay vì chỉ phản chiếu (mirror) lại toàn bộ thao tác của nhân viên thu ngân trên màn hình chính.

**Thao tác thực hiện:**

1. Trên ứng dụng **KiotViet Máy bán hàng**, truy cập vào mục **Cài đặt** (biểu tượng bánh răng).

2. Trong menu cài đặt, tìm và chọn mục **"Hiển thị"**
3. Tìm tùy chọn **"Sử dụng màn hình phụ"**
4. **Bật** tính năng này lên (gạt nút sang màu xanh).

5. Sau khi bật, hệ thống sẽ tự động hiển thị giao diện tối ưu cho khách hàng trên màn hình phụ mỗi khi bạn thực hiện bán hàng (ví dụ: hiển thị chi tiết đơn hàng, tổng tiền phải trả).

6. Nếu bạn **Tắt** tính năng này, màn hình phụ sẽ chỉ phản chiếu lại chính xác những gì đang diễn ra trên màn hình chính của thu ngân.
