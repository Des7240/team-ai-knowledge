...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-thanh-toan/thanh-toan-qua-sacombank/
---
...
Nhằm hỗ trợ các gian hàng thúc đẩy việc thanh toán phi tiền mặt, KiotViet kết hợp cùng ngân hàng Sacombank đã ra mắt tính năng thanh toán chuyển khoản bằng phương pháp quét mã VietQR và nhận thông báo kết quả ngay trên phần mềm.

**Đối tượng áp dụng:** Tất cả gian hàng trên KiotViet (bao gồm cả gian hàng dùng thử và gian hàng chính thức) có tài khoản thanh toán cá nhân hoặc tài khoản hộ kinh doanh tại ngân hàng Sacombank.

**Lợi ích nổi bật của tính năng**:

* **Giúp chủ cửa hàng và quản lý**: Dễ dàng đăng ký và quản lý việc liên kết tài khoản Sacombank cho từng chi nhánh. Một tài khoản ngân hàng có thể sử dụng cho nhiều chi nhánh của cùng một gian hàng.
...
**Tóm tắt luồng hoạt động**: Về cơ bản, luồng hoạt động của tính năng bao gồm 2 bước chính: 1. Kích hoạt dịch vụ nhận thông báo thanh toán QR của Sacombank 2. Nhận thông báo kết quả giao dịch trên màn hình **Bán hàng**.
...
* **Lưu ý về nguyên tắc liên kết Sacombank với chi nhánh/gian hàng:**
  + Liên kết được thực hiện theo từng chi nhánh.
  + Đối với **một chi nhánh** của một gian hàng:
    - Chỉ có thể liên kết với **một tài khoản Sacombank** tại một thời điểm.
    - Phải hủy liên kết hiện tại mới có thể liên kết tài khoản Sacombank khác
  + Đối với **một tài khoản Sacombank**:
    - Có thể liên kết với **nhiều chi nhánh** trong cùng một gian hàng.
    - Và cũng có thể liên kết với nhiều chi nhánh của gian hàng khác

Quá trình này được thực hiện như sau:

#### **1.1. Đăng ký dịch vụ trên KiotViet**

* Tài khoản admin của chủ gian hàng đăng nhập vào màn hình **Quản lý**, chọn mục **Thanh toán** và nhấn ***Đăng ký*** tại thẻ ***Sacombank***.

* Tiếp theo, bạn chọn tài khoản Sacombank và điền đầy đủ thông tin được yêu cầu (Số tài khoản, Họ tên của chủ tài khoản, Số CCCD, Số điện thoại, Chi nhánh muốn đăng ký).
* Tích vào ô đồng ý với điều khoản và chọn ***Đăng ký***.

#### **1.2. Xác thực bằng mã OTP**

* Sau khi điền thông tin đăng ký trên KiotViet, bạn cần các thực mã OTP để hoàn thành liên kết
* **Lưu ý:**
  + Mã OTP sẽ được gửi về theo 1 trong 3 hình thức bạn đã đăng ký nhận OTP với ngân hàng trước đó:
    - Gửi SMS về số điện thoại.
    - Gửi về app Sacombank pay.
    - Gửi về app Sacombank msign.
  + Mã OTP sẽ có hiện lực trong vòng 1 phút.
  + Nếu nhập sai OTP quá số lần quy định, tài khoản STB của bạn sẽ bị khóa.
...
* Thao tác trên màn hình **Bán hàng**:
  + Khi tạo hóa đơn, bạn chọn phương thức thanh toán Chuyển khoản để hiển thị mã QR của tài khoản Sacombank đã liên kết.
...
* Để gia tăng hiệu quả và tốc độ xử lý đơn hàng, bạn có thể kết hợp dịch vụ thông báo thanh toán của Sacombank với các tiện ích như:
...
### **1. Xem danh sách tài khoản Sacombank đã đăng ký dịch vụ**

* **Tình huống**: Khi bạn cần kiểm tra lại thông tin các tài khoản Sacombank nào đang được kết nối để nhận thông báo tự động trên KiotViet.
* **Thao tác thực hiện như sau**:

1. Tại màn hình **Quản lý**, vào menu **Thanh toán**.
2. Chọn thẻ **Sacombank** và nhấn **Xem chi tiết** để xem danh sách các tài khoản đã liên kết.

### **2. Hủy dịch vụ nhận thông báo thanh toán Sacombank**

* **Tình huống:** Khi bạn không còn nhu cầu sử dụng dịch vụ nhận thông báo tự động cho một tài khoản Sacombank cụ thể.
* **Thao tác thực hiện như sau**:
...
1. Nhập mã OTP → **Xác nhận** để hoàn tất hủy đăng ký.

## **IV. Thao tác trên ứng dụng KiotViet Mobile**
...
* Chọn thẻ **Sacombank**, điền các thông tin cần thiết và nhấn ***Tiếp tục***.
* Nhập mã OTP để hoàn tất.
...
* Truy cập mục **Thanh toán** và chọn thẻ **Sacombank**.
...
Tính năng Thanh toán qua Sacombank trên Máy POS Android hỗ trợ cửa hàng thực hiện thao tác thanh toán bằng cách hiển thị mã QR của Sacombank cho khách hàng.

* **Tình huống**: Khi bạn đang bán hàng tại quầy và muốn khách hàng thanh toán bằng cách quét mã QR của Sacombank trên màn hình máy POS.
* **Thao tác thực hiện như sau**:

1. Đảm bảo bạn đã thêm tài khoản Sacombank và đăng ký dịch vụ trên phiên bản máy tính hoặc ứng dụng di động.
2. Khi tạo hóa đơn trên máy POS, chọn phương thức thanh toán là **Chuyển khoản** và chọn tài khoản Sacombank đã liên kết.
