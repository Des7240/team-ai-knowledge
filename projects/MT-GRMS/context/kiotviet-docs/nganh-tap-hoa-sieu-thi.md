...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-chuyen-nganh/nganh-tap-hoa-sieu-thi/
---
...
Để đáp ứng những yêu cầu đặc thù của ngành Tạp hóa - Siêu thị, KiotViet đã phát triển một bộ tính năng chuyên ngành, được thiết kế riêng để giúp các cửa hàng vận hành hiệu quả, chuyên nghiệp và tối ưu hóa việc quản lý sản phẩm. Bộ tính năng này không chỉ là một công cụ quản lý bán hàng thông thường mà còn là một giải pháp toàn diện, tập trung vào việc quản lý hàng nghìn mặt hàng đa dạng (thực phẩm, đồ uống, hàng tiêu dùng) theo **nhiều đơn vị tính (hộp, lốc, thùng)**, kiểm soát chặt chẽ sản phẩm có hạn sử dụng theo **Lô – Hạn sử dụng**, tạo các **gói hàng (combo/giỏ quà)** hấp dẫn và quản lý **chương trình khách hàng thân thiết (tích điểm)**. Tất cả đều nhằm mục đích giúp chủ cửa hàng kiểm soát chặt chẽ hàng tồn kho, giảm thiểu rủi ro, tăng cường sự gắn kết của khách hàng và đẩy nhanh tốc độ thanh toán tại quầy.

**Lợi ích nổi bật của tính năng:**

* **Quản lý sản phẩm hiệu quả theo Lô – Hạn sử dụng:** Hệ thống tự động gợi ý xuất bán các lô sữa, thực phẩm có hạn sử dụng gần nhất trước (theo nguyên tắc FEFO), giúp giảm thiểu rủi ro kinh doanh, tránh lãng phí và thất thoát do hàng hóa hết hạn.
* **Kiểm soát tồn kho chính xác, minh bạch:** Dễ dàng theo dõi số lượng tồn kho của từng loại hàng hóa theo nhiều đơn vị tính và của từng lô hàng riêng biệt. Mọi giao dịch đều được ghi nhận chi tiết, giúp bạn truy xuất lịch sử và quản lý hàng hóa một cách minh bạch, tránh thất thoát.
* **Tối ưu hóa bán hàng và chăm sóc khách hàng:** Nhanh chóng tạo các gói combo, giỏ quà hấp dẫn, xác định sản phẩm sắp hết hạn để lên chương trình khuyến mại, kết hợp với các chính sách giá và chương trình tích điểm linh hoạt để giữ chân khách hàng và gia tăng doanh thu.

*Tài liệu này hướng dẫn anh chị các tính năng phổ biến liên quan tới ngành hàng Tạp hóa - Siêu thị mà KiotViet gợi ý cửa hàng tham khảo và lựa chọn các giải pháp phù hợp.*

**Thông báo về việc cập nhật giao diện:**

Hiện tại, KiotViet đang triển khai nâng cấp **Giao diện mới 2026** cho Màn hình Quản lý. Bạn vui lòng lưu ý một số thay đổi sau:

* **Về vị trí các tính năng:** Một số gian hàng sẽ thấy các mục bao gồm: **Nhập hàng, Đặt hàng nhập, Trả hàng nhập, Nhà cung cấp, Hóa đơn đầu vào** được chuyển vào menu **Mua hàng** (thay vì nằm trong mục *Hàng hóa* như trước đây). Mặc dù có sự thay đổi về vị trí hiển thị các menu, nhưng **quy trình nghiệp vụ chi tiết không có sự khác biệt**. Bạn hoàn toàn có thể yên tâm thực hiện theo các bước hướng dẫn để hoàn thành công việc.
* **Về tài liệu hướng dẫn:** Nội dung trong bài viết này đang hướng dẫn luồng thao tác chi tiết thực hiện trên **Giao diện tiêu chuẩn 2025**. Ngay sau khi giao diện mới 2026 được áp dụng đồng bộ cho tất cả các gian hàng, KiotViet sẽ cập nhật lại hệ thống tài liệu hướng dẫn này trong thời gian sớm nhất.

## **II. Các Thao Tác Cơ Bản**

Để dễ hình dung, các ví dụ dưới đây sẽ minh họa những tình huống thực tế tại cửa hàng Tạp hóa - Siêu thị.

### **1. Thiết lập ban đầu**

* **Tình huống:** Trước khi bắt đầu nhập và bán sản phẩm, bạn cần kích hoạt các tính năng cần thiết như quản lý Lô - Hạn sử dụng và chương trình Tích điểm cho khách hàng.
* **Thao tác thực hiện như sau:**

1. **Bật tính năng Lô - Hạn sử dụng:**
   * Vào menu **Thiết lập** → **Hàng hóa**.

* Bật tùy chọn **Quản lý tồn kho theo Lô, hạn sử dụng**.

2. **Thiết lập Tích điểm:**
   * Vào menu **Thiết lập** → **Khách hàng**.

* Bật tính năng **Tích điểm**.

* Thiết lập tỷ lệ quy đổi, ví dụ: **100,000 VNĐ** mua hàng tương ứng **1 điểm**, và **1 điểm** có thể đổi thành **1,000 VNĐ** trừ vào hóa đơn.
* Nhấn **Lưu** để hoàn tất.

### **2. Thêm mới hàng hóa và tạo Combo**

#### **2.1. Thêm mới hàng hóa nhiều đơn vị tính**

* **Tình huống:** Bạn cần tạo một sản phẩm mới như "Sữa tươi" và muốn quản lý việc bán hàng theo nhiều đơn vị khác nhau (Hộp, Lốc, Thùng) để linh hoạt trong việc bán lẻ và bán sỉ.
* **Thao tác thực hiện như sau:**

1. Tại màn hình **Hàng hóa** -> **Danh sách hàng hóa**, bạn nhấn **Tạo mới** -> **Hàng hóa**.

2. Điền các thông tin cơ bản về sản phẩm (tên, giá bán, giá vốn, nhóm hàng...).

3. Chọn **Có** vào ô **Quản lý theo lô, hạn sử dụng** để kích hoạt tính năng quản lý theo lô (nếu cần).

4. **Thêm Đơn vị tính:** Tại mục ***Quản lý theo thuộc tính, đơn vị tính***, nhấn ***Thiết lập***.

* Tại khu vực **Đơn vị tính**:
  + ***Thêm đơn vị cơ bản***: Điền ***Tên đơn vị cơ bản***: Hộp; ***Giá bán***: 6,000 → nhấn ***Xong***

* ***Thêm đơn vị***:
  + ***Tên đơn vị***: Lốc; Giá trị quy đổi: 4; Giá bán: 22,000 → nhấn ***Xong & Thêm mới***

* ***Tên đơn vị***: Thùng; Giá trị quy đổi: 48, Giá bán: 260,000 → nhấn ***Xong***

5. Nhấn ***Xong*** *→* hệ thống quay lại màn hình **Tạo hàng hóa**, bạn nhấn ***Lưu*** ở cuối trang

#### **2.2. Tạo gói hàng (Combo/Giỏ quà)**

* **Tình huống:** Bạn muốn tạo một "Giỏ quà Tết" hấp dẫn bao gồm nhiều sản phẩm với giá ưu đãi để thu hút khách hàng vào dịp lễ.
* **Thao tác thực hiện như sau:**

1. Tại màn hình **Hàng hóa** → **Danh sách hàng hóa**, bạn nhấn ***Tạo mới*** → ***Combo - đóng gói***.

2. Đặt tên cho combo, ví dụ: "Giỏ quà Tết An Khang".
3. Tại mục ***Hàng thành phần***, tìm và thêm các sản phẩm bạn muốn đưa vào giỏ quà (ví dụ: 1 hộp bánh, 1 hộp trà, 1 chai rượu vang).
4. Nhập ***Giá bán*** cho cả giỏ quà. Hệ thống sẽ tự động trừ tồn kho của từng sản phẩm thành phần khi bạn bán combo này.
5. Nhấn ***Lưu*** để hoàn tất.

### **3. Nhập hàng theo Lô - Hạn sử dụng**

* **Tình huống:** Bạn vừa nhập một lô "Sữa tươi" mới và cần ghi nhận số lượng, hạn sử dụng và giá vốn của lô đó vào hệ thống.
* **Thao tác thực hiện như sau:**

1. Khi tạo phiếu **Nhập hàng**, với sản phẩm quản lý theo lô, bạn nhấn vào **T*hêm mới lô, hạn sử dụng***.
2. Nhập ***Lô***, ***Hạn sử dụng***, ***Số lượng*** **→** nhấn ***Thêm***

3. Tiếp tục nhập ***Đơn giá*** và các thông tin thanh toán cho lô hàng.
4. Nhấn ***Hoàn thành*** phiếu nhập để tăng tồn kho cho lô hàng vừa nhập.

### **4. Bán hàng và Thanh toán**

* **Tình huống:** Khách hàng mua một sản phẩm, bạn cần xuất bán từ lô hàng có hạn sử dụng gần nhất và cho phép khách dùng điểm tích lũy để thanh toán.
* **Thao tác thực hiện như sau:**

1. Khi thêm sản phẩm vào hóa đơn, hệ thống sẽ tự động gợi ý lô có hạn sử dụng gần nhất (nguyên tắc FEFO) chưa hết hạn sử dụng.
2. Hệ thống sẽ cảnh báo bằng màu sắc: màu vàng cho lô sắp hết hạn và màu hồng cho lô đã hết hạn.

3. **Sử dụng điểm tích lũy:** Tại thông tin thanh toán bên phải màn hình, hệ thống sẽ hiển thị số điểm khách có và giá trị quy đổi. Bạn bật xanh ***Điểm*** → nhập số tiền muốn quy đổi (không vượt quá tổng tiền khách phải trả)
4. Nhấn **Thanh toán** để hoàn tất giao dịch.

## **III. Các tính năng nâng cao**

### **1. Quản lý khách hàng và tích điểm**

* **Tình huống:** Bạn muốn xem lại lịch sử mua hàng và lịch sử điểm của một khách hàng thân thiết.
* **Thao tác thực hiện như sau:**

1. Vào menu **Khách hàng**.
2. Tìm và chọn khách hàng cần xem.
3. Trong trang chi tiết, bạn có thể xem toàn bộ lịch sử bán/trả hàng và lịch sử đặt hàng, tích điểm của khách hàng đó.

### **2. Thiết lập bảng giá linh hoạt**

* **Tình huống:** Bạn muốn tạo một bảng giá riêng cho khách mua sỉ hoặc khách hàng thành viên với mức giá ưu đãi hơn so với giá bán lẻ.
* **Thao tác thực hiện như sau:**

1. Vào menu **Hàng hóa** -> **Thiết lập giá**.

2. Nhấn ***Tạo mới*** bên trái màn hình hoặc ***+ Bảng giá*** bên phải màn hình, đặt tên là "Bảng giá sỉ".

3. Thiết lập ***Phạm vi áp dụng*** (ví dụ: cho nhóm khách hàng "Khách sỉ").

4. Sau khi ***Lưu***, hệ thống sẽ chuyển sang màn hình để bạn nhập giá sỉ cho từng hàng hóa cụ thể hoặc thêm nhanh theo nhóm hàng.

### **3. Xem báo cáo hàng hóa theo hạn sử dụng**

* **Tình huống:** Bạn muốn kiểm tra xem có loại sữa hoặc thực phẩm nào trong kho sắp hết hạn trong 3 tháng tới để lên kế hoạch khuyến mại, giảm giá.
* **Thao tác thực hiện như sau:**

1. Bạn truy cập vào hệ thống **Phân tích** → **Báo cáo** → **Hàng hóa**.

2. Chọn mối quan tâm là **Hạn sử dụng**. Báo cáo sẽ liệt kê chi tiết các lô hàng sắp hết hạn và đã hết hạn để bạn đưa ra quyết định kinh doanh phù hợp, tránh lãng phí.

## **IV. Thao tác trên Điện thoại**

Ứng dụng KiotViet hỗ trợ các thao tác quản lý cốt lõi ngay trên thiết bị di động, giúp bạn linh hoạt hơn trong việc vận hành cửa hàng.

### **1. Thêm mới và Nhập hàng**

* **Tình huống:** Bạn cần tạo mới một sản phẩm và nhập lô hàng đầu tiên cho nó ngay trên ứng dụng di động.
* **Thao tác thực hiện như sau:**

1. Trong menu **Hàng hóa** trên ứng dụng KiotViet, chạm vào biểu tượng dấu **+** để thêm hàng hóa mới, bật các tùy chọn quản lý cần thiết.

2. Khi tạo phiếu **Nhập hàng**, sau khi chọn sản phẩm, ứng dụng sẽ cho phép bạn nhập thông tin chi tiết về lô hàng (nếu có).

### **2. Bán hàng theo Lô - Hạn sử dụng**

* **Tình huống:** Bạn đang tư vấn bên ngoài và cần tạo đơn hàng cho khách, chọn đúng lô sản phẩm để giao.
* **Thao tác thực hiện như sau:**

1. Khi tạo hóa đơn trên ứng dụng, sau khi chạm vào một sản phẩm quản lý theo lô, màn hình **Chọn lô** sẽ hiện ra.
2. Bạn chạm vào lô cần bán và nhập số lượng tương ứng để thêm vào hóa đơn.

### **3. Kiểm kho trên điện thoại**

* **Tình huống:** Bạn cần thực hiện kiểm kho định kỳ mà không muốn phải mang sản phẩm về máy tính, đặc biệt với số lượng hàng hóa lớn.
* **Thao tác thực hiện như sau:**

1. Từ menu **Nhiều hơn**, chọn tính năng **Kiểm kho**.
2. Bạn có thể cầm điện thoại đi quanh cửa hàng, dùng camera để quét mã vạch sản phẩm và điền số lượng thực tế.
3. Sau khi hoàn tất, bạn có thể lưu phiếu tạm hoặc hoàn thành để cân bằng lại tồn kho.

## **V. Thao tác trên Máy POS**

Ứng dụng KiotViet trên Máy POS Android hỗ trợ bán hàng theo Lô - Hạn sử dụng một cách nhanh chóng tại quầy.

### **Chọn Lô - Hạn sử dụng khi bán hàng**

* **Tình huống:** Nhân viên tại quầy cần nhanh chóng xuất bán sản phẩm cho khách theo đúng lô hàng được hệ thống gợi ý.
* **Thao tác thực hiện như sau:**

1. Khi thêm một sản phẩm vào hóa đơn trên máy POS, một pop-up chọn lô sẽ tự động hiện ra.
2. Hệ thống sẽ gợi ý lô có hạn sử dụng gần nhất. Nhân viên có thể xác nhận hoặc chọn một lô khác từ danh sách.

3. Sau khi chọn lô, sản phẩm sẽ được thêm vào hóa đơn để tiến hành thanh toán.
