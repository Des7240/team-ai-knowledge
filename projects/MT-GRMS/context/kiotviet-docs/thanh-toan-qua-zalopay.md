...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-thanh-toan/thanh-toan-qua-zalopay/
---
...
Nhằm hỗ trợ các gian hàng thúc đẩy việc thanh toán phi tiền mặt, KiotViet kết hợp cùng ví điện tử ZaloPay ra mắt tính năng thanh toán bằng phương pháp quét mã QR và nhận thông báo kết quả ngay trên phần mềm.

* **Đối tượng áp dụng**: Tất cả gian hàng trên KiotViet có tài khoản ZaloPay Merchant.

**Lưu ý**: Nếu chưa có tài khoản ZaloPay Merchant, bạn có thể đăng ký trực tiếp qua link: https://mc.zalopay.vn/user-register?msp=kiotviet

**Lợi ích nổi bật của tính năng**:

* **Giúp chủ cửa hàng và quản lý**: Dễ dàng kết nối và quản lý tài khoản ZaloPay Merchant, tập trung dòng tiền và đối soát giao dịch tự động, giảm thiểu sai sót thủ công.
...
**Tóm tắt luồng hoạt động**: Về cơ bản, luồng hoạt động của tính năng bao gồm 2 bước chính: 1. Kết nối tài khoản ZaloPay Merchant -> 2. Nhận thông báo kết quả giao dịch trên màn hình **Bán hàng**.

Nội dung dưới đây sẽ hướng dẫn chi tiết các thao tác được thực hiện trên phiên bản KiotViet dành cho website.

### **1. Kết nối tài khoản ZaloPay Merchant**

Để kích hoạt tính năng, bạn cần lấy thông tin từ tài khoản ZaloPay Merchant và điền vào phần thiết lập trên KiotViet.

* **Chuẩn bị thông tin cần thiết**: Trước khi kết nối, bạn cần đăng nhập vào trang **Merchant Tool** của ZaloPay để lấy các thông tin sau:

1. Truy cập trang Merchant Tool của ZaloPay tại địa chỉ: https://mc.zalopay.vn

2. Chọn **Dịch vụ tích hợp** -> nhấn **Thao tác** ở thẻ **Web to App**.

3. Nhấn **Lấy thông tin key tích hợp**, nhập mật khẩu tài khoản ZaloPay Merchant của bạn và chọn **Tiếp tục** để tải file key về máy.

4. Mật khẩu giải nén tệp chứa thông tin key sẽ được gửi qua email đã đăng ký. Sau khi giải nén, bạn sẽ có các thông tin cần thiết để điền vào KiotViet, bao gồm: App ID, Key 1, Key 2.

* **Thực hiện kết nối trên KiotViet**:

1. Tài khoản admin của chủ gian hàng đăng nhập vào màn hình **Quản lý**, chọn mục **Thanh toán** → thẻ **ZaloPay**, nhấn ***Kết nối***.

2. Điền đầy đủ các thông tin đã chuẩn bị ở trên vào các trường tương ứng.
3. Nhấn ***Kết nối*** để hoàn tất.

4. Hệ thống sẽ báo thành công nếu thông tin chính xác.
...
* **Thao tác thực hiện như sau**:
  + Khi tạo hóa đơn, bạn chọn phương thức thanh toán **Ví ZaloPay** để hiển thị mã QR.
...
* **Tình huống**: Khi bạn muốn sửa, xóa hoặc kết nối với một tài khoản ZaloPay Merchant khác.
* **Thao tác thực hiện như sau**:

1. Trên màn hình **Quản lý**, bạn truy cập menu **Thanh toán**, chọn thẻ **ZaloPay** và nhấn **Xem chi tiết**.
2. Để thay đổi thông tin, bạn cần nhấn **Xóa kết nối** hiện tại và thực hiện kết nối lại từ đầu với tài khoản mới.
...
* Chọn thẻ **ZaloPay**, điền đầy đủ thông tin kết nối và nhấn **Kết nối**.

***Lưu ý****: Bạn nên thực hiện việc* *lấy key tích hợp* *trước khi thao tác kết nối trên điện thoại để quá trình diễn ra thuận tiện hơn.*
...
* Truy cập mục **Thanh toán** và chọn thẻ **ZaloPay**.

* Nhấn **Xóa kết nối** để gỡ bỏ và thực hiện kết nối lại nếu cần.
