...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-thanh-toan/thanh-toan-khong-tiep-xuc/
---
...
Tính năng thanh toán không tiếp xúc (SoftPOS) qua tài khoản MB Bank cho phép bạn hỗ trợ khách hàng thanh toán chạm/quét thẻ một cách an toàn và nhanh chóng trực tiếp trên Máy POS bán hàng cầm tay KiotViet hoặc điện thoại sử dụng hệ điều hành Android có hỗ trợ đọc thẻ NFC.

**Lợi ích nổi bật của tính năng:**

* **Đơn giản hóa giao dịch**: Thanh toán 1 chạm qua SoftPOS loại bỏ nhu cầu quẹt hoặc cắm thẻ truyền thống, dẫn đến thời gian thanh toán nhanh hơn và hiệu quả tổng thể được cải thiện.
* **Giảm chi phí**: Việc sử dụng SoftPOS cũng có thể giảm chi phí chấp nhận thẻ tín dụng hoặc thẻ ghi nợ, vì nó loại bỏ nhu cầu về thiết bị bổ sung.
* **Trải nghiệm khách hàng được cải thiện**: Cung cấp tùy chọn thanh toán thuận tiện, an toàn, không cần chờ đợi trả tiền thừa.
* **Hỗ trợ đa dạng**: Chấp nhận thẻ vật lý có NFC (Visa, Master Card, JCB) và các ứng dụng thanh toán NFC (Apple Pay, Samsung Pay, Google Pay).

**Để sử dụng được tính năng, bạn cần đảm bảo các điều kiện tiên quyết sau**:

* **Thông tin kích hoạt:** Cửa hàng đã được cấp đầy đủ thông tin bao gồm TID, MID và Active Code.
* **Tài khoản liên kết:** Tài khoản ngân hàng thanh toán là MB Bank đã được liên kết thành công với cửa hàng.
* **Thiết bị cài đặt:** Máy POS bán hàng cầm tay KiotViet hoặc điện thoại Android của bạn đã cài đặt sẵn ứng dụng KiotViet Pay.

**Lưu ý:**

* Thiết bị của bạn chỉ cần kích hoạt 1 lần.
* Việc hủy kích hoạt được thực hiện thông qua ứng dụng nền KiotViet Pay.
* Nếu cần kích hoạt lại thiết bị (trong trường hợp đổi cửa hàng, đổi tài khoản...), bạn cần thực hiện hủy kích hoạt trước, sau đó mới thao tác lại quy trình kích hoạt với TID, MID, Active Code mới.

## **II. Các thao tác cơ bản**

### **1. Cài đặt ứng dụng KiotViet Pay**

**Tình huống:** Khi bạn bắt đầu sử dụng SoftPOS, bạn cần cài đặt ứng dụng **KiotViet Pay** trên Máy POS bán hàng cầm tay KiotViet hoặc điện thoại Android có hỗ trợ đọc thẻ NFC để làm nền tảng kết nối.

**Thao tác thực hiện như sau:**

* **Bước 1:** Trên Máy POS bán hàng cầm tay KiotViet hoặc điện thoại Android, bạn truy cập vào cửa hàng ứng dụng CH Play (Google Play Store).
* **Bước 2:** Tìm kiếm từ khóa "KiotViet Pay" (hoặc truy cập trực tiếp qua đường dẫn: https://play.google.com/store/apps/details?id=com.kiotviet.kpay).
* **Bước 3:** Chọn ứng dụng **KiotViet Pay** và thực hiện cài đặt trên thiết bị.

* **Bước 4:** Sau khi cài đặt xong, bạn tiếp tục thực hiện các bước kích hoạt thiết bị để sử dụng.

### **2. Thanh toán trên ứng dụng KiotViet**

**Tình huống:** Khi bạn sử dụng ứng dụng **KiotViet** trên điện thoại hoặc Máy POS bán hàng cầm tay KiotViet để tạo đơn và muốn khách hàng thanh toán bằng phương thức quét thẻ không tiếp xúc.

**Thao tác thực hiện như sau:**

* **Bước 1:** **Thiết lập Thanh toán không tiếp xúc**. Bạn Đăng nhập vào ứng dụng **KiotViet** → tại menu **Nhiều hơn** → chọn **Thiết lập cửa hàng** → **Bán hàng** và bật xanh tính năng ***Thanh toán không tiếp xúc***.

* **Bước 2:** **Kích hoạt thiết bị POS**
  + Khi thanh toán đơn hàng, bạn chọn
    - Hình thức thanh toán là ***Thẻ***.
    - Tài khoản ngân hàng là ***MB Bank***.
    - Chạm ***Quét thẻ***.

* Nếu thiết bị chưa được đăng ký tiện ích Thanh toán không tiếp xúc → ứng dụng hiển thị popup **Thiết bị chưa đăng ký**, bạn chạm ***Đăng ký*** → ứng dụng chuyển đến màn hình **Kích hoạt thiết bị**, bạn nhập các thông tin đã được cấp (MID, TID, Active Code) → chạm ***Kích hoạt***.
* Sau khi đã kích hoạt thành công, bạn chạm ***Quay lại*** để trở về màn hình **Thanh toán.**

* **Bước 3:** **Thực hiện thanh toán**.
  + Trên màn hình **Thanh toán**, bạn chạm ***Quét thẻ***.
  + Ứng dụng chuyển đến màn hình chờ quét thẻ, bạn để khách hàng chạm thẻ/ thiết bị cài đặt ứng dụng thanh toán NFC (Apple Pay, Samsung Pay, Google Pay) vào đầu máy POS hoặc mặt sau của điện thoại..
  + Sau khi giao dịch thanh toán thành công → bạn chạm ***Hoàn tất***.
  + Ứng dụng ghi nhận thông tin trên đơn hàng để bạn tiếp tục thanh toán kết thúc giao dịch.

### **3. Hủy kích hoạt thiết bị**

**Tình huống:** Khi bạn cần đổi cửa hàng, đổi tài khoản kết nối hoặc không còn nhu cầu sử dụng thiết bị hiện tại cho việc quét thẻ SoftPOS, bạn cần tiến hành hủy kích hoạt.

**Thao tác thực hiện như sau:**

* **Bước 1:** Mở ứng dụng **KiotViet Pay** trên Máy POS bán hàng cầm tay KiotViet hoặc điện thoại Android của bạn.
* **Bước 2:** Chạm ***Hủy kích hoạt***.
* **Bước 3:** Chạm ***Xác nhận***.
