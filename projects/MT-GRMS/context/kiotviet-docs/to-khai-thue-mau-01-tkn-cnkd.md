...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-to-khai-thue-hkd/to-khai-thue-mau-01-tkn-cnkd/
---
...
Hỗ trợ
Tờ khai Thuế HKDTờ khai thuế Mẫu 01/TKN-CNKD
...
Từ kỳ kê khai năm 2026, phần mềm KiotViet hỗ trợ Hộ kinh doanh tạo tờ khai thuế năm theo Mẫu 01/TKN-CNKD (Quy định tại Thông tư 18/2026/TT-BTC) trực tiếp trên hệ thống.

Trong phiên bản hiện tại, tính năng tập trung hỗ trợ cho nhu cầu của **Hộ kinh doanh Nhóm 1 kinh doanh ổn định (có doanh thu năm dưới 1 tỷ đồng)**. Hệ thống sẽ tự động tổng hợp toàn bộ doanh thu từ sổ kế toán, đồng thời cho phép bạn xem trước biểu mẫu chuẩn và xuất tệp dữ liệu để nộp lên cơ quan thuế.

**Lưu ý quan trọng**:

* Tính năng này chỉ hỗ trợ cho các kỳ kê khai từ năm 2026 trở đi. Hiện tại, KiotViet đóng vai trò hỗ trợ bạn chuẩn bị và xuất tệp dữ liệu chính xác nhất, thao tác nộp tờ khai chính thức vẫn sẽ được thực hiện trên cổng thông tin của cơ quan Thuế.
* Đối với nhóm Hộ kinh doanh nộp thuế TNCN theo % doanh thu và đề nghị hoàn thuế, KiotViet sẽ hỗ trợ tính năng này trong các phiên bản cập nhật tiếp theo.

**Lợi ích nổi bật của tính năng:**

* **Tự động hóa hoàn toàn số liệu:** Doanh thu năm được hệ thống tự động tổng hợp chính xác từ các sổ sách kế toán, loại bỏ thao tác nhập liệu thủ công và các sai sót đi kèm.
* **Tối ưu theo nhóm doanh thu:** Hệ thống tự động thiết lập biểu mẫu cho Hộ kinh doanh Nhóm 1 (doanh thu dưới 1 tỷ), các cột thuế sẽ được tự động để trống đúng theo quy định hiện hành.
* **Tiện lợi đối chiếu và lưu trữ:** Cho phép người dùng xem trước tờ khai dưới giao diện chuẩn xác của biểu mẫu nhà nước và tải về các định dạng tệp (XML, Excel) để nộp hoặc lưu trữ nội bộ.

## **II. Các thao tác cơ bản**

### **1. Xác nhận kỳ tính thuế**

**Tình huống:** Khi bạn tạo hồ sơ khai thuế lần đầu hoặc thay đổi nhóm doanh thu về nhóm 1 (dưới 1 tỷ), bạn cần xác nhận kỳ tính thuế (theo năm hoặc 6 tháng) để hệ thống tạo đúng tờ khai. Tùy vào thời điểm bạn bắt đầu kinh doanh trên phần mềm (6 tháng đầu năm hay 6 tháng cuối năm), hệ thống sẽ cung cấp các lựa chọn và hạn nộp tương ứng.

**Khái niệm cơ bản**:

* Kỳ tính thuế là cách bạn khai thuế trong năm.
* 01/TKN là tờ khai thuế khoán năm.
* 01/BK-STK là bảng kê số tài khoản ngân hàng.

**Thao tác thực hiện như sau:**

* **Bước 1:** Mở màn hình Danh sách tờ khai (hoặc nhấn chọn "Xem tờ khai thuế của bạn" ngay sau khi hoàn tất thiết lập ban đầu). Hệ thống sẽ tự động hiển thị popup **Xác nhận kỳ tính thuế**.

* **Bước 2:** Đọc thông tin trên popup. Bạn có thể nhấn vào ***Tìm hiểu thêm*** để xem chi tiết hướng dẫn tương ứng từng kỳ tính thuế.

* **Bước 3:** Lựa chọn kỳ tính thuế phù hợp với thực tế kinh doanh → nhấn ***Xác nhận***.

* **Bước 4:** Dựa trên lựa chọn này, danh sách tờ khai, bảng kê số tài khoản và thời hạn nộp sẽ được tự động hiển thị chuẩn xác.

### **2. Truy cập và kiểm tra số liệu tờ khai**

**Tình huống:** Bạn là Hộ kinh doanh Nhóm 1 (doanh thu năm dưới 1 tỷ). Đã đến kỳ hạn nộp thuế, bạn cần truy cập vào hệ thống để kiểm tra số liệu doanh thu mà phần mềm đã tự động tổng hợp xem có chính xác không.

**Thao tác thực hiện như sau:**

* **Bước 1:** Truy cập vào menu **Thuế & Kế toán** → **Thuế & Kế toán**.

* **Bước 2:** Chọn **Tờ khai thuế** → nhấn ***Xem chi tiết*** tại tờ khai cần xem.

* **Bước 3:** Tiến hành kiểm tra các thông tin đã được điền. Hệ thống đã tự động kéo toàn bộ dữ liệu từ **Sổ kế toán** → **Sổ doanh thu (S1a-HKD)** sang tờ khai, bao gồm doanh thu phân bổ theo từng địa điểm và ngành nghề.

* **Bước 4**: Xem báo cáo doanh thu hàng hóa theo ngành nghề. Tại mục **I. Kê khai thuế giá trị gia tăng (GTGT), thuế thu nhập cá nhân (TNCN)** → bạn nhấn vào giá trị trên các cột ***Doanh thu, Thuế GTGT, Thuế TNCN*** để xem chi tiết **Báo cáo doanh thu hàng hóa theo ngành nghề** với 2 mối quan tâm: theo ***Hàng hóa*** hoặc theo từng ***Giao dịch*** cụ thể. Tại đây, bạn có thể ***Xuất Excel*** để lưu trữ thông tin.

### **3.** **Kê khai thuế tiêu thụ đặc biệt (TTĐB)**
...
* **Bước 3**: Nhập thông tin ***Hàng hóa, dịch vụ chịu thuế TTĐBB*** và chọn ***Loại hàng hóa***. Hệ thống tự điền ***Thuế suất*** và gợi ý ***Đơn vị tính*** (có thể sửa đơn vị tính).
* **Bước 4**: Nhập ***Lượng hàng hóa chịu thuế*** và ***Giá tính thuế*** (phải ≥ 0). Hệ thống sẽ tự động hiển thị ***Số thuế TTĐB*** đã tính toán.
* **Bước 5**: Kiểm tra lại thông tin và nhấn ***Lưu*** → hệ thống tự động tạo bút toán và ghi vào Sổ thuế đặc thù (S3a-HKD).

### **4.** **Kê khai thuế/phí bảo vệ môi trường hoặc thuế tài nguyên**
...
### **5.** **Xem trước tờ khai theo biểu mẫu chuẩn**

**Tình huống:** Bạn là Hộ kinh doanh Nhóm 1 (doanh thu năm dưới 1 tỷ). Trước khi tiến hành xuất tệp dữ liệu để nộp, bạn muốn đối chiếu toàn bộ các số liệu hiển thị trên tờ khai xem đã khớp đúng với bố cục biểu mẫu chuẩn theo quy định chưa.
...
* ***Xác nhận*** theo 1 trong 2 lựa chọn:
  + Chỉ cập nhật cho tờ khai 6 tháng đầu năm
  + Cập nhật cho tờ khai 6 tháng đầu năm và tất cả các tờ khai kỳ tiếp theo

* **Bước 2:** Nhấn ***Xem trước*** ở góc phải màn hình.

* **Bước 3:** Hệ thống hiển thị bản xem trước của biểu mẫu 01/TKN-CNKD đã điền dữ liệu tự động. Bạn đọc và đối chiếu từng phần: Thông tin chung, Xác định nghĩa vụ thuế, Hỗ trợ thông tin nộp thuế và Đề nghị xử lý khoản nộp thừa.

* **Lưu ý**: Hệ thống KHÔNG hỗ trợ chỉnh sửa trực tiếp số liệu trên bản xem trước. Bạn cần quay lại **Sổ kế toán** → **Sổ doanh thu (S1a-HKD)** để sửa thông tin gốc, sau đó mới mở lại bản xem trước.

## **III. Các tính năng nâng cao**

### **1.** **Xem Sổ thuế đặc thù (S3a-HKD)**
...
* **Bước 2**: Chọn bộ lọc ***Thời gian*** để xem thông tin.

### **2. Đổi kỳ tính thuế**

**Tình huống:** Quá trình kinh doanh có sự thay đổi, bạn muốn chuyển đổi kỳ tính thuế từ Cả năm sang 6 tháng (hoặc ngược lại) mà không làm mất các dữ liệu thuế đã nhập.

**Thao tác thực hiện như sau:**

* **Bước 1:** Tại màn hình **Quản lý**, chọn **Thuế & Kế toán** → **Thuế & Kế toán** → **Thiết lập**

* **Bước 2:** Chọn **Thông tin hồ sơ** → chọn ***Kỳ tính thuế*** mới.

* **Bước 3:** Hệ thống sẽ hiển thị bảng cảnh báo xác nhận đổi kỳ và các hệ quả đi kèm.
* **Bước 4:** Nhấn ***Đổi kỳ tính thuế***. Danh sách tờ khai và hạn nộp sẽ được tự động tạo lại theo kỳ mới.

Thao tác thay đổi kỳ tính thuế cũng được hỗ trợ tương tự tại ***Hồ sơ kê khai*** trong menu **Thiết lập** → **Xem tất cả thiết lập** → **Thuế & Kế toán**.

### **3. Xử lý các tình huống đặc biệt và lỗi thường gặp**

**Tình huống:** Trong lúc lưu hoặc xem tờ khai, bạn gặp lỗi không thể hoàn tất thao tác.

**Thao tác thực hiện như sau:**

* Lỗi khi ***Lưu*** tờ khai: Hệ thống báo đỏ các thông tin không hợp lệ. Bạn cần kiểm tra, sửa hết các lỗi rồi mới tiến hành ***Lưu*** lại.
* Đã điền nhưng xem trước hoặc tải về không thấy dữ liệu: Do bạn quên nhấn ***Lưu***. Hãy nhấn ***Lưu***, sau đó mở lại bản xem trước.
* Cảnh báo thiếu địa chỉ: Hệ thống sẽ hiển thị bảng thông báo nếu địa điểm kinh doanh chưa có địa chỉ. Bạn cần cập nhật thông tin này, cảnh báo sẽ tự động biến mất.
* Tờ khai trạng thái ***Đã nộp***: Khi tờ khai chuyển sang trạng thái này, bạn sẽ không thể chỉnh sửa nội dung. Hệ thống giữ nguyên tờ khai đã nộp ngay cả khi bạn đổi kỳ tính thuế.

​

## **IV. Thao tác trên Điện thoại**

Tính năng Kê khai thuế theo Mẫu 01/TKN-CNKD trên ứng dụng KiotViet hỗ trợ cửa hàng thiết lập kỳ tính thuế, kiểm tra thông tin tờ khai, nhập liệu các loại thuế/phí đặc thù và tra cứu sổ sách một cách tiện lợi, nhanh chóng ngay trên điện thoại.

**Tình huống:** Bạn là Hộ kinh doanh Nhóm 1 (doanh thu năm dưới 1 tỷ) cần xác nhận kỳ tính thuế, kiểm tra nhanh số liệu doanh thu năm đã được phần mềm tổng hợp, thêm các loại thuế đặc thù ngay trên điện thoại

**Thao tác thực hiện như sau:**

* **Bước 1:** Truy cập vào ứng dụng KiotViet trên điện thoại → chạm **Nhiều hơn** → chọn **Thuế & Kế toán**.
* **Bước 2:** Chọn MST (nếu có nhiều MST) → chọn **Tờ khai thuế** → hệ thống sẽ tự động hiển thị popup **Xác nhận kỳ tính thuế**.

* **Bước 3:** Đọc thông tin trên popup. Bạn có thể chạm vào ***Tìm hiểu thêm*** để xem chi tiết hướng dẫn tương ứng từng kỳ tính thuế → chạm ***Đã hiểu***.

* **Bước 4**: Lựa chọn kỳ tính thuế phù hợp với thực tế kinh doanh → chạm ***Xác nhận***.
* **Bước 5**: Dựa trên lựa chọn này, danh sách tờ khai, bảng kê số tài khoản và thời hạn nộp sẽ được tự động hiển thị.

* **Bước 6**: Chọn kỳ kê khai và xem dữ liệu tổng hợp tương tự như trên giao diện Web.

* **Bước 7**: Chỉnh sửa **Thông tin người nộp thuế**. Bạn chạm khối thông tin người nộp thuế → nhấn ***Sửa*** → thay đổi thông tin→ nhấn ***Xong*** để ghi nhận.

* **Bước 8**: Xem doanh thu theo nhóm ngành nghề. Bạn chạm vào khu vực ***Kê khai thuế giá trị trị gia tăng (GTGT), thuế thu nhập cá nhân (TNCN)*** để xem thông tin.

* **Bước 9**: Kê khai thuế tiêu thụ đặc biệt (TTĐB). Bạn chạm vào khu vực B → chạm ***Thêm hàng hóa*** → nhập thông tin → chạm ***Xong***.

* **Bước 10**: Kê khai thuế/phí bảo vệ môi trường hoặc thuế tài nguyên. Tại khu vực C, bạn chạm vào mục cần khai thông tin tương ứng → chạm ***Thêm tài nguyên hàng hóa*** → nhập thông tin → chạm ***Xong***.

* **Bước 11**: Xem trước tờ khai theo biểu mẫu chuẩn. Trên màn hình **Tờ khai thuế**, bạn chạm 3 chấm → chạm ***Xem trước*** để hiển thị toàn bộ biểu mẫu 01/TKN-CNKD đã điền dữ liệu tự động.
