...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-thiet-bi-phan-cung/huong-dan-thay-doi-dns/
---
...
Trong một số trường hợp, hệ thống DNS (Domain Name System) mặc định của nhà cung cấp mạng có thể hoạt động không ổn định, dẫn đến tình trạng truy cập vào gian hàng KiotViet bị chậm hoặc gián đoạn. Việc thay đổi DNS sang các hệ thống công cộng tin cậy (như Google hoặc Cloudflare) sẽ giúp cải thiện tốc độ và sự ổn định khi kết nối.

**Lợi ích nổi bật của việc thay đổi DNS:**

* **Lợi ích 1:** Khắc phục tình trạng không truy cập được vào màn hình bán hàng hoặc quản lý, đảm bảo hoạt động kinh doanh không bị gián đoạn.
* **Lợi ích 2:** Tăng tốc độ tải dữ liệu khi sử dụng phần mềm KiotViet trên máy tính.

## **II. Các Thao Tác Cơ Bản**

Để khắc phục sự cố kết nối, bạn hãy thực hiện theo trình tự các bước dưới đây trên máy tính sử dụng hệ điều hành Windows.

**Thay đổi địa chỉ DNS và làm mới bộ nhớ đệm mạng (Flush DNS)**

* **Tình huống:** Bạn đang sử dụng máy tính để bán hàng nhưng gặp tình trạng phần mềm tải rất chậm hoặc báo lỗi không kết nối được, trong khi các thiết bị khác vẫn vào mạng bình thường.
* **Thao tác thực hiện như sau:  
  Bước 1: Mở cài đặt mạng (Network Connections)**
  1. Trên bàn phím, nhấn tổ hợp phím **Windows + R** để mở hộp thoại Run.
  2. Nhập từ khóa ncpa.cpl và nhấn **Enter** (hoặc chọn OK).

* **Bước 2: Chọn mạng đang sử dụng**
  1. Tại cửa sổ Network Connections, xác định mạng bạn đang dùng (thường hiển thị là **Wi-Fi** hoặc **Ethernet**).
  2. Nhấp chuột phải vào biểu tượng mạng đó và chọn **Properties**

* **Bước 3: Thiết lập giao thức IP**
  1. Trong bảng Properties, tìm và chọn dòng **Internet Protocol Version 4 (TCP/IPv4)**.
  2. Nhấn nút **Properties**.

* **Bước 4: Nhập địa chỉ DNS mới**
  1. Tích chọn vào mục **Use the following DNS server addresses**.
  2. Nhập thông tin địa chỉ DNS như sau:
     + **Preferred DNS server:** 8.8.8.8
     + **Alternate DNS server:** 1.1.1.1 (hoặc 8.8.4.4)

1. Nhấn **OK** để lưu lại, sau đó nhấn **Close** để đóng các cửa sổ cài đặt.

* **Bước 5: Làm mới bộ nhớ đệm DNS (Flush DNS)**
  1. Trên bàn phím, nhấn tổ hợp phím **Windows + R** để mở hộp thoại Run, gõ từ khóa cmd.

1. Tại cửa sổ dòng lệnh màu đen vừa hiện ra, nhập lệnh sau: ipconfig /flushdns

1. Nhấn **Enter**. Hệ thống sẽ thông báo đã xóa bộ nhớ đệm thành công.

* *Sau khi hoàn tất, bạn vui lòng tải lại trang KiotViet để kiểm tra kết nối.*

## **III. Thao tác trên Điện thoại**

Tính năng thay đổi DNS trên ứng dụng di động hỗ trợ cửa hàng thực hiện các thao tác: Cài đặt thủ công địa chỉ DNS trên điện thoại Android và iOS để ổn định kết nối cho ứng dụng KiotViet.

### **1. Thay đổi DNS trên hệ điều hành Android**

* **Tình huống:** Bạn sử dụng ứng dụng KiotViet trên điện thoại Android để kiểm kho hoặc bán hàng nhưng gặp hiện tượng phản hồi chậm từ máy chủ.
* **Thao tác thực hiện như sau:**
  1. Vào **Cài đặt** -> **Kết nối** -> **Wi-Fi**.
  2. Nhấn vào biểu tượng bánh răng (hoặc giữ lì) tại tên Wi-Fi đang kết nối -> Chọn **Xem thêm** hoặc **Quản lý cài đặt mạng**.
  3. Tại mục **Cài đặt IP**, chuyển từ **DHCP** sang **Tĩnh**.
  4. Kéo xuống mục **DNS 1** nhập 8.8.8.8 và **DNS 2** nhập 1.1.1.1.
  5. Nhấn **Lưu**.

### **2. Thay đổi DNS trên hệ điều hành iOS (iPhone/iPad)**

* **Tình huống:** Thiết bị iOS của bạn không thể đồng bộ dữ liệu đơn hàng về ứng dụng KiotViet do lỗi DNS của nhà mạng.
* **Thao tác thực hiện như sau:**
  1. Vào **Cài đặt** -> **Wi-Fi**.
  2. Nhấn vào biểu tượng chữ **(i)** bên cạnh mạng Wi-Fi đang kết nối.
  3. Cuộn xuống tìm mục **Định cấu hình DNS** -> Chọn **Thủ công**.
  4. Xóa các máy chủ cũ và chọn **Thêm máy chủ** để nhập: 8.8.8.8 và 1.1.1.1.
  5. Nhấn **Lưu**.

## **IV. Thao tác trên Máy POS**

Tính năng thay đổi DNS trên máy POS Android hỗ trợ cửa hàng thực hiện các thao tác: Cấu hình mạng trực tiếp trên thiết bị bán hàng chuyên dụng để đảm bảo KiotViet Máy bán hàng hoạt động mượt mà.

**Thay đổi DNS trên máy POS**

* **Tình huống:** Tại quầy thu ngân, KiotViet Máy POS Nhà hàng không thể in hóa đơn hoặc tải danh sách hàng hóa do mạng chập chờn.
* **Thao tác thực hiện như sau:**
  1. Vuốt từ trên màn hình máy POS xuống và chọn biểu tượng **Cài đặt**.
  2. Chọn mục **Mạng và Internet** -> **Wi-Fi**.
  3. Nhấn vào tên Wi-Fi đang kết nối -> Chọn biểu tượng **Chỉnh sửa (hình cây bút)**.
  4. Mở phần **Tùy chọn nâng cao**.
  5. Tại mục **Cài đặt IP**, chuyển sang **Tĩnh**.
  6. Nhập địa chỉ tại **DNS 1**: 8.8.8.8 và **DNS 2**: 1.1.1.1.
  7. Nhấn **Lưu**.
