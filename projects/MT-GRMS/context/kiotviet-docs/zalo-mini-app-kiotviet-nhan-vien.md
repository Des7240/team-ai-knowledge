...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-nhan-vien/zalo-mini-app-kiotviet-nhan-vien/
---
...
Zalo Mini App – KiotViet Nhân viên là giải pháp quản lý thu nhập và công việc dành cho nhân viên tại các cửa hàng sử dụng phần mềm KiotViet. Chạy trực tiếp trên nền tảng Zalo, ứng dụng giúp nhân viên dễ dàng chấm công nhanh chóng qua định vị (GPS), theo dõi bảng chấm công, lịch làm việc, cũng như xem phiếu lương chi tiết ngay trên Zalo mà không cần cài thêm ứng dụng nào khác.

**Lợi ích nổi bật của tính năng:**

* Hệ thống tự động tạo mã QR, đường dẫn (link) chấm công, giúp nhân viên truy cập nhanh chóng.
* Cho phép nhân viên tự tạo hồ sơ, cập nhật số điện thoại từ Zalo và gửi lên quản lý phê duyệt.
* Giảm bớt các bước xác thực phức tạp, tiết kiệm thời gian cho cả quản lý (không cần tạo hồ sơ thủ công trước) và nhân viên.

## **II. Các thao tác cơ bản**

### **1. Thiết lập chấm công**

**Tình huống:** Bạn là quản lý cửa hàng, bạn cần tạo đường dẫn (link) hoặc mã QR để nhân viên quét và đăng nhập vào hệ thống chấm công của cửa hàng một cách nhanh chóng.

**Thao tác thực hiện như sau:**

* **Bước 1:** Trên màn hình **Quản lý** → chọn **Nhân viên** → **Thiết lập nhân viên**.
* **Bước 2:** Khi **Khởi tạo** → **Hình thức chấm công** hoặc chọn menu **Zalo mini App** (thao tác này có thể thực hiện trên giao diện website hoặc ứng dụng KiotViet trên điện thoại) → bạn bật xanh tính năng.

* **Bước 3:** ***Thêm địa chỉ chấm công*** cho các chi nhánh.
...
* **Bước 4: Chọn tính năng mà nhân viên được phép sử dụng**, gồm:
  + ***Bảng chấm công***
  + ***Bảng lương***

* **Bước 5: Chia sẻ đường dẫn hoặc mã QR vào Zalo Mini App cho nhân viên**. Bạn nhấn ***Chia sẻ đường dẫn → Sao chép*** đường dẫn gửi nhân viên truy cập hoặc gửi/in ***mã QR*** cho nhân viên quét.

### **2. Nhân viên chấm công**

**Tình huống:** Bạn cần truy cập vào Zalo Mini App để thực hiện chấm công.

**Thao tác thực hiện như sau:**

* **Bước 1:** Bạn dùng điện thoại (đã bật GPS và chia sẻ vị trí) truy cập đường dẫn hoặc quét mã QR vào Zalo Mini App.
* **Bước 2:** Chọn ***Tiếp tục*** → kiểm tra số điện thoại → chạm ***Tiếp tục***.
* **Bước 3:** Với lần đầu tiên truy cập khi thiết bị chưa được xác nhận, bạn cần chạm ***Gửi yêu cầu xác nhận*** và chờ quản lý phê duyệt.

* **Bước 4:** Sau khi yêu cầu được duyệt thành công. Bạn quay lại màn hình **Đăng nhập** → chạm ***Tiếp tục***.
* **Bước 5:** Chọn ***Chi nhánh*** làm việc (nếu có nhiều chi nhánh), ***Chọn ca*** làm việc (nếu có nhiều ca)
* **Bước 6:** Chạm ***Vào***/ ***Ra*** tương ứng để hệ thống ghi nhận chấm công.

### **3. Xem bảng chấm công**

**Tình huống:** Trong quá trình làm việc, bạn muốn kiểm tra lại toàn bộ lịch sử các ca đã chấm công.

**Thao tác thực hiện như sau:**

* **Bước 1:** Trên ứng dụng Zalo Mini App → KiotViet Nhân Viên, tại **Trang chủ** → hệ thống hiển thị thông tin tổng quan bảng chấm công tháng hiện tại.
* **Bước 2:** Bạn chạm vào ***Bảng chấm công*** hoặc từng trạng thái cụ thể (Đi làm, Đi muộn, Về sớm, nghỉ làm, Làm thêm) để xem các ca đã thực hiện chấm công (đi làm, nghỉ làm), được liệt kê theo từng ngày với các thông tin: Tên ca, khung giờ ca, giờ chấm công thực tế và phân loại (Đúng giờ, Đi muộn/ Về sớm). Bạn có thể thay đổi bộ lọc để tìm kiếm thông tin.

* Ngoài ra, trên menu **Bảng chấm công** (ở thanh menu phía dưới màn hình) → hệ thống hiển thị danh sách tất cả các ca có lịch làm việc mặc định theo ***Tuần này*** với ***Tất cả các trạng thái***, liệt kê theo từng ngày với các thông tin: Tên ca, khung giờ ca, giờ chấm công thực tế và phân loại (Đúng giờ, Đi muộn/ Về sớm, Chưa đến ca, Chưa chấm công, Chấm công thiếu). . Bạn có thể thay đổi bộ lọc để tìm kiếm thông tin.

### **4. Xem phiếu lương**

**Tình huống:** Bạn muốn kiểm tra chi tiết các khoản thu nhập, lương, thưởng, hoa hồng, phụ cấp, giảm trừ của mình trong tháng.

**Thao tác thực hiện như sau:**

* **Bước 1:** Trên ứng dụng Zalo Mini App → KiotViet Nhân Viên, bạn chọn **Phiếu lương**.

​

* **Bước 2:** Hệ thống sẽ hiển thị danh sách phiếu lương theo tháng, gồm: mã phiếu, kỳ lương, tổng lương và trạng thái (Tạm tính hoặc Đã chốt).
* **Bước 3:** Bạn có thể sử dụng bộ lọc trạng thái và chọn xem phiếu Tạm tính, Đã chốt, Đã hủy.

* **Bước 4:** Nhấn vào một phiếu lương cụ thể để xem chi tiết các khoản: Lương chính, Làm thêm giờ, Hoa hồng, Phụ cấp, Thưởng, Giảm trừ, Bảo hiểm bắt buộc, Thuế TNCN.
* **Bước 5:** Bạn có thể nhấn dấu mũi tên (>) bên phải từng khoản để xem diễn giải chi tiết.

## **III. Các tính năng nâng cao**

### **1. Xử lý các tình huống đặc biệt**

**Tình huống:** Trong quá trình đăng nhập, bạn gặp phải các vấn đề như: sai số điện thoại, chưa được tạo hồ sơ nhân viên trên hệ thống, bạn đổi thiết bị mới, tài khoản bị báo đã nghỉ việc hoặc yêu cầu gửi lên quản lý trước đó bị từ chối. Bạn cần xử lý để gửi lại thông tin chuẩn xác.

**Thao tác thực hiện như sau:**

* Tại màn hình **Đăng nhập**, sau khi chạm ***Tiếp tục*** → nếu thông tin không khớp, hệ thống sẽ đưa ra các lựa chọn xử lý.
* Nếu yêu cầu duyệt bị từ chối do thao tác nhầm, bạn có thể tiếp tục ***Gửi lại yêu cầu*** (tối đa 2 lần) → chạm ***Đồng ý*** và liên hệ với quản lý để được phê duyệt.

* Nếu số điện thoại chưa được đăng ký trên hệ thống → bạn chọn lý do phù hợp với thực tế của mình:
  + Đối với trường hợp chưa có hồ sơ nhân viên, bạn chạm ***Chưa có, tôi là nhân viên mới*** → chạm ***Cho phép*** KiotViet Nhân viên nhận các thông tin của bạn → chỉnh sửa Họ tên (nếu cần) → chạm ***Gửi yêu cầu tạo hồ sơ***.

* Đối với trường hợp khác số điện thoại, bạn chọn ***Đã có, nhưng tôi đã đổi số điện thoại*** → điền số điện thoại cũ → chạm ***Gửi yêu cầu cập nhật***.

* Nếu nhân viên đã nghỉ việc → hệ thống hiển thị thông báo và không cho phép đăng nhập.

### **2. Quản lý xét duyệt yêu cầu**

**Tình huống:** Bạn là quản lý cửa hàng, khi nhân viên gửi các yêu cầu chờ duyệt như: tạo hồ sơ mới, cập nhật số điện thoại, đổi thiết bị chấm công, chấm công ngoài phạm vi cho phép,... bạn cần truy cập hệ thống để kiểm tra và phê duyệt cho nhân viên.

**Thao tác thực hiện như sau:**

* **Bước 1:** Khi có yêu cầu chờ duyệt mới, hệ thống sẽ tự động gửi thông báo tới tài khoản của chủ gian hàng (trên website và trên ứng dụng KiotViet), cụ thể tại các chức năng sau:
  + Trên website: Màn hình **Danh sách nhân viên** hoặc **Bảng chấm công** → ***Duyệt yêu cầu***.

* Trên ứng dụng KiotViet:
  + Màn hình **Tổng quan** → quả chuông

* Màn hình **Nhân viên** → 3 chấm → ***Duyệt yêu cầu***.

* Màn hình **Bảng chấm công** → 3 chấm → ***Xét duyệt chấm công***.

* **Bước 2:** Bấm trực tiếp vào thông báo nhận được trên ứng dụng KiotViet hoặc nhấn ***Duyệt yêu cầu*** trên màn hình.
* **Bước 3:** Hệ thống hiển thị danh sách yêu cầu gồm 2 tab: **Nhân viên** và **Chấm công** ghi nhận cụ thể Thời gian gửi yêu cầu, Tên nhân viên, Loại yêu cầu và Nội dung chi tiết. Bạn có thể sử dụng thanh tìm kiếm (theo từ khóa tên nhân viên) hoặc kết hợp bộ lọc chi nhánh để tìm nhanh.
  + Giao diện website:

* Giao diện điện thoại:

* **Bước 4:** Nhấn ***Xác nhận*** để đồng ý phê duyệt cho nhân viên hoặc ***Từ chối*** nếu không phê duyệt.

### **3. Nhập mã xác nhận khi quản lý không thể duyệt yêu cầu**

**Tình huống:** Bạn được quản lý cung cấp mã xác nhận thay vì được duyệt yêu cầu đăng nhập trên thiết bị mới.

**Thao tác thực hiện như sau:**

* **Bước 1:** Trên KiotViet, quản lý mở chi tiết nhân viên (thao tác này có thể thực hiện trên giao diện website hoặc ứng dụng KiotViet trên điện thoại) → nhấn ***Lấy mã xác nhận***. Mã này có hiệu lực 5 phút.

* **Bước 2:** Tại màn hình thông báo **Đang chờ duyệt yêu cầu** trên Zalo Mini App, nhân viên chạm Nhập mã xác nhận ***tại đây***.
* **Bước 3:** Nhập chính xác mã xác nhận → chạm ***Tiếp tục***. Nếu mã hợp lệ, hệ thống sẽ ngay lập tức phê duyệt và chuyển bạn vào màn hình **KiotViet Nhân viên**.
