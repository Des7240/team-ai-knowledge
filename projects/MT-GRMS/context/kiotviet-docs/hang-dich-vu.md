...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-hang-hoa/hang-dich-vu/
---
...
Việc tạo và quản lý các sản phẩm dịch vụ trên KiotViet mang lại cho cửa hàng của bạn những lợi ích thiết thực sau:

**Lợi ích nổi bật của việc quản lý Hàng dịch vụ trên KiotViet:**

* **Quản lý doanh thu dịch vụ chính xác và chuyên nghiệp:** Dễ dàng tạo và quản lý các sản phẩm phi vật chất như phí sửa chữa, phí giao hàng, công lắp đặt... giúp bạn theo dõi chính xác doanh thu từ các dịch vụ này, tách biệt hoàn toàn với doanh thu từ hàng hóa vật lý.
* **Đơn giản hóa quản lý kho:** Hàng dịch vụ không được quản lý tồn kho, do đó sẽ không ảnh hưởng đến các số liệu trong kho hàng, giúp việc kiểm kê và quản lý hàng hóa vật lý của bạn trở nên đơn giản, chính xác và tránh nhầm lẫn.
* **Thanh toán tiện lợi, gộp chung trên một hóa đơn:** Bạn có thể dễ dàng thêm các khoản phí dịch vụ vào chung một hóa đơn với các sản phẩm hàng hóa khác, giúp quy trình thanh toán cho khách hàng trở nên nhanh chóng, liền mạch và chuyên nghiệp hơn.

## **II. Các thao tác cơ bản**

Trên giao diện website, bạn có thể thực hiện đầy đủ các nghiệp vụ liên quan đến việc tạo và bán các sản phẩm dịch vụ.

### **1. Thêm mới hàng dịch vụ**

* **Tình huống:** Bạn cần khởi tạo một sản phẩm là “Dịch vụ lắp đặt” trong danh mục của mình.
...
3. Điền các thông tin cần thiết: Tên hàng, Nhóm hàng, Giá bán.
4. Tích chọn "Bán trực tiếp" để dịch vụ này hiển thị trên màn hình **Bán hàng**.
5. Nhấn ***Lưu*** để hoàn tất.

### **2. Thêm dịch vụ vào hóa đơn bán hàng**

* **Tình huống:** Bạn cần thêm một khoản phí dịch vụ (ví dụ: Dịch vụ lắp đặt) vào hóa đơn cho khách.
* **Thao tác thực hiện như sau:**

1. Truy cập màn hình **Bán hàng**.
2. Tại ô tìm kiếm, bạn nhập tên hoặc mã của dịch vụ cần bán.
3. Chọn dịch vụ từ kết quả tìm kiếm để thêm vào hóa đơn và tiến hành thanh toán như bình thường.

### **3. Chỉnh sửa/Xóa hàng dịch vụ**

* **Tình huống:** Bạn cần thay đổi giá hoặc xóa một dịch vụ không còn cung cấp.
* **Thao tác thực hiện như sau:** 
  + **Để chỉnh sửa:** Vào **Hàng hóa** → **Danh sách hàng hóa**, tìm đến dịch vụ cần sửa và nhấn ***Chỉnh sửa*** → thay đổi thông tin và nhấn ***Lưu***.
...
Bạn có thể quản lý danh mục dịch vụ của mình ngay trên ứng dụng KiotViet một cách tiện lợi.

### **1. Thêm mới hàng dịch vụ**

* **Tình huống:** Bạn cần tạo nhanh một gói dịch vụ mới ngay trên điện thoại.
* **Thao tác thực hiện như sau:**

1. Mở ứng dụng KiotViet, trên menu chọn **Hàng hóa**.
2. Chạm vào biểu tượng dấu **+** và chọn loại hàng hóa là **dịch vụ**.
3. Nhập các thông tin cần thiết như Tên dịch vụ, Nhóm hàng, Giá bán.
4. Chạm ***Lưu*** để hoàn tất.

### **2. Chỉnh sửa/Xóa hàng dịch vụ**

* **Tình huống:** Bạn cần chỉnh sửa hoặc xóa một dịch vụ không còn sử dụng.
* **Thao tác thực hiện như sau:** 
  + **Chỉnh sửa:** Tại danh sách **Hàng hóa**, chạm vào dịch vụ cần sửa. Tại mỗi khu vực thông tin, chạm ***Sửa*** để cập nhật lại thông tin và ***Lưu***.

* **Xóa/ Ngừng kinh doanh:** Trong màn hình chi tiết dịch vụ, chạm vào biểu tượng ba chấm (**...**) và chọn **Xóa/ Ngừng kinh doanh**.

### **2. Bán hàng dịch vụ**

* **Tình huống:** Bạn cần thêm dịch vụ vào hóa đơn khi đang bán hàng bằng ứng dụng di động.
* **Thao tác thực hiện như sau:**

1. Mở ứng dụng KiotViet.
2. Tại màn hình **Bán hàng**, tìm kiếm tên hoặc mã dịch vụ.
3. Chọn dịch vụ để thêm vào hóa đơn và tiến hành thanh toán.

## **IV. Thao tác trên Máy POS**

Trên máy POS, việc bán các sản phẩm dịch vụ đã được tạo sẵn trong danh mục được thực hiện rất nhanh chóng.

* **Tình huống:** Nhân viên thu ngân cần thêm “Dịch vụ lắp đặt” vào hóa đơn cho khách ngay tại quầy.
* **Thao tác thực hiện như sau:**

1. Trên ứng dụng KiotViet Máy bán hàng của máy POS, bạn sử dụng ô "Tìm hàng hóa" để nhập tên hoặc mã của dịch vụ.
2. Chọn dịch vụ từ kết quả tìm kiếm. Dịch vụ sẽ được thêm vào hóa đơn.
