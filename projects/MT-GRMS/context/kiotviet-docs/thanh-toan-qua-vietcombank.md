...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-thanh-toan/thanh-toan-qua-vietcombank/
---
...
Nhằm hỗ trợ các gian hàng thúc đẩy việc thanh toán phi tiền mặt, KiotViet kết hợp cùng ngân hàng Vietcombank đã ra mắt tính năng thanh toán chuyển khoản bằng phương pháp quét mã VietQR và nhận thông báo kết quả ngay trên phần mềm.

**Đối tượng áp dụng**: Tất cả gian hàng trên KiotViet (bao gồm cả gian hàng dùng thử và gian hàng chính thức) có tài khoản tại ngân hàng Vietcombank.

**Lợi ích nổi bật của tính năng**:

* **Giúp chủ cửa hàng và quản lý**: Dễ dàng đăng ký và quản lý nhiều tài khoản Vietcombank trên cùng một gian hàng, giúp việc đối soát và theo dõi dòng tiền trở nên đơn giản và tập trung.
...
**Tóm tắt luồng hoạt động**: Về cơ bản, luồng hoạt động của tính năng bao gồm 2 bước chính: 1. Đăng ký dịch vụ nhận thông báo thanh toán của Vietcombank -> 2. Nhận thông báo kết quả giao dịch trên màn hình **Bán hàng**.
...
Để kích hoạt tính năng nhận thông báo thanh toán tự động, bạn cần hoàn tất việc đăng ký dịch vụ trên KiotViet và xác thực liên kết trên nền tảng của Vietcombank.

* **Lưu ý về nguyên tắc liên kết tài khoản Vietcombank**:
  + Một gian hàng KiotViet có thể liên kết với **nhiều tài khoản Vietcombank**.
  + Một tài khoản Vietcombank tại một thời điểm **chỉ có thể liên kết với một gian hàng KiotViet duy nhất**. Nếu muốn sử dụng tài khoản cho gian hàng khác, bạn cần hủy liên kết ở gian hàng cũ trước.

Quá trình này được thực hiện như sau:

#### **1.1. Đăng ký dịch vụ trên KiotViet**

* Tài khoản admin của chủ gian hàng đăng nhập vào màn hình **Quản lý**, chọn mục **Thanh toán** và nhấn **Đăng ký** tại thẻ **Vietcombank**.

* Hoặc trên màn hình **Bán hàng**,
* Ngay sau khi ***Lưu*** thông tin thêm tài khoản ngân hàng Vietcombank -> hệ thống hiển thị popup **Bật thông báo thanh toán QR**, bạn chọn ***Bật ngay***
* Hay khi tạo đơn hàng, bạn chọn phương thức thanh toán ***Chuyển khoản*** -> chọn tài khoản Vietcombank -> nhấn ***Nhận thông báo tiền về***

* Tiếp theo, bạn chọn loại tài khoản là **Cá nhân** hoặc **Doanh nghiệp** (tài khoản tương ứng của hộ kinh doanh/doanh nghiệp tại ngân hàng) và điền đầy đủ thông tin được yêu cầu (Số tài khoản, Chủ tài khoản, Số điện thoại hoặc User Digibiz).
* Tích vào ô đồng ý với điều khoản và chọn ***Đăng ký***.

#### **1.2. Xác thực liên kết trên ứng dụng/website của Vietcombank**

– Sau khi đăng ký trên KiotViet, bạn cần mở nền tảng tương ứng của Vietcombank để xác thực yêu cầu liên kết.

– **Lưu ý**: Yêu cầu xác thực thường có hiệu lực trong một khoảng thời gian ngắn (ví dụ: 3 phút).

– **Với tài khoản cá nhân**: Mở ứng dụng **VCB Digibank**, quét mã QR hoặc làm theo hướng dẫn trên màn hình để xác thực.

– **Với tài khoản doanh nghiệp/hộ kinh doanh**: Bạn nhấn ***Xác thực ngay*** để truy cập trang web **VCB DigiBiz** và thực hiện theo 4 bước như trên màn hình hướng dẫn.

– Sau khi thành công, hệ thống KiotViet sẽ hiển thị thông báo dịch vụ đã được kích hoạt. Bạn nhấn ***Đã hiểu***

### **2. Nhận thông báo kết quả giao dịch**
...
* **Thao tác trên màn hình Bán hàng**:
  + Khi tạo hóa đơn, bạn chọn phương thức thanh toán **Chuyển khoản** để hiển thị mã QR của tài khoản Vietcombank đã liên kết.
...
* Để gia tăng hiệu quả và tốc độ xử lý đơn hàng, bạn có thể kết hợp dịch vụ thông báo thanh toán của Vietcombank với các tiện ích như:
...
### **1. Xem danh sách tài khoản Vietcombank đã đăng ký dịch vụ**

* **Tình huống**: Khi bạn cần kiểm tra lại thông tin các tài khoản Vietcombank nào đang được kết nối để nhận thông báo tự động trên KiotViet.
* **Thao tác thực hiện như sau**:

1. Tại màn hình **Quản lý**, vào menu **Thanh toán**.
2. Chọn thẻ **Vietcombank** và nhấn **Xem chi tiết** để xem danh sách các tài khoản đã liên kết.

### **2. Hủy dịch vụ nhận thông báo thanh toán Vietcombank**

* **Tình huống**: Khi bạn không còn nhu cầu sử dụng dịch vụ nhận thông báo tự động cho một tài khoản Vietcombank hoặc muốn chuyển sang gian hàng khác.
* **Thao tác thực hiện như sau**:
  + **Lưu ý**: Thao tác hủy được thực hiện trên ứng dụng/website của ngân hàng Vietcombank, không thực hiện trên KiotViet.
  + **Với tài khoản Cá nhân (trên app VCB Digibank)**:

1. Đăng nhập ứng dụng, chọn ***Xem tất cả***.
2. Tại mục **Tiện ích**, chọn ***Liên kết tài khoản***.
3. Chọn ***Dịch vụ Liên kết thông báo biến động tài khoản qua KiotViet***.
4. Chọn ***Hủy liên kết*** và ***Đồng ý*** để xác nhận.

* **Với tài khoản Doanh nghiệp (trên web VCB DigiBiz)**:

1. Tại mục **Tiện ích**, chọn **Quản lý tài khoản liên kết**.

1. Chọn dịch vụ **Liên kết thông báo biến động tài khoản**, chọn tài khoản **KIOTVIET** và nhấn 3 chấm →  ***Hủy liên kết***.

1. Chọn **Đồng ý** để xác nhận.

## **IV. Thao tác trên Điện thoại**

Tại ứng dụng KiotViet trên điện thoại, bạn có thể thực hiện các thao tác tương tự giao diện trên website bao gồm đăng ký, nhận thông báo kết quả giao dịch và xem các tài khoản đã liên kết.

**1. Đăng ký và liên kết dịch vụ**

 – Từ menu **Nhiều hơn** hoặc **Tổng quan**, bạn chọn mục **Thanh toán** -> nhấn **Đăng ký ngay**.

– Chọn thẻ **Vietcombank**, điền các thông tin tương tự như trên phiên bản máy tính và nhấn **Tiếp tục**.

– Mở ứng dụng **VCB Digibank** (hoặc web **VCB DigiBiz**) trên điện thoại và thực hiện xác thực theo hướng dẫn.

Minh họa thao tác với loại tài khoản cá nhân

Minh họa thao tác với loại tài khoản doanh nghiệp/hộ kinh doanh.
...
* Khi kết hợp với các **Thiết lập bán hàng** trên ứng dụng, hệ thống sẽ:

* Đọc số tiền khách thanh toán qua loa thiết bị.
* Tự động hoàn thành đơn hàng khi quét QR thành công.

**3. Xem và quản lý các tài khoản đã đăng ký**

– Truy cập mục **Thanh toán** và chọn thẻ **Vietcombank**.

 – Ứng dụng sẽ hiển thị danh sách các tài khoản đã liên kết thành công. Bạn có thể nhấn nút cộng  để thêm liên kết cho tài khoản khác.

## **V. Thao tác trên Máy POS Android**

Tính năng Thanh toán qua Vietcombank trên Máy POS Android hỗ trợ cửa hàng thực hiện thao tác thanh toán bằng cách hiển thị mã QR của Vietcombank cho khách hàng.

* **Tình huống**: Khi bạn đang bán hàng tại quầy và muốn khách hàng thanh toán bằng cách quét mã QR của Vietcombank trên màn hình máy POS.
* **Thao tác thực hiện như sau**:

1. Đảm bảo bạn đã thêm tài khoản Vietcombank và đăng ký dịch vụ trên phiên bản máy tính hoặc ứng dụng di động.
2. Khi tạo hóa đơn trên máy POS, chọn phương thức thanh toán là **Chuyển khoản** và chọn tài khoản Vietcombank đã liên kết.
...
1. Khách hàng quét mã QR và thanh toán thành công, ứng dụng sẽ hiển thị thông báo kết quả ngay trên màn hình **Thanh toán**.

1. Khi kết hợp với các **Cài đặt** (trong 3 gạch) trên ứng dụng, hệ thống sẽ:
   * Đọc số tiền khách thanh toán qua loa thiết bị.
   * Tự động hoàn thành đơn hàng khi quét QR thành công.
