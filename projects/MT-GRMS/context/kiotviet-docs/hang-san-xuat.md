...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-hang-hoa/hang-san-xuat/
---
...
Việc sử dụng tính năng Hàng sản xuất trên KiotViet sẽ mang lại cho cửa hàng của bạn những lợi ích thiết thực, giúp quy trình quản lý trở nên chuyên nghiệp và chính xác hơn:

**Lợi ích nổi bật của tính năng Sản xuất hàng hóa trên KiotViet:**

* **Kiểm soát chính xác nguyên vật liệu:** Tính năng cho phép bạn định nghĩa chi tiết các thành phần cấu thành nên một sản phẩm, tự động tính toán và cảnh báo nếu không đủ nguyên liệu, giúp bạn chủ động trong việc chuẩn bị.
* **Tự động hóa quản lý tồn kho:** Khi hoàn thành sản xuất, KiotViet sẽ tự động trừ tồn kho nguyên vật liệu và cộng tồn kho thành phẩm, đảm bảo số liệu luôn chính xác và tiết kiệm thời gian quản lý.
* **Minh bạch hóa giá vốn và hạch toán lãi lỗ:** Giá vốn của thành phẩm được hệ thống tự động tính toán dựa trên tổng giá vốn của các nguyên vật liệu, giúp bạn hạch toán lãi lỗ và đưa ra các quyết định kinh doanh hiệu quả hơn.
...
* **Tình huống:** Để bắt đầu sử dụng, bạn cần kích hoạt tính năng Sản xuất hàng hóa cho cửa hàng của mình.
* **Thao tác thực hiện như sau**: Bạn vào menu **Thiết lập** →  **Hàng hóa** → bật tính năng **Sản xuất hàng hóa**.

### **2. Khai báo Hàng sản xuất (Thêm thành phần cho hàng hóa)**

* **Tình huống:** Bạn cần định nghĩa một sản phẩm mới được tạo ra từ nhiều nguyên vật liệu có sẵn, ví dụ như một chiếc bánh ngọt.
* **Thao tác thực hiện như sau:**

1. Tạo hàng hóa thành phẩm mới trong **Hàng hóa** → **Danh sách hàng hóa**.

2. Bạn nhấn ***Tạo mới*** → chọn ***Hàng sản xuất***

3. Đặt tên cho hàng sản xuất, ví dụ: "Bánh ngọt".
4. Tại mục ***Hàng thành phần***, tìm và thêm các sản phẩm bạn muốn đưa vào giỏ quà (ví dụ: Bột mì, bơ, đường kính, trứng gà,...).
5. Tại mục ***Hàng thành phần***, tìm kiếm và thêm các nguyên vật liệu (phải là hàng hóa đã có trong danh mục) cùng số lượng cần thiết để tạo ra một đơn vị thành phẩm.
6. Nhập ***Giá bán*** cho “Bánh ngọt”.
7. Nhấn ***Lưu*** để hoàn tất.

**Lưu ý**: Giá vốn của hàng sản xuất sẽ được hệ thống tự động tính.

### **3. Thực hiện Sản xuất hàng hóa (Tạo phiếu sản xuất)**

* **Tình huống:** Bạn vừa hoàn thành một mẻ bánh và cần ghi nhận số lượng thành phẩm mới vào kho, đồng thời trừ đi lượng nguyên liệu đã sử dụng.
* **Thao tác thực hiện như sau:**
...
3. Tại ô **Sản xuất mặt hàng**, chọn hàng hóa thành phẩm đã được khai báo thành phần nguyên liệu.
4. Nhập **Số lượng** thành phẩm muốn sản xuất.

5. Hệ thống sẽ tự động tính và cảnh báo nếu không đủ nguyên vật liệu.

6. Nhấn ***Hoàn thành*** để kết thúc. Hệ thống sẽ tự động cập nhật lại tồn kho.

### **4. Quản lý các phiếu sản xuất**

* **Tình huống:** Bạn cần xem lại lịch sử sản xuất, tìm kiếm một phiếu cụ thể hoặc hủy một phiếu đã tạo.
* **Thao tác thực hiện như sau:** 
  + Để xem danh sách, vào **Hàng hóa** → **Sản xuất**.
  + Sử dụng các bộ lọc để tìm kiếm hoặc sắp xếp danh sách.

* Bạn có thể thực hiện các thao tác như: ***In***, ***Chỉnh sửa*** (ghi chú, thời gian), ***Xuất file*** hoặc ***Hủy***.
