...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-giao-van/thiet-lap-xac-thuc-otp-kship/
---
...
# **Thiết lập Giao hàng Xác thực OTP**

(Ngành Bán buôn, Bán lẻ)

## **Các thao tác cơ bản:**

Trong **Thiết lập tính năng giao hàng**, nếu gian hàng có sự thay đổi về 1 trong 2 thông tin:

- **Số điện thoại liên hệ**

- **Tài khoản nhận tiền**

KiotViet sẽ gửi mã OTP xác nhận qua tin nhắn SMS đến **Số điện thoại liên hệ** hiện tại của gian hàng.

Bạn nhập mã OTP vào phần mềm -> chọn ***Xác nhận***

Hệ thống cập nhật thành công hiện thông báo như sau:
