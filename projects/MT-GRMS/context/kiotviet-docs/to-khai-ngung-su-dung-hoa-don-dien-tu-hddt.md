...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-thiet-lap-ban-dau-hddt/to-khai-ngung-su-dung-hoa-don-dien-tu-hddt/
---
...
Hỗ trợ
Thiết lập ban đầu HĐĐTTờ khai ngừng sử dụng hóa đơn điện tử (HĐĐT)
...
Tính năng cho phép bạn khai báo với Cơ quan Thuế (CQT) khoảng thời gian tạm ngừng sử dụng dịch vụ hóa đơn điện tử của một hoặc nhiều nhà cung cấp.

**Lợi ích nổi bật của tính năng:**

* Khai báo ngừng sử dụng hóa đơn điện tử (HĐĐT) trực tiếp và nhanh chóng, không cần vào form Tờ khai đăng ký/thay đổi thông tin.
* Theo dõi trạng thái Cơ quan Thuế (CQT) phản hồi (Chấp nhận / Không chấp nhận) tập trung tại 1 nơi.
* Hỗ trợ khai báo nhiều nhà cung cấp dịch vụ HĐĐT trong cùng 1 tờ khai.

**Lưu ý:**

* Tờ khai được áp dụng ở cấp công ty theo Mã số thuế (MST), không phân biệt chi nhánh.
* Tổ chức cung cấp dịch vụ HĐĐT là các đơn vị được CQT cấp phép cung cấp phần mềm/dịch vụ HĐĐT (ví dụ: KiotViet, VNPT, Viettel, MISA...).
* Số sê-ri chứng thư là mã định danh duy nhất của chứng thư số dùng để ký tờ khai/hóa đơn. Mỗi chứng thư có thời hạn hiệu lực riêng.
* Hình thức tờ khai "Thay đổi thông tin" là loại hành động khai báo với CQT về việc thay đổi thông tin sử dụng HĐĐT (ở đây là ngừng sử dụng).

## **II. Các thao tác cơ bản**

### **1. Tạo tờ khai ngừng sử dụng HĐĐT**

**Tình huống:** Khi cửa hàng hoặc doanh nghiệp của bạn quyết định tạm dừng kinh doanh hoặc đổi nhà cung cấp dịch vụ HĐĐT, bạn cần thực hiện thao tác này để khai báo với Cơ quan Thuế về khoảng thời gian tạm ngừng sử dụng dịch vụ.

**Thao tác thực hiện như sau:**

* **Bước 1:** Vào menu **Tờ khai**, chọn **Tờ khai ngừng SD HĐĐT**.

* **Bước 2:** Hệ thống hiển thị màn hình danh sách **Tờ khai ngừng sử dụng HĐĐT**, bạn nhấn **+ Tạo tờ khai**.

* **Bước 3:** Đọc hướng dẫn trên màn hình → nhấn ***Bắt đầu Lập tờ khai***.

* **Bước 4:** Hệ thống hiển thị popup **Tạo tờ khai ngừng sử dụng hóa đơn điện tử**. Bạn nhấn ***+ Thêm dòng*** và điền đầy đủ các thông tin bắt buộc sau:
  + ***Từ ngày***: Ngày đầu tiên sau khi quyết định tạm ngừng có hiệu lực.
  + ***Đến ngày***: Ngày dự kiến quay lại dùng HĐĐT.
  + ***Tên tổ chức cung cấp dịch vụ***: Điền tên đầy đủ của tổ chức cung cấp dịch vụ hóa đơn điện tử mà đơn vị đang sử dụng. Đây có thể là tổ chức cung cấp phần mềm hóa đơn điện tử hoặc tổ chức cung cấp dịch vụ truyền nhận hóa đơn điện tử được cơ quan thuế cấp phép.
  + ***MST tổ chức cung cấp dịch vụ***: Nhập mã số thuế của tổ chức cung cấp dịch vụ hóa đơn điện tử đơn vị đang sử dụng (10 hoặc 13 chữ số).
  + ***Chọn Số sê-ri chứng thư*** từ danh sách. Hệ thống sẽ hiển thị mã sê-ri kèm theo thời gian hiệu lực (ví dụ: 2C772721762FE969... — 15/05/2025 đến 15/05/2026).
  + ***Số sê-ri chứng thư***: Tự động được điền sau khi ***Chọn*** ***Số sê-ri chứng thư*** (bạn có thể chỉnh sửa thủ công nếu cần).
  + ***Ghi chú***: Bạn có thể điền thêm thông tin nội bộ (không bắt buộc).
* **Bước 5:** Kiểm tra lại toàn bộ thông tin và nhấn ***Nộp tờ khai cho CQT***.

**Lưu ý:**

* Nếu nhập "Từ ngày" lớn hơn "Đến ngày", hệ thống sẽ cảnh báo và không cho nộp. Bạn cần sửa lại khoảng thời gian hợp lý.
* Nếu MST tổ chức cung cấp sai định dạng, hệ thống sẽ báo lỗi định dạng. Bạn cần nhập đúng định dạng MST (10 hoặc 13 chữ số).
* Nếu bạn nhấn **Hủy bỏ** trong lúc đang tạo, bảng thông tin sẽ đóng lại và toàn bộ dữ liệu bạn vừa nhập sẽ bị mất.
* Tờ khai sau khi nộp sẽ được gửi cho CQT xử lý và bạn không thể chỉnh sửa lại nội dung (chỉ ở chế độ xem).

### **2. Theo dõi trạng thái tờ khai**

**Tình huống:** Sau khi nộp tờ khai lên Cơ quan Thuế, bạn cần kiểm tra lại kết quả phê duyệt để lấy mã CQT cấp làm bằng chứng pháp lý, hoặc xử lý kịp thời nếu tờ khai bị từ chối.

Hệ thống cung cấp danh sách quản lý tờ khai với các thông tin chi tiết:

* **Mã tờ khai:** Mã do hệ thống tự sinh (ví dụ: TK000452).
* **Ngày gửi:** Ngày bạn nộp tờ khai lên CQT.
* **Hình thức tờ khai:** Mặc định là hành động "Thay đổi thông tin".
* **Loại hóa đơn:** Loại hóa đơn bị ảnh hưởng.
* **Ngày chấp nhận:** Ngày CQT phản hồi.
* **Trạng thái:** Kết quả từ CQT (Chấp nhận hoặc Không chấp nhận).
* **Mã CQT cấp:** Mã do CQT cấp khi tờ khai được chấp nhận.
* **Tác vụ:** Hỗ trợ xem chi tiết tờ khai.

**Thao tác thực hiện như sau:**

* **Bước 1:** Sau khi nộp thành công, quay về trang danh sách **Tờ khai ngừng SD HĐĐT**. Tờ khai mới tạo sẽ hiển thị ở đầu danh sách kèm theo Mã tờ khai tự sinh.
* **Bước 2:** Theo dõi cột **Trạng thái**:
  + Nếu hiển thị **CQT Chấp nhận** (màu xanh lá): Tờ khai hợp lệ, hệ thống sẽ tự động ghi nhận **Mã CQT cấp** ở cột tương ứng.

* Nếu hiển thị **CQT không chấp nhận** (màu đỏ): Bạn nhấn vào biểu tượng chữ i (thông tin) để xem lý do bị từ chối.

* **Bước 3:** Nhấn ***Xem chi tiết*** ở cột ***Tác vụ*** để mở nội dung tờ khai đã nộp (chỉ xem, không thể chỉnh sửa).

**Lưu ý:** Trong trường hợp CQT không chấp nhận tờ khai (trạng thái đỏ + lý do từ CQT), bạn bắt buộc phải tạo một tờ khai mới với thông tin đã sửa chữa. Hệ thống KHÔNG hỗ trợ sửa trực tiếp trên tờ khai cũ đã nộp.

## **III. Các tính năng nâng cao**

### **Khai báo nhiều nhà cung cấp trong 1 tờ khai**

**Tình huống:** Trong trường hợp cửa hàng của bạn sử dụng dịch vụ HĐĐT của nhiều nhà cung cấp khác nhau và muốn tạm ngừng đồng loạt, bạn có thể gộp việc khai báo vào cùng một tờ khai duy nhất để tiết kiệm thao tác.

**Thao tác thực hiện như sau:**

* **Bước 1:** Trên popup **Tạo tờ khai ngừng sử dụng hóa đơn điện tử**, sau khi đã điền đầy đủ thông tin trên dòng đầu tiên, bạn tiếp tục nhấn ***+ Thêm dòng***.
* **Bước 2:** Điền đầy đủ thông tin trên dòng thứ 2. Mỗi dòng sẽ tương ứng với một nhà cung cấp dịch vụ, một khoảng thời gian và một chứng thư riêng.
* **Bước 3:** Nếu bạn muốn xóa một dòng bất kỳ, chỉ cần nhấn vào biểu tượng thùng rác ở cột ***Thao tác*** của dòng đó (chỉ áp dụng xóa trước khi nộp).
* **Bước 4:** Kiểm tra kỹ tất cả các dòng và nhấn ***Nộp tờ khai cho CQT***.
