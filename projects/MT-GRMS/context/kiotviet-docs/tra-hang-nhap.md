...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-giao-dich/tra-hang-nhap/
---
...
Tính năng Trả hàng nhập là một công cụ thiết yếu giúp bạn giải quyết các vấn đề phát sinh sau khi nhập hàng.

**Lợi ích nổi bật của tính năng:**

* **Quản lý tồn kho và giá vốn chính xác:** Khi bạn thực hiện trả hàng nhập, hệ thống sẽ tự động giảm trừ số lượng tồn kho và tính toán lại giá vốn (nếu cần), giúp việc hạch toán lãi lỗ luôn chính xác.
* **Kiểm soát chặt chẽ công nợ với nhà cung cấp:** Mỗi giao dịch trả hàng nhập đều cập nhật lại công nợ phải trả cho nhà cung cấp một cách tự động, giúp bạn quản lý dòng tiền và các khoản thanh toán một cách minh bạch, tránh sai sót.
* **Linh hoạt và chuyên nghiệp trong quy trình:** Hỗ trợ hai hình thức trả hàng linh hoạt là "Trả hàng nhập nhanh" và "Trả theo phiếu nhập hàng". Mỗi giao dịch đều được ghi nhận bằng một phiếu trả hàng riêng biệt, dễ dàng tìm kiếm và quản lý.
...
**Tình huống:** Bạn cần trả hàng cho nhà cung cấp nhưng không cần tham chiếu đến một phiếu nhập hàng cụ thể.

**Thao tác thực hiện như sau:**

* **Bước 1**: Tại màn hình **Quản lý**, vào menu **Mua hàng**, chọn **Trả hàng nhập**.
* **Bước 2**: Nhấn ***+ Trả hàng nhập***.

* **Bước 3**: Thêm hàng hóa vào phiếu trả bằng cách tìm kiếm hoặc quét mã vạch.

* **Bước 4**: Chọn Nhà cung cấp và nhập các thông tin thanh toán (***Tiền nhà cung cấp trả***). Phần tiền chênh lệch sẽ được tự động ghi nhận vào công nợ.
* **Bước 5**: Nhấn ***Hoàn thành*** để kết thúc. Hệ thống sẽ trừ tồn kho và cập nhật công nợ.

### **2. Trả hàng nhập theo phiếu nhập hàng**

**Tình huống:** Bạn muốn trả lại hàng hóa dựa trên một lần nhập hàng cụ thể để đảm bảo tính chính xác.

**Thao tác thực hiện như sau:**

* **Bước 1**: Tại màn hình **Quản lý**, vào menu **Mua hàng**, chọn **Nhập hàng**.
* **Bước 2**: Tìm và mở phiếu nhập hàng gốc bạn cần trả lại.
* **Bước 3**: Trong chi tiết phiếu nhập, nhấn ***Trả hàng nhập***.

* **Bước 4**: Hệ thống sẽ chuyển sang màn hình **Trả hàng nhập** với thông tin được điền sẵn. Bạn chỉ cần nhập số lượng thực tế cần trả.
* **Bước 5**: Hoàn tất các bước thanh toán và nhấn ***Hoàn thành***.

## **III. Các tính năng nâng cao**

**Tình huống:** Bạn cần xem lại, sửa thông tin, hủy hoặc tạo nhanh một phiếu trả hàng mới dựa trên phiếu cũ.

**Thao tác thực hiện như sau:**

* **Xem danh sách:**
  + Vào **Mua hàng** → **Trả hàng nhập** để xem và sử dụng bộ lọc để tìm kiếm theo mã phiếu, nhà cung cấp, trạng thái…
  + Nhấn vào tiêu đề của các cột (Mã nhập hàng, Thời gian, Tổng cộng...) để sắp xếp danh sách theo thứ tự tăng/giảm dần.

* **Cập nhật:** Với các phiếu đã hoàn thành, bạn có thể thay đổi các thông tin như: ***Người trả***, ***Ngày trả***, ***Ghi chú***.

* **Hủy:** Mở một phiếu đã hoàn thành và nhấn ***Hủy*** **→** nhấn ***Đồng ý***. Thao tác này sẽ cộng lại tồn kho và cập nhật lại công nợ.

* **Sao chép:** Mở một phiếu đã có và nhấn **Sao chép** để tạo một phiếu mới với thông tin tương tự.

* **In**: Trong danh sách phiếu **Trả hàng nhập**, tìm và chọn phiếu → nhấn ***In***

* **Xuất file**:
  + Xuất file chi tiết phiếu trả hàng nhập: Trong danh sách phiếu **Trả hàng nhập**, tìm và chọn phiếu → nhấn ***Xuất file***.
  + Xuất file hàng loạt:
    - Nhấn nút **Xuất file** để tải về danh sách phiếu nhập đã tích chọn (dạng ***File tổng quan*** hoặc ***File chi tiết***) ra file Excel để lưu trữ hoặc xử lý thêm.
    - **Lưu ý**: Nếu không tích chọn → hệ thống mặc định xuất file tất cả các phiếu nhập hàng đã lọc trên màn hình.

## **IV. Thao tác trên Điện thoại**

Tính năng **Trả hàng nhập** trên ứng dụng KiotViet hỗ trợ cửa hàng thực hiện các thao tác: Xem danh sách, trả hàng theo phiếu nhập và hủy phiếu.

### **1. Trả hàng nhập từ phiếu nhập hàng**

**Tình huống:** Bạn cần thực hiện trả hàng cho nhà cung cấp ngay trên điện thoại dựa vào một phiếu nhập đã có.

**Thao tác thực hiện như sau:**

* **Bước 1**: Mở ứng dụng KiotViet, vào menu **Nhiều hơn**, chạm **Nhập hàng**.
* **Bước 2**: Tìm và mở chi tiết một phiếu nhập hàng ở trạng thái ***Đã nhập hàng***.

* **Bước 3**: Chạm vào ***Trả hàng nhập***.
* **Bước 4**: Nhập số lượng hàng cần trả cho từng sản phẩm.
* **Bước 5**: Chạm ***Thanh toán***, điền các thông tin về việc trả tiền cho nhà cung cấp.
* **Bước 6**: Chạm ***Hoàn thành*** để xác nhận phiếu trả hàng.

### **2. Quản lý phiếu trả hàng nhập**

**Tình huống:** Bạn cần xem lại danh sách hoặc hủy một phiếu trả hàng nhập đã tạo.

**Thao tác thực hiện như sau:**

* **Xem danh sách:** Vào menu **Nhiều hơn** → **Trả hàng nhập** để xem tất cả các phiếu đã tạo.

* **Tìm kiếm:** Chạm vào biểu tượng kính lúp, nhập từ khóa (mã phiếu, hàng hóa, nhà cung cấp, ghi chú) và chọn tiêu chí tìm kiếm.

* **Lọc:** Chạm vào biểu tượng bộ lọc để chọn các điều kiện như Thời gian, Trạng thái, Người tạo…

* **Sắp xếp:** Chạm vào biểu tượng sắp xếp để thay đổi thứ tự hiển thị theo **Mới nhất** hoặc **Cũ nhất**.

* **Hủy phiếu:**
  + **Cách 1 (Từ danh sách):** Tại màn hình danh sách, vuốt phiếu nhập cần hủy sang trái và chọn **Hủy** → xác nhận ***Đồng ý*** để hoàn tất việc hủy.

* **Cách 2 (Từ chi tiết):** Mở chi tiết phiếu trả hàng nhập, chạm vào biểu tượng 3 chấm ở góc trên và chọn ***Hủy phiếu*** → xác nhận ***Đồng ý*** để hoàn tất việc hủy.
