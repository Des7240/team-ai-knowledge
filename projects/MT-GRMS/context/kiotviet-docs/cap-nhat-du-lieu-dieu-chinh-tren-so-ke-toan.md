...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-ke-toan-hkd-so-ke-toan/cap-nhat-du-lieu-dieu-chinh-tren-so-ke-toan/
---
...
Hỗ trợ
Kế toán HKD - Sổ kế toánCập nhật dữ liệu điều chỉnh trên Sổ kế toán
...
Tính năng quản lý và đồng bộ Sổ kế toán, Tờ khai thuế giúp cửa hàng và kế toán viên kiểm soát chặt chẽ dữ liệu tài chính. Hệ thống tự động lấy toàn bộ giao dịch bán hàng (bao gồm cả giao dịch có và không có Hóa đơn điện tử) lên Sổ và Tờ khai nhằm đảm bảo số liệu tại Sổ kế toán và Tờ khai luôn đồng nhất tuyệt đối.

**Lợi ích nổi bật của tính năng:**

* **Đảm bảo tính đồng nhất dữ liệu:** Ngăn chặn hoàn toàn tình trạng sai lệch số liệu giữa Sổ kế toán và Tờ khai thuế do việc sửa tay độc lập ở các nền tảng.
* **Kiểm soát số liệu minh bạch:** Hệ thống áp dụng cơ chế loại bỏ/khôi phục giao dịch. Các giao dịch không hợp lệ được lưu trữ riêng để điều chỉnh số liệu, đảm bảo luôn lưu vết thao tác.
* **Tối ưu thời gian đối soát:** Hỗ trợ tính năng điều hướng thông minh từ Tờ khai sang Sổ kế toán. Hệ thống tự động áp dụng bộ lọc ngành nghề và kỳ thời gian tương ứng, giúp bạn tra cứu chi tiết nhanh chóng.

## **II. Các thao tác cơ bản**

Để dễ hình dung, các ví dụ dưới đây sẽ minh họa những tình huống thực tế trong ngành Bán buôn, Bán lẻ.

### **1. Xem Chi tiết Sổ Doanh thu từ Tờ khai**

**Tình huống:** Bạn đang xem báo cáo Tờ khai thuế cuối kỳ và muốn kiểm tra chéo từng giao dịch chi tiết cấu thành nên con số doanh thu tổng trên tờ khai.

**Thao tác thực hiện như sau:**

* **Bước 1:** Truy cập vào menu **Thuế & Kế toán** → **Thuế & Kế toán**.

* **Bước 2:** Chọn **Tờ khai thuế** → nhấn ***Xem chi tiết*** tại tờ khai theo kỳ kê khai tương ứng (theo Quý hoặc Tháng).

* **Bước 3:** Chọn tab **Mẫu 01/CNKD** → tại mục ***A. Kê khai thuế giá trị gia tăng (GTGT), thuế thu nhập cá nhân (TNCN)***, nhấn vào biểu tượng điều hướng  của một nhóm ngành nghề.

* **Bước 4:** Hệ thống sẽ tự động chuyển sang màn hình **Sổ doanh thu** chi tiết.

**Lưu ý**: Tại đây, hệ thống đã tự động áp dụng bộ lọc hiển thị đúng nhóm ngành nghề và kỳ thời gian tương ứng từ tờ khai, bạn không cần điều chỉnh.

* **Bước 5:** Tiến hành kiểm tra danh sách các giao dịch, số liệu thuế TNCN và thuế GTGT được hiển thị trên từng dòng giao dịch.

### **2. Loại bỏ giao dịch khỏi Sổ kế toán**

**Tình huống:** Trong quá trình rà soát, bạn phát hiện có một vài giao dịch không hợp lệ hoặc bị nhầm lẫn. Bạn cần loại bỏ các giao dịch này khỏi số liệu **Sổ kế toán** và **Tờ khai thuế** nhưng vẫn muốn giữ lại trên hệ thống để phục vụ đối soát sau này.

**Thao tác thực hiện như sau:**

* **Bước 1:** Tại màn hình **Sổ doanh thu** chi tiết, tích chọn các giao dịch cần loại bỏ*.*
* **Bước 2:** Nhấn ***Loại bỏ giao dịch*** góc trên bên phải màn hình*.*

* **Bước 3:** Đọc kỹ nội dung trên popup xác nhận → nhấn ***Loại bỏ giao dịch*** (hoặc nhấn ***Hủy bỏ*** để thoát thao tác).

* **Bước 4:** Màn hình **Sổ doanh thu** hiển thị danh sách các giao dịch hợp lệ còn lại. Số liệu tổng trên Sổ và **Tờ khai thuế** tự động cập nhật đồng bộ với nhau.

**Lưu ý**:

* Các giao dịch trả hàng liên quan đến các giao dịch này cũng sẽ được loại bỏ để dữ liệu sổ hợp lệ.
* Bạn có thể xem và khôi phục các giao dịch đã loại bỏ tại **Danh sách giao dịch đã loại bỏ** bất kỳ lúc nào.

### **3. Xem và khôi phục giao dịch đã loại bỏ**

**Tình huống:** Bạn phát hiện trước đó mình đã thao tác loại bỏ nhầm một số giao dịch bán hàng hợp lệ. Bạn cần xem lại danh sách này và khôi phục chúng về lại Sổ kế toán để ghi nhận đúng doanh thu.

**Thao tác thực hiện như sau:**

* **Bước 1:** Tại màn hình **Sổ doanh thu** chi tiết, nhấn vào biểu tượng 3 chấm góc bên phải.

* **Bước 2:** Hệ thống hiển thị popup **Danh sách giao dịch đã loại bỏ**, bao gồm danh sách giao dịch và chi tiết các cột thông tin: Mã giao dịch, Ngày tháng, Chứng từ, Doanh thu, Thuế GTGT, Thuế TNCN, Người loại, Ngày loại bỏ và Lý do.
* **Bước 3:** Bạn thực hiện tìm kiếm giao dịch theo mã giao dịch, chứng từ → tích chọn các giao dịch cần khôi phục → nhấn ***Khôi phục giao dịch***.

* **Bước 4:** Nhấn ***Khôi phục giao dịch*** để hoàn tất. Các giao dịch này được tính lại trong **Sổ doanh thu**, **Sổ doanh thu - chi phí** và **Sổ tiền**, đồng thời **Tờ khai thuế** cũng tự động cập nhật theo dữ liệu mới.

* **Lưu ý về các tình huống đặc biệt:**
  + **Không thể loại bỏ giao dịch:**
    - Nếu bạn thực hiện loại bỏ các giao dịch thuộc kỳ đã khóa sổ hoặc đã phát hành Hóa đơn điện tử, hệ thống sẽ chặn thao tác và hiển thị popup **Không thể loại bỏ giao dịch** kèm lý do cụ thể.
    - **Cách xử lý**: Bạn cần bỏ khóa sổ hoặc tiến hành chọn lại giao dịch khác.

* **Khôi phục giao dịch có chứa giao dịch không hợp lệ:** Nếu trong danh sách các giao dịch bạn chọn để khôi phục có các giao dịch không hợp lệ (giao dịch thuộc kỳ đã khóa sổ, trả hàng có bán hàng liên quan bị loại bỏ,...) popup xác nhận sẽ hiển thị thông tin chi tiết liệt kê từng lý do giao dịch không thể khôi phục. Tuy nhiên, hệ thống vẫn cho phép bạn tiến hành khôi phục đối với các giao dịch hợp lệ còn lại.

* **Khôi phục/Loại bỏ làm ảnh hưởng đến Tờ khai đã nộp:** Trong trường hợp giao dịch được khôi phục/loại bỏ làm thay đổi số liệu của một Tờ khai thuế có trạng thái ***Đã nộp*** → hệ thống sẽ tự động cập nhật tờ khai theo dữ liệu mới và chuyển trạng thái thành ***Chưa nộp***. Bạn cần lập tờ khai bổ sung gửi Cơ quan thuế để khai báo sự thay đổi.

## **III. Thao tác trên Điện thoại**

Các thao tác điều chỉnh dữ liệu kế toán trên ứng dụng **KiotViet Hotel** được thực hiện tương tự như trên giao dịch web, giúp bạn quản lý linh hoạt mọi lúc mọi nơi.

### **1. Xem Chi tiết Sổ Doanh thu từ Tờ khai**

**Tình huống:** Bạn đang sử dụng điện thoại để kiểm tra nhanh số liệu thuế và cần xem chi tiết các giao dịch trong một nhóm ngành nghề cụ thể.

**Thao tác thực hiện như sau:**

* **Bước 1**: Truy cập vào ứng dụng KiotViet Hotel trên điện thoại → chạm **Nhiều hơn** →  chọn **Thuế & Kế toán**.
* **Bước 2**: Chọn MST (nếu có nhiều MST) → chọn **Tờ khai thuế**.
* **Bước 3**: Chọn kỳ kê khai
* **Bước 4**: Tại mục ***A. Kê khai thuế giá trị gia tăng (GTGT), thuế thu nhập cá nhân (TNCN)***, chạm vào giá trị Doanh thu.

* **Bước 5**: Ứng dụng chuyển đến màn hình **Sổ doanh thu** chi tiết với bộ lọc thời gian và ngành nghề đã được thiết lập sẵn để bạn đối soát.

### **2. Loại bỏ giao dịch khỏi Sổ kế toán**

**Tình huống:** Bạn cần loại bỏ nhanh một giao dịch sai sót ngay trên điện thoại để số liệu trên Tờ khai thuế được cập nhật kịp thời.

**Thao tác thực hiện như sau:**

* **Bước 1**: Tại màn hình **Sổ doanh thu** chi tiết trên ứng dụng, bạn chạm ***Chọn nhiều*** → tích chọn vào các giao dịch muốn loại bỏ.
* **Bước 2**: Chạm ***Loại bỏ giao dịch***.
* **Bước 3**: Xác nhận ***Loại bỏ giao dịch*** để hoàn tất thao tác.

### **3. Xem và khôi phục giao dịch đã loại bỏ**

**Tình huống:** Khi cần đưa các giao dịch đã loại bỏ trước đó quay trở lại Sổ kế toán bằng thiết bị di động.

**Thao tác thực hiện như sau:**

* **Bước 1**: Tại màn hình **Sổ doanh thu chi tiết**, bạn chạm vào biểu tượng tùy chọn (3 chấm) ở góc phải màn hình.
* **Bước 2**: Chạm ***Danh sách giao dịch đã loại bỏ***.
* **Bước 3**: Tích chọn các giao dịch cần lấy lại → chạm ***Khôi phục giao dịch***.
* **Bước 4**: Xác nhận ***Khôi phục*** để hệ thống đưa giao dịch trở lại các sổ kế toán và cập nhật lại Tờ khai thuế.
