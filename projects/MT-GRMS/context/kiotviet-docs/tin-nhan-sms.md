...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-cskh/tin-nhan-sms/
---
...
KiotViet kết hợp với Vietguys để cung cấp tính năng gửi SMS trên hệ thống của KiotViet. Tính năng gửi SMS cho khách hàng là một công cụ hữu ích giúp chủ cửa hàng triển khai chương trình chăm sóc khách hàng hay quảng cáo bán hàng.

**Thông báo về việc cập nhật giao diện**

Hiện tại, KiotViet đang triển khai nâng cấp giao diện mới 2026 cho màn hình quản lý. Bạn vui lòng lưu ý một số thông tin sau:

* **Về thay đổi giao diện:** Một số gian hàng sẽ được cập nhật hiển thị theo giao diện mới 2026 với cấu trúc menu và vị trí các tính năng được sắp xếp lại để tối ưu trải nghiệm.
* **Về tài liệu hướng dẫn:** Nội dung trong bài viết này đang hướng dẫn luồng thao tác thực hiện trên **giao diện tiêu chuẩn 2025**.
* **Lộ trình cập nhật:** Ngay sau khi giao diện mới 2026 được áp dụng đồng bộ cho tất cả các gian hàng, KiotViet sẽ cập nhật lại hệ thống tài liệu hướng dẫn này trong thời gian sớm nhất.

Về mặt nghiệp vụ, quy trình vận hành trên giao diện mới **về cơ bản tương tự** giao diện tiêu chuẩn 2025, đồng thời có thêm một số tinh chỉnh nâng cấp để thao tác thuận tiện hơn. Bạn hoàn toàn có thể yên tâm thực hiện theo các bước hướng dẫn để hoàn thành công việc.

## **I. Thiết lập**

- Tại màn hình **Quản lý**, từ menu **Thiết lập** (1), bạn chọn **Thiết lập cửa hàng** (2).

- Trên khối ***Thiết lập quản lý*** bạn chọn ***Đối tác*** (3), kích chọn biểu tượng  để bật tính năng ***G******ửi SMS – Email – Tin nhắn Zalo*** (4) -> kích ***Chi tiết*** (5) để cài đặt cấu hình ***Gửi SMS***

- Cấu hình gửi SMS cụ thể như sau:

* Trong ***Chi tiết***, chọn tab SMS – Vietguys tích chọn ***“Tôi đồng ý với điều khoản và dịch vụ”*** sau đó kích ***Kết nối với Vietguys*** để vào giao diện gửi SMS của Vietguys.
...
*- Lưu ý:* Bảng giá dịch vụ của các loại tin sử dụng được cung cấp chi tiết bên cạnh form đăng ký. Các bạn tìm hiểu kỹ trước khi chọn loại tin đăng ký.

- Sau khi hoàn tất đăng ký Vietguys, để gửi được tin nhắn, bạn cần thực hiện nạp tiền vào tài khoản.

* Trong màn hình quản lý chọn menu ***$ Nạp tiền***

* Màn hình nạp tiền được chuyển sang trang website của Vietguys.

* Tại màn hình **Nạp tiền**, bạn chọn mức tiền nạp và hoàn thiện thông tin và nhấn ***Thanh toán*** để nạp tiền.

* Sau khi nạp tiền thành công bạn quay trở lại màn hình Thiết lập SMS – Email để kiểm tra thông tin tài khoản bằng cách chọn menu **Thông tin tài khoản**

## **II. Gửi SMS**

- Trên menu **Đối tác**, chọn **Khách hàng**

- Trong màn hình **Khách hàng** chọn khách hàng cần gửi tin theo 2 cách**:**

* **Cách 1****:** Tích chọn người nhận SMS từ màn hình **Khách hàng,** kích ***Gửi tin***, chọn ***SMS*** hoặc
* **Cách 2:** Kích ***Gửi tin***, chọn ***SMS*,** nhập khách hàng

- Màn hình **Gửi SMS** hiện ra như sau:

- Tiếp tục nhập thông tin:

* **Thương hiệu gửi tin**: Chọn thương hiệu bạn đăng ký với Vietguys hoặc đầu số ngẫu nhiên 555 để gửi tin.
* **Người nhận**: Ngầm định danh sách khách hàng đã chọn và có thể chọn thêm.
* **Tiêu đề**: Nhập nếu muốn lưu mẫu SMS
* **Nội dung**: Bắt buộc nhập. (Số ký tự và số tin nhắn của nội dung sẽ được hiển thị ở góc dưới màn hình của phần soạn thảo nội dung).
* *Lưu ý*: Hệ thống báo lỗi nếu trong danh sách không có khách hàng nào có số điện thoại
* Sau khi soạn thảo nội dung SMS xong, có các tùy chọn:
  + **Gửi:** KiotViet chuyển thông tin tới Vietguys để thực hiện tác vụ gửi tin SMS.
  + **Lưu:** Sao lưu nội dung để sau này dùng nhiều lần.
  + **Hủy:** Hủy bỏ việc gửi SMS này.
* Hoàn tất thông tin SMS, kích ***Gửi*** và xác nhận để thực hiện gửi tin.
* Sau khi kích Gửi xác nhận gửi SMS thành công hệ thống sẽ thông báo gửi thành công.

- Để xem lại các chiến dịch gửi SMS, các nội dung sms được lưu, từ menu **Thiết lập**, chọn **Quản lý mẫu tin**

- Màn hình **Quản lý mẫu tin**, tab **Quản lý mẫu tin** chọn bộ lọc ***Loại tin***là***SMS***để xem các mẫu tin được lưu

- Chọn tab **Lịch sử gửi tin** để xem lại các chiến dịch gửi tin. KiotViet cung cấp các bộ lọc: *tìm kiếm, loại tin, người gửi hay thời gian gửi* để xem lại các lần gửi SMS.

- Ngoài ra, bạn có thể thực hiện việc gửi tin nhắn trên màn hình gửi tin của Vietguys bằng cách Chọn menu **Thiết lập,** kích chọn ***Thiết lập cửa hàng*** *à* ***Thiết lập tính năng** ->****Sử dụng tính năng gửi SMS – Email***, chọn tab ***SMS – Vietguys*.**

- Để thực hiện gửi tin trên hệ thống của Vietguys, bạn xem hướng dẫn chi tiết bằng cách chọn menu ***Hướng dẫn.***
