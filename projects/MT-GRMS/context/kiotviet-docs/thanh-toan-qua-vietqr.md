...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-thanh-toan/thanh-toan-qua-vietqr/
---
...
KiotViet hỗ trợ tính năng thanh toán bằng mã QR, giúp quy trình thanh toán tại cửa hàng của bạn diễn ra liền mạch, chính xác và không dùng tiền mặt.

Tính năng này được chia thành 2 phần chính:

### **1. Tính năng tạo mã thanh toán QR động**

Tính năng tạo mã thanh toán QR động trên KiotViet hỗ trợ tất cả các ngân hàng thuộc hệ thống Napas. Hệ thống sẽ tự động tạo mã QR với đúng số tiền và thông tin tài khoản cho mỗi giao dịch. Điều này giúp nhân viên thu ngân và khách hàng tiết kiệm thời gian tại quầy, đồng thời loại bỏ hoàn toàn sai sót do nhập liệu thủ công.

Thông báo thanh toán thành công có thể phát qua đa dạng các thiết bị bao gồm: máy tính, điện thoại, máy POS hoặc Màn hình hiển thị QR chuyên dụng của KiotViet.

### **2. Giải pháp thông báo thanh toán QR (QR ting ting)**

Đây là giải pháp liên kết của KiotViet với một số đơn vị ngân hàng / ví điện tử đối tác. Với giải pháp này, hệ thống tự động xác nhận giao dịch thành công ngay trên màn hình bán hàng mà không cần kiểm tra ứng dụng ngân hàng, ví điện tử giúp quy trình thanh toán diễn ra liền mạch và không bị gián đoạn.

Thông báo thanh toán thành công có thể phát qua đa dạng các thiết bị bao gồm: máy tính, điện thoại, máy POS hoặc Màn hình hiển thị QR chuyên dụng của KiotViet.

Quy trình kết nối dịch vụ được thực hiện theo từng loại tài khoản như sau:

**Dành cho Tài khoản của Cá nhân:**

* **VietinBank:** Đăng ký tại giao diện phần mềm KiotViet, chọn tài khoản cá nhân.
* **MB Bank:** Đăng ký tại giao diện phần mềm KiotViet, chọn loại tài khoản cá nhân.
* **Vietcombank:** Đăng ký tại giao diện phần mềm KiotViet, chọn loại tài khoản cá nhân.
* **VIB:** Đã hỗ trợ tất cả các loại tài khoản, không cần chọn loại.
* **BIDV:** Đăng ký tại giao diện phần mềm KiotViet, chọn tài khoản cá nhân.
* **VPBank:** Đăng ký tại giao diện phần mềm KiotViet, chọn loại tài khoản Cá nhân.
* **Techcombank:** Đăng ký tại giao diện phần mềm KiotViet, chọn loại tài khoản Cá nhân.
* **Sacombank:** Đăng ký tại giao diện phần mềm KiotViet, chọn tài khoản cá nhân.
* **MoMo:** Đăng ký tại giao diện phần mềm KiotViet, kết nối tài khoản M4B của MoMo (áp dụng được cho cả cá nhân, hộ kinh doanh, doanh nghiệp).
* **Zalopay:** Cho phép khách hàng cá nhân, hộ kinh doanh, doanh nghiệp sử dụng tài khoản Zalopay để liên kết tài khoản với KiotViet.
* **Napas:** Đăng ký qua Hotline KiotViet 19006522 (cho phép thanh toán QR xuyên quốc gia VietQRGlobal với ứng dụng ngân hàng từ Thái, Lào, Cam, Trung (Alipay, UPI, Wechat) và Hàn (Ứng dụng của GLN, Toss, Hana Money, Hana 1Q, Hana Pay, Naver Pay).

**Dành cho Tài khoản của Hộ kinh doanh:**

* **VietinBank:** Đăng ký tại giao diện phần mềm KiotViet, chọn tài khoản cá nhân (Nhập số ĐKKD tại trường CCCD).
* **MB Bank:** Đăng ký tại giao diện phần mềm KiotViet, chọn loại tài khoản cá nhân.
* **Vietcombank:** Đăng ký tại giao diện phần mềm KiotViet, chọn loại tài khoản Doanh nghiệp.
* **VIB:** Đã hỗ trợ tất cả các loại tài khoản, không cần chọn loại.
* **BIDV:** Đăng ký tại giao diện phần mềm KiotViet, chọn tài khoản cá nhân (Nhập số ĐKKD tại trường CCCD).
* **VPBank:** Đăng ký tại giao diện phần mềm KiotViet, chọn loại tài khoản Cá nhân.
* **Techcombank:** Đăng ký tại giao diện phần mềm KiotViet, chọn loại tài khoản Cá nhân.
* **Sacombank:** Đăng ký tại giao diện phần mềm KiotViet, chọn tài khoản cá nhân (Nhập số ĐKKD tại trường CCCD).
* **MoMo:** Đăng ký tại giao diện phần mềm KiotViet, kết nối tài khoản M4B của MoMo (áp dụng được cho cả cá nhân, hộ kinh doanh, doanh nghiệp).
* **Zalopay:** Cho phép khách hàng cá nhân, hộ kinh doanh, doanh nghiệp sử dụng tài khoản Zalopay để liên kết tài khoản với KiotViet.
* **Napas:** Đăng ký qua Hotline KiotViet 19006522 (cho phép thanh toán QR xuyên quốc gia VietQRGlobal với ứng dụng ngân hàng từ Thái, Lào, Cam, Trung (Alipay, UPI, Wechat) và Hàn (Ứng dụng của GLN, Toss, Hana Money, Hana 1Q, Hana Pay, Naver Pay).

**Dành cho Tài khoản của Doanh nghiệp:**

* **Vietcombank:** Đăng ký tại giao diện phần mềm KiotViet, chọn loại tài khoản Doanh nghiệp.
* **VIB:** Đã hỗ trợ tất cả các loại tài khoản, không cần chọn loại.
* **MB Bank:** Đăng ký loại tài khoản Doanh nghiệp và chờ KiotViet xử lý.
* **VietinBank:** Đăng ký qua Hotline KiotViet 19006522.
* **BIDV:** Đăng ký qua Hotline KiotViet 19006522.
* **MoMo:** Đăng ký tại giao diện phần mềm KiotViet, kết nối tài khoản M4B của MoMo (áp dụng được cho cả cá nhân, hộ kinh doanh, doanh nghiệp).
* **Zalopay:** Cho phép khách hàng cá nhân, hộ kinh doanh, doanh nghiệp sử dụng tài khoản Zalopay để liên kết tài khoản với KiotViet.
* **Napas:** Đăng ký qua Hotline KiotViet 19006522 (cho phép thanh toán QR xuyên quốc gia VietQRGlobal với ứng dụng ngân hàng từ Thái, Lào, Cam, Trung (Alipay, UPI, Wechat) và Hàn (Ứng dụng của GLN, Toss, Hana Money, Hana 1Q, Hana Pay, Naver Pay).
* **VPBank, Techcombank, Sacombank:** Chưa tích hợp.

## **II. Các thao tác cơ bản**

Để dễ hình dung, các ví dụ dưới đây sẽ minh họa những tình huống bán hàng thực tế. Các thao tác này áp dụng cho việc tạo mã QR cơ bản, giúp hiển thị đúng số tiền cần thanh toán.

### **1. Thêm tài khoản ngân hàng**

**Tình huống**: Khi bạn muốn bắt đầu sử dụng thanh toán QR, việc đầu tiên là cần khai báo thông tin tài khoản ngân hàng của cửa hàng bạn vào hệ thống KiotViet.

**Thao tác thực hiện như sau**:

* **Bước 1:** Tại màn hình **Bán hàng** (khi chọn phương thức thanh toán là **Chuyển khoản/Thẻ/Ví**) **→** chọn ***Thêm tài khoản***hoặc màn hình **Sổ quỹ** (khi chọn phương thức **Ngân hàng/ Ví điện tử**) -> bạn nhấn vào ***Thêm***.
* **Bước 2:**Chọn ngân hàng tương ứng, điền đầy đủ thông tin tài khoản và nhấn **Lưu**.
  + Minh họa thao tác trên màn hình **Bán hàng**

* Minh họa thao tác trên màn hình **Sổ quỹ**

### **2. Tạo mã QR khi thanh toán**

**Tình huống**: Khi khách hàng của bạn muốn thanh toán hóa đơn bằng cách chuyển khoản qua mã QR.

**Thao tác thực hiện như sau**:

* **Bước 1:**Tại màn hình **Bán hàng**, sau khi lên đơn, chọn phương thức thanh toán là **Chuyển khoản** và chọn tài khoản ngân hàng bạn đã thêm.
* **Bước 2:**Một mã QR động sẽ được tạo ra. Bạn có thể cho khách hàng quét trực tiếp trên màn hình, hoặc nhấn **Hiện mã QR** để phóng to, **In mã QR** hoặc hiển thị qua các thiết bị kết nối như màn hình phụ, KiotViet QR.
* **Lưu ý**: Với dịch vụ **Thông báo thanh toán QR** khi chuyển khoản qua ngân hàng hoặc ví điện tử liên kết trên KiotViet, khách hàng vui lòng **không** thay đổi nội dung mặc định để đảm bảo giao dịch được ghi nhận chính xác.

## **III. Các tính năng nâng cao**

### **Xác nhận thông báo thanh toán thành công**

**Tình huống**: Khi bạn muốn hệ thống tự động xác nhận giao dịch thành công ngay trên màn hình bán hàng mà không cần kiểm tra ứng dụng ngân hàng, giúp quy trình thanh toán diễn ra liền mạch và không bị gián đoạn.

**Thao tác thực hiện như sau (Đăng ký dịch vụ)**:

* **Bước 1:**Tại màn hình **Quản lý** **→** **Tổng quan** **→** vào menu **Thanh toán**.
* **Bước 2:**Chọn thẻ của ngân hàng/ ví điện tử bạn muốn kết nối và nhấn **Đăng ký**.

* **Bước 3:**Chọn tài khoản, điền thông tin và thực hiện các bước xác thực theo yêu cầu của ngân hàng (nhập mã OTP hoặc xác thực trực tiếp trên ứng dụng ngân hàng).
* **Lưu ý**: Tính năng nâng cao này áp dụng cho các ngân hàng và ví điện tử có hợp tác với KiotViet: VIB, BIDV, Vietinbank, Vietcombank, MB Bank, VPbank, Techcombank, Sacombank, Momo, Zalopay,.... Để xem hướng dẫn sử dụng chi tiết, bạn vui lòng tham khảo các bài viết hướng dẫn sử dụng khác trong mục **Thanh toán**.

**IV. Thao tác trên Điện thoại**

Tính năng Thanh toán qua QR trên Điện thoại hỗ trợ cả thao tác tạo mã cơ bản và thiết lập tính năng nâng cao trên ứng dụng KiotViet.

* **Tạo mã QR cơ bản**: Khi thanh toán, bạn chỉ cần chọn phương thức **Chuyển khoản/ Ví** và chọn tài khoản, ứng dụng sẽ hiển thị mã QR với đúng số tiền để khách hàng quét.

* **Đăng ký dịch vụ nâng cao**:
  + **Bước 1:**Đăng nhập ứng dụng bằng tài khoản admin. Từ menu **Nhiều hơn** hoặc **Tổng quan**, chọn mục **Thanh toán**.
  + **Bước 2:**Chạm vào **Đăng ký ngay**. Chọn thẻ ngân hàng/ví điện tử bạn muốn liên kết.
  + **Bước 3:**Chọn hoặc thêm mới số tài khoản, điền thông tin và làm theo các bước xác thực.

## **V. Thao tác trên Máy POS**

Tính năng Thanh toán qua QR trên Máy POS Android hỗ trợ cửa hàng tạo mã QR và nhận thông báo thanh toán. Để nhận thông báo tự động, bạn cần đảm bảo đã đăng ký dịch vụ nâng cao trên phiên bản máy tính hoặc ứng dụng KiotViet.

**Tình huống**: Khi bạn cần tạo hóa đơn và nhận thông báo thanh toán QR ngay trên máy POS tại quầy.

**Thao tác thực hiện như sau**:

* **Bước 1:**Khi tạo hóa đơn trên máy POS, bạn chọn phương thức thanh toán là **Chuyển khoản/ Ví**.
* **Bước 2:**Chọn đúng tài khoản đã được liên kết dịch vụ.
* **Bước 3:**Hệ thống sẽ hiển thị một mã QR động trên màn hình máy POS hoặc thiết bị KiotViet QR.
* **Bước 4:**Khách hàng dùng ứng dụng ngân hàng để quét mã và thanh toán.

* **Bước 5:**Nếu đã đăng ký dịch vụ nâng cao, thông báo giao dịch thành công sẽ hiển thị ngay trên các thiết bị KiotViet, giúp thu ngân xác nhận và hoàn tất đơn hàng.
