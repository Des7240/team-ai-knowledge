...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-thanh-toan/thanh-toan-qua-vib/
---
...
Nhằm hỗ trợ các gian hàng thúc đẩy việc thanh toán phi tiền mặt, KiotViet kết hợp cùng ngân hàng VIB đã ra mắt tính năng thanh toán chuyển khoản bằng phương pháp quét mã VietQR và nhận thông báo kết quả ngay trên phần mềm.

* **Đối tượng áp dụng**: Tất cả gian hàng trên KiotViet (bao gồm cả gian hàng dùng thử và gian hàng chính thức) có tài khoản tại ngân hàng VIB.

**Lợi ích nổi bật của tính năng**:

* **Giúp chủ cửa hàng và quản lý**: Dễ dàng kích hoạt và quản lý tài khoản nhận thanh toán VIB cho cửa hàng, giúp tập trung theo dõi dòng tiền và đối soát giao dịch một cách hiệu quả.
...
**Tóm tắt luồng hoạt động**: Về cơ bản, luồng hoạt động của tính năng bao gồm 2 bước chính: 1. Kích hoạt dịch vụ nhận thông báo thanh toán (Digi Invoice) của VIB -> 2. Nhận thông báo kết quả giao dịch trên màn hình **Bán hàng**.

Nội dung dưới đây sẽ hướng dẫn chi tiết các thao tác được thực hiện trên phiên bản KiotViet dành cho website.

### **1. Kích hoạt dịch vụ (Digi Invoice)**

Để nhận thông báo thanh toán tự động, bạn cần kích hoạt dịch vụ trực tiếp trên phần mềm KiotViet và xác thực bằng mã OTP.

* **Lưu ý về nguyên tắc liên kết tài khoản VIB**:
  + Mỗi gian hàng KiotViet tại một thời điểm **chỉ có thể liên kết với một tài khoản VIB duy nhất**.
  + Để quá trình kích hoạt thành công, bạn cần đảm bảo đã **đăng nhập vào ứng dụng MyVIB 2.0** trên điện thoại bằng tài khoản tương ứng ít nhất một lần trước đó.

Quá trình này được thực hiện như sau:

**1.1. Đăng ký dịch vụ trên KiotViet**

– Tài khoản admin của chủ gian hàng đăng nhập vào màn hình **Quản lý**, chọn mục **Thanh toán** và nhấn **Đăng ký** tại thẻ **VIB**.

* Hoặc trên màn hình **Bán hàng**,
  + Ngay sau khi ***Lưu*** thông tin thêm tài khoản ngân hàng VIB -> hệ thống hiển thị popup **Bật thông báo thanh toán QR**, bạn chọn ***Bật ngay***
  + Hay khi tạo đơn hàng, bạn chọn phương thức thanh toán ***Chuyển khoản*** -> chọn tài khoản ***VIB*** -> nhấn ***Nhận thông báo tiền về***

– Tiếp theo, bạn chọn số tài khoản VIB cần kích hoạt, đồng ý với điều khoản và chọn **Đăng ký**.

**1.2. Xác thực bằng mã OTP**

– Sau khi nhấn Đăng ký, hệ thống sẽ gửi một mã OTP đến số điện thoại bạn đã đăng ký với ngân hàng VIB.
...
* Thao tác trên màn hình **Bán hàng**:
  + Khi tạo hóa đơn, bạn chọn phương thức thanh toán ***Chuyển khoản*** để hiển thị mã QR của tài khoản VIB đã liên kết.
...
* Để gia tăng hiệu quả và tốc độ xử lý đơn hàng, bạn có thể kết hợp dịch vụ thông báo thanh toán của VIB với các tiện ích như:
...
### **1. Xem thông tin tài khoản VIB đã đăng ký dịch vụ**

* **Tình huống:** Khi bạn cần kiểm tra lại thông tin tài khoản VIB nào đang được kết nối để nhận thông báo tự động trên KiotViet.
* **Thao tác thực hiện như sau:**

1. Tại màn hình **Quản lý**, vào menu **Thanh toán**.
2. Chọn thẻ **VIB** và nhấn **Xem chi tiết** để xem thông tin tài khoản đã liên kết.

### **2. Hủy dịch vụ nhận thông báo thanh toán VIB**

* **Tình huống**: Khi bạn không còn nhu cầu sử dụng dịch vụ nhận thông báo tự động cho tài khoản VIB hiện tại hoặc muốn đổi sang một tài khoản khác.
* **Thao tác thực hiện như sau**:

1. Tại mục xem chi tiết tài khoản (như thao tác trên), nhấn vào nút **Hủy đăng ký**.
2. Xác nhận lại bằng cách nhấn **Hủy đăng ký** một lần nữa.

3. Nhập mã OTP được gửi về số điện thoại đăng ký tài khoản VIB và nhấn **Xác nhận** để hoàn tất.

## **IV. Thao tác trên Điện thoại**

Tại ứng dụng KiotViet trên điện thoại, bạn có thể thực hiện các thao tác tương tự giao diện trên website bao gồm kích hoạt, nhận thông báo kết quả giao dịch và quản lý tài khoản đã liên kết.

### **1. Kích hoạt dịch vụ**

– Từ menu **Nhiều hơn** hoặc **Tổng quan**, bạn chọn mục **Thanh toá**n -> nhấn ***Đăng ký ngay***.

– Chọn thẻ VIB, điền các thông tin cần thiết và nhấn ***Tiếp tục***.
...
### **3. Xem và hủy liên kết**

– Truy cập mục **Thanh toán** và chọn thẻ **VIB**.

– Ứng dụng sẽ hiển thị tài khoản đã liên kết thành công.

– Để hủy dịch vụ, bạn nhấn ***Hủy đăng ký*** và xác thực bằng mã OTP.

## **V. Thao tác trên Máy POS**

Tính năng Thanh toán qua VIB trên Máy POS Android hỗ trợ cửa hàng thực hiện thao tác thanh toán bằng cách hiển thị mã QR của VIB cho khách hàng.

* **Tình huống**: Khi bạn đang bán hàng tại quầy và muốn khách hàng thanh toán bằng cách quét mã QR của VIB trên màn hình máy POS.
* **Thao tác thực hiện như sau**:

1. Đảm bảo bạn đã thêm tài khoản VIB và kích hoạt dịch vụ trên phiên bản máy tính hoặc ứng dụng di động.
2. Khi tạo hóa đơn trên máy POS, chọn phương thức thanh toán là **Chuyển khoản** và chọn tài khoản VIB đã liên kết.
