...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-thiet-lap-ban-dau-hddt/thiet-lap-hoa-don-dien-tu-khi-ban-xe-may-o-to/
---
...
Hỗ trợ
Thiết lập ban đầu HĐĐTQuy định phát hành HĐĐT khi kinh doanh xe ô tô, mô tô, xe máy

# **Quy định phát hành HĐĐT khi kinh doanh xe ô tô, mô tô, xe máy**

## **1. Bối cảnh & Quy định bắt buộc**

Căn cứ theo **Nghị định 254/2026/NĐ-CP** (hướng dẫn thi hành Luật Quản lý thuế số 108/2025/QH15) và **Quyết định số 1233/QĐ-CT** (ban hành quy định về thành phần chứa dữ liệu nghiệp vụ hóa đơn, chứng từ điện tử và phương thức truyền nhận với cơ quan thuế), các cá nhân, hộ kinh doanh và doanh nghiệp kinh doanh xe ô tô, mô tô, xe máy cần nắm rõ và tuân thủ các quy định mới sau đây:

* **Không áp dụng hóa đơn từ máy tính tiền:** Với hàng hóa là ô tô, mô tô, xe máy các loại không được sử dụng mẫu hóa đơn điện tử (HĐĐT) có mã được khởi tạo từ máy tính tiền.
* **Điều kiện áp dụng:** Người nộp thuế cần có tờ khai đăng ký sử dụng HĐĐT với hình thức “Hóa đơn có mã” được cơ quan thuế chấp nhận.
* **Bổ sung các trường thông tin bắt buộc:** Hóa đơn hợp lệ phải có đầy đủ: Số khung, Số máy, Loại sản phẩm kinh doanh xe,...
* **Lợi ích thiết thực:** Xuất hóa đơn đúng mẫu mới giúp hệ thống thuế tự động liên thông dữ liệu kê khai lệ phí trước bạ, thông báo nộp lệ phí trước bạ sẽ được gửi tự động trực tiếp đến người mua, rút ngắn đáng kể thời gian làm thủ tục lăn bánh.

## **2. Các bước cần thực hiện**

Nhằm chuẩn hóa quy trình nghiệp vụ và phòng ngừa tối đa rủi ro sai sót dữ liệu khi phát hành hóa đơn điện tử, các gian hàng cần lưu ý thay đổi thiết lập tại phần mềm Quản lý bán hàng KiotViet và phần mềm Hóa đơn điện tử theo các bước sau:

* **Bước 1: Chuẩn bị tờ khai và cài đặt mẫu hóa đơn**
  + Kiểm tra **Tờ khai sử dụng HĐĐT** đã được CQT chấp nhận mới nhất có ***Hình thức hóa đơn Có mã của cơ quan thuế*** hay chưa.

* Nếu chưa, cần lập tờ khai đăng ký bổ sung. Khi đã được cơ quan thuế chấp nhận →  tiến hành tạo mẫu **Hóa đơn kinh doanh xe** trên phần mềm HĐĐT.

* **Bước 2: Tắt tính năng tự động phát hành hóa đơn điện tử khi bán hàng trên phần mềm Quản lý bán hàng KiotViet**
  + Tại màn hình **Thiết lập** → **Hóa đơn điện tử** → **KHÔNG** tích ***Phát hành hóa đơn điện tử ngay trên Màn hình bán hàng***.

* Hoặc khi bán sản phẩm là xe ô tô, mô tô, xe máy → **KHÔNG** tích ***Phát hành hóa đơn điện tử***.

* Áp dụng tương tự trên App KiotViet trên điện thoại và máy Pos.

* **Bước 3: Chuyển nháp hóa đơn từ màn hình Quản lý**
  + Sau khi tạo hóa đơn bán hàng thành công, bạn vào màn hình **Quản lý** → **Đơn hàng** → **Hóa đơn** → tích chọn hóa đơn bán xe → chọn 3 chấm → ***Chuyển hóa đơn điện tử*** → xác nhận ***Chuyển***.
  + Lưu ý: Chọn đúng mẫu hóa đơn kinh doanh xe đã thiết lập ở Bước 1.

* **Bước 4: Bổ sung thông tin xe và Ký phát hành**
  + Truy cập phần mềm HĐĐT → vào danh sách hóa đơn nháp vừa chuyển sang → nhấn ***Chỉnh sửa*** trên từng hóa đơn.

* Sửa lại ***Tính chất hàng hóa, dịch vụ*** của ô tô/ mô tô/ xe máy sang loại ***Hàng hóa đặc trưng*** để nhập các thông tin người mua và thông tin phương tiện bắt buộc. (Chi tiết tại đây)

* Nhấn ***Phát hành*** và ký số để chính thức gửi cơ quan thuế.

**Lưu ý**: Quy định về nội dung và biểu mẫu hóa đơn là bắt buộc chung theo Luật Thuế. Nếu gian hàng sử dụng HĐĐT của bên thứ ba tích hợp với KiotViet (như MISA meInvoice, VNPT, Viettel...), quy trình thực hiện là hoàn toàn tương tự: khởi tạo mẫu xe trên hệ thống nhà cung cấp tương ứng, sau đó chuyển nháp từ KiotViet sang để hoàn thiện thông tin xe và phát hành.
