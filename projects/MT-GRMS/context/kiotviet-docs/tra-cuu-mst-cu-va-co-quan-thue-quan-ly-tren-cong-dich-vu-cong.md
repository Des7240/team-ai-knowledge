...
source_url: https://www.kiotviet.vn/huong-dan-su-dung-kiotviet/retail-to-khai-thue-hkd/tra-cuu-mst-cu-va-co-quan-thue-quan-ly-tren-cong-dich-vu-cong/
---
...
Hỗ trợ
Tờ khai Thuế HKDTra cứu MST cũ và Cơ quan thuế quản lý trên cổng Dịch vụ công

# **Tra cứu MST cũ và Cơ quan thuế quản lý trên cổng Dịch vụ công**

## **I. Giới thiệu chung**

Kê khai và nộp thuế là nghĩa vụ quan trọng của mỗi cơ sở kinh doanh, tuy nhiên việc tìm kiếm chính xác các thông tin như mã số thuế cũ hay cơ quan quản lý đôi khi làm gián đoạn công việc của bạn. Nắm bắt được khó khăn đó, bài viết này sẽ hướng dẫn bạn cách tra cứu thông tin nhanh chóng và chuẩn xác nhất.

* **Đối tượng áp dụng:** Hộ kinh doanh, cá nhân kinh doanh trên KiotViet cần thông tin để thực hiện nghĩa vụ thuế.
* **Lợi ích nổi bật của tính năng:**
  + Giúp bạn chủ động tra cứu chính xác mã số thuế cũ và thông tin cơ quan thuế quản lý trực tiếp trên hệ thống Dịch vụ công của Chính phủ.
  + Đảm bảo tính minh bạch, chính xác về dữ liệu cửa hàng, phục vụ kịp thời và hợp lệ cho các nghiệp vụ kê khai, nộp thuế định kỳ.

​

## **II. Thao tác tra cứu thông tin trên Cổng dịch vụ công**

**Tình huống:** Khi bạn cần lấy thông tin mã số thuế cũ và mã cơ quan thuế quản lý để phục vụ cho việc kê khai, bạn cần thực hiện tra cứu trực tiếp trên hệ thống của Cổng Dịch vụ công.

**Thao tác thực hiện như sau:**

* **Bước 1:** Truy cập cổng Dịch vụ công và đăng nhập vào tài khoản hộ kinh doanh của bạn.
* **Bước 2:** Chọn **Hộ, cá nhân kinh doanh**.

* **Bước 3:** Tại màn **Dịch vụ dành cho hộ, cá nhân kinh doanh**, nhấn **Tiếp tục**.

* **Bước 4:** Tại mục **Đăng ký thuế/Hóa đơ**n, chọn **Quản lý địa điểm kinh doanh**.

* **Bước 5:** Tại đây, hệ thống sẽ hiển thị danh sách các địa điểm kinh doanh đã đăng ký. Bạn xem thông tin **MST cũ**, **Mã CQT quản lý** và **Tên CQT quản lý** tại cột tương ứng để phục vụ cho việc kê khai.
